...
// src/cores/host/scanner/ports.rs
...
pub fn common_ports() -> Vec<u16> {
    vec![
        21, 22, 23, 25, 53, 80, 110, 143, 443, 445, 993, 995, 1723, 3306, 3389, 5900, 8080, 8443,
    ]
}
...
impl<'a> PortIterator<'a> {
    pub fn new(host: IpAddr, ports: &'a [u16]) -> Self {
        Self {
            host,
            ports,
            index: 0,
