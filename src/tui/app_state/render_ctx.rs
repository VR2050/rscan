...
impl AppState {
    pub(crate) fn render_ctx<'a>(&'a self, footer_text: &'a str) -> RenderCtx<'a> {
        RenderCtx {
            ...
            dashboard_total: self.dashboard_total,
            dashboard_running: self.dashboard_running,
            dashboard_failed: self.dashboard_failed,
            dashboard_succeeded: self.dashboard_succeeded,
            dashboard_lines: &self.dashboard_lines,
            dashboard_recent_items: &self.dashboard_recent_items,
