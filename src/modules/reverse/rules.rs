...
pub struct RuleLibrary {
    ...
    pub obfuscation_keywords: Vec<String>,
    ...
    fn default() -> Self {
        Self {
            anti_debug_keywords: vec![
                ...
                "zwqueryinformationprocess".to_string(),
                "rdtsc".to_string(),
                "rdtscp".to_string(),
                "prctl".to_string(),
                "seccomp".to_string(),
            ...
            obfuscation_keywords: vec![
                "obfuscator".to_string(),
                "vmprotect".to_string(),
                "themida".to_string(),
                "confuser".to_string(),
                "dexguard".to_string(),
            ...
            suspicious_string_keywords: vec![
                ...
                "sh -c".to_string(),
                "su -c".to_string(),
                "frida-server".to_string(),
                "magisk".to_string(),
                "xposedbridge".to_string(),
            ...
            packer_string_keywords: vec![
                ...
                "secneo".to_string(),
                "ijiami".to_string(),
                "dexprotector".to_string(),
                "shellapplication".to_string(),
            ],
