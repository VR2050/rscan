...
public class FcRecommendFragment extends CommFcListFragment implements NotificationCenter.NotificationCenterDelegate, FcItemActionClickListener, BaseFcContract.IFcPageRecommendView, FcDoReplyDialog.OnFcDoReplyListener {
    ...
    RecyclerView.OnScrollListener rvScrollListener = new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.fragments.FcRecommendFragment.3
    ...
    protected void initView() {
        ...
        this.mSmartRefreshLayout.setOnRefreshLoadMoreListener(new OnRefreshLoadMoreListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.fragments.FcRecommendFragment.1
    ...
    private void initEmptyView() {
        ...
        this.emptyView.setOnEmptyClickListener(new MryEmptyView.OnEmptyOrErrorClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.fragments.-$$Lambda$FcRecommendFragment$57OlqjXsNcEEFnzJahAMbhdJRv0
            ...
            public final boolean onEmptyViewButtonClick(boolean z) {
                return this.f$0.lambda$initEmptyView$0$FcRecommendFragment(z);
            }
        });
    ...
    public void onVisible() {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.fragments.FcRecommendFragment.2
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        ...
        if (id == NotificationCenter.fcDeleteReplyItem) {
            ...
            if (!TextUtils.equals(this.TAG, tag7)) {
                ...
                if (fcHomeAdapter5 != null && forumId3 > 0 && commentId > 0) {
                    ...
                    for (int i7 = 0; i7 < dataList7.size(); i7++) {
                        ...
                        if (respFcListBean8 != null && respFcListBean8.getForumID() == forumId3) {
                            int parentPosition2 = i7;
                            parentPosition = parentPosition2;
                            break;
                        }
                    }
                    parentPosition = -1;
                ...
                if (parentPosition != -1) {
                    doDeleteReplySuccAfterViewChange(forumId3, commentId, parentPosition, -1);
                    return;
                }
                return;
            }
        ...
        if (id == NotificationCenter.fcPublishSuccess) {
            ...
            if (!TextUtils.equals(this.TAG, tag8) && (respFcListBean = (RespFcListBean) args[1]) != null && respFcListBean.isRecommend()) {
    ...
    private void getDBCache() {
        ...
        for (RecommendFcListBean recommendFcListBean : queryAll) {
    ...
    public void getFcListSucc(ArrayList<RespFcListBean> data) {
        ...
        if (data != null) {
            ...
            for (RespFcListBean respFcListBean : data) {
                tempInsertList.add(new RecommendFcListBean(respFcListBean));
            }
    ...
    public void onAction(View view, int index, final int position, Object object) {
        ...
        if (index == FcHomeAdapter.Index_click_pop_delete) {
            if (object instanceof RespFcListBean) {
                ...
                FcDialogUtil.chooseIsDeleteMineItemDialog(this, new FcDialog.OnConfirmClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.fragments.-$$Lambda$FcRecommendFragment$xC8ZjWn2esFeX8HPaVRdMQaL-5M
                    @Override // im.uwrkaxlmjj.ui.dialogs.FcDialog.OnConfirmClickListener
                    public final void onClick(View view2) {
                        this.f$0.lambda$onAction$1$FcRecommendFragment(position, model2, view2);
                    }
                }, null);
                return;
            }
        ...
        if (index == FcHomeAdapter.Index_click_pop_shield_item) {
            if (object instanceof RespFcListBean) {
                ...
                FcDialogUtil.chooseIsSetOtherFcItemPrivacyDialog(this, new FcDialog.OnConfirmClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.fragments.-$$Lambda$FcRecommendFragment$ksXkXfILRqIk0FPxkgodK5dHeXo
                    @Override // im.uwrkaxlmjj.ui.dialogs.FcDialog.OnConfirmClickListener
                    public final void onClick(View view2) {
                        this.f$0.lambda$onAction$2$FcRecommendFragment(position, model3, view2);
                    }
                }, null);
                return;
            }
        ...
        if (index == FcHomeAdapter.Index_click_pop_shield_user) {
            if (object instanceof RespFcListBean) {
                ...
                FcDialogUtil.choosePrivacyAllFcDialog(this, new FcDialog.OnConfirmClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.fragments.-$$Lambda$FcRecommendFragment$OjDfbiWiteih7jeYzIztkTTuECE
                    @Override // im.uwrkaxlmjj.ui.dialogs.FcDialog.OnConfirmClickListener
                    public final void onClick(View view2) {
                        this.f$0.lambda$onAction$3$FcRecommendFragment(model4, view2);
                    }
                }, null);
                return;
            }
    ...
    protected void doLikeAfterViewChange(int position, boolean isLike, FcLikeBean data) {
        ...
        if (data != null) {
            ...
            updateLocalItemLikeStatus(RecommendFcListBean.class, model.getForumID(), isLike, model.getThumbUp());
        }
    }
    ...
    public void doDeleteReplySuccAfterViewChange(long forumId, long commentId, int parentPosition, int childPosition) {
        ...
        if (respFcListBean != null) {
            ...
            if (respFcListBean != null) {
                ...
                deleteLocalReply(RecommendFcListBean.class, forumId, commentId, commentCount);
            }
        }
    }
