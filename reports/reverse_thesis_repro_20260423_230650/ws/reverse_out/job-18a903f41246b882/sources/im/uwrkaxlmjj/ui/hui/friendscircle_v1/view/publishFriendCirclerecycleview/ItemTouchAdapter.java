...
public abstract class ItemTouchAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements ItemTouchHelperAdapter<T> {
    ...
    protected RecyclerView.AdapterDataObserver mObserver = new RecyclerView.AdapterDataObserver() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.view.publishFriendCirclerecycleview.ItemTouchAdapter.1
    ...
    @Override // im.uwrkaxlmjj.ui.hui.friendscircle_v1.view.publishFriendCirclerecycleview.ItemTouchHelperAdapter
