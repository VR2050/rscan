...
import im.uwrkaxlmjj.javaBean.fc.RequestFcReportBean;
...
public class FcReportActivity extends CommFcActivity {
    ...
    public FcReportActivity(long ForumID) {
    ...
    protected void initActionBar() {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.ui.FcReportActivity.1
    ...
    protected void initView() {
        initActionBar();
        FrameLayout frameLayout = (FrameLayout) this.fragmentView.findViewById(R.attr.container);
        this.container = frameLayout;
        frameLayout.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        this.submit = (ColorTextView) this.fragmentView.findViewById(R.attr.submit);
        this.lin_report1 = (LinearLayout) this.fragmentView.findViewById(R.attr.lin_report1);
        this.lin_report2 = (LinearLayout) this.fragmentView.findViewById(R.attr.lin_report2);
        this.lin_report3 = (LinearLayout) this.fragmentView.findViewById(R.attr.lin_report3);
        this.lin_report4 = (LinearLayout) this.fragmentView.findViewById(R.attr.lin_report4);
        ...
        this.img_report1 = (ImageView) this.fragmentView.findViewById(R.attr.img_report1);
        this.img_report2 = (ImageView) this.fragmentView.findViewById(R.attr.img_report2);
        this.img_report3 = (ImageView) this.fragmentView.findViewById(R.attr.img_report3);
        this.img_report4 = (ImageView) this.fragmentView.findViewById(R.attr.img_report4);
        ...
        this.fragmentView.findViewById(R.attr.lin_report1).setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.ui.FcReportActivity.2
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FcReportActivity.this.changeImgStatus(1);
            }
        });
        this.fragmentView.findViewById(R.attr.lin_report2).setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.ui.FcReportActivity.3
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FcReportActivity.this.changeImgStatus(2);
            }
        });
        this.fragmentView.findViewById(R.attr.lin_report3).setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.ui.FcReportActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FcReportActivity.this.changeImgStatus(3);
            }
        });
        this.fragmentView.findViewById(R.attr.lin_report4).setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.ui.FcReportActivity.5
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                FcReportActivity.this.changeImgStatus(4);
            }
        });
        this.fragmentView.findViewById(R.attr.submit).setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.ui.FcReportActivity.6
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
