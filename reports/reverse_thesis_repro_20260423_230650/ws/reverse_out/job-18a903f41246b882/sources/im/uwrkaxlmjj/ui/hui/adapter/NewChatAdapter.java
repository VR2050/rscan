...
public class NewChatAdapter extends RecyclerListView.SectionsAdapter {
    ...
    public void sortOnlineContacts() {
        ...
        try {
            ...
            Collections.sort(this.onlineContacts, new Comparator() { // from class: im.uwrkaxlmjj.ui.hui.adapter.-$$Lambda$NewChatAdapter$r53ZZT3vX_aY9Gh88Wj5t8W1Lo4
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return NewChatAdapter.lambda$sortOnlineContacts$0(messagesController, currentTime, (TLRPC.Contact) obj, (TLRPC.Contact) obj2);
                }
            });
            notifyDataSetChanged();
        } catch (Exception e) {
    ...
    public void onBindViewHolder(int section, int position, RecyclerView.ViewHolder holder) {
        ...
        if (section == 0) {
            if (this.needPhonebook) {
                if (position == 0) {
                    textCell.setTextAndIcon(LocaleController.getString("NewSecretChat", R.string.NewSecretChat), R.id.icon_new_secret_chat, true);
                } else if (position == 1) {
                    textCell.setTextAndIcon(LocaleController.getString("NewGroup", R.string.NewGroup), R.id.fmt_contacts_groups, true);
                } else if (position == 2) {
                    textCell.setTextAndIcon(LocaleController.getString("NewChannel", R.string.NewChannel), R.id.fmt_contacts_channel, true);
                }
