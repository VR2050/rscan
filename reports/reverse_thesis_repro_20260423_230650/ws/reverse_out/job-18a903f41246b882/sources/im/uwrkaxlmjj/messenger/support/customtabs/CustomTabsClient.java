...
public class CustomTabsClient {
    ...
    public static String getPackageName(Context context, List<String> packages, boolean ignoreDefault) {
        ...
        Intent activityIntent = new Intent("android.intent.action.VIEW", Uri.parse(DefaultWebClient.HTTP_SCHEME));
    ...
    public static boolean connectAndInitialize(Context context, String packageName) {
        ...
        CustomTabsServiceConnection connection = new CustomTabsServiceConnection() { // from class: im.uwrkaxlmjj.messenger.support.customtabs.CustomTabsClient.1
    ...
    public CustomTabsSession newSession(final CustomTabsCallback callback) {
        ICustomTabsCallback.Stub wrapper = new ICustomTabsCallback.Stub() { // from class: im.uwrkaxlmjj.messenger.support.customtabs.CustomTabsClient.2
            ...
            public void onNavigationEvent(final int navigationEvent, final Bundle extras) {
                ...
                this.mHandler.post(new Runnable() { // from class: im.uwrkaxlmjj.messenger.support.customtabs.CustomTabsClient.2.1
            ...
            public void extraCallback(final String callbackName, final Bundle args) throws RemoteException {
                ...
                this.mHandler.post(new Runnable() { // from class: im.uwrkaxlmjj.messenger.support.customtabs.CustomTabsClient.2.2
                    @Override // java.lang.Runnable
                    public void run() {
            ...
            public void onMessageChannelReady(final Bundle extras) throws RemoteException {
                ...
                this.mHandler.post(new Runnable() { // from class: im.uwrkaxlmjj.messenger.support.customtabs.CustomTabsClient.2.3
                    @Override // java.lang.Runnable
                    public void run() {
            ...
            public void onPostMessage(final String message, final Bundle extras) throws RemoteException {
                ...
                this.mHandler.post(new Runnable() { // from class: im.uwrkaxlmjj.messenger.support.customtabs.CustomTabsClient.2.4
                    @Override // java.lang.Runnable
                    public void run() {
