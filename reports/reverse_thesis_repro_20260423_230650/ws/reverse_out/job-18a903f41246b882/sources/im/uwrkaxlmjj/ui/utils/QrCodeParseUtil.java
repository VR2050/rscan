...
public class QrCodeParseUtil {
    ...
    */
    ...
    static /* synthetic */ void lambda$runLinkRequest$7(final int currentAccount, final AlertDialog finalProgressDialog, final Object hostObj, final TLObject response, final TLRPC.TL_error error) throws Exception {
        if (error == null) {
