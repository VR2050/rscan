...
public class StartChatAdapter extends RecyclerListView.SectionsAdapter {
    ...
    public void sortOnlineContacts() {
        ...
        try {
            ...
            Collections.sort(this.onlineContacts, new Comparator() { // from class: im.uwrkaxlmjj.ui.hui.adapter.-$$Lambda$StartChatAdapter$DEJb-zAyjU1uiAEMHwTIBVU2aNA
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return StartChatAdapter.lambda$sortOnlineContacts$0(messagesController, currentTime, (TLRPC.Contact) obj, (TLRPC.Contact) obj2);
                }
            });
            notifyDataSetChanged();
        } catch (Exception e) {
    ...
    public void onBindViewHolder(int section, int position, RecyclerView.ViewHolder holder) {
        ...
        if (itemViewType == 1) {
            if (section != 0 || !this.needPhonebook) {
            }
            return;
        }
        if (itemViewType == 2) {
