...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void show(Activity activity, Runnable closeRunnable) {
        ...
        FrameLayout frameLayout = new FrameLayout(activity) { // from class: im.uwrkaxlmjj.ui.components.PipRoundVideoView.1
            ...
            public boolean onTouchEvent(MotionEvent event) {
                ...
                if (event.getAction() == 2) {
                    ...
                    if (this.startDragging) {
                        ...
                        PipRoundVideoView.this.windowLayoutParams.x = (int) (r1.x + dx);
                        PipRoundVideoView.this.windowLayoutParams.y = (int) (r1.y + dy);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(activity) { // from class: im.uwrkaxlmjj.ui.components.PipRoundVideoView.2
                @Override // android.view.ViewGroup
            ...
            aspectRatioFrameLayout.setOutlineProvider(new ViewOutlineProvider() { // from class: im.uwrkaxlmjj.ui.components.PipRoundVideoView.3
            ...
            AspectRatioFrameLayout aspectRatioFrameLayout2 = new AspectRatioFrameLayout(activity) { // from class: im.uwrkaxlmjj.ui.components.PipRoundVideoView.4
        ...
        this.aspectRatioFrameLayout.addView(textureView, LayoutHelper.createFrame(-1, -1.0f));
    ...
    public void showTemporary(boolean show) {
        ...
        this.hideShowAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.PipRoundVideoView.5
    ...
    private void runShowHideAnimation(final boolean show) {
        ...
        this.hideShowAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.PipRoundVideoView.6
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
                if (animation.equals(PipRoundVideoView.this.hideShowAnimation)) {
                    if (!show) {
    ...
    public void animateToBoundsMaybe() {
        ...
        if (animators != null) {
            ...
            if (slideOut) {
                ...
                animatorSet.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.PipRoundVideoView.7
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animation) {
                        PipRoundVideoView.this.close(false);
