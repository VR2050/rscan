...
public class SimpleTextView extends View implements Drawable.Callback {
    ...
    public int getSideDrawablesSize() {
        ...
        int size = drawable != null ? 0 + drawable.getIntrinsicWidth() + this.drawablePadding : 0;
        ...
        if (this.text != null) {
            try {
                ...
                if (this.scrollNonFitText) {
                    ...
                    CharSequence string2 = this.text;
                    string = TextUtils.ellipsize(string2, this.textPaint, width, TextUtils.TruncateAt.END);
                }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            ...
            textOffsetX = (this.gravity & 7) == 3 ? 0 + this.drawablePadding + this.leftDrawable.getIntrinsicWidth() : 0;
        ...
        if (this.layout != null) {
            ...
            if (this.scrollNonFitText && (this.textDoesNotFit || this.scrollingOffset != 0.0f)) {
                if (this.scrollingOffset < AndroidUtilities.dp(10.0f)) {
                    ...
                    this.fadeDrawable.setAlpha((int) ((1.0f - (dist / AndroidUtilities.dp(10.0f))) * 255.0f));
                } else {
    ...
    public int getTextWidth() {
        int totalWidth = this.textWidth;
        Drawable drawable = this.leftDrawable;
        if (drawable != null) {
            totalWidth += drawable.getIntrinsicWidth() + this.drawablePadding;
        }
        Drawable drawable2 = this.rightDrawable;
        if (drawable2 != null) {
            return totalWidth + drawable2.getIntrinsicWidth() + this.drawablePadding;
        }
        return totalWidth;
    }
    ...
    private void updateScrollAnimation() {
        ...
        if (this.scrollNonFitText) {
            ...
            if (i > 0) {
                ...
                float fDp = this.scrollingOffset + ((dt / 1000.0f) * AndroidUtilities.dp(pixelsPerSecond));
                this.scrollingOffset = fDp;
                this.lastUpdateTime = newUpdateTime;
                if (fDp > totalDistance) {
                    this.scrollingOffset = 0.0f;
                    this.currentScrollDelay = 500;
                }
            }
