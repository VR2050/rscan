...
public class ChatObject {
    ...
    public static boolean canUserDoAction(TLRPC.Chat chat, int action) {
        ...
        return (chat.default_banned_rights == null || getBannedRight(chat.default_banned_rights, action)) ? false : true;
    }
    ...
    public static boolean hasAdminRights(TLRPC.Chat chat) {
        if (chat != null) {
            ...
            return chat.megagroup ? (chat.admin_rights == null || (chat.admin_rights.flags & 542) == 0) ? false : true : (!isChannel(chat) || chat.admin_rights == null || chat.admin_rights.flags == 0 || chat.admin_rights.flags == 64) ? false : true;
        }
        return false;
    }
