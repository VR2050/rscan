...
public class JoinGroupAlert extends BottomSheet {
    ...
    public /* synthetic */ void lambda$null$2$JoinGroupAlert(final TLRPC.TL_messages_importChatInvite req, final TLObject response, final TLRPC.TL_error error) throws Exception {
        if (error == null) {
