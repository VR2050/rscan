...
public class BrightnessControlCell extends FrameLayout {
    ...
    public BrightnessControlCell(Context context) {
        ...
        SeekBarView seekBarView = new SeekBarView(context) { // from class: im.uwrkaxlmjj.ui.cells.BrightnessControlCell.1
        ...
        this.seekBarView.setDelegate(new SeekBarView.SeekBarViewDelegate() { // from class: im.uwrkaxlmjj.ui.cells.-$$Lambda$zKuT5AqqM0qFB3SlAa-w8UjlCXk
