...
public class InviteUserCell extends FrameLayout {
    ...
    public InviteUserCell(Context context, boolean needCheck) {
        ...
        if (needCheck) {
            ...
            addView(this.checkBox, LayoutHelper.createFrame(24.0f, 24.0f, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 0.0f : 40.0f, 40.0f, LocaleController.isRTL ? 39.0f : 0.0f, 0.0f));
        }
    }
