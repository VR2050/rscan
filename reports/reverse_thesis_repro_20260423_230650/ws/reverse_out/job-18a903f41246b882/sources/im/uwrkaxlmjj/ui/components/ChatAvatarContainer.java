...
public class ChatAvatarContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ChatAvatarContainer(Context context, ChatActivity chatActivity, boolean needTime) {
        ...
        if (needTime) {
            ...
            this.timeItem.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$ChatAvatarContainer$3dx0Ay5nbrvmNdHNATxmYZ-afk0
        ...
        if (chatActivity2 != null && !chatActivity2.isInScheduleMode()) {
            setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$ChatAvatarContainer$cmoJH19e6ruifIM1KE2JRqayqZ4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$new$1$ChatAvatarContainer(view);
                }
            });
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int viewTop = ((actionBarHeight - AndroidUtilities.dp(32.0f)) / 2) + ((Build.VERSION.SDK_INT < 21 || !this.occupyStatusBar) ? 0 : AndroidUtilities.statusBarHeight);
        ...
        if (this.subtitleTextView.getVisibility() == 0) {
            this.titleTextView.layout(AndroidUtilities.dp(45), AndroidUtilities.dp(1.3f) + viewTop, AndroidUtilities.dp(45) + this.titleTextView.getMeasuredWidth(), this.titleTextView.getTextHeight() + viewTop + AndroidUtilities.dp(1.3f));
        } else {
            this.titleTextView.layout(AndroidUtilities.dp(45), AndroidUtilities.dp(11.0f) + viewTop, AndroidUtilities.dp(45) + this.titleTextView.getMeasuredWidth(), this.titleTextView.getTextHeight() + viewTop + AndroidUtilities.dp(11.0f));
        }
        ImageView imageView = this.timeItem;
        if (imageView != null) {
        ...
        this.subtitleTextView.layout(AndroidUtilities.dp(45), AndroidUtilities.dp(20.0f) + viewTop, AndroidUtilities.dp(45) + this.subtitleTextView.getMeasuredWidth(), this.subtitleTextView.getTextHeight() + viewTop + AndroidUtilities.dp(20.0f));
    }
        ...
        if (printString == null || printString.length() == 0 || (ChatObject.isChannel(chat) && !chat.megagroup)) {
            ...
            if (chat != null) {
                ...
                if (ChatObject.isChannel(chat)) {
                    if (info != null && info.participants_count != 0) {
                        if (chat.megagroup) {
                            ...
                            if (chat.megagroup) {
                                newSubtitle2 = LocaleController.formatPluralString("Members", result[0]).replace(String.format("%d", Integer.valueOf(result[0])), shortNumber);
                            } else {
                                newSubtitle2 = LocaleController.formatPluralString("Subscribers", result[0]).replace(String.format("%d", Integer.valueOf(result[0])), shortNumber);
                            }
                        ...
                        if (info == null) {
                            ...
                            CharSequence newSubtitle3 = chat.username;
                            if (!TextUtils.isEmpty(newSubtitle3)) {
                    ...
                    if (this.onlineCount > 1 && count != 0) {
                        ...
                        CharSequence newSubtitle4 = LocaleController.formatPluralString("Members", count);
                        newSubtitle = newSubtitle4;
                    }
                }
            } else if (user != null) {
                ...
                if (user.id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                    ...
                    zArr[0] = false;
                    String newStatus = LocaleController.formatUserStatus(this.currentAccount, user, zArr);
    ...
    public void checkAndUpdateAvatar() {
        ...
        if (chat != null) {
            ...
            if (backupImageView3 != null) {
                backupImageView3.setImage(ImageLocation.getForChat(chat, false), "50_50", this.avatarDrawable, chat);
            }
        }
    }
