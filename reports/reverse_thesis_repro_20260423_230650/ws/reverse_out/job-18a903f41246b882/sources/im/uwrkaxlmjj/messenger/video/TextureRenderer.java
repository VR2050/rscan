...
public class TextureRenderer {
    ...
    public TextureRenderer(int rotation) {
        ...
        FloatBuffer floatBufferAsFloatBuffer = ByteBuffer.allocateDirect(mTriangleVerticesData.length * 4).order(ByteOrder.nativeOrder()).asFloatBuffer();
        this.mTriangleVertices = floatBufferAsFloatBuffer;
        floatBufferAsFloatBuffer.put(mTriangleVerticesData).position(0);
