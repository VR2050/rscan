...
public class VoIPHelper {
    ...
    static class AnonymousClass7 implements View.OnClickListener {
        ...
        static /* synthetic */ void lambda$onClick$0(int currentAccount, boolean[] includeLogs, File log, TLRPC.TL_phone_setCallRating req, ArrayList problemTags, TLObject response, TLRPC.TL_error error) throws Exception {
