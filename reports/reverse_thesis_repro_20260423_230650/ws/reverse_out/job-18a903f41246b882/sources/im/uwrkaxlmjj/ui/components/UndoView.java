...
public class UndoView extends FrameLayout {
    ...
    public UndoView(Context context) {
        ...
        this.undoButton.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$UndoView$Pz2a0PU_lEM-8impqKuw6S3tFuM
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$UndoView$VBFqwNi3CQI2G3-fRZR7GY2434c
    ...
    public void hide(boolean apply, int animated) {
        ...
        if (animated != 0) {
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.UndoView.1
    ...
    public void showWithAction(long did, int action, Object infoObject, Runnable actionRunnable, Runnable cancelRunnable) {
        ...
        if (!isTooltipAction()) {
            ...
            if (i2 == 2 || i2 == 4) {
                ...
                MessagesController.getInstance(this.currentAccount).addDialogAction(did, this.currentAction == 0);
                i = 2;
            }
        } else {
            int size = 36;
            if (action == 9 || action == 10) {
                ...
                if (action == 3) {
                    ...
                    CharSequence infoText2 = LocaleController.getString("ChatsArchived", R.string.ChatsArchived);
                    infoText = infoText2;
                }
            ...
            if (subInfoText != null) {
                ...
                layoutParams4.leftMargin = AndroidUtilities.dp(58.0f);
        ...
        if (hasSubInfo()) {
            ...
            int width2 = parent.getMeasuredWidth();
            if (width2 != 0) {
                width = width2;
            } else {
        ...
        if (getVisibility() != 0) {
            ...
            fArr[0] = AndroidUtilities.dp(8.0f) + this.undoViewHeight;
            fArr[1] = -this.additionalTranslationY;
            animatorSet.playTogether(ObjectAnimator.ofFloat(this, (Property<UndoView, Float>) property, fArr));
            animatorSet.setInterpolator(new DecelerateInterpolator());
            animatorSet.setDuration(180L);
            animatorSet.start();
        }
    ...
    protected void onDraw(Canvas canvas) {
        int i = this.currentAction;
        if (i == 1 || i == 0) {
            int newSeconds = this.timeLeft > 0 ? (int) Math.ceil(r4 / 1000.0f) : 0;
            if (this.prevSeconds != newSeconds) {
                this.prevSeconds = newSeconds;
                this.timeLeftString = String.format("%d", Integer.valueOf(Math.max(1, newSeconds)));
