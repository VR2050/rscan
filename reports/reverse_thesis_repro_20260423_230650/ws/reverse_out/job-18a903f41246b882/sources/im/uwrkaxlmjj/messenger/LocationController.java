...
public class LocationController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$null$10$LocationController(TLObject response, TLRPC.TL_error error) throws Exception {
        if (error != null) {
            return;
        }
    ...
    public /* synthetic */ void lambda$null$13$LocationController(TLObject response, TLRPC.TL_error error) throws Exception {
        if (error != null) {
            return;
        }
        getMessagesController().processUpdates((TLRPC.Updates) response, false);
