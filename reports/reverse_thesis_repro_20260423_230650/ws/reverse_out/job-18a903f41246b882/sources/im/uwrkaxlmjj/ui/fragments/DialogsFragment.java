...
public class DialogsFragment extends BaseFmts implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$didReceivedNotification$9$DialogsFragment(TLRPC.Chat chat, long dialogId, boolean revoke) {
    ...
    public /* synthetic */ void lambda$null$14$DialogsFragment(TLRPC.Chat chat, final TLRPC.Dialog dialog, final boolean param) {
    ...
    public /* synthetic */ void lambda$null$13$DialogsFragment(TLRPC.Dialog dialog, boolean param) {
    ...
    public /* synthetic */ void lambda$null$15$DialogsFragment(TLRPC.Chat chat, TLRPC.Dialog dialog, boolean param) {
        if (chat == null || ChatObject.isNotInChat(chat)) {
    ...
    public /* synthetic */ void lambda$performMenuClick$19$DialogsFragment(ArrayList copy) {
    ...
    public /* synthetic */ void lambda$showDeleteOrClearSheet$20$DialogsFragment(BottomDialog bottomDialog, int id, View v) {
        if (id == 0) {
    ...
    public void perfromSelectedDialogsAction(final int action) {
    ...
    public /* synthetic */ void lambda$perfromSelectedDialogsAction$21$DialogsFragment(ArrayList copy) {
        getMessagesController().addDialogToFolder(copy, this.folderId == 0 ? 0 : 1, -1, null, 0L);
    }

    public /* synthetic */ void lambda$perfromSelectedDialogsAction$23$DialogsFragment(final int action, final TLRPC.Chat chat, final long selectedDialog, final boolean isBot, final boolean param) {
        toggleEditModel();
    ...
    public /* synthetic */ void lambda$null$22$DialogsFragment(int action, long selectedDialog, boolean param, TLRPC.Chat chat, boolean isBot) {
        if (action == 3) {
