...
public class ShareCardSelectContactActivity extends BaseSearchViewFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        initActionBar();
        this.fragmentView = new FrameLayout(context) { // from class: im.uwrkaxlmjj.ui.hui.contacts.ShareCardSelectContactActivity.1
            ...
            protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
                ...
                if (ShareCardSelectContactActivity.this.listView.getAdapter() == ShareCardSelectContactActivity.this.listViewAdapter) {
                    if (ShareCardSelectContactActivity.this.emptyView.getVisibility() == 0) {
                        ShareCardSelectContactActivity.this.emptyView.setTranslationY(AndroidUtilities.dp(74.0f));
                        return;
                    }
                    return;
                }
                ShareCardSelectContactActivity.this.emptyView.setTranslationY(AndroidUtilities.dp(0.0f));
            }
        };
    ...
    private void initActionBar() {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: im.uwrkaxlmjj.ui.hui.contacts.ShareCardSelectContactActivity.2
    ...
    private void initHeaderView(FrameLayout frameLayout, Context context) {
        ...
        frameLayout2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), 0.0f, 0.0f, Theme.getColor(Theme.key_windowBackgroundGray)));
    ...
    private void initList(FrameLayout frameLayout, Context context) {
        ...
        SearchAdapter searchAdapter = new SearchAdapter(context, this.ignoreUsers, this.allowUsernameSearch, false, false, this.allowBots, true, 0) { // from class: im.uwrkaxlmjj.ui.hui.contacts.ShareCardSelectContactActivity.3
        ...
        searchAdapter.setMiViewType(1);
        CreateGroupAdapter createGroupAdapter = new CreateGroupAdapter(context) { // from class: im.uwrkaxlmjj.ui.hui.contacts.ShareCardSelectContactActivity.4
            ...
            public void notifyDataSetChanged() {
                ...
                if (ShareCardSelectContactActivity.this.listView != null && ShareCardSelectContactActivity.this.listView.getAdapter() == this) {
                    ...
                    ShareCardSelectContactActivity.this.emptyView.setVisibility(count == 0 ? 0 : 8);
                }
            }
        };
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: im.uwrkaxlmjj.ui.hui.contacts.ShareCardSelectContactActivity.5
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.hui.contacts.-$$Lambda$ShareCardSelectContactActivity$LpdOB7wXapzSAtvLSqJQMCs_xY0
            @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i) {
                this.f$0.lambda$initList$0$ShareCardSelectContactActivity(view, i);
            }
        });
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.hui.contacts.ShareCardSelectContactActivity.6
            private boolean scrollingManually;

            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ShareCardSelectContactActivity.this.isCharClicked = false;
                if (newState == 1) {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!ShareCardSelectContactActivity.this.isCharClicked) {
                    ...
                    String s = ShareCardSelectContactActivity.this.listViewAdapter.getLetter(firstPosition);
                    ShareCardSelectContactActivity.this.sideBar.setChooseChar(s);
                }
            }
        });
    }
    ...
    private void initSideBar(FrameLayout frameLayout, Context context) {
        ...
        this.sideBar.setOnTouchingLetterChangedListener(new SideBar.OnTouchingLetterChangedListener() { // from class: im.uwrkaxlmjj.ui.hui.contacts.-$$Lambda$ShareCardSelectContactActivity$zbTlEODEo86KKtyPnhvN43bUBbU
            @Override // im.uwrkaxlmjj.ui.hviews.sidebar.SideBar.OnTouchingLetterChangedListener
            public final void onTouchingLetterChanged(String str) {
                this.f$0.lambda$initSideBar$1$ShareCardSelectContactActivity(str);
            }
        });
    }
    ...
    public void updateHint() {
        if (this.checkedMap.size() != 0) {
            this.actionBar.setSubtitle(this.checkedMap.size() + "/" + this.maxCount);
            return;
        }
    ...
    class CreateGroupHeaderAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            final TLRPC.User user = (TLRPC.User) ShareCardSelectContactActivity.this.checkedMap.valueAt(position);
            cell.setUser(user);
            cell.setDelegate(new AvatarDelCell.AvatarDelDelegate() { // from class: im.uwrkaxlmjj.ui.hui.contacts.-$$Lambda$ShareCardSelectContactActivity$CreateGroupHeaderAdapter$UEdhfsQnCqRnZVMDJvx1uK57deU
                @Override // im.uwrkaxlmjj.ui.hcells.AvatarDelCell.AvatarDelDelegate
                public final void onClickDelete() {
                    this.f$0.lambda$onBindViewHolder$0$ShareCardSelectContactActivity$CreateGroupHeaderAdapter(user);
                }
            });
        }
        ...
        public void notifyDataSetChanged() {
            ...
            if (ShareCardSelectContactActivity.this.headerListView != null && ShareCardSelectContactActivity.this.headerListView.getAdapter() == this) {
                ...
                ShareCardSelectContactActivity.this.textInfoCell.setVisibility(count == 0 ? 0 : 8);
            }
        }
    }
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescription.ThemeDescriptionDelegate cellDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: im.uwrkaxlmjj.ui.hui.contacts.-$$Lambda$ShareCardSelectContactActivity$NtZnFv1C55xfHMUvxzf-cxObaZs
            @Override // im.uwrkaxlmjj.ui.actionbar.ThemeDescription.ThemeDescriptionDelegate
            public final void didSetColor() {
                this.f$0.lambda$getThemeDescriptions$2$ShareCardSelectContactActivity();
            }
        };
