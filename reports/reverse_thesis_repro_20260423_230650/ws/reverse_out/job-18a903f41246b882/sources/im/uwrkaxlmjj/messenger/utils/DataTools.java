...
public class DataTools {
    ...
    public static String getAnimalYearName(int year) {
        String[] animalYear = {"猴", "鸡", "狗", "猪", "鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊"};
    ...
    public static String formatCard(String cardNo) {
        ...
        return card + cardNo.substring(cardNo.length() - 4);
    }
    ...
    public static String formatCardEnd4(String cardNo) {
        ...
        String card = "" + cardNo.substring(cardNo.length() - 4);
        return card;
    }
    ...
    public static int oneCn2ASCII(String s) {
        ...
        try {
            ...
            if (bytes.length == 1) {
                ...
                int highByte = bytes[0] + UByte.MIN_VALUE;
                int lowByte = bytes[1] + UByte.MIN_VALUE;
                int ascii2 = ((highByte * 256) + lowByte) - 65536;
                ascii = ascii2;
            } else {
    ...
    public static String oneCn2PY(String s) {
        ...
        if (ascii >= 0 && ascii <= 127) {
            String ret = String.valueOf((char) ascii);
            return ret;
        }
