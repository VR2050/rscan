...
public class MrySwitch extends View {
    ...
    public void setDrawRipple(boolean value) {
        ...
        if (this.rippleDrawable == null) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                maskDrawable = new Drawable() { // from class: im.uwrkaxlmjj.ui.hviews.MrySwitch.1
                    @Override // android.graphics.drawable.Drawable
                    public void draw(Canvas canvas) {
                        Rect bounds = getBounds();
                        canvas.drawCircle(bounds.centerX(), bounds.centerY(), AndroidUtilities.dp(18.0f), MrySwitch.this.ripplePaint);
                    }
    ...
    private void animateToCheckedState(boolean newCheckedState) {
        ...
        this.checkAnimator.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.hviews.MrySwitch.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
                MrySwitch.this.checkAnimator = null;
            }
        });
    ...
    private void animateIcon(boolean newCheckedState) {
        ...
        objectAnimatorOfFloat.setDuration(250L);
        this.iconAnimator.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.hviews.MrySwitch.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
                MrySwitch.this.iconAnimator = null;
            }
        });
    ...
    */
    protected void onDraw(android.graphics.Canvas r53) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.ui.hviews.MrySwitch.onDraw(android.graphics.Canvas):void");
    }
