...
public class ItemSettings extends FrameLayout {
    ...
    private void initView(boolean attrs) {
        View view = View.inflate(this.mContext, mpEIGo.juqQQs.esbSDO.R.layout.item_setting_layout, null);
        this.leftImageView = (ImageView) view.findViewById(mpEIGo.juqQQs.esbSDO.R.attr.ivLimage);
        this.rightImageView = (ImageView) view.findViewById(mpEIGo.juqQQs.esbSDO.R.attr.ivRimage);
        this.titleTextView = (TextView) view.findViewById(mpEIGo.juqQQs.esbSDO.R.attr.tvTitleText);
        this.subTitleTextView = (TextView) view.findViewById(mpEIGo.juqQQs.esbSDO.R.attr.tvSubTitleText);
        this.descTextView = (TextView) view.findViewById(mpEIGo.juqQQs.esbSDO.R.attr.tvDescText);
    ...
    public void setTitleTextView(CharSequence title) {
