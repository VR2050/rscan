...
import im.uwrkaxlmjj.ui.newcall.AddNewCallActivity;
...
public class CallRecordsFragment extends BaseFmts implements NotificationCenter.NotificationCenterDelegate, View.OnClickListener {
    ...
    private View.OnClickListener callBtnClickListener = new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$12YoohgLV_9l0sUinrcjZJoobCM
        @Override // android.view.View.OnClickListener
        public final void onClick(View view) {
            this.f$0.lambda$new$6$CallRecordsFragment(view);
        }
    };
    ...
    class CallLogRow {
        ...
        /* synthetic */ CallLogRow(CallRecordsFragment x0, AnonymousClass1 x1) {
            this();
        }
    }
    ...
    private void initView(Context context) {
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$APzIzbHwfuf03ttSHTdC1TdbSR8
            @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemClickListener
            public final void onItemClick(View view, int i) {
                this.f$0.lambda$initView$0$CallRecordsFragment(view, i);
            }
        });
    ...
    /* JADX INFO: renamed from: im.uwrkaxlmjj.ui.fragments.CallRecordsFragment$1, reason: invalid class name */
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (visibleItemCount > 0) {
                ...
                if (!CallRecordsFragment.this.endReached && !CallRecordsFragment.this.loading && !CallRecordsFragment.this.calls.isEmpty() && firstVisibleItem + visibleItemCount >= totalItemCount - 5) {
                    final CallLogRow row = (CallLogRow) CallRecordsFragment.this.calls.get(CallRecordsFragment.this.calls.size() - 1);
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$1$YtqsZLMhwK1l39orcMBuLgXnL40
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onScrolled$0$CallRecordsFragment$1(row);
                        }
                    });
                }
            }
    ...
    public void onClick(View v) {
        ...
        if (id == R.attr.tv_cancel_call && this.m_tvCurrent.getId() != v.getId()) {
            changeTabState(v);
    ...
    public void getCalls(int max_id, int count) {
        ...
        int reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$fCI0z8iGhrBlegVRCmuHJ49EbKg
            @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$getCalls$2$CallRecordsFragment(tLObject, tL_error);
            }
        }, 2);
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(reqId, this.classGuid);
    }

    public /* synthetic */ void lambda$getCalls$2$CallRecordsFragment(final TLObject response, final TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$mC0en2IVq0VPJmhz9t8kmgHTukU
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$null$1$CallRecordsFragment(error, response);
            }
        });
    }
    ...
    public void confirmAndDelete(final CallLogRow row) {
        ...
        new AlertDialog.Builder(getParentActivity()).setTitle(LocaleController.getString("AppName", R.string.AppName)).setMessage(LocaleController.getString("ConfirmDeleteCallLog", R.string.ConfirmDeleteCallLog)).setPositiveButton(LocaleController.getString("Delete", R.string.Delete), new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$R0mwxXsqOG5VQCOUg6Q2yLMDDPI
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$confirmAndDelete$3$CallRecordsFragment(row, dialogInterface, i);
            }
    ...
    private void showAlert(final TLRPC.User user) {
        ...
        DialogCommonList dialogCommonList = new DialogCommonList(getParentActivity(), list, list1, Color.parseColor("#222222"), new DialogCommonList.RecyclerviewItemClickCallBack() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$fxEmLFL_xErDA29Sz_k7mPFiJ5I
            ...
            public final void onRecyclerviewItemClick(int i) {
                this.f$0.lambda$showAlert$4$CallRecordsFragment(user, i);
            }
        }, 1);
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            final CallLogRow row = (CallLogRow) CallRecordsFragment.this.calls.get(position);
            ...
            holder.itemView.findViewById(R.attr.iv_more).setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$ListAdapter$dMEnDSUm8uD26MVCTfnmAhiuPG4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$onBindViewHolder$0$CallRecordsFragment$ListAdapter(row, view);
                }
            });
            ...
            btnDelete.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$ListAdapter$PuXKBP_b_oZPk63ia_LRQtvkr2o
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$onBindViewHolder$2$CallRecordsFragment$ListAdapter(position, row, view);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$onBindViewHolder$2$CallRecordsFragment$ListAdapter(int position, final CallLogRow row, View v) {
            if (position >= 0 && position < CallRecordsFragment.this.calls.size()) {
                final CallLogRow callLogRow = (CallLogRow) CallRecordsFragment.this.calls.get(position);
                ...
                new AlertDialog.Builder(CallRecordsFragment.this.getParentActivity()).setTitle(LocaleController.getString("Calls", R.string.Calls)).setItems((CharSequence[]) items.toArray(new String[0]), new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$ListAdapter$zXaHdZc8Yh67XjT0ZzlWfK_SJHQ
                    @Override // android.content.DialogInterface.OnClickListener
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        this.f$0.lambda$null$1$CallRecordsFragment$ListAdapter(row, callLogRow, dialogInterface, i);
                    }
                }).show();
            }
        }
    ...
    public /* synthetic */ void lambda$new$6$CallRecordsFragment(View v) {
        ...
        list1.add(Integer.valueOf(R.drawable.menu_voice_call));
        list1.add(Integer.valueOf(R.drawable.menu_video_call));
        DialogCommonList dialogCommonList = new DialogCommonList(getParentActivity(), list, list1, Color.parseColor("#222222"), new DialogCommonList.RecyclerviewItemClickCallBack() { // from class: im.uwrkaxlmjj.ui.fragments.-$$Lambda$CallRecordsFragment$uyBQk4QGWoN_bwvNTR8bE90yHXo
            @Override // im.uwrkaxlmjj.ui.dialogs.DialogCommonList.RecyclerviewItemClickCallBack
            public final void onRecyclerviewItemClick(int i) {
                this.f$0.lambda$null$5$CallRecordsFragment(row, i);
            }
        }, 1);
        dialogCommonList.show();
    }
