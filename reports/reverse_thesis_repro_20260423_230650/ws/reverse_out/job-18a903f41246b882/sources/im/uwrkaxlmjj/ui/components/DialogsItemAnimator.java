...
public class DialogsItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (movesPending) {
            ...
            Runnable mover = new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$DialogsItemAnimator$srFSUOOz7bvDb7EVyhKViyDPrkA
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$runPendingAnimations$0$DialogsItemAnimator(moves);
                }
            };
            mover.run();
        }
        if (changesPending) {
            ...
            Runnable changer = new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$DialogsItemAnimator$scRhtTCpEi6dPxhaBhdtxDj47bA
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$runPendingAnimations$1$DialogsItemAnimator(changes);
                }
            };
            changer.run();
        }
        if (additionsPending) {
            ...
            Runnable adder = new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$DialogsItemAnimator$d77tDeOJWGdY6Pbu2-xSDwI15N4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$runPendingAnimations$2$DialogsItemAnimator(additions);
                }
            };
            adder.run();
        }
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder holder) {
        ...
        if (view instanceof DialogCell) {
            ...
            animator.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.DialogsItemAnimator.1
        ...
        animation.setDuration(180L).alpha(0.0f).setListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.DialogsItemAnimator.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator2) {
                DialogsItemAnimator.this.dispatchRemoveStarting(holder);
            }
    ...
    void animateAddImpl(final RecyclerView.ViewHolder holder) {
        ...
        if (view instanceof DialogCell) {
            final DialogCell dialogCell = (DialogCell) view;
            ObjectAnimator animator = ObjectAnimator.ofFloat(dialogCell, AnimationProperties.CLIP_DIALOG_CELL_PROGRESS, 0.0f).setDuration(180L);
            animator.setInterpolator(sDefaultInterpolator);
            animator.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.DialogsItemAnimator.3
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationStart(Animator animator2) {
        ...
        final ViewPropertyAnimator animation = view.animate();
        animation.alpha(1.0f).setDuration(180L).setListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.DialogsItemAnimator.4
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator2) {
                DialogsItemAnimator.this.dispatchAddStarting(holder);
            }
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(180L).setListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.DialogsItemAnimator.5
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        animatorSet.playTogether(ObjectAnimator.ofFloat(holder.itemView, (Property<View, Float>) View.ALPHA, 0.0f), ObjectAnimator.ofFloat(newHolder.itemView, (Property<View, Float>) View.ALPHA, 1.0f));
        this.mChangeAnimations.add(changeInfo.oldHolder);
        this.mChangeAnimations.add(changeInfo.newHolder);
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.DialogsItemAnimator.6
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
