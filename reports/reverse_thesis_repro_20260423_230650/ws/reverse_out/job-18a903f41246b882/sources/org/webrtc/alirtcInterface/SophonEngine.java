...
public abstract class SophonEngine {
    ...
    public static synchronized SophonEngineImpl create(Context context, String extras, SophonEventListener listener) throws Exception {
        if (context != null) {
            if (mInstance == null) {
                SophonEngineImpl sophonEngineImplCreate = new SophonEngineImpl(context, extras, listener).create();
                mInstance = sophonEngineImplCreate;
                return sophonEngineImplCreate;
            }
        }
        return mInstance;
    }
    ...
    public static synchronized SophonEngineImpl create(Context context, SophonEventListener listener) throws Exception {
        if (context != null) {
            if (mInstance == null) {
                SophonEngineImpl sophonEngineImplCreate = new SophonEngineImpl(context, listener).create();
                mInstance = sophonEngineImplCreate;
                return sophonEngineImplCreate;
            }
        }
