...
class Camera1Session extends CameraSession {
    ...
    class AnonymousClass4 implements Camera.PreviewCallback {
        ...
        static /* synthetic */ void lambda$onPreviewFrame$2(AnonymousClass4 anonymousClass4, byte[] bArr) {
            Camera1Session.this.cameraThreadHandler.post(Camera1Session$4$$Lambda$2.lambdaFactory$(anonymousClass4, bArr));
        }
