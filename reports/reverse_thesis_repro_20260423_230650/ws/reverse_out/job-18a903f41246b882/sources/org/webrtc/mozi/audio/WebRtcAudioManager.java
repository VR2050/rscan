...
class WebRtcAudioManager {
    ...
    static int getSampleRate(AudioManager audioManager) {
        ...
        int sampleRateHz = WebRtcAudioUtils.runningOnJellyBeanMR1OrHigher() ? getSampleRateOnJellyBeanMR10OrHigher(audioManager) : 16000;
    ...
    private static int getLowLatencyFramesPerBuffer(AudioManager audioManager) {
        ...
        if (WebRtcAudioUtils.runningOnJellyBeanMR1OrHigher() && (framesPerBuffer = audioManager.getProperty("android.media.property.OUTPUT_FRAMES_PER_BUFFER")) != null) {
