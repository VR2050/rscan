...
public final class UStringsKt {
    ...
    public static final String m952toStringLxnNnR4(byte $this$toString, int radix) {
    ...
    public static final String m954toStringolVBNx4(short $this$toString, int radix) {
    ...
    public static final String m953toStringV7xB4Y4(int $this$toString, int radix) {
    ...
    public static final String m951toStringJSWoG40(long $this$toString, int radix) {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int radix) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m122constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m122constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m282boximpl(UShort.m288constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m122constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                ...
                limitBeforeMul = UnsignedKt.m348uintDivideJ1ME1BU(-1, uradix);
                if (UnsignedKt.uintCompare(result, limitBeforeMul) > 0) {
                    return null;
                }
            }
            int result2 = UInt.m122constructorimpl(result * uradix);
            result = UInt.m122constructorimpl(UInt.m122constructorimpl(digit) + result2);
            if (UnsignedKt.uintCompare(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m116boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m191constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                if (limitBeforeMul == 512409557603043100L) {
                    limitBeforeMul = UnsignedKt.m350ulongDivideeb3DHEI(-1L, uradix);
                    if (UnsignedKt.ulongCompare(result, limitBeforeMul) > 0) {
                        return null;
                    }
                } else {
            ...
            long result2 = ULong.m191constructorimpl(result * uradix);
            result = ULong.m191constructorimpl(ULong.m191constructorimpl(((long) UInt.m122constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m185boximpl(result);
    }
}
