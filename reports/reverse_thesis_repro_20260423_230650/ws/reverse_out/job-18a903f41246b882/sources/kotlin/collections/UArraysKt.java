...
public final class UArraysKt {
    ...
    public static final int m380random2D5oskM(int[] random, Random random2) {
        Intrinsics.checkParameterIsNotNull(random, "$this$random");
        Intrinsics.checkParameterIsNotNull(random2, "random");
        if (UIntArray.m176isEmptyimpl(random)) {
            throw new NoSuchElementException("Array is empty.");
        }
        return UIntArray.m173getimpl(random, random2.nextInt(UIntArray.m174getSizeimpl(random)));
    }

    @JvmStatic
    /* JADX INFO: renamed from: random-JzugnMA, reason: not valid java name */
    public static final long m381randomJzugnMA(long[] random, Random random2) {
        Intrinsics.checkParameterIsNotNull(random, "$this$random");
        Intrinsics.checkParameterIsNotNull(random2, "random");
        if (ULongArray.m245isEmptyimpl(random)) {
            throw new NoSuchElementException("Array is empty.");
        }
        return ULongArray.m242getimpl(random, random2.nextInt(ULongArray.m243getSizeimpl(random)));
    }

    @JvmStatic
    /* JADX INFO: renamed from: random-oSF2wD8, reason: not valid java name */
    public static final byte m382randomoSF2wD8(byte[] random, Random random2) {
        Intrinsics.checkParameterIsNotNull(random, "$this$random");
        Intrinsics.checkParameterIsNotNull(random2, "random");
        if (UByteArray.m107isEmptyimpl(random)) {
            throw new NoSuchElementException("Array is empty.");
        }
        return UByteArray.m104getimpl(random, random2.nextInt(UByteArray.m105getSizeimpl(random)));
    }

    @JvmStatic
    /* JADX INFO: renamed from: random-s5X_as8, reason: not valid java name */
    public static final short m383randoms5X_as8(short[] random, Random random2) {
        Intrinsics.checkParameterIsNotNull(random, "$this$random");
        Intrinsics.checkParameterIsNotNull(random2, "random");
        if (UShortArray.m340isEmptyimpl(random)) {
            throw new NoSuchElementException("Array is empty.");
        }
        return UShortArray.m337getimpl(random, random2.nextInt(UShortArray.m338getSizeimpl(random)));
    }

    @JvmStatic
    /* JADX INFO: renamed from: contentEquals-ctEhBpI, reason: not valid java name */
    public static final boolean m368contentEqualsctEhBpI(int[] contentEquals, int[] other) {
    ...
    public static final boolean m371contentEqualsus8wMrg(long[] contentEquals, long[] other) {
        Intrinsics.checkParameterIsNotNull(contentEquals, "$this$contentEquals");
        Intrinsics.checkParameterIsNotNull(other, "other");
        return Arrays.equals(contentEquals, other);
    }
    ...
    public static final boolean m369contentEqualskdPth3s(byte[] contentEquals, byte[] other) {
        Intrinsics.checkParameterIsNotNull(contentEquals, "$this$contentEquals");
        Intrinsics.checkParameterIsNotNull(other, "other");
        return Arrays.equals(contentEquals, other);
    }
    ...
    public static final boolean m370contentEqualsmazbYpA(short[] contentEquals, short[] other) {
        Intrinsics.checkParameterIsNotNull(contentEquals, "$this$contentEquals");
        Intrinsics.checkParameterIsNotNull(other, "other");
        return Arrays.equals(contentEquals, other);
    }
    ...
    public static final int m372contentHashCodeajY9A(int[] contentHashCode) {
    ...
    public static final int m374contentHashCodeQwZRm1k(long[] contentHashCode) {
        Intrinsics.checkParameterIsNotNull(contentHashCode, "$this$contentHashCode");
        return Arrays.hashCode(contentHashCode);
    }
    ...
    public static final int m373contentHashCodeGBYM_sE(byte[] contentHashCode) {
        Intrinsics.checkParameterIsNotNull(contentHashCode, "$this$contentHashCode");
        return Arrays.hashCode(contentHashCode);
    }
    ...
    public static final int m375contentHashCoderL5Bavg(short[] contentHashCode) {
        Intrinsics.checkParameterIsNotNull(contentHashCode, "$this$contentHashCode");
        return Arrays.hashCode(contentHashCode);
    }
    ...
    public static final String m376contentToStringajY9A(int[] contentToString) {
        Intrinsics.checkParameterIsNotNull(contentToString, "$this$contentToString");
        return CollectionsKt.joinToString$default(UIntArray.m166boximpl(contentToString), ", ", "[", "]", 0, null, null, 56, null);
    }

    @JvmStatic
    /* JADX INFO: renamed from: contentToString-QwZRm1k, reason: not valid java name */
    public static final String m378contentToStringQwZRm1k(long[] contentToString) {
        Intrinsics.checkParameterIsNotNull(contentToString, "$this$contentToString");
        return CollectionsKt.joinToString$default(ULongArray.m235boximpl(contentToString), ", ", "[", "]", 0, null, null, 56, null);
    }

    @JvmStatic
    /* JADX INFO: renamed from: contentToString-GBYM_sE, reason: not valid java name */
    public static final String m377contentToStringGBYM_sE(byte[] contentToString) {
        Intrinsics.checkParameterIsNotNull(contentToString, "$this$contentToString");
        return CollectionsKt.joinToString$default(UByteArray.m97boximpl(contentToString), ", ", "[", "]", 0, null, null, 56, null);
    }

    @JvmStatic
    /* JADX INFO: renamed from: contentToString-rL5Bavg, reason: not valid java name */
    public static final String m379contentToStringrL5Bavg(short[] contentToString) {
        Intrinsics.checkParameterIsNotNull(contentToString, "$this$contentToString");
        return CollectionsKt.joinToString$default(UShortArray.m330boximpl(contentToString), ", ", "[", "]", 0, null, null, 56, null);
    }

    @JvmStatic
    /* JADX INFO: renamed from: toTypedArray--ajY-9A, reason: not valid java name */
    public static final UInt[] m384toTypedArrayajY9A(int[] toTypedArray) {
        Intrinsics.checkParameterIsNotNull(toTypedArray, "$this$toTypedArray");
        int iM174getSizeimpl = UIntArray.m174getSizeimpl(toTypedArray);
        UInt[] uIntArr = new UInt[iM174getSizeimpl];
        for (int i = 0; i < iM174getSizeimpl; i++) {
            int index = i;
            uIntArr[i] = UInt.m116boximpl(UIntArray.m173getimpl(toTypedArray, index));
        }
        return uIntArr;
    }
    ...
    public static final ULong[] m386toTypedArrayQwZRm1k(long[] toTypedArray) {
        Intrinsics.checkParameterIsNotNull(toTypedArray, "$this$toTypedArray");
        int iM243getSizeimpl = ULongArray.m243getSizeimpl(toTypedArray);
        ULong[] uLongArr = new ULong[iM243getSizeimpl];
        for (int i = 0; i < iM243getSizeimpl; i++) {
            int index = i;
            uLongArr[i] = ULong.m185boximpl(ULongArray.m242getimpl(toTypedArray, index));
        }
        return uLongArr;
    }
    ...
    public static final UByte[] m385toTypedArrayGBYM_sE(byte[] toTypedArray) {
        Intrinsics.checkParameterIsNotNull(toTypedArray, "$this$toTypedArray");
        int iM105getSizeimpl = UByteArray.m105getSizeimpl(toTypedArray);
        UByte[] uByteArr = new UByte[iM105getSizeimpl];
        for (int i = 0; i < iM105getSizeimpl; i++) {
            int index = i;
            uByteArr[i] = UByte.m49boximpl(UByteArray.m104getimpl(toTypedArray, index));
        }
        return uByteArr;
    }
    ...
    public static final UShort[] m387toTypedArrayrL5Bavg(short[] toTypedArray) {
        Intrinsics.checkParameterIsNotNull(toTypedArray, "$this$toTypedArray");
        int iM338getSizeimpl = UShortArray.m338getSizeimpl(toTypedArray);
        UShort[] uShortArr = new UShort[iM338getSizeimpl];
        for (int i = 0; i < iM338getSizeimpl; i++) {
            int index = i;
            uShortArr[i] = UShort.m282boximpl(UShortArray.m337getimpl(toTypedArray, index));
        }
        return uShortArr;
    }
}
