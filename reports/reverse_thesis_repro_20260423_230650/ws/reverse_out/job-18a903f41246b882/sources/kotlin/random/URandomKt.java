...
public final class URandomKt {
    public static final int nextUInt(Random nextUInt) {
        ...
        return UInt.m122constructorimpl(nextUInt.nextInt());
    }

    /* JADX INFO: renamed from: nextUInt-qCasIEU, reason: not valid java name */
    public static final int m910nextUIntqCasIEU(Random nextUInt, int until) {
        Intrinsics.checkParameterIsNotNull(nextUInt, "$this$nextUInt");
        return m909nextUInta8DCA5k(nextUInt, 0, until);
    }

    /* JADX INFO: renamed from: nextUInt-a8DCA5k, reason: not valid java name */
    public static final int m909nextUInta8DCA5k(Random nextUInt, int from, int until) {
        Intrinsics.checkParameterIsNotNull(nextUInt, "$this$nextUInt");
        m904checkUIntRangeBoundsJ1ME1BU(from, until);
        ...
        return UInt.m122constructorimpl(signedResult);
    }
    ...
    public static final int nextUInt(Random nextUInt, UIntRange range) {
        ...
        if (!range.isEmpty()) {
            return UnsignedKt.uintCompare(range.getLast(), -1) < 0 ? m909nextUInta8DCA5k(nextUInt, range.getFirst(), UInt.m122constructorimpl(range.getLast() + 1)) : UnsignedKt.uintCompare(range.getFirst(), 0) > 0 ? UInt.m122constructorimpl(m909nextUInta8DCA5k(nextUInt, UInt.m122constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt(nextUInt);
        }
    ...
    public static final long nextULong(Random nextULong) {
        ...
        return ULong.m191constructorimpl(nextULong.nextLong());
    }

    /* JADX INFO: renamed from: nextULong-V1Xi4fY, reason: not valid java name */
    public static final long m911nextULongV1Xi4fY(Random nextULong, long until) {
        Intrinsics.checkParameterIsNotNull(nextULong, "$this$nextULong");
        return m912nextULongjmpaWc(nextULong, 0L, until);
    }

    /* JADX INFO: renamed from: nextULong-jmpaW-c, reason: not valid java name */
    public static final long m912nextULongjmpaWc(Random nextULong, long from, long until) {
        Intrinsics.checkParameterIsNotNull(nextULong, "$this$nextULong");
        m905checkULongRangeBoundseb3DHEI(from, until);
        ...
        return ULong.m191constructorimpl(signedResult);
    }
    ...
    public static final long nextULong(Random nextULong, ULongRange range) {
        ...
        if (UnsignedKt.ulongCompare(range.getLast(), -1L) < 0) {
            return m912nextULongjmpaWc(nextULong, range.getFirst(), ULong.m191constructorimpl(range.getLast() + ULong.m191constructorimpl(((long) 1) & 4294967295L)));
        }
        if (UnsignedKt.ulongCompare(range.getFirst(), 0L) <= 0) {
            return nextULong(nextULong);
        }
        long j = ((long) 1) & 4294967295L;
        return ULong.m191constructorimpl(m912nextULongjmpaWc(nextULong, ULong.m191constructorimpl(range.getFirst() - ULong.m191constructorimpl(j)), range.getLast()) + ULong.m191constructorimpl(j));
    }

    /* JADX INFO: renamed from: nextUBytes-EVgfTAA, reason: not valid java name */
    public static final byte[] m906nextUBytesEVgfTAA(Random nextUBytes, byte[] array) {
    ...
    public static final byte[] nextUBytes(Random nextUBytes, int size) {
        Intrinsics.checkParameterIsNotNull(nextUBytes, "$this$nextUBytes");
        return UByteArray.m99constructorimpl(nextUBytes.nextBytes(size));
    }
    ...
    public static final byte[] m907nextUBytesWvrt4B4(Random nextUBytes, byte[] array, int fromIndex, int toIndex) {
        Intrinsics.checkParameterIsNotNull(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkParameterIsNotNull(array, "array");
    ...
    public static final void m904checkUIntRangeBoundsJ1ME1BU(int from, int until) {
        if (!(UnsignedKt.uintCompare(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m116boximpl(from), UInt.m116boximpl(until)).toString());
        }
    }

    /* JADX INFO: renamed from: checkULongRangeBounds-eb3DHEI, reason: not valid java name */
    public static final void m905checkULongRangeBoundseb3DHEI(long from, long until) {
        if (!(UnsignedKt.ulongCompare(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m185boximpl(from), ULong.m185boximpl(until)).toString());
        }
    }
}
