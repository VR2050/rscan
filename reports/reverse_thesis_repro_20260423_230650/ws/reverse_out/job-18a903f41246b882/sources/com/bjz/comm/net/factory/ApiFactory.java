...
public class ApiFactory {
    ...
    private ApiFactory() {
        ...
        this.mRetrofit = new Retrofit.Builder().baseUrl(HttpUtils.getInstance().getFcBaseUrl()).addConverterFactory(MyGsonConverterFactory.create()).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).callFactory(new CallFactoryProxy(builder.build()) { // from class: com.bjz.comm.net.factory.ApiFactory.1
            ...
            protected HttpUrl getNewUrl(Request request) {
                ...
                if (BuildVars.DEBUG_VERSION) {
                    Log.d(ApiFactory.this.TAG, "requestFcUrl == " + requestHttpUrl.host());
                }
                ...
                if (BuildVars.DEBUG_VERSION) {
                    Log.d(ApiFactory.this.TAG, "newBaseFcUrl == " + newBaseUrl.host());
                }
