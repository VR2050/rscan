...
public class HttpUrlSource implements Source {
    ...
    public void open(long offset) throws ProxyCacheException {
        try {
            HttpURLConnection httpURLConnectionOpenConnection = openConnection(offset, -1);
            this.connection = httpURLConnectionOpenConnection;
            String mime = httpURLConnectionOpenConnection.getContentType();
    ...
    private HttpURLConnection openConnection(long offset, int timeout) throws IOException, ProxyCacheException {
        ...
        do {
            ...
            if (redirected) {
                url = connection.getHeaderField(AgentWebPermissions.ACTION_LOCATION);
                redirectCount++;
