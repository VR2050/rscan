...
public final class AppUtils {
    ...
    private static Intent getInstallAppIntent(File file, boolean isNewTask) throws XmlPullParserException, IOException {
        Uri data;
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            Uri data2 = FileProvider.getUriForFile(Utils.getApp(), authority, file);
            intent.setFlags(1);
            data = data2;
        }
    ...
    private static Intent getLaunchAppIntent(String packageName, boolean isNewTask) {
        ...
        if (!launcherActivity.isEmpty()) {
            ...
            ComponentName cn2 = new ComponentName(packageName, launcherActivity);
