...
public class TrackFragmentRandomAccessBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_11 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setEntries", "com.coremedia.iso.boxes.fragment.TrackFragmentRandomAccessBox", "java.util.List", RemoteConfigConstants.ResponseFieldKey.ENTRIES, "", "void"), PsExtractor.PRIVATE_STREAM_1);
    ...
    public static class Entry {
        ...
        public int hashCode() {
            ...
            int result3 = ((result2 * 31) + ((int) (j3 ^ (j3 >>> 32)))) * 31;
            long j4 = this.trunNumber;
            int result4 = (result3 + ((int) (j4 ^ (j4 >>> 32)))) * 31;
            long j5 = this.sampleNumber;
            return result4 + ((int) (j5 ^ (j5 >>> 32)));
        }
    }
