...
public final class Id3Decoder implements MetadataDecoder {
    ...
    /* JADX WARN: Removed duplicated region for block: B:159:0x0216 A[Catch: all -> 0x0154, UnsupportedEncodingException -> 0x0157, TryCatch #1 {all -> 0x0154, blocks: (B:91:0x0141, B:161:0x0221, B:163:0x0240, B:169:0x024b, B:93:0x0149, B:104:0x0168, B:106:0x0170, B:114:0x018b, B:123:0x01a3, B:134:0x01be, B:141:0x01d0, B:147:0x01df, B:152:0x01f7, B:158:0x0211, B:159:0x0216), top: B:179:0x0137 }] */
    /*
    ...
    */
    ...
    private static String getFrameId(int majorVersion, int frameId0, int frameId1, int frameId2, int frameId3) {
        ...
        return majorVersion == 2 ? String.format(locale, "%c%c%c", Integer.valueOf(frameId0), Integer.valueOf(frameId1), Integer.valueOf(frameId2)) : String.format(locale, "%c%c%c%c", Integer.valueOf(frameId0), Integer.valueOf(frameId1), Integer.valueOf(frameId2), Integer.valueOf(frameId3));
    }
