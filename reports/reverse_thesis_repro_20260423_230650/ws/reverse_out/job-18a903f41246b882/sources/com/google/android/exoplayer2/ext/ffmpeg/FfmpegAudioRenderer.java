...
public final class FfmpegAudioRenderer extends SimpleDecoderAudioRenderer {
    ...
    private boolean shouldUseFloatOutput(Format inputFormat) {
        ...
        if (iHashCode != 187078296) {
            if (iHashCode == 187094639 && str.equals(MimeTypes.AUDIO_RAW)) {
                b = 0;
            }
        } else if (str.equals(MimeTypes.AUDIO_AC3)) {
            b = 1;
        }
        return b != 0 ? b != 1 : inputFormat.pcmEncoding == Integer.MIN_VALUE || inputFormat.pcmEncoding == 1073741824 || inputFormat.pcmEncoding == 4;
    }
}
