...
public final class SilenceSkippingAudioProcessor implements AudioProcessor {
    ...
    public void flush() {
        if (isActive()) {
            ...
            int iDurationUsToFrames = durationUsToFrames(PADDING_SILENCE_US) * this.bytesPerFrame;
            this.paddingSize = iDurationUsToFrames;
            if (this.paddingBuffer.length != iDurationUsToFrames) {
                this.paddingBuffer = new byte[iDurationUsToFrames];
            }
        }
        this.state = 0;
        this.outputBuffer = EMPTY_BUFFER;
