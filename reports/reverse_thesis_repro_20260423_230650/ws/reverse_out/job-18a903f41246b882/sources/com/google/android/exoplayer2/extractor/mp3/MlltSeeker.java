...
final class MlltSeeker implements Mp3Extractor.Seeker {
    ...
    private static Pair<Long, Long> linearlyInterpolate(long x, long[] xReferences, long[] yReferences) {
        ...
        double proportion = xNextReference == xPreviousReference ? FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE : (x - xPreviousReference) / (xNextReference - xPreviousReference);
