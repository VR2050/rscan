...
public final class zzd implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            logger2.e(strValueOf3.length() != 0 ? "IOException when revoking access: ".concat(strValueOf3) : new String("IOException when revoking access: "), new Object[0]);
        } catch (Exception e2) {
            Logger logger3 = zzbd;
            String strValueOf4 = String.valueOf(e2.toString());
            logger3.e(strValueOf4.length() != 0 ? "Exception when revoking access: ".concat(strValueOf4) : new String("Exception when revoking access: "), new Object[0]);
        }
