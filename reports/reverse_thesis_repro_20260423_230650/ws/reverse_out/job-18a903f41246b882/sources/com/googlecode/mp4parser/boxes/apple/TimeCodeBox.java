...
public class TimeCodeBox extends AbstractBox implements SampleEntry {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_10 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setReserved1", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "int", "reserved1", "", "void"), TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
        ajc$tjp_11 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "getReserved2", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "", "", "", "int"), TsExtractor.TS_STREAM_TYPE_SPLICE_INFO);
        ajc$tjp_12 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setReserved2", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "int", "reserved2", "", "void"), TsExtractor.TS_STREAM_TYPE_DTS);
