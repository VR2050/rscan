...
public class SegmentIndexBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_1 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig("1", "setEntries", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "java.util.List", RemoteConfigConstants.ResponseFieldKey.ENTRIES, "", "void"), 132);
    ...
    protected long getContentSize() {
        long size = 4 + 4;
        return size + 4 + ((long) (getVersion() == 0 ? 8 : 16)) + 2 + 2 + ((long) (this.entries.size() * 12));
    }
