...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:36:0x0070, code lost:
        ...
        r5 = com.bumptech.glide.load.resource.bitmap.HardwareConfigState.DEFAULT_MAXIMUM_FDS_FOR_HARDWARE_CONFIGS;
     */
    ...
    */
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry familyEntry, Resources resources, int style) {
        ...
        try {
            ...
            FontStyle defaultStyle = new FontStyle((style & 1) != 0 ? HardwareConfigState.DEFAULT_MAXIMUM_FDS_FOR_HARDWARE_CONFIGS : 400, (style & 2) != 0 ? 1 : 0);
