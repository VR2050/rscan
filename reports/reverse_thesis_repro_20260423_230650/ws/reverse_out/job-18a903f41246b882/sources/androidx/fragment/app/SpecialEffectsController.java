        ...
        synchronized (this.mPendingOperations) {
            ...
            for (Operation operation : runningOperations) {
                if (FragmentManager.isLoggingEnabled(2)) {
                    ...
                    sb.append(attachedToWindow ? "" : "Container " + this.mContainer + " is not attached to window. ");
            ...
            for (Operation operation2 : pendingOperations) {
                if (FragmentManager.isLoggingEnabled(2)) {
                    ...
                    sb2.append(attachedToWindow ? "" : "Container " + this.mContainer + " is not attached to window. ");
