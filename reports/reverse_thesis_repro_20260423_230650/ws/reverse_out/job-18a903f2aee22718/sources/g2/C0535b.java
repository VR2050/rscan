...
public final class C0535b extends O1.d {

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static final a f9213i = new a(null);

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private final WritableMap f9214h;
    ...
    public C0535b(int i3, WritableMap writableMap) {
        super(i3);
        t2.j.f(writableMap, "mEventData");
        this.f9214h = writableMap;
    }
    ...
    public void c(RCTEventEmitter rCTEventEmitter) {
        ...
        rCTEventEmitter.receiveEvent(o(), k(), this.f9214h);
    }
