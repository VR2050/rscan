...
public abstract class NativeSegmentFetcherSpec extends ReactContextBaseJavaModule implements TurboModule {
    ...
    @ReactMethod
    public abstract void fetchSegment(double d3, ReadableMap readableMap, Callback callback);
    ...
    @ReactMethod
    public void getSegment(double d3, ReadableMap readableMap, Callback callback) {
    }
}
