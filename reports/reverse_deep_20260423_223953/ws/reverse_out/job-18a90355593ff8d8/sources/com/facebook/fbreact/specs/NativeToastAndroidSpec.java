...
public abstract class NativeToastAndroidSpec extends ReactContextBaseJavaModule implements TurboModule {
    ...
    @ReactMethod
    public abstract void show(String str, double d3);

    @ReactMethod
    public abstract void showWithGravity(String str, double d3, double d4);

    @ReactMethod
    public abstract void showWithGravityAndOffset(String str, double d3, double d4, double d5, double d6);
}
