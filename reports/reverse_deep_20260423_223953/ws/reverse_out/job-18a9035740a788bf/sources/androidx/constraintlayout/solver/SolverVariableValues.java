    ...
    public String toString() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v != null) {
                ...
                int index = indexOf(v);
                String str3 = str2 + "[p: ";
                String str4 = (this.previous[index] != -1 ? str3 + this.mCache.mIndexedVariables[this.variables[this.previous[index]]] : str3 + SchedulerSupport.NONE) + ", n: ";
                str = (this.next[index] != -1 ? str4 + this.mCache.mIndexedVariables[this.variables[this.next[index]]] : str4 + SchedulerSupport.NONE) + "]";
            }
        }
        return str + " }";
    }
