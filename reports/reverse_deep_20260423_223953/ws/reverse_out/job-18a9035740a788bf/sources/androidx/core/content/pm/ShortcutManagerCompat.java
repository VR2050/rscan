...
public class ShortcutManagerCompat {
    ...
    public static boolean requestPinShortcut(final Context context, ShortcutInfoCompat shortcut, final IntentSender callback) throws PackageManager.NameNotFoundException {
        if (Build.VERSION.SDK_INT >= 26) {
