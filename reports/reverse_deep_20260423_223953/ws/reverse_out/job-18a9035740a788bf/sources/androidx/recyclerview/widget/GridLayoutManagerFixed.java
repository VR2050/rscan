        ...
        while (working) {
            ...
            while (i2 < count) {
                ...
                if (this.mOrientationHelper.getDecoratedMeasurement(view5) == maxSize2) {
                    ...
                    firstPositionStart = firstPositionStart2;
                    int wSpec = getChildMeasureSpec(totalSpaceInOther, 1073741824, horizontalInsets, lp.width, false);
                    int hSpec = View.MeasureSpec.makeMeasureSpec(maxSize2 - verticalInsets, 1073741824);
            ...
            if ((!fromOpositeSide || layoutState.mLayoutDirection != -1) && (fromOpositeSide || layoutState.mLayoutDirection != 1)) {
                ...
                if (layoutState.mLayoutDirection == -1) {
                    ...
                    int top3 = bottom4 + result.mConsumed;
                    int bottom5 = top3 + maxSize;
                    left = 0;
                    top = top3;
                    bottom = bottom5;
                }
                ...
                while (i3 < count2) {
                    ...
                    int i5 = i3;
                    int i6 = bottom;
                    layoutDecoratedWithMargins(view6, left2, top, i4, i6);
                    if (layoutState.mLayoutDirection == -1) {
                        left = left2;
                    } else {
                        left = left2 + right;
                ...
                if (layoutState.mLayoutDirection == -1) {
                    ...
                    left3 = 0;
                    bottom2 = bottom6;
                    top2 = bottom6 - maxSize2;
                } else {
                    int bottom7 = layoutState.mOffset;
                    int top4 = result.mConsumed + bottom7;
                    int bottom8 = top4 + maxSize2;
                    left3 = getWidth();
                    bottom2 = bottom8;
                    top2 = top4;
                }
                ...
                while (i7 >= 0) {
                    ...
                    layoutDecoratedWithMargins(view7, left4, maxSize5, left4 + right2, bottom2);
                    if (layoutState.mLayoutDirection != -1) {
                        left3 = left4;
                    } else {
                        left3 = left4 + right2;
