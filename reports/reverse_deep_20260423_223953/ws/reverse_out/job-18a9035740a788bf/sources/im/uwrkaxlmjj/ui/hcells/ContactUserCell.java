...
public class ContactUserCell extends FrameLayout {
    ...
    public void init(Context context, int padding, int checkbox, boolean admin, boolean needAddButton) {
        ...
        addView(view, LayoutHelper.createFrame(-1.0f, 20.0f, i3, f, 10.0f, i2, 0.0f));
        SimpleTextView simpleTextView2 = new SimpleTextView(context);
        this.statusTextView = simpleTextView2;
        simpleTextView2.setTextSize(13);
        this.statusTextView.setGravity((LocaleController.isRTL ? 5 : 3) | 48);
        addView(this.statusTextView, LayoutHelper.createFrame(-1.0f, 20.0f, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 0 + 28 : padding + 64, 39.0f, LocaleController.isRTL ? padding + 64 : 0 + 28, 0.0f));
        if (checkbox == 2) {
    ...
    public void update(int mask) {
        ...
        if (userFull != null) {
            this.statusTextView.setText(userFull.about);
        }
