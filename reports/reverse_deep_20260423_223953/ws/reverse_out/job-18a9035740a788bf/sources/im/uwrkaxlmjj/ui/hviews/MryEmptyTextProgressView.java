...
public class MryEmptyTextProgressView extends FrameLayout {
    ...
    public MryEmptyTextProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: im.uwrkaxlmjj.ui.hviews.-$$Lambda$MryEmptyTextProgressView$LhBsJaURXB9P-vJfhdUytV39Foc
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return MryEmptyTextProgressView.lambda$new$0(view, motionEvent);
            }
        });
    }
