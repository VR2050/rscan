...
public class CheckBox extends View {
    ...
    private void animateToCheckedState(boolean newCheckedState) {
        ...
        objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.CheckBox.1
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawBackground || this.progress != 0.0f) {
            ...
            if (roundProgressCheckState < progressBounceDiff) {
                rad -= (AndroidUtilities.dp(2.0f) * roundProgressCheckState) / progressBounceDiff;
            } else if (roundProgressCheckState < 0.4f) {
                rad -= AndroidUtilities.dp(2.0f) - ((AndroidUtilities.dp(2.0f) * (roundProgressCheckState - progressBounceDiff)) / progressBounceDiff);
            }
            ...
            if (this.checkedText != null) {
                this.checkCanvas.drawText(this.checkedText, (getMeasuredWidth() - ((int) Math.ceil(this.textPaint.measureText(r4)))) / 2, AndroidUtilities.dp(this.size == 40 ? 28.0f : 21.0f), this.textPaint);
            } else {
