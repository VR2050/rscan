...
public final class VideoPlayerManager implements IVideoPlayer.PlayCallback {
    ...
    public void setvLast(View vLast) {
        this.vLast = vLast;
    }
    ...
    public void setPlayMessageId(int iPlayMessageId, View view) {
        this.iPlayMessageId = iPlayMessageId;
    ...
    private void createPlayer() {
        AbsBaseVideoPlayer absBaseVideoPlayerCreate = this.mVideoPlayerConfig.getPlayerFactory().create();
        this.mPlayer = absBaseVideoPlayerCreate;
        absBaseVideoPlayerCreate.setPlayCallback(this);
    }
    ...
    public void setPlayingView(View vLast) {
        this.mPlayingView = vLast;
    }
    ...
    public boolean onBackPressed() {
        boolean consume = ScreenViewState.isNormal(this.mScreenState);
        if (!consume) {
    ...
    @Override // im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.IVideoPlayer.PlayCallback
