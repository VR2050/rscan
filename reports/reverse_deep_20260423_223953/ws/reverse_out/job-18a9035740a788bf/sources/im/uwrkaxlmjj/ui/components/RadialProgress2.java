    ...
    public void draw(Canvas canvas) {
        ...
        if (this.overlayImageView.hasBitmapImage()) {
            ...
            if (alpha >= 1.0f) {
                ...
                int gD = (int) ((255 - g) * alpha);
                int originalAlpha3 = 255 - b;
                int bD = (int) (originalAlpha3 * alpha);
                int color4 = 255 - a;
                int aD = (int) (color4 * alpha);
                int i3 = a + aD;
                int a2 = r2 + rD;
                int rD2 = g + gD;
                int gD2 = b + bD;
        ...
        if (this.drawMiniIcon) {
            ...
            if (canvas5 == null) {
                ...
                canvas5.drawCircle(AndroidUtilities.dp(size + 18 + offset), AndroidUtilities.dp(size + 18 + offset), AndroidUtilities.dp(halfSize + 1) * alpha2, Theme.checkboxSquare_eraserPaint);
            }
