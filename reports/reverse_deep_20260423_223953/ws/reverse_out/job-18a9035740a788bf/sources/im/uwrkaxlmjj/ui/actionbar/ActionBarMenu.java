...
public class ActionBarMenu extends LinearLayout {
    ...
    public ActionBarMenuItem addItem(int id, Drawable drawable) {
        return addItem(id, 0, null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, drawable, AndroidUtilities.dp(48.0f), null, 0, 0);
    }
    ...
    public ActionBarMenuItem addItem(int id, CharSequence text) {
        return addItem(id, 0, text, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, null, 0, text, 0, 0);
    }

    public ActionBarMenuItem addItem(int id, int icon, int backgroundColor) {
        return addItem(id, icon, null, backgroundColor, null, AndroidUtilities.dp(48.0f), null, 0, 0);
    }

    public ActionBarMenuItem addItemWithWidth(int id, int icon, int width) {
        return addItem(id, icon, null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, null, width, null, 0, 0);
    }

    public ActionBarMenuItem addItemWithWidth(int id, int icon, int width, int marginStart, int marginEnd) {
        return addItem(id, icon, null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, null, width, null, marginStart, marginEnd);
    }

    public ActionBarMenuItem addItemWithWidth(int id, int icon, int width, CharSequence title) {
        return addItem(id, icon, null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, null, width, title, 0, 0);
    }
    ...
    public ActionBarMenuItem addItem(int id, int icon, CharSequence text, int backgroundColor, Drawable drawable, int width, CharSequence title, int marginStart, int marginEnd) {
        ActionBarMenuItem menuItem = new ActionBarMenuItem(getContext(), this, backgroundColor, this.isActionMode ? this.parentActionBar.itemsActionModeColor : this.parentActionBar.itemsColor, text != null);
        ...
        if (text != null) {
            ...
            if (marginStart != 0) {
                layoutParams2.leftMargin = AndroidUtilities.dp(marginStart);
            }
            if (marginEnd != 0) {
                layoutParams2.rightMargin = AndroidUtilities.dp(marginEnd);
            }
            addView(menuItem, layoutParams2);
        }
        menuItem.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.actionbar.-$$Lambda$ActionBarMenu$WD2CG9_3vnbo7q9Zyz-M0vO9ffQ
    ...
    public View addItemView(int id, View view) {
        ...
        view.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.actionbar.ActionBarMenu.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                ActionBarMenu.this.onItemClick(((Integer) view2.getTag()).intValue());
            }
        });
        return view;
    }
    ...
    public View addItemView(int id, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        view.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.actionbar.ActionBarMenu.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                ActionBarMenu.this.onItemClick(((Integer) view2.getTag()).intValue());
            }
    ...
    public View addRightItemView(int id, CharSequence value) {
        ...
        view.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.actionbar.ActionBarMenu.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                ActionBarMenu.this.onItemClick(((Integer) view2.getTag()).intValue());
            }
