...
public class ArchiveHintCell extends FrameLayout {
    ...
    public ArchiveHintCell(Context context) {
        super(context);
        ViewPager viewPager = new ViewPager(context) { // from class: im.uwrkaxlmjj.ui.cells.ArchiveHintCell.1
        ...
        this.viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: im.uwrkaxlmjj.ui.cells.ArchiveHintCell.2
