...
import im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.view.AbsVideoPlayerView;
...
public class FullScreenExoPlayer extends Dialog {
    ...
    public FullScreenExoPlayer(final Context context, AbsVideoPlayerView player, float Ratio, final boolean blnShowExtension, String strTitle, dismissListener Listener) {
        super(context, R.plurals.DialogTheme);
        this.blnMute = false;
        this.mExecutorService = Executors.newSingleThreadScheduledExecutor();
        this.mUpdateProgressTask = new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$-Rg9ANzlpUOBhDPhY4jtrHxVavs
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$new$5$FullScreenExoPlayer();
            }
        };
        ...
        if (blnShowExtension) {
            ...
            view.findViewById(R.attr.ll_return).setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$oGMWfmvF0cQRVRpKesx7nojz_7M
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f$0.lambda$new$0$FullScreenExoPlayer(view2);
                }
            });
            this.iv_play.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$qn0TvTnzkCOJLztHlrP-hoG7LH8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f$0.lambda$new$1$FullScreenExoPlayer(view2);
                }
            });
            this.iv_mute.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$5sXzAt6VUO9Yf3lCNyQFjpm7J4M
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f$0.lambda$new$2$FullScreenExoPlayer(view2);
                }
            });
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$J-o02qmR5nHZf4Iy4sODsMcVGsE
                @Override // java.lang.Runnable
                public final void run() {
        ...
        this.root_view.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.FullScreenExoPlayer.1
            @Override // android.view.View.OnClickListener
    ...
    private void createSeekBar(final AbsVideoPlayerView player) {
        ...
        this.videoPlayerSeekbar.setDelegate(new SeekBar.SeekBarDelegate() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.FullScreenExoPlayer.2
        ...
        FrameLayout frameLayout = new FrameLayout(getContext()) { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.FullScreenExoPlayer.3
    ...
    private void startVideoProgressUpdate() {
        ...
        if (!this.mExecutorService.isShutdown()) {
            this.mScheduleFuture = this.mExecutorService.scheduleAtFixedRate(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.friendscircle_v1.player.player.-$$Lambda$FullScreenExoPlayer$CGSIua6emsx_gRRXULPvLEKQ9IM
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$startVideoProgressUpdate$4$FullScreenExoPlayer();
                }
