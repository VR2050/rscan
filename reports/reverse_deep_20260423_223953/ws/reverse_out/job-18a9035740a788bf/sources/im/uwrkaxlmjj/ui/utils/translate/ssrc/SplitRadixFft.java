...
public class SplitRadixFft {
    ...
    public void dfct(int n, double[] a, double[] t, int[] ip, double[] w) {
        ...
        if (n > 2) {
            ...
            for (i2 = 2; m2 >= i2; i2 = 2) {
                ...
                if (m3 > i) {
                    int i5 = nw;
                    cftfsub(m3, t, ip, 2, i5, w);
                    rftfsub(m3, t, nc, w, i5);
                } else if (m3 == i) {
                    cftfsub(m3, t, ip, 2, nw, w);
                }
                a[n - l] = t[0] - t[1];
                a[l] = t[0] + t[1];
                int k2 = 0;
                for (int j3 = 2; j3 < m3; j3 += 2) {
                    k2 += l << 2;
                    a[k2 - l] = t[j3] - t[j3 + 1];
                    a[k2 + l] = t[j3] + t[j3 + 1];
                }
                l <<= 1;
                int mh2 = m3 >> 1;
                for (int j4 = 0; j4 < mh2; j4++) {
                    int k3 = m3 - j4;
                    t[j4] = t[m3 + k3] - t[m3 + j4];
                    t[k3] = t[m3 + k3] + t[m3 + j4];
                }
                t[mh2] = t[m3 + mh2];
                m2 = mh2;
            }
        ...
        if (n > 2) {
            ...
            while (j3 >= 2) {
                ...
                if (j3 > m) {
                    int i2 = nw;
                    int m5 = j3;
                    cftfsub(j3, t, ip, 2, i2, w);
                    rftfsub(m5, t, nc, w, i2);
                    m3 = m5;
                } else if (j3 != m) {
                    m3 = j3;
                } else {
    ...
    private void cftfsub(int n, double[] a, int[] ip, int ipP, int nw, double[] w) {
        if (n > 32) {
            ...
            if (n > 512) {
                cftrec1(m, a, 0, nw, w);
                cftrec2(m, a, m, nw, w);
                cftrec1(m, a, m * 2, nw, w);
                cftrec1(m, a, m * 3, nw, w);
            } else if (m > 32) {
                cftexp1(n, a, 0, nw, w);
            } else {
                cftfx41(n, a, 0, nw, w);
    ...
    private void cftf1st(int n, double[] a, double[] w, int wP) {
        ...
        double wd3i3 = wd1r + wn4r;
        double wk1r2 = wd3i3 * csc1;
        ...
        int j24 = j14 + m;
        int j34 = j24 + m;
        double x0r12 = a[mh - 2] + a[j24 - 2];
        double x0i12 = a[mh - 1] + a[j24 - 1];
        double x1r4 = a[mh - 2] - a[j24 - 2];
        double x1i4 = a[mh - 1] - a[j24 - 1];
        double x2r4 = a[j14 - 2] + a[j34 - 2];
        double x2i4 = a[j14 - 1] + a[j34 - 1];
        double x3r4 = a[j14 - 2] - a[j34 - 2];
        double x3i4 = a[j14 - 1] - a[j34 - 1];
        a[mh - 2] = x0r12 + x2r4;
        a[mh - 1] = x0i12 + x2i4;
        a[j14 - 2] = x0r12 - x2r4;
        a[j14 - 1] = x0i12 - x2i4;
        double x0r13 = x1r4 - x3i4;
        double x0i13 = x1i4 + x3r4;
        a[j24 - 2] = (wk1r2 * x0r13) - (wk1i2 * x0i13);
        a[j24 - 1] = (wk1r2 * x0i13) + (wk1i2 * x0r13);
        double x0r14 = x1r4 + x3i4;
        double x0i14 = x1i4 - x3r4;
        a[j34 - 2] = (wk3r2 * x0r14) + (wk3i2 * x0i14);
        a[j34 - 1] = (wk3r2 * x0i14) - (wk3i2 * x0r14);
        double x0r15 = a[mh] + a[j24];
        double x0i15 = a[mh + 1] + a[j24 + 1];
        double x1r5 = a[mh] - a[j24];
        double x1i5 = a[mh + 1] - a[j24 + 1];
        double x2r5 = a[j14] + a[j34];
        double x2i5 = a[j14 + 1] + a[j34 + 1];
        double x3r5 = a[j14] - a[j34];
        double x3i5 = a[j14 + 1] - a[j34 + 1];
        a[mh] = x0r15 + x2r5;
        a[mh + 1] = x0i15 + x2i5;
        a[j14] = x0r15 - x2r5;
        a[j14 + 1] = x0i15 - x2i5;
        double x0r16 = x1r5 - x3i5;
        double x0i16 = x1i5 + x3r5;
        a[j24] = (x0r16 - x0i16) * wn4r;
        a[j24 + 1] = (x0i16 + x0r16) * wn4r;
        double x0r17 = x1r5 + x3i5;
        double x0i17 = x1i5 - x3r5;
        a[j34] = (-wn4r) * (x0r17 + x0i17);
        a[j34 + 1] = (-wn4r) * (x0i17 - x0r17);
        double x0r18 = a[mh + 2] + a[j24 + 2];
        double x0i18 = a[mh + 3] + a[j24 + 3];
        double x1r6 = a[mh + 2] - a[j24 + 2];
        double x1i6 = a[mh + 3] - a[j24 + 3];
        double x2r6 = a[j14 + 2] + a[j34 + 2];
        double x2i6 = a[j14 + 3] + a[j34 + 3];
        double x3r6 = a[j14 + 2] - a[j34 + 2];
        double x3i6 = a[j14 + 3] - a[j34 + 3];
        a[mh + 2] = x0r18 + x2r6;
        a[mh + 3] = x0i18 + x2i6;
        a[j14 + 2] = x0r18 - x2r6;
        a[j14 + 3] = x0i18 - x2i6;
        double x0r19 = x1r6 - x3i6;
        double x0i19 = x1i6 + x3r6;
        a[j24 + 2] = (wk1i2 * x0r19) - (wk1r2 * x0i19);
        a[j24 + 3] = (wk1i2 * x0i19) + (wk1r2 * x0r19);
        double x0r20 = x1r6 + x3i6;
        double x0i20 = x1i6 - x3r6;
    ...
    private final void cftb1st(int n, double[] a, double[] w, int wP) {
        ...
        int j24 = j14 + m3;
        int j34 = j24 + m3;
        double x0r12 = a[mh3 - 2] + a[j24 - 2];
        double x0i12 = (-a[mh3 - 1]) - a[j24 - 1];
        double x1r4 = a[mh3 - 2] - a[j24 - 2];
        double x1i5 = (-a[mh3 - 1]) + a[j24 - 1];
        double x2r4 = a[j14 - 2] + a[j34 - 2];
        double x2i4 = a[j14 - 1] + a[j34 - 1];
        double x3r4 = a[j14 - 2] - a[j34 - 2];
        double x3i4 = a[j14 - 1] - a[j34 - 1];
        ...
        a[j14 - 1] = x0i12 + x2i4;
        double x0r13 = x1r4 + x3i4;
        double x0i13 = x1i5 + x3r4;
        a[j24 - 2] = (wk1r2 * x0r13) - (wk1i2 * x0i13);
        a[j24 - 1] = (wk1r2 * x0i13) + (wk1i2 * x0r13);
        double x0r14 = x1r4 - x3i4;
        double x0i14 = x1i5 - x3r4;
        a[j34 - 2] = (wk3r2 * x0r14) + (wk3i2 * x0i14);
        a[j34 - 1] = (wk3r2 * x0i14) - (wk3i2 * x0r14);
        double x0r15 = a[mh3] + a[j24];
        double x0i15 = (-a[mh3 + 1]) - a[j24 + 1];
        double x1r5 = a[mh3] - a[j24];
        double x1i6 = (-a[mh3 + 1]) + a[j24 + 1];
        double x2r5 = a[j14] + a[j34];
        double x2i5 = a[j14 + 1] + a[j34 + 1];
        double x3r5 = a[j14] - a[j34];
        double x3i5 = a[j14 + 1] - a[j34 + 1];
        ...
        a[j14 + 1] = x0i15 + x2i5;
        double x0r16 = x1r5 + x3i5;
        double x0i16 = x1i6 + x3r5;
        a[j24] = (x0r16 - x0i16) * wn4r2;
        a[j24 + 1] = (x0i16 + x0r16) * wn4r2;
        double x0r17 = x1r5 - x3i5;
        double x0i17 = x1i6 - x3r5;
        a[j34] = (-wn4r2) * (x0r17 + x0i17);
        a[j34 + 1] = (-wn4r2) * (x0i17 - x0r17);
        double x0r18 = a[mh3 + 2] + a[j24 + 2];
        double x0i18 = (-a[mh3 + 3]) - a[j24 + 3];
        double x1r6 = a[mh3 + 2] - a[j24 + 2];
        double x1i7 = (-a[mh3 + 3]) + a[j24 + 3];
        double x2r6 = a[j14 + 2] + a[j34 + 2];
        double x2i6 = a[j14 + 3] + a[j34 + 3];
        double x3r6 = a[j14 + 2] - a[j34 + 2];
        double x3i6 = a[j14 + 3] - a[j34 + 3];
        ...
        a[j14 + 3] = x0i18 + x2i6;
        double x0r19 = x1r6 + x3i6;
        double x0i19 = x1i7 + x3r6;
        a[j24 + 2] = (wk1i2 * x0r19) - (wk1r2 * x0i19);
        a[j24 + 3] = (wk1i2 * x0i19) + (wk1r2 * x0r19);
        double x0r20 = x1r6 - x3i6;
        double x0i20 = x1i7 - x3r6;
        a[j34 + 2] = (wk3i2 * x0r20) + (wk3r2 * x0i20);
        a[j34 + 3] = (wk3i2 * x0i20) - (wk3r2 * x0r20);
    }
    ...
    private void cftrec1(int n, double[] a, int aP, int nw, double[] w) {
        ...
        if (n > 512) {
            ...
            cftrec1(m, a, aP + (m * 2), nw, w);
            cftrec1(m, a, aP + (m * 3), nw, w);
            return;
        }
        cftexp1(n, a, aP, nw, w);
    }
    ...
    private void cftexp1(int n, double[] a, int aP, int nw, double[] w) {
        ...
        while (l > 128) {
            for (int k = l; k < n; k <<= 2) {
                for (int j = k - l; j < n; j += k * 4) {
                    int i = l;
                    cftmdl1(i, a, aP + j, w, nw - (l >> 1));
                    cftmdl2(i, a, aP + k + j, w, nw - l);
                    cftmdl1(i, a, (k * 2) + aP + j, w, nw - (l >> 1));
                }
            }
        ...
        for (int k2 = l; k2 < n; k2 <<= 2) {
            for (int j2 = k2 - l; j2 < n; j2 += k2 * 4) {
                int i2 = l;
                cftmdl1(i2, a, aP + j2, w, nw - (l >> 1));
                cftfx41(i2, a, aP + j2, nw, w);
                cftmdl2(i2, a, aP + k2 + j2, w, nw - l);
                cftfx42(i2, a, aP + k2 + j2, nw, w);
                cftmdl1(i2, a, (k2 * 2) + aP + j2, w, nw - (l >> 1));
                cftfx41(i2, a, (k2 * 2) + aP + j2, nw, w);
            }
        }
        int i3 = l;
        cftmdl1(i3, a, (aP + n) - l, w, nw - (l >> 1));
        cftfx41(i3, a, (aP + n) - l, nw, w);
    }
    ...
    private void cftexp2(int n, double[] a, int aP, int nw, double[] w) {
        ...
        while (l > 128) {
            for (int k = l; k < m; k <<= 2) {
                for (int j = k - l; j < m; j += k * 2) {
                    int i = l;
                    cftmdl1(i, a, aP + j, w, nw - (l >> 1));
                    cftmdl1(i, a, aP + m + j, w, nw - (l >> 1));
                }
                for (int j2 = (k * 2) - l; j2 < m; j2 += k * 4) {
                    int i2 = l;
                    cftmdl2(i2, a, aP + j2, w, nw - l);
                    cftmdl2(i2, a, aP + m + j2, w, nw - l);
                }
            }
            l >>= 2;
        }
        for (int k2 = l; k2 < m; k2 <<= 2) {
            for (int j3 = k2 - l; j3 < m; j3 += k2 * 2) {
                int i3 = l;
                cftmdl1(i3, a, aP + j3, w, nw - (l >> 1));
                cftfx41(i3, a, aP + j3, nw, w);
                cftmdl1(i3, a, aP + m + j3, w, nw - (l >> 1));
                cftfx41(i3, a, aP + m + j3, nw, w);
            }
            for (int j4 = (k2 * 2) - l; j4 < m; j4 += k2 * 4) {
                int i4 = l;
                cftmdl2(i4, a, aP + j4, w, nw - l);
                cftfx42(i4, a, aP + j4, nw, w);
                cftmdl2(i4, a, aP + m + j4, w, nw - l);
                cftfx42(i4, a, aP + m + j4, nw, w);
            }
        }
    }
    ...
    private final void cftmdl1(int n, double[] a, int aP, double[] w, int wP) {
        ...
        double x2r = a[aP + m] + a[aP + j3];
        double x2i = a[aP + m + 1] + a[aP + j3 + 1];
        double x3r = a[aP + m] - a[aP + j3];
        double x3i = a[(aP + m) + 1] - a[(aP + j3) + 1];
        a[aP + 0] = wk3i + x2r;
        a[aP + 1] = x0i + x2i;
        a[aP + m] = wk3i - x2r;
        a[aP + m + 1] = x0i - x2i;
        ...
        while (j32 < mh) {
            ...
            int j22 = j1 + m;
            int j33 = j22 + m;
            double x0r = a[aP + j32] + a[aP + j22];
            double x0i2 = a[aP + j32 + 1] + a[aP + j22 + 1];
            double x1r2 = a[aP + j32] - a[aP + j22];
            double x1i2 = a[(aP + j32) + 1] - a[(aP + j22) + 1];
            double x2r2 = a[aP + j1] + a[aP + j33];
            double x2i2 = a[aP + j1 + 1] + a[aP + j33 + 1];
            double x3r2 = a[aP + j1] - a[aP + j33];
            double x3i2 = a[(aP + j1) + 1] - a[(aP + j33) + 1];
            a[aP + j32] = x0r + x2r2;
            a[aP + j32 + 1] = x0i2 + x2i2;
            a[aP + j1] = x0r - x2r2;
            a[aP + j1 + 1] = x0i2 - x2i2;
            ...
            a[aP + j33] = (wk3r * x0r3) + (wk3i2 * x0i4);
            a[aP + j33 + 1] = (wk3r * x0i4) - (wk3i2 * x0r3);
            int j0 = m - j32;
            int j12 = j0 + m;
            int j23 = j12 + m;
            int j34 = j23 + m;
            ...
            double x2r3 = a[aP + j12] + a[aP + j34];
            double x2i3 = a[aP + j12 + 1] + a[aP + j34 + 1];
            double x3r3 = a[aP + j12] - a[aP + j34];
            double x3i3 = a[(aP + j12) + 1] - a[(aP + j34) + 1];
            a[aP + j0] = x0r4 + x2r3;
            a[aP + j0 + 1] = x0i5 + x2i3;
            a[aP + j12] = x0r4 - x2r3;
            a[aP + j12 + 1] = x0i5 - x2i3;
            ...
            a[aP + j34] = (wk3i2 * x0r6) + (wk3r * x0i7);
            a[aP + j34 + 1] = (wk3i2 * x0i7) - (wk3r * x0r6);
            j32 += 2;
            wk3i = x0r6;
        }
        int j13 = mh + m;
        int j14 = j13 + m;
        int j24 = j14 + m;
        double x0r7 = a[aP + mh] + a[aP + j14];
        double x0i8 = a[aP + mh + 1] + a[aP + j14 + 1];
        double x1r4 = a[aP + mh] - a[aP + j14];
        double x1i4 = a[(aP + mh) + 1] - a[(aP + j14) + 1];
        double x2r4 = a[aP + j13] + a[aP + j24];
        double x2i4 = a[aP + j13 + 1] + a[aP + j24 + 1];
        double x3r4 = a[aP + j13] - a[aP + j24];
        double x3i4 = a[(aP + j13) + 1] - a[(aP + j24) + 1];
        a[aP + mh] = x0r7 + x2r4;
        a[aP + mh + 1] = x0i8 + x2i4;
        a[aP + j13] = x0r7 - x2r4;
        a[aP + j13 + 1] = x0i8 - x2i4;
        double x0r8 = x1r4 - x3i4;
        double x0r9 = x1i4 + x3r4;
        a[aP + j14] = (x0r8 - x0r9) * wn4r;
        a[aP + j14 + 1] = (x0r9 + x0r8) * wn4r;
        double x0r10 = x1r4 + x3i4;
        double x0i9 = x1i4 - x3r4;
        a[aP + j24] = (-wn4r) * (x0r10 + x0i9);
        a[aP + j24 + 1] = (-wn4r) * (x0i9 - x0r10);
    }
    ...
    private final void cftmdl2(int n, double[] a, int aP, double[] w, int wP) {
        ...
        int j25 = j14 + m;
        int j33 = j25 + m;
        double x0r4 = a[aP + mh] - a[(aP + j25) + 1];
        double x0i4 = a[aP + mh + 1] + a[aP + j25];
        double x1r4 = a[aP + mh] + a[aP + j25 + 1];
        double x1i4 = a[(aP + mh) + 1] - a[aP + j25];
        double x2r4 = a[aP + j14] - a[(aP + j33) + 1];
        double x2i4 = a[aP + j14 + 1] + a[aP + j33];
        double x3r4 = a[aP + j14] + a[aP + j33 + 1];
        double x3i4 = a[(aP + j14) + 1] - a[aP + j33];
        double y0r7 = (wk1r2 * x0r4) - (wk1i2 * x0i4);
        double y0i7 = (wk1r2 * x0i4) + (wk1i2 * x0r4);
        double y2r5 = (wk1i2 * x2r4) - (wk1r2 * x2i4);
        double d = (wk1i2 * x2i4) + (wk1r2 * x2r4);
        a[aP + mh] = y0r7 + y2r5;
        a[aP + mh + 1] = y0i7 + d;
        a[aP + j14] = y0r7 - y2r5;
        a[aP + j14 + 1] = y0i7 - d;
        double y0r8 = (wk1i2 * x1r4) - (wk1r2 * x1i4);
        double y0i8 = (wk1i2 * x1i4) + (wk1r2 * x1r4);
        double y2r6 = (wk1r2 * x3r4) - (wk1i2 * x3i4);
        double y2i5 = (wk1r2 * x3i4) + (wk1i2 * x3r4);
        a[aP + j25] = y0r8 - y2r6;
        a[aP + j25 + 1] = y0i8 - y2i5;
        a[aP + j33] = y0r8 + y2r6;
        a[aP + j33 + 1] = y0i8 + y2i5;
    }
    ...
    private void cftf161(double[] a, int aP, double[] w, int wP) {
        ...
        double x3r7 = (x2i8 - x0i14) * wn4r;
        double x3i10 = (x0i14 + x2i8) * wn4r;
        double x0r14 = y4r - y6i;
        ...
        a[aP + 14] = x1r7 + x3i10;
        a[aP + 15] = x1i7 - x3r7;
        double x0r15 = y0r + x3i5;
        double x0i16 = y0i + y2i;
        double x1r8 = y0r - x3i5;
        double x1i8 = y0i - y2i;
        double x2r8 = x3i3 + x3i7;
        double x2i9 = y1i + y3i;
        double x3r8 = x3i3 - x3i7;
        double x3i11 = y1i - y3i;
        a[aP + 0] = x0r15 + x2r8;
        a[aP + 1] = x0i16 + x2i9;
        a[aP + 2] = x0r15 - x2r8;
        a[aP + 3] = x0i16 - x2i9;
    ...
    private void cftf162(double[] a, int aP, double[] w, int wP) {
        ...
        double x2i4 = (wk3i * x0i4) + (wk3r * x0r4);
        double x2i5 = x1r3 + x2r3;
        double y1i = x1i3 + x2i4;
        double y5r = x1r3 - x2r3;
        double y5i = x1i3 - x2i4;
        ...
        double x2i6 = (wk1r * x0i6) - (wk1i * x0r6);
        double x2i7 = x1r4 - x2r4;
        double y9i = x1i4 - x2i6;
        double y13r = x1r4 + x2r4;
        double y13i = x1i4 + x2i6;
        ...
        double x2i8 = (wk2i * x0i8) + (wk2r * x0r8);
        double x2i9 = x1r5 + x2r5;
        double y2i = x1i5 + x2i8;
        double y6r = x1r5 - x2r5;
        double y6i = x1i5 - x2i8;
        ...
        double x2i10 = (wk2r * x0i10) + (wk2i * x0r10);
        double x2i11 = x1r6 - x2r6;
        double y10i = x1i6 - x2i10;
        double y14r = x1r6 + x2r6;
        double y14i = x1i6 + x2i10;
        ...
        double x2i12 = (wk1i * x0i12) + (wk1r * x0r12);
        double x2i13 = x1r7 + x2r7;
        double y3i = x1i7 + x2i12;
        double y7r = x1r7 - x2r7;
        double y7i = x1i7 - x2i12;
        ...
        double x2i14 = (wk3i * x0i14) + (wk3r * x0r14);
        double x2i15 = x1r8 + x2r8;
        double y11i = x1i8 + x2i14;
        double y15r = x1r8 - x2r8;
        double y15i = x1i8 - x2i14;
        double x1r9 = y0r + x2i9;
        double x1i9 = y0i + y2i;
        double x2r9 = x2i5 + x2i13;
        double x2i16 = y1i + y3i;
        a[aP + 0] = x1r9 + x2r9;
        a[aP + 1] = x1i9 + x2i16;
        a[aP + 2] = x1r9 - x2r9;
        a[aP + 3] = x1i9 - x2i16;
        double x1r10 = y0r - x2i9;
        double x1i10 = y0i - y2i;
        double x2r10 = x2i5 - x2i13;
        double x2i17 = y1i - y3i;
        a[aP + 4] = x1r10 - x2i17;
        a[aP + 5] = x1i10 + x2r10;
        a[aP + 6] = x1r10 + x2i17;
        a[aP + 7] = x1i10 - x2r10;
        ...
        double x2i19 = (x0i16 + x0r16) * wn4r;
        a[aP + 12] = x1r12 - x2i19;
        a[aP + 13] = x1i12 + x2r12;
        a[aP + 14] = x1r12 + x2i19;
        a[aP + 15] = x1i12 - x2r12;
        double x1r13 = x2i3 + x2i11;
        double x1i13 = y8i + y10i;
        double x1i14 = x2i7 - x2i15;
        double x2r13 = y9i - y11i;
        a[aP + 16] = x1r13 + x1i14;
        a[aP + 17] = x1i13 + x2r13;
        a[aP + 18] = x1r13 - x1i14;
        a[aP + 19] = x1i13 - x2r13;
        double x1r14 = x2i3 - x2i11;
        double x1i15 = y8i - y10i;
        double x2r14 = x2i7 + x2i15;
        double x2i20 = y9i + y11i;
        a[aP + 20] = x1r14 - x2i20;
        a[aP + 21] = x1i15 + x2r14;
        a[aP + 22] = x1r14 + x2i20;
        a[aP + 23] = x1i15 - x2r14;
