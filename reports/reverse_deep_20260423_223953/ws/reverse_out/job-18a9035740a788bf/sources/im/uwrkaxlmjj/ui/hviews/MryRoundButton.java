...
public class MryRoundButton extends MryAlphaButton {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mRadiusTopLeft = typedArray.getDimensionPixelSize(8, 0);
        this.mRadiusTopRight = typedArray.getDimensionPixelSize(9, 0);
        this.mRadiusBottomLeft = typedArray.getDimensionPixelSize(6, 0);
        this.mRadiusBottomRight = typedArray.getDimensionPixelSize(7, 0);
        typedArray.recycle();
    ...
    @Override // im.uwrkaxlmjj.ui.hviews.MryAlphaButton
    ...
    public void setRadius(float topLeftRadius, float topRightRadius, float bottomLeftRadius, float bottomRightRadius) {
        ...
        if (topLeftRadius > 0.0f || topRightRadius > 0.0f || bottomLeftRadius > 0.0f || bottomRightRadius > 0.0f) {
            ...
            float[] radii = {f, f, f2, f2, f3, f3, f4, f4};
            this.mRoundBg.setCornerRadii(radii);
            return;
        }
