...
import im.uwrkaxlmjj.ui.hviews.ScaleTextureView;
...
public class PlayerUtils extends ViewGroup implements VideoPlayer.VideoPlayerDelegate, AudioManager.OnAudioFocusChangeListener {
    ...
    */
    protected java.lang.String downloadUrlContent(android.os.AsyncTask r24, java.lang.String r25, java.util.HashMap<java.lang.String, java.lang.String> r26, boolean r27) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.messenger.utils.PlayerUtils.downloadUrlContent(android.os.AsyncTask, java.lang.String, java.util.HashMap, boolean):java.lang.String");
    }
        ...
        */
        public java.lang.String[] doInBackground(java.lang.Void... r28) {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.messenger.utils.PlayerUtils.YoutubeVideoTask.doInBackground(java.lang.Void[]):java.lang.String[]");
        }

        public /* synthetic */ void lambda$doInBackground$1$PlayerUtils$YoutubeVideoTask(String functionCodeFinal) {
            if (Build.VERSION.SDK_INT >= 21) {
                PlayerUtils.this.webView.evaluateJavascript(functionCodeFinal, new ValueCallback() { // from class: im.uwrkaxlmjj.messenger.utils.-$$Lambda$PlayerUtils$YoutubeVideoTask$S4VuPZ1tNEFyQyz4oIHnhz6Mgl8
                    @Override // android.webkit.ValueCallback
                    public final void onReceiveValue(Object obj) {
                        this.f$0.lambda$null$0$PlayerUtils$YoutubeVideoTask((String) obj);
                    }
                });
                return;
            }
            try {
                ...
                PlayerUtils.this.webView.loadUrl("data:text/html;charset=utf-8;base64," + base64);
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
    ...
    class ControlsView extends FrameLayout {
        ...
        public ControlsView(Context context) {
            super(context);
            this.isVisible = true;
            this.hideRunnable = new Runnable() { // from class: im.uwrkaxlmjj.messenger.utils.-$$Lambda$PlayerUtils$ControlsView$BTwX8rFQC5K-FVuIRvUZylWy0iY
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$new$0$PlayerUtils$ControlsView();
                }
            };
        ...
        public void show(boolean value, boolean animated) {
            ...
            if (this.isVisible) {
                if (animated) {
                    ...
                    this.currentAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.messenger.utils.PlayerUtils.ControlsView.1
                ...
                this.currentAnimation.setDuration(150L);
                this.currentAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.messenger.utils.PlayerUtils.ControlsView.2
                    @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                    public void onAnimationEnd(Animator animator) {
                        ControlsView.this.currentAnimation = null;
                    }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (PlayerUtils.this.drawImage) {
                if (PlayerUtils.this.firstFrameRendered && PlayerUtils.this.currentAlpha != 0.0f) {
                    ...
                    PlayerUtils.this.currentAlpha -= dt / 150.0f;
    ...
    public PlayerUtils(Context context, boolean allowInline, boolean allowShare, WebPlayerViewDelegate webPlayerViewDelegate) {
        ...
        this.progressRunnable = new Runnable() { // from class: im.uwrkaxlmjj.messenger.utils.PlayerUtils.1
            @Override // java.lang.Runnable
            public void run() {
        ...
        this.surfaceTextureListener = new TextureView.SurfaceTextureListener() { // from class: im.uwrkaxlmjj.messenger.utils.PlayerUtils.2
            ...
            /* JADX INFO: renamed from: im.uwrkaxlmjj.messenger.utils.PlayerUtils$2$1, reason: invalid class name */
            class AnonymousClass1 implements ViewTreeObserver.OnPreDrawListener {
                ...
                public boolean onPreDraw() {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.utils.-$$Lambda$PlayerUtils$2$1$ZMOIVfnfNgHMC0HXcBYwmaQVMpA
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$onPreDraw$0$PlayerUtils$2$1();
                        }
                    });
        ...
        this.switchToInlineRunnable = new Runnable() { // from class: im.uwrkaxlmjj.messenger.utils.PlayerUtils.3
            @Override // java.lang.Runnable
            public void run() {
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(context) { // from class: im.uwrkaxlmjj.messenger.utils.PlayerUtils.4
        ...
        webView.addJavascriptInterface(new JavaScriptInterface(new CallJavaResultInterface() { // from class: im.uwrkaxlmjj.messenger.utils.-$$Lambda$PlayerUtils$ITjM4RwybsaW5kNlmtKDeBjynAw
            @Override // im.uwrkaxlmjj.messenger.utils.PlayerUtils.CallJavaResultInterface
            public final void jsCallFinished(String str) {
                this.f$0.lambda$new$0$PlayerUtils(str);
            }
        }), this.interfaceName);
        ...
        this.fullscreenButton.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.messenger.utils.-$$Lambda$PlayerUtils$6J8ShpLLjTLOr5y0mrXY-hjsbm8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$1$PlayerUtils(view);
            }
        });
        ...
        this.playButton.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.messenger.utils.-$$Lambda$PlayerUtils$3EGzNB6qGaoGxdrCStDQ98QQny8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$2$PlayerUtils(view);
            }
        });
        if (allowInline) {
            ...
            this.inlineButton.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.messenger.utils.-$$Lambda$PlayerUtils$K6wpv3LaSFvnYH3miWIbYKsMswM
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$new$3$PlayerUtils(view);
                }
            });
        }
        if (allowShare) {
            ...
            this.shareButton.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.messenger.utils.-$$Lambda$PlayerUtils$jw8GIwJYMdqR_NobFGwBrE2ySFw
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$new$4$PlayerUtils(view);
                }
            });
        }
        updatePlayButton();
    ...
    public void showProgress(boolean show, boolean animated) {
        if (animated) {
            ...
            this.progressAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.messenger.utils.PlayerUtils.5
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
