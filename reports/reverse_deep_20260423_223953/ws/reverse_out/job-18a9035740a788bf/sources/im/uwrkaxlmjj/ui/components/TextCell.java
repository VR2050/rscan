...
public class TextCell extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        this.container = (LinearLayout) view.findViewById(R.attr.container);
        this.titleText = (TextView) view.findViewById(R.attr.titleText);
        this.valueText = (TextView) view.findViewById(R.attr.valueText);
        this.imageView = (ImageView) view.findViewById(R.attr.ivIcon);
        this.imageValue = (ImageView) view.findViewById(R.attr.ivArrow);
    ...
    public void setTitleSize(int size) {
        this.titleText.setTextSize(1, size);
    }
    ...
    public void setText(String text, boolean arrow, boolean div) {
        setData(0, text, "", arrow ? R.id.icon_arrow_right : 0, div);
    }

    public void setText(int icon, String text, boolean arrow, boolean div) {
        setData(icon, text, "", arrow ? R.id.icon_arrow_right : 0, div);
    }

    public void setText(String text, String value, boolean arrow, boolean div) {
        setData(0, text, value, arrow ? R.id.icon_arrow_right : 0, div);
    }

    public void setData(int lId, String title, int rId, boolean divider) {
        setData(lId, title, "", rId, divider);
    }
    ...
    public void setData(int lId, String title, String value, int rId, boolean divider) {
        if (lId > 0) {
    ...
    public void setData(String title, Drawable rd, boolean divider) {
        this.imageView.setVisibility(8);
    ...
    public void setEnabled(boolean value, ArrayList<Animator> animators) {
        ...
        if (this.imageValue.getVisibility() == 0) {
            this.imageValue.setAlpha(value ? 1.0f : 0.5f);
        }
    }
