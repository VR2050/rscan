...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            drawerProfileCell.setOnArrowClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.adapters.-$$Lambda$DrawerLayoutAdapter$zxL8auxsU65r70b6Wz0kGWg9eXs
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f$0.lambda$onCreateViewHolder$0$DrawerLayoutAdapter(view2);
                }
            });
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (itemViewType == 0) {
            ...
            profileCell.setUser(MessagesController.getInstance(UserConfig.selectedAccount).getUser(Integer.valueOf(UserConfig.getInstance(UserConfig.selectedAccount).getClientUserId())), this.accountsShowed);
            return;
        }
        if (itemViewType != 3) {
            if (itemViewType == 4) {
    ...
    private void resetItems() {
        ...
        Collections.sort(this.accountNumbers, new Comparator() { // from class: im.uwrkaxlmjj.ui.adapters.-$$Lambda$DrawerLayoutAdapter$ti7fb05gm2kmWOEkjNODHaH50cI
