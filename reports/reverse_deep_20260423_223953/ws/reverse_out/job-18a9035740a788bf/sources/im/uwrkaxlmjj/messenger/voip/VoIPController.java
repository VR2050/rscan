...
public class VoIPController {
    ...
    public void setConfig(double recvTimeout, double initTimeout, int dataSavingOption, long callID) {
        ...
        nativeSetConfig(j, recvTimeout, initTimeout, dataSavingOption, z, z2, true, logFilePath, (BuildVars.DEBUG_VERSION && dump) ? getLogFilePath("voipStats") : null, BuildVars.DEBUG_VERSION);
    }
