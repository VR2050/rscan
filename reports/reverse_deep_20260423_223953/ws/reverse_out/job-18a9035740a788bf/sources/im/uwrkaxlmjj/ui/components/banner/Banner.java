package im.uwrkaxlmjj.ui.components.banner;
...
import im.uwrkaxlmjj.ui.components.banner.indicator.Indicator;
...
import im.uwrkaxlmjj.ui.components.banner.transformer.MZScaleInTransformer;
import im.uwrkaxlmjj.ui.components.banner.transformer.ScaleInTransformer;
import im.uwrkaxlmjj.ui.components.banner.util.BannerLifecycleObserver;
import im.uwrkaxlmjj.ui.components.banner.util.BannerLifecycleObserverAdapter;
import im.uwrkaxlmjj.ui.components.banner.util.BannerUtils;
import im.uwrkaxlmjj.ui.components.banner.util.ScrollSpeedManger;
...
public class Banner<T, BA extends BannerAdapter<T, ? extends RecyclerView.ViewHolder>> extends FrameLayout implements BannerLifecycleObserver {
    ...
    public Banner(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mAdapterDataObserver = new RecyclerView.AdapterDataObserver() { // from class: im.uwrkaxlmjj.ui.components.banner.Banner.1
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            this.mBannerRadius = a.getDimensionPixelSize(17, 0);
            this.mLoopTime = a.getInt(15, 3000);
    ...
    */
    public boolean onInterceptTouchEvent(android.view.MotionEvent r8) {
        ...
        L8d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.ui.components.banner.Banner.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void drawTopRight(Canvas canvas) {
        int width = getWidth();
        Path path = new Path();
        path.moveTo(width - this.mBannerRadius, 0.0f);
        path.lineTo(width, 0.0f);
        path.lineTo(width, this.mBannerRadius);
        float f = this.mBannerRadius;
    ...
    private void drawBottomLeft(Canvas canvas) {
        ...
        Path path = new Path();
        path.moveTo(0.0f, height - this.mBannerRadius);
        path.lineTo(0.0f, height);
        path.lineTo(this.mBannerRadius, height);
        float f = this.mBannerRadius;
    ...
    private void drawBottomRight(Canvas canvas) {
        ...
        int width = getWidth();
        Path path = new Path();
        path.moveTo(width - this.mBannerRadius, height);
        path.lineTo(width, height);
        path.lineTo(width, height - this.mBannerRadius);
        float f = this.mBannerRadius;
        ...
        public void onPageScrollStateChanged(int state) {
            if (state == 1 || state == 2) {
                ...
                if (this.mTempPosition != -1 && Banner.this.mIsInfiniteLoop) {
                    ...
                    if (i != 0) {
                        if (i == Banner.this.getItemCount() - 1) {
    ...
    public Banner setBannerGalleryEffect(int leftItemWidth, int rightItemWidth, int pageMargin, float scale) {
        ...
        int iDp2px = 0;
        int iDp2px2 = leftItemWidth > 0 ? (int) BannerUtils.dp2px(leftItemWidth + pageMargin) : 0;
        if (rightItemWidth > 0) {
            iDp2px = (int) BannerUtils.dp2px(rightItemWidth + pageMargin);
        }
        setRecyclerViewPadding(iDp2px2, iDp2px);
        return this;
    }
    ...
    public Banner setIndicatorWidth(float normalWidth, float selectedWidth) {
        if (getIndicatorConfig() != null) {
    ...
    public Banner setIndicatorNormalWidth(float normalWidth) {
        if (getIndicatorConfig() != null) {
            getIndicatorConfig().setNormalWidth(normalWidth);
        }
        return this;
    ...
    public Banner setIndicatorSelectedWidth(float selectedWidth) {
        if (getIndicatorConfig() != null) {
            getIndicatorConfig().setSelectedWidth(selectedWidth);
        }
        return this;
    ...
    public Banner setIndicatorRadius(float indicatorRadius) {
        if (getIndicatorConfig() != null) {
    ...
    public Banner setIndicatorHeight(float indicatorHeight) {
        if (getIndicatorConfig() != null) {
    ...
    @Override // im.uwrkaxlmjj.ui.components.banner.util.BannerLifecycleObserver
