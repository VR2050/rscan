...
public class MP3Frame {
    ...
    static final class CRC16 {
        ...
        public void update(int value, int length) {
            ...
            int mask = 1 << (length - 1);
            do {
                if (((this.crc & ShortCompanionObject.MIN_VALUE) == 0) ^ ((value & mask) == 0)) {
    ...
    boolean isChecksumError() {
        ...
        int crc = (bArr[5] & UByte.MAX_VALUE) | ((bArr[4] & UByte.MAX_VALUE) << 8);
    ...
    boolean isXingFrame() {
        ...
        return bArr2[xingOffset] == 73 && bArr2[xingOffset + 1] == 110 && bArr2[xingOffset + 2] == 102 && bArr2[xingOffset + 3] == 111;
    }
