...
public class Media1Activity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static final Interpolator interpolator = new Interpolator() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$XGgUjxpLNShpKK4Y9bo_mgeCrbY
        @Override // android.animation.TimeInterpolator
        public final float getInterpolation(float f) {
            return Media1Activity.lambda$static$0(f);
        }
    };
    ...
    public Media1Activity(Bundle args, int[] media, SharedMediaData[] mediaData, int initTab) {
        ...
        this.info = null;
        this.columnsCount = 4;
        this.SCROLL_Y = new AnimationProperties.FloatProperty<Media1Activity>("animationValue") { // from class: im.uwrkaxlmjj.ui.Media1Activity.1
        ...
        this.provider = new PhotoViewer.EmptyPhotoViewerProvider() { // from class: im.uwrkaxlmjj.ui.Media1Activity.2
            ...
            public PhotoViewer.PlaceProviderObject getPlaceForPhoto(MessageObject messageObject, TLRPC.FileLocation fileLocation, int index, boolean needPreview) {
                ...
                for (int a = 0; a < count; a++) {
                    ...
                    if (imageView != null) {
                        ...
                        object.clipTopAddition = (int) (Media1Activity.this.actionBar.getHeight() + Media1Activity.this.actionBar.getTranslationY());
    ...
    public View createView(Context context) {
        ...
        for (int a = 0; a < 10; a++) {
            ...
            if (this.initialTab == 4) {
                SharedAudioCell cell = new SharedAudioCell(context) { // from class: im.uwrkaxlmjj.ui.Media1Activity.3
        ...
        if (i2 != -1) {
            scrollSlidingTextTabStrip2.setInitialTabId(i2);
            this.initialTab = -1;
        }
        this.actionBar.addView(this.scrollSlidingTextTabStrip, LayoutHelper.createFrame(-1, 44, 83));
        this.scrollSlidingTextTabStrip.setDelegate(new ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate() { // from class: im.uwrkaxlmjj.ui.Media1Activity.5
            ...
            public void onPageSelected(int id, boolean forward2) {
                ...
                media1Activity.swipeBackEnabled = id == media1Activity.scrollSlidingTextTabStrip.getFirstTabId();
                Media1Activity.this.mediaPages[1].selectedType = id;
                Media1Activity.this.mediaPages[1].setVisibility(0);
                Media1Activity.this.switchToCurrentSelectedMode(true);
                Media1Activity.this.animatingForward = forward2;
            }
            ...
            public void onPageScrolled(float progress) {
                if (progress != 1.0f || Media1Activity.this.mediaPages[1].getVisibility() == 0) {
                    if (Media1Activity.this.animatingForward) {
                        Media1Activity.this.mediaPages[0].setTranslationX((-progress) * Media1Activity.this.mediaPages[0].getMeasuredWidth());
                        Media1Activity.this.mediaPages[1].setTranslationX(Media1Activity.this.mediaPages[0].getMeasuredWidth() - (Media1Activity.this.mediaPages[0].getMeasuredWidth() * progress));
                    } else {
                        Media1Activity.this.mediaPages[0].setTranslationX(Media1Activity.this.mediaPages[0].getMeasuredWidth() * progress);
                        Media1Activity.this.mediaPages[1].setTranslationX((Media1Activity.this.mediaPages[0].getMeasuredWidth() * progress) - Media1Activity.this.mediaPages[0].getMeasuredWidth());
                    }
                    ...
                    if (progress == 1.0f) {
                        ...
                        Media1Activity.this.searchItemState = 0;
                    }
                }
            }
        });
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = menu.addItem(0, R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: im.uwrkaxlmjj.ui.Media1Activity.6
            @Override // im.uwrkaxlmjj.ui.actionbar.ActionBarMenuItem.ActionBarMenuItemSearchListener
            public void onSearchExpand() {
                Media1Activity.this.searching = true;
                Media1Activity.this.resetScroll();
            }

            @Override // im.uwrkaxlmjj.ui.actionbar.ActionBarMenuItem.ActionBarMenuItemSearchListener
            public void onSearchCollapse() {
                Media1Activity.this.searching = false;
                Media1Activity.this.searchWas = false;
                Media1Activity.this.documentsSearchAdapter.search(null);
                Media1Activity.this.linksSearchAdapter.search(null);
                Media1Activity.this.audioSearchAdapter.search(null);
                if (Media1Activity.this.ignoreSearchCollapse) {
                    Media1Activity.this.ignoreSearchCollapse = false;
                } else {
            ...
            public void onTextChanged(EditText editText) {
                ...
                if (text.length() != 0) {
                    Media1Activity.this.searchWas = true;
                    Media1Activity.this.switchToCurrentSelectedMode(false);
                } else {
                    Media1Activity.this.searchWas = false;
                    Media1Activity.this.switchToCurrentSelectedMode(false);
        ...
        this.selectedMessagesCountTextView.setOnTouchListener(new View.OnTouchListener() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$1umEGocHiMtquFHwA3bMfQfysTQ
            @Override // android.view.View.OnTouchListener
            public final boolean onTouch(View view2, MotionEvent motionEvent) {
                return Media1Activity.lambda$createView$1(view2, motionEvent);
            }
        });
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: im.uwrkaxlmjj.ui.Media1Activity.7
            ...
            private boolean prepareForMoving(MotionEvent ev, boolean forward2) {
                int id = Media1Activity.this.scrollSlidingTextTabStrip.getNextPageId(forward2);
                if (id >= 0) {
                    ...
                    Media1Activity.this.switchToCurrentSelectedMode(true);
                    if (forward2) {
                        Media1Activity.this.mediaPages[1].setTranslationX(Media1Activity.this.mediaPages[0].getMeasuredWidth());
                    } else {
                        Media1Activity.this.mediaPages[1].setTranslationX(-Media1Activity.this.mediaPages[0].getMeasuredWidth());
                    }
                    return true;
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                for (int a3 = 0; a3 < Media1Activity.this.mediaPages.length; a3++) {
                    if (Media1Activity.this.mediaPages[a3] != null) {
                        if (Media1Activity.this.mediaPages[a3].listView != null) {
                            Media1Activity.this.mediaPages[a3].listView.setPadding(0, Media1Activity.this.additionalPadding + actionBarHeight, 0, AndroidUtilities.dp(4.0f));
                        }
                        if (Media1Activity.this.mediaPages[a3].emptyView != null) {
                            Media1Activity.this.mediaPages[a3].emptyView.setPadding(0, Media1Activity.this.additionalPadding + actionBarHeight, 0, 0);
                        }
                        if (Media1Activity.this.mediaPages[a3].progressView != null) {
                            Media1Activity.this.mediaPages[a3].progressView.setPadding(0, Media1Activity.this.additionalPadding + actionBarHeight, 0, 0);
                        }
                    }
                }
            ...
            public void setPadding(int left, int top, int right, int bottom) {
                Media1Activity.this.additionalPadding = top;
                if (Media1Activity.this.fragmentContextView != null) {
                    Media1Activity.this.fragmentContextView.setTranslationY(top + Media1Activity.this.actionBar.getTranslationY());
                }
                int actionBarHeight = Media1Activity.this.actionBar.getMeasuredHeight();
                for (int a3 = 0; a3 < Media1Activity.this.mediaPages.length; a3++) {
                    if (Media1Activity.this.mediaPages[a3] != null) {
                        ...
                        if (Media1Activity.this.mediaPages[a3].listView != null) {
                            Media1Activity.this.mediaPages[a3].listView.setPadding(0, Media1Activity.this.additionalPadding + actionBarHeight, 0, AndroidUtilities.dp(4.0f));
                            Media1Activity.this.mediaPages[a3].listView.checkSection();
                        }
                    }
                }
            }
            ...
            public boolean checkTabsAnimationInProgress() {
                ...
                if (Media1Activity.this.backAnimation) {
                    if (Math.abs(Media1Activity.this.mediaPages[0].getTranslationX()) < 1.0f) {
                        ...
                        Media1Activity.this.mediaPages[1].setTranslationX(Media1Activity.this.mediaPages[0].getMeasuredWidth() * (Media1Activity.this.animatingForward ? 1 : -1));
                        cancel = true;
                    }
                } else if (Math.abs(Media1Activity.this.mediaPages[1].getTranslationX()) < 1.0f) {
                    Media1Activity.this.mediaPages[0].setTranslationX(Media1Activity.this.mediaPages[0].getMeasuredWidth() * (Media1Activity.this.animatingForward ? -1 : 1));
                ...
                if (cancel) {
                    if (Media1Activity.this.tabsAnimation != null) {
                        ...
                        Media1Activity.this.tabsAnimation = null;
                    }
                    Media1Activity.this.tabsAnimationInProgress = false;
                }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRect(0.0f, Media1Activity.this.actionBar.getMeasuredHeight() + Media1Activity.this.actionBar.getTranslationY(), getMeasuredWidth(), getMeasuredHeight(), Media1Activity.this.backgroundPaint);
            }
            ...
            public boolean onTouchEvent(MotionEvent ev) {
                ...
                if (ev != null && ev.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
                    ...
                    if (this.maybeStartTracking && !this.startedTracking) {
                        ...
                        Media1Activity.this.mediaPages[0].setTranslationX(dx2);
                        if (Media1Activity.this.animatingForward) {
                            Media1Activity.this.mediaPages[1].setTranslationX(Media1Activity.this.mediaPages[0].getMeasuredWidth() + dx2);
                        } else {
                            Media1Activity.this.mediaPages[1].setTranslationX(dx2 - Media1Activity.this.mediaPages[0].getMeasuredWidth());
                        }
                        float scrollProgress = Math.abs(dx2) / Media1Activity.this.mediaPages[0].getMeasuredWidth();
                        if (Media1Activity.this.searchItemState == 2) {
                    ...
                    this.velocityTracker.computeCurrentVelocity(1000, Media1Activity.this.maximumVelocity);
                    ...
                    if (this.startedTracking) {
                        ...
                        Media1Activity.this.tabsAnimation = new AnimatorSet();
                        float velX2 = this.velocityTracker.getXVelocity();
                        float velY2 = this.velocityTracker.getYVelocity();
                        Media1Activity.this.backAnimation = Math.abs(x) < ((float) Media1Activity.this.mediaPages[0].getMeasuredWidth()) / 3.0f && (Math.abs(velX2) < 3500.0f || Math.abs(velX2) < Math.abs(velY2));
                        if (!Media1Activity.this.backAnimation) {
                            dx = Media1Activity.this.mediaPages[0].getMeasuredWidth() - Math.abs(x);
                            if (Media1Activity.this.animatingForward) {
                                Media1Activity.this.tabsAnimation.playTogether(ObjectAnimator.ofFloat(Media1Activity.this.mediaPages[0], (Property<MediaPage, Float>) View.TRANSLATION_X, -Media1Activity.this.mediaPages[0].getMeasuredWidth()), ObjectAnimator.ofFloat(Media1Activity.this.mediaPages[1], (Property<MediaPage, Float>) View.TRANSLATION_X, 0.0f));
                            } else {
                                Media1Activity.this.tabsAnimation.playTogether(ObjectAnimator.ofFloat(Media1Activity.this.mediaPages[0], (Property<MediaPage, Float>) View.TRANSLATION_X, Media1Activity.this.mediaPages[0].getMeasuredWidth()), ObjectAnimator.ofFloat(Media1Activity.this.mediaPages[1], (Property<MediaPage, Float>) View.TRANSLATION_X, 0.0f));
                            }
                        } else {
                            dx = Math.abs(x);
                            if (Media1Activity.this.animatingForward) {
                                Media1Activity.this.tabsAnimation.playTogether(ObjectAnimator.ofFloat(Media1Activity.this.mediaPages[0], (Property<MediaPage, Float>) View.TRANSLATION_X, 0.0f), ObjectAnimator.ofFloat(Media1Activity.this.mediaPages[1], (Property<MediaPage, Float>) View.TRANSLATION_X, Media1Activity.this.mediaPages[1].getMeasuredWidth()));
                            } else {
                                Media1Activity.this.tabsAnimation.playTogether(ObjectAnimator.ofFloat(Media1Activity.this.mediaPages[0], (Property<MediaPage, Float>) View.TRANSLATION_X, 0.0f), ObjectAnimator.ofFloat(Media1Activity.this.mediaPages[1], (Property<MediaPage, Float>) View.TRANSLATION_X, -Media1Activity.this.mediaPages[1].getMeasuredWidth()));
                            }
                        }
                        ...
                        Media1Activity.this.tabsAnimation.setDuration(Math.max(150, Math.min(duration, 600)));
                        Media1Activity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.Media1Activity.7.1
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                if (Media1Activity.this.backAnimation) {
                                    ...
                                    Media1Activity.this.searchItemState = 0;
                                    Media1Activity.this.swipeBackEnabled = Media1Activity.this.mediaPages[0].selectedType == Media1Activity.this.scrollSlidingTextTabStrip.getFirstTabId();
                        ...
                        Media1Activity.this.tabsAnimationInProgress = true;
                    } else {
                        this.maybeStartTracking = false;
                        this.startedTracking = false;
                        Media1Activity.this.actionBar.setEnabled(true);
        ...
        while (true) {
            ...
            final MediaPage mediaPage = new MediaPage(context) { // from class: im.uwrkaxlmjj.ui.Media1Activity.8
                @Override // android.view.View
                public void setTranslationX(float translationX) {
                    super.setTranslationX(translationX);
                    if (Media1Activity.this.tabsAnimationInProgress && Media1Activity.this.mediaPages[0] == this) {
                        float scrollProgress = Math.abs(Media1Activity.this.mediaPages[0].getTranslationX()) / Media1Activity.this.mediaPages[0].getMeasuredWidth();
                        Media1Activity.this.scrollSlidingTextTabStrip.selectTabWithId(Media1Activity.this.mediaPages[1].selectedType, scrollProgress);
                        if (Media1Activity.this.searchItemState == 2) {
                            Media1Activity.this.searchItem.setAlpha(1.0f - scrollProgress);
                        } else if (Media1Activity.this.searchItemState == 1) {
            ...
            final LinearLayoutManager layoutManager = mediaPageArr2[a3].layoutManager = new LinearLayoutManager(context, i, false) { // from class: im.uwrkaxlmjj.ui.Media1Activity.9
                @Override // androidx.recyclerview.widget.LinearLayoutManager, androidx.recyclerview.widget.RecyclerView.LayoutManager
                public boolean supportsPredictiveItemAnimations() {
                    return false;
                }
            };
            this.mediaPages[a3].listView = new RecyclerListView(context) { // from class: im.uwrkaxlmjj.ui.Media1Activity.10
            ...
            this.mediaPages[a3].listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$RcpsvgJtaxyw3fibwo9xeS8_lp4
                @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemClickListener
                public final void onItemClick(View view2, int i4) {
                    this.f$0.lambda$createView$2$Media1Activity(mediaPage, view2, i4);
                }
            });
            this.mediaPages[a3].listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.Media1Activity.11
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    ...
                    Media1Activity.this.scrolling = newState != 0;
                    if (newState != 1) {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    if (visibleItemCount != 0 && firstVisibleItem + visibleItemCount > totalItemCount - 2 && !Media1Activity.this.sharedMediaData[mediaPage.selectedType].loading) {
                        ...
                        if (!Media1Activity.this.sharedMediaData[mediaPage.selectedType].endReached[0]) {
                            Media1Activity.this.sharedMediaData[mediaPage.selectedType].loading = true;
                    ...
                    if (recyclerView == Media1Activity.this.mediaPages[0].listView && !Media1Activity.this.searching && !Media1Activity.this.actionBar.isActionModeShowed()) {
                    ...
                    Media1Activity.this.updateSections(recyclerView, false);
                }
            });
            this.mediaPages[a3].listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$8Fpp8HxgcdS4bd_STfdc1OQKgBo
                ...
                public final boolean onItemClick(View view2, int i4) {
                    return this.f$0.lambda$createView$3$Media1Activity(mediaPage, view2, i4);
                }
            });
            ...
            this.mediaPages[a3].emptyView = new LinearLayout(context) { // from class: im.uwrkaxlmjj.ui.Media1Activity.12
            ...
            this.mediaPages[a3].emptyView.setOnTouchListener(new View.OnTouchListener() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$mPVM2nrA8yXakfk4GeZuDfeAAJ0
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return Media1Activity.lambda$createView$4(view2, motionEvent);
                }
            });
            ...
            this.mediaPages[a3].progressView = new LinearLayout(context) { // from class: im.uwrkaxlmjj.ui.Media1Activity.13
                @Override // android.widget.LinearLayout, android.view.View
                protected void onDraw(Canvas canvas) {
                    Media1Activity.this.backgroundPaint.setColor(Theme.getColor(Theme.key_windowBackgroundGray));
                    canvas.drawRect(0.0f, Media1Activity.this.actionBar.getMeasuredHeight() + Media1Activity.this.actionBar.getTranslationY(), getMeasuredWidth(), getMeasuredHeight(), Media1Activity.this.backgroundPaint);
        ...
        if (!AndroidUtilities.isTablet()) {
            ...
            frameLayout.addView(fragmentContextView, LayoutHelper.createFrame(-1.0f, 39.0f, 51, 0.0f, 8.0f, 0.0f, 0.0f));
        }
    ...
    /* JADX INFO: renamed from: im.uwrkaxlmjj.ui.Media1Activity$4, reason: invalid class name */
    class AnonymousClass4 extends ActionBar.ActionBarMenuOnItemClick {
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                if (Media1Activity.this.actionBar.isActionModeShowed()) {
                    ...
                    Media1Activity.this.cantDeleteMessagesCount = 0;
            ...
            if (id == 4) {
                ...
                Media1Activity media1Activity = Media1Activity.this;
                AlertsCreator.createDeleteMessagesAlert(media1Activity, currentUser, currentChat, currentEncryptedChat, null, media1Activity.mergeDialogId, null, Media1Activity.this.selectedFiles, null, false, 1, new Runnable() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$4$PxNZXZGSVUuwo5F9AID0sy4ubG0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onItemClick$0$Media1Activity$4();
                    }
                });
                return;
            }
            if (id == 3) {
                ...
                fragment.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$4$n_h5pNLvrc0yIBuWgn-QMhgwNcs
                    @Override // im.uwrkaxlmjj.ui.DialogsActivity.DialogsActivityDelegate
                    public final void didSelectDialogs(DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z) {
                        this.f$0.lambda$onItemClick$1$Media1Activity$4(dialogsActivity, arrayList, charSequence, z);
                    }
                });
                Media1Activity.this.presentFragment(fragment);
                return;
            }
            if (id != 7 || Media1Activity.this.selectedFiles[0].size() != 1) {
                return;
            }
        ...
        public /* synthetic */ void lambda$onItemClick$1$Media1Activity$4(DialogsActivity fragment1, ArrayList dids, CharSequence message, boolean param) {
            ...
            for (int a = 1; a >= 0; a--) {
                ...
                for (Integer id1 : ids) {
                    if (id1.intValue() > 0) {
                        arrayList.add(Media1Activity.this.selectedFiles[a].get(id1.intValue()));
                    }
                }
                Media1Activity.this.selectedFiles[a].clear();
            }
            Media1Activity.this.cantDeleteMessagesCount = 0;
            Media1Activity.this.actionBar.hideActionMode();
            if (dids.size() > 1 || ((Long) dids.get(0)).longValue() == UserConfig.getInstance(Media1Activity.this.currentAccount).getClientUserId() || message != null) {
                Media1Activity.this.updateRowsSelection();
                for (int a2 = 0; a2 < dids.size(); a2++) {
                    long did = ((Long) dids.get(a2)).longValue();
                    if (message != null) {
                        SendMessagesHelper.getInstance(Media1Activity.this.currentAccount).sendMessage(message.toString(), did, null, null, true, null, null, null, true, 0);
                    }
                    SendMessagesHelper.getInstance(Media1Activity.this.currentAccount).sendMessage(arrayList, did, true, 0);
                }
            ...
            if (lower_part != 0 && !MessagesController.getInstance(Media1Activity.this.currentAccount).checkCanOpenChat(args1, fragment1)) {
                return;
            }
            NotificationCenter.getInstance(Media1Activity.this.currentAccount).postNotificationName(NotificationCenter.closeChats, new Object[0]);
        ...
        while (true) {
            ...
            if (a < mediaPageArr.length) {
                if (mediaPageArr[a].listView != null) {
                    ...
                    obs.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: im.uwrkaxlmjj.ui.Media1Activity.14
    ...
    /* JADX INFO: renamed from: im.uwrkaxlmjj.ui.Media1Activity$15, reason: invalid class name */
    class AnonymousClass15 implements SharedLinkCell.SharedLinkCellDelegate {
        ...
        public void onLinkLongPress(final String urlFinal) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Open", R.string.Open), LocaleController.getString("Copy", R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$15$mxvHy1bffKD18bIJoTmOnSv6ivU
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$onLinkLongPress$0$Media1Activity$15(urlFinal, dialogInterface, i);
                }
            });
    ...
    private class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < Media1Activity.this.sharedMediaData[3].sections.size()) {
                String name = (String) Media1Activity.this.sharedMediaData[3].sections.get(section);
                ArrayList<MessageObject> messageObjects = (ArrayList) Media1Activity.this.sharedMediaData[3].sectionArrays.get(name);
        ...
        public void onBindViewHolder(int section, int position, RecyclerView.ViewHolder holder) {
            if (holder.getItemViewType() != 2) {
                ...
                if (itemViewType == 1) {
                    ...
                    if (Media1Activity.this.actionBar.isActionModeShowed()) {
                        sharedLinkCell.setChecked(Media1Activity.this.selectedFiles[(messageObject.getDialogId() > Media1Activity.this.dialog_id ? 1 : (messageObject.getDialogId() == Media1Activity.this.dialog_id ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0, !Media1Activity.this.scrolling);
                    } else {
    ...
    private class SharedDocumentsAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < Media1Activity.this.sharedMediaData[this.currentType].sections.size()) {
                String name = (String) Media1Activity.this.sharedMediaData[this.currentType].sections.get(section);
                ArrayList<MessageObject> messageObjects = (ArrayList) Media1Activity.this.sharedMediaData[this.currentType].sectionArrays.get(name);
                MessageObject messageObject = messageObjects.get(0);
                ((GraySectionCell) view).setText(LocaleController.formatSectionDate(messageObject.messageOwner.date));
            }
            return view;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                ...
                if (this.currentType == 4 && !Media1Activity.this.audioCellCache.isEmpty()) {
                    ...
                    view = new SharedAudioCell(this.mContext) { // from class: im.uwrkaxlmjj.ui.Media1Activity.SharedDocumentsAdapter.1
                        @Override // im.uwrkaxlmjj.ui.cells.SharedAudioCell
                        public boolean needPlayMessage(MessageObject messageObject) {
                            if (messageObject.isVoice() || messageObject.isRoundVideo()) {
                                boolean result = MediaController.getInstance().playMessage(messageObject);
        ...
        public void onBindViewHolder(int section, int position, RecyclerView.ViewHolder holder) {
            if (holder.getItemViewType() != 2) {
                ...
                if (itemViewType == 1) {
                    ...
                    if (Media1Activity.this.actionBar.isActionModeShowed()) {
                        sharedDocumentCell.setChecked(Media1Activity.this.selectedFiles[(messageObject.getDialogId() > Media1Activity.this.dialog_id ? 1 : (messageObject.getDialogId() == Media1Activity.this.dialog_id ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0, true ^ Media1Activity.this.scrolling);
                        return;
                    } else {
                ...
                if (itemViewType == 3) {
                    ...
                    if (Media1Activity.this.actionBar.isActionModeShowed()) {
                        sharedAudioCell.setChecked(Media1Activity.this.selectedFiles[(messageObject2.getDialogId() > Media1Activity.this.dialog_id ? 1 : (messageObject2.getDialogId() == Media1Activity.this.dialog_id ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject2.getId()) >= 0, true ^ Media1Activity.this.scrolling);
                    } else {
    ...
    private class SharedPhotoVideoAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public int getCountForSection(int section) {
            if (section < Media1Activity.this.sharedMediaData[0].sections.size()) {
                return ((int) Math.ceil(((ArrayList) Media1Activity.this.sharedMediaData[0].sectionArrays.get(Media1Activity.this.sharedMediaData[0].sections.get(section))).size() / Media1Activity.this.columnsCount)) + 1;
            }
            return 1;
        }
        ...
        public View getSectionHeaderView(int section, View view) {
            ...
            if (section < Media1Activity.this.sharedMediaData[0].sections.size()) {
                String name = (String) Media1Activity.this.sharedMediaData[0].sections.get(section);
                ArrayList<MessageObject> messageObjects = (ArrayList) Media1Activity.this.sharedMediaData[0].sectionArrays.get(name);
                MessageObject messageObject = messageObjects.get(0);
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                ...
                SharedPhotoVideoCell cell = (SharedPhotoVideoCell) view;
                cell.setDelegate(new SharedPhotoVideoCell.SharedPhotoVideoCellDelegate() { // from class: im.uwrkaxlmjj.ui.Media1Activity.SharedPhotoVideoAdapter.1
                    ...
                    public void didClickItem(SharedPhotoVideoCell cell2, int index, MessageObject messageObject, int a) {
                        Media1Activity.this.onItemClick(index, cell2, messageObject, a, 0);
                    }

                    @Override // im.uwrkaxlmjj.ui.cells.SharedPhotoVideoCell.SharedPhotoVideoCellDelegate
                    public boolean didLongClickItem(SharedPhotoVideoCell cell2, int index, MessageObject messageObject, int a) {
                        if (!Media1Activity.this.actionBar.isActionModeShowed()) {
                            return Media1Activity.this.onItemLongClick(messageObject, cell2, a);
                        }
            ...
            if (holder.getItemViewType() != 2) {
                ...
                if (itemViewType == 1) {
                    ...
                    for (int a = 0; a < Media1Activity.this.columnsCount; a++) {
                        int index = ((position - 1) * Media1Activity.this.columnsCount) + a;
                        if (index < messageObjects.size()) {
                            ...
                            if (Media1Activity.this.actionBar.isActionModeShowed()) {
                                cell.setChecked(a, Media1Activity.this.selectedFiles[(messageObject.getDialogId() > Media1Activity.this.dialog_id ? 1 : (messageObject.getDialogId() == Media1Activity.this.dialog_id ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject.getId()) >= 0, !Media1Activity.this.scrolling);
                            } else {
    ...
    public class MediaSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void queryServerSearch(String query, final int max_id, long did) {
            ...
            this.searchesInProgress++;
            this.reqId = ConnectionsManager.getInstance(Media1Activity.this.currentAccount).sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$MediaSearchAdapter$lj4mPIpO6M9vIU2mjeuCH1LHGic
                @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    this.f$0.lambda$queryServerSearch$1$Media1Activity$MediaSearchAdapter(max_id, currentReqId, tLObject, tL_error);
                }
            }, 2);
        ...
        public /* synthetic */ void lambda$queryServerSearch$1$Media1Activity$MediaSearchAdapter(int max_id, final int currentReqId, TLObject response, TLRPC.TL_error error) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$MediaSearchAdapter$8gwn_RsYN_gLN6j1thaj7K6adfw
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$null$0$Media1Activity$MediaSearchAdapter(currentReqId, messageObjects);
                }
            });
        }
            ...
            for (int a = 0; a < Media1Activity.this.mediaPages.length; a++) {
                if (Media1Activity.this.mediaPages[a].selectedType == this.currentType) {
                    if (getItemCount() != 0) {
                        ...
                        Media1Activity.this.mediaPages[a].listView.setEmptyView(null);
                        Media1Activity.this.mediaPages[a].emptyView.setVisibility(8);
                        Media1Activity.this.mediaPages[a].progressView.setVisibility(0);
                    }
                }
            }
            Runnable runnable2 = new Runnable() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$MediaSearchAdapter$h3ynmDklQ-zoZDacFB6zX9NvZME
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$search$3$Media1Activity$MediaSearchAdapter(query);
                }
            };
        ...
        public /* synthetic */ void lambda$search$3$Media1Activity$MediaSearchAdapter(final String query) {
            int i;
            ...
            if (i2 == 1 || i2 == 4) {
                final ArrayList<MessageObject> copy = new ArrayList<>(Media1Activity.this.sharedMediaData[this.currentType].messages);
                this.searchesInProgress++;
                Utilities.searchQueue.postRunnable(new Runnable() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$MediaSearchAdapter$UhknfP7tT_DJhw1Um7miUtrFXuQ
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$null$2$Media1Activity$MediaSearchAdapter(query, copy);
                    }
                });
            }
        }
        ...
        private void updateSearchResults(final ArrayList<MessageObject> documents) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$MediaSearchAdapter$rIvwRXHOKn9kutaL1q3zgnv6Dzg
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$updateSearchResults$4$Media1Activity$MediaSearchAdapter(documents);
                }
            });
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (i == 1) {
                ...
                view = new SharedAudioCell(this.mContext) { // from class: im.uwrkaxlmjj.ui.Media1Activity.MediaSearchAdapter.1
                    @Override // im.uwrkaxlmjj.ui.cells.SharedAudioCell
                    public boolean needPlayMessage(MessageObject messageObject) {
                        if (messageObject.isVoice() || messageObject.isRoundVideo()) {
                            boolean result = MediaController.getInstance().playMessage(messageObject);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (i == 3) {
                ...
                if (Media1Activity.this.actionBar.isActionModeShowed()) {
                    sharedLinkCell.setChecked(Media1Activity.this.selectedFiles[(messageObject2.getDialogId() > Media1Activity.this.dialog_id ? 1 : (messageObject2.getDialogId() == Media1Activity.this.dialog_id ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject2.getId()) >= 0, true ^ Media1Activity.this.scrolling);
                    return;
                } else {
            ...
            if (i == 4) {
                ...
                if (Media1Activity.this.actionBar.isActionModeShowed()) {
                    sharedAudioCell.setChecked(Media1Activity.this.selectedFiles[(messageObject3.getDialogId() > Media1Activity.this.dialog_id ? 1 : (messageObject3.getDialogId() == Media1Activity.this.dialog_id ? 0 : -1)) == 0 ? (char) 0 : (char) 1].indexOfKey(messageObject3.getId()) >= 0, true ^ Media1Activity.this.scrolling);
                } else {
                    sharedAudioCell.setChecked(false, true ^ Media1Activity.this.scrolling);
                }
            }
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        for (int a = 0; a < this.mediaPages.length; a++) {
            final int num = a;
            ThemeDescription.ThemeDescriptionDelegate cellDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$Media1Activity$sy2yKQRhDyPXOUYO4gMNZO9zgrc
                @Override // im.uwrkaxlmjj.ui.actionbar.ThemeDescription.ThemeDescriptionDelegate
                public final void didSetColor() {
                    this.f$0.lambda$getThemeDescriptions$5$Media1Activity(num);
                }
            };
