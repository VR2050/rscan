package im.uwrkaxlmjj.ui.hui.friendscircle_v1.view.panel;
...
import im.uwrkaxlmjj.ui.hui.friendscircle_v1.utils.StatusBarHeightUtil;
import im.uwrkaxlmjj.ui.hui.friendscircle_v1.utils.ViewUtil;
...
public class KPSwitchRootLayoutHandler {
    ...
    public void handleBeforeMeasure(int width, int height) {
        ...
        if (Math.abs(offset) < KeyboardUtils.getMinKeyboardHeight(this.mTargetRootView.getContext())) {
