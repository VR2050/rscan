...
public class SharedConfig {
    ...
    public static void checkKeepMedia() {
        ...
        Utilities.globalQueue.postRunnable(new Runnable() { // from class: im.uwrkaxlmjj.messenger.-$$Lambda$SharedConfig$Zxf6Cizo83cfgS566yYkWnvs51Y
            @Override // java.lang.Runnable
            public final void run() {
                SharedConfig.lambda$checkKeepMedia$0(time);
            }
        });
    }
    ...
    public static void checkSaveToGalleryFiles() {
        try {
            File path = new File(Environment.getExternalStorageDirectory(), "Sbcc");
            File imagePath = new File(path, "Sbcc Images");
            imagePath.mkdir();
            File videoPath = new File(path, "Sbcc Video");
            videoPath.mkdir();
            if (saveToGallery) {
