...
public class BottomDialog extends BottomSheetDialog {
    ...
    private void initView(Window window) {
        ...
        this.mTvTitle = (TextView) window.findViewById(R.attr.tv_title);
        this.mScrollView = (NestedScrollView) window.findViewById(R.attr.scroll_view);
        this.mLlContainer = (LinearLayout) window.findViewById(R.attr.ll_container);
        this.mTvCancel = (TextView) window.findViewById(R.attr.tv_cancel);
        View viewFindViewById = window.findViewById(R.attr.divider);
        this.mDivider = viewFindViewById;
        viewFindViewById.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
    ...
    private void setCancelButtonAction() {
        ...
        if (onCancelClickListener == null) {
            this.mTvCancel.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.dialogs.-$$Lambda$BottomDialog$RAzYBk12AC4muglOoMTHPfIsGc4
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$setCancelButtonAction$0$BottomDialog(view);
                }
            });
        } else {
    ...
    private void resetContentHeight(final ViewGroup viewGroup) {
        this.mOnGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: im.uwrkaxlmjj.ui.dialogs.-$$Lambda$BottomDialog$OHTDWvMgyDptKt-WSKzBDtmz6aE
            @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
            public final void onGlobalLayout() {
                this.f$0.lambda$resetContentHeight$1$BottomDialog(viewGroup);
            }
        };
    ...
    public static class NormalTextItem extends FrameLayout implements TextItem {
        ...
        public NormalTextItem(final int id, CharSequence text, boolean needDivider) {
            ...
            setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.dialogs.-$$Lambda$BottomDialog$NormalTextItem$ycWRQqiUEwuV2uNsfWMCiFunLe8
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f$0.lambda$new$0$BottomDialog$NormalTextItem(id, view2);
                }
            });
        }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (lineCount > 0) {
                setMeasuredDimension(width, AndroidUtilities.dp((lineCount - 1) * 24) + height);
            } else {
    ...
    public static class TextWithLeftImageItem extends FrameLayout implements TextItem {
        ...
        public TextWithLeftImageItem(final int id, int imageResId, CharSequence leftText, CharSequence rightText, boolean needDivider) {
            super(BottomDialog.mContext);
            ...
            setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.dialogs.-$$Lambda$BottomDialog$TextWithLeftImageItem$m7IDclpRVG2FR1B1ikNcE8DLw4Q
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    this.f$0.lambda$new$0$BottomDialog$TextWithLeftImageItem(id, view2);
                }
            });
        }
