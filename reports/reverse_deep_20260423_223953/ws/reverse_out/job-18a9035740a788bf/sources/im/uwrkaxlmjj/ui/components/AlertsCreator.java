...
public class AlertsCreator {
    ...
    */
    ...
    public static void showBlockReportSpamAlert(BaseFragment fragment, final long dialog_id, final TLRPC.User currentUser, final TLRPC.Chat currentChat, final TLRPC.EncryptedChat encryptedChat, final boolean isLocation, TLRPC.ChatFull chatInfo, final MessagesStorage.IntCallback callback) {
        ...
        builder.setPositiveButton(reportText, new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$AlertsCreator$JOC0H1nrSyJlr9G7sGi7oYOnTA4
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i3) throws Exception {
    ...
    static /* synthetic */ void lambda$showBlockReportSpamAlert$4(TLRPC.User currentUser, AccountInstance accountInstance, CheckBoxCell[] cells, long dialog_id, TLRPC.Chat currentChat, TLRPC.EncryptedChat encryptedChat, boolean isLocation, MessagesStorage.IntCallback callback, DialogInterface dialogInterface, int i) throws Exception {
        if (currentUser != null) {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    static /* synthetic */ void lambda$createDeleteMessagesAlert$58(im.uwrkaxlmjj.messenger.MessageObject r21, im.uwrkaxlmjj.messenger.MessageObject.GroupedMessages r22, im.uwrkaxlmjj.tgnet.TLRPC.EncryptedChat r23, int r24, long r25, boolean[] r27, boolean r28, android.util.SparseArray[] r29, im.uwrkaxlmjj.tgnet.TLRPC.User r30, boolean[] r31, im.uwrkaxlmjj.tgnet.TLRPC.Chat r32, im.uwrkaxlmjj.tgnet.TLRPC.ChatFull r33, java.lang.Runnable r34, android.content.DialogInterface r35, int r36) throws java.lang.Exception {
        /*
