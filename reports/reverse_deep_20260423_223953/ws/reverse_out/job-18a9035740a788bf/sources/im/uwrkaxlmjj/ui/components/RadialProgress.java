...
public class RadialProgress {
    ...
    private class CheckDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            float p = this.progress != 1.0f ? RadialProgress.decelerateInterpolator.getInterpolation(this.progress) : 1.0f;
    ...
    private void updateAnimation(boolean progress) {
        ...
        if (progress) {
            if (this.animatedProgressValue != 1.0f) {
                ...
                if (progressDiff > 0.0f) {
                    ...
                    if (j < 300) {
                        this.animatedProgressValue = f2 + (decelerateInterpolator.getInterpolation(j / 300.0f) * progressDiff);
                    } else {
            ...
            if (this.animatedProgressValue >= 1.0f && this.previousDrawable != null) {
                float f4 = this.animatedAlphaValue - (dt / 200.0f);
        ...
        if (this.drawMiniProgress) {
            if (this.previousMiniDrawable != null) {
                float f5 = this.animatedAlphaValue - (dt / 200.0f);
        ...
        if (this.previousDrawable != null) {
            float f6 = this.animatedAlphaValue - (dt / 200.0f);
    ...
    public void setMiniBackground(Drawable drawable, boolean withRound, boolean animated) {
        ...
        boolean z = (this.previousMiniDrawable == null && drawable == null) ? false : true;
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.drawMiniProgress && this.currentDrawable != null) {
            ...
            if (this.previousMiniDrawable != null && this.alphaForMiniPrevious) {
                float alpha2 = this.animatedAlphaValue * this.overrideAlpha;
                alpha = alpha2;
            } else {
                alpha = 1.0f;
            }
