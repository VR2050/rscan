...
import im.uwrkaxlmjj.messenger.video.Track;
...
public class Track {
    ...
    public void prepare() {
        ...
        Collections.sort(this.samplePresentationTimes, new Comparator() { // from class: im.uwrkaxlmjj.messenger.video.-$$Lambda$Track$t_ZM-zSm4O7za-skQT386-cOvC8
