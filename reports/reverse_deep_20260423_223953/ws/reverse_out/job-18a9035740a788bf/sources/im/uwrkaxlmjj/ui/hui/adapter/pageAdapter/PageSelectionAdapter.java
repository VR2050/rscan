...
public abstract class PageSelectionAdapter<T, VH extends PageHolder> extends RecyclerListView.SelectionAdapter implements PageLoadMoreListener, OnRefreshLoadMoreListener, MryEmptyView.OnEmptyOrErrorClickListener {
    ...
    protected int getItemViewTypeForChild(int position) {
        return super.getItemViewType(position);
    }

    protected boolean isEnableForChild(VH holder) {
        return true;
    }
    ...
    public final VH onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (pageAdapterHelper != null) {
            vh = (VH) pageAdapterHelper.onCreateViewHolder(viewGroup, i);
        }
        if (vh == null) {
            return (VH) onCreateViewHolderForChild(viewGroup, i);
        }
        return vh;
    }
    ...
    public final boolean isEnabled(RecyclerView.ViewHolder holder) {
        ...
        if (!enable) {
            boolean enable2 = isEnableForChild((PageHolder) holder);
            return enable2;
        }
        return enable;
    }
    ...
    public void addData(List<T> data) {
        PageAdapterHelper<T, VH> pageAdapterHelper = this.mHelper;
        if (pageAdapterHelper != null) {
            pageAdapterHelper.addData((List) data);
        }
    }
    ...
    @Override // im.uwrkaxlmjj.ui.hui.adapter.pageAdapter.PageLoadMoreListener
