...
public class TimeWheelPickerDialog extends BottomSheet {
    ...
    public TimeWheelPickerDialog(Context context, PickerOptions mPickerOptions, int backgroundType) {
    ...
    protected void init(Context context, boolean needFocus, int backgroundType) {
        ...
        TimePickerView mTimePickerView = new TimePickerView(this.mPickerOptions) { // from class: im.uwrkaxlmjj.ui.dialogs.TimeWheelPickerDialog.1
        ...
        customView.findViewById(R.attr.timepicker).setLayoutParams(LayoutHelper.createLinear(-1, 230));
