...
public class CreateSecureAdapter extends RecyclerListView.SectionsAdapter {
    ...
    public void sortOnlineContacts() {
        ...
        try {
            ...
            Collections.sort(this.onlineContacts, new Comparator() { // from class: im.uwrkaxlmjj.ui.hui.adapter.-$$Lambda$CreateSecureAdapter$FV0AvBmsTLpKOPQaK1V38AZkllw
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return CreateSecureAdapter.lambda$sortOnlineContacts$0(messagesController, currentTime, (TLRPC.Contact) obj, (TLRPC.Contact) obj2);
                }
            });
            notifyDataSetChanged();
        } catch (Exception e) {
