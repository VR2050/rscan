...
import im.uwrkaxlmjj.ui.ChatEditActivity;
import im.uwrkaxlmjj.ui.ChatRightsEditActivity;
import im.uwrkaxlmjj.ui.ChatUsersActivity;
...
import im.uwrkaxlmjj.ui.cells.AboutLinkCell;
...
public class ProfileGroupActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate {
    ...
    private class TopView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), ProfileGroupActivity.this.extraHeight + height, this.paint);
    ...
    public ProfileGroupActivity(Bundle args) {
        ...
        this.onlineCount = -1;
        this.provider = new PhotoViewer.EmptyPhotoViewerProvider() { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.1
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.user_id != 0) {
            ...
            if (chat == null) {
                ...
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$AN1oS3z_Wr7BHCidbNfymQIkB_0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$onFragmentCreate$0$ProfileGroupActivity(countDownLatch);
                    }
                });
                try {
    ...
    protected ActionBar createActionBar(Context context) {
        ActionBar actionBar = new ActionBar(context) { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.2
            @Override // im.uwrkaxlmjj.ui.actionbar.ActionBar, android.view.View
        ...
        actionBar.setBackButtonImage(R.id.ic_back);
    ...
    public View createView(Context context) {
        ...
        this.fragmentView = new FrameLayout(context) { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.4
            @Override // android.view.View
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.5
            ...
            public void onDraw(Canvas c) {
                ...
                if (ProfileGroupActivity.this.lastSectionRow != -1) {
                    ...
                    holder = (ProfileGroupActivity.this.sharedSectionRow == -1 || (ProfileGroupActivity.this.membersSectionRow != -1 && ProfileGroupActivity.this.membersSectionRow >= ProfileGroupActivity.this.sharedSectionRow)) ? (ProfileGroupActivity.this.membersSectionRow == -1 || (ProfileGroupActivity.this.sharedSectionRow != -1 && ProfileGroupActivity.this.membersSectionRow <= ProfileGroupActivity.this.sharedSectionRow)) ? ProfileGroupActivity.this.settingsSectionRow != -1 ? findViewHolderForAdapterPosition(ProfileGroupActivity.this.settingsSectionRow) : ProfileGroupActivity.this.infoSectionRow != -1 ? findViewHolderForAdapterPosition(ProfileGroupActivity.this.infoSectionRow) : null : findViewHolderForAdapterPosition(ProfileGroupActivity.this.membersSectionRow) : findViewHolderForAdapterPosition(ProfileGroupActivity.this.sharedSectionRow);
                }
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context) { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.6
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListenerExtended() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$c-wosrmkBQ8VVpTaxtRCzlajv18
            @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemClickListenerExtended
            public final void onItemClick(View view, int i, float f, float f2) {
                this.f$0.lambda$createView$4$ProfileGroupActivity(view, i, f, f2);
            }
        });
        this.listView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$OulCEtn_frTtFKGarI5EsTmgE5w
            @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemLongClickListener
            public final boolean onItemClick(View view, int i) {
                return this.f$0.lambda$createView$7$ProfileGroupActivity(view, i);
            }
        });
        if (this.banFromGroup != 0) {
            ...
            if (this.currentChannelParticipant == null) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$CMDYIviblf0ApgWTfpDDAsLXnK4
                    @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        this.f$0.lambda$createView$9$ProfileGroupActivity(tLObject, tL_error);
                    }
                });
            }
            FrameLayout frameLayout1 = new FrameLayout(context) { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.7
                @Override // android.view.View
                protected void onDraw(Canvas canvas) {
            ...
            frameLayout1.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$Foejj_QFQxUcy3_WALM7Cm-lBeg
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$createView$10$ProfileGroupActivity(chat, view);
                }
            });
        ...
        topView.setBackgroundColor(AvatarDrawable.getProfileBackColorForId((this.user_id != 0 || (ChatObject.isChannel(this.chat_id, this.currentAccount) && !this.currentChat.megagroup)) ? 5 : this.chat_id));
        ...
        this.avatarImage.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$ObHacvfbl7ASlQAqr1rU0q5D9og
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$createView$11$ProfileGroupActivity(view);
            }
        });
        ...
        if (a2 != 0) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                animator.addState(new int[]{android.R.attr.state_pressed}, ObjectAnimator.ofFloat(this.writeButton, (Property<ImageView, Float>) View.TRANSLATION_Z, AndroidUtilities.dp(2.0f), AndroidUtilities.dp(4.0f)).setDuration(200L));
                animator.addState(new int[0], ObjectAnimator.ofFloat(this.writeButton, (Property<ImageView, Float>) View.TRANSLATION_Z, AndroidUtilities.dp(4.0f), AndroidUtilities.dp(2.0f)).setDuration(200L));
                this.writeButton.setStateListAnimator(animator);
                this.writeButton.setOutlineProvider(new ViewOutlineProvider() { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.9
            ...
            this.writeButton.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$1r0nP1MnrgnhLByuekKeKJfaH8c
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.lambda$createView$12$ProfileGroupActivity(view);
                }
            });
        }
        needLayout();
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.10
    ...
    /* JADX INFO: renamed from: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity$3, reason: invalid class name */
    class AnonymousClass3 extends ActionBar.ActionBarMenuOnItemClick {
        ...
        public void onItemClick(int id) {
            ...
            if (id == 2) {
                ...
                if (user != null) {
                    if (!ProfileGroupActivity.this.isBot || MessagesController.isSupportUser(user)) {
                        ...
                        if (ProfileGroupActivity.this.reportSpam) {
                            AlertsCreator.showBlockReportSpamAlert(ProfileGroupActivity.this, r5.user_id, user, null, ProfileGroupActivity.this.currentEncryptedChat, false, null, new MessagesStorage.IntCallback() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$3$BfDCX3aSDCAWhLxmss6I4clblEU
                                @Override // im.uwrkaxlmjj.messenger.MessagesStorage.IntCallback
                                public final void run(int i) {
                                    this.f$0.lambda$onItemClick$0$ProfileGroupActivity$3(i);
                                }
                            });
                            return;
                        }
                        AlertDialog.Builder builder = new AlertDialog.Builder(ProfileGroupActivity.this.getParentActivity());
                        builder.setTitle(LocaleController.getString("BlockUser", R.string.BlockUser));
                        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AreYouSureBlockContact2", R.string.AreYouSureBlockContact2, ContactsController.formatName(user.first_name, user.last_name))));
                        builder.setPositiveButton(LocaleController.getString("BlockContact", R.string.BlockContact), new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$3$H_ST93j6N-P3889zNe3uK_QhGl0
                            @Override // android.content.DialogInterface.OnClickListener
                            public final void onClick(DialogInterface dialogInterface, int i) {
                                this.f$0.lambda$onItemClick$1$ProfileGroupActivity$3(dialogInterface, i);
                            }
                        });
                    ...
                    MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).unblockUser(ProfileGroupActivity.this.user_id);
                    SendMessagesHelper.getInstance(ProfileGroupActivity.this.currentAccount).sendMessage("/start", ProfileGroupActivity.this.user_id, null, null, false, null, null, null, true, 0);
                    ProfileGroupActivity.this.finishFragment();
                    return;
                }
                return;
            ...
            if (id == 9) {
                final TLRPC.User user3 = MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).getUser(Integer.valueOf(ProfileGroupActivity.this.user_id));
                if (user3 == null) {
                    return;
                }
                ...
                args5.putString("addToGroupAlertString", LocaleController.formatString("AddToTheGroupTitle", R.string.AddToTheGroupTitle, UserObject.getName(user3), "%1$s"));
                DialogsActivity fragment3 = new DialogsActivity(args5);
                fragment3.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$3$MQzROWEc26D3-LCtWc3kZuZsHpo
                    @Override // im.uwrkaxlmjj.ui.DialogsActivity.DialogsActivityDelegate
                    public final void didSelectDialogs(DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z) {
                        this.f$0.lambda$onItemClick$3$ProfileGroupActivity$3(user3, dialogsActivity, arrayList, charSequence, z);
                    }
                });
            ...
            if (id == 10) {
                try {
                    ...
                    if (ProfileGroupActivity.this.botInfo != null && ProfileGroupActivity.this.userInfo != null && !TextUtils.isEmpty(ProfileGroupActivity.this.userInfo.about)) {
                        intent.putExtra("android.intent.extra.TEXT", String.format("%s https://" + MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).linkPrefix + "/%s", ProfileGroupActivity.this.userInfo.about, user4.username));
                    } else {
                        intent.putExtra("android.intent.extra.TEXT", String.format(DefaultWebClient.HTTPS_SCHEME + MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).linkPrefix + "/%s", user4.username));
                    }
                    ProfileGroupActivity.this.startActivityForResult(Intent.createChooser(intent, LocaleController.getString("BotShare", R.string.BotShare)), SlidingItemMenuRecyclerView.DEFAULT_ITEM_SCROLL_DURATION);
                    return;
                } catch (Exception e) {
                    FileLog.e(e);
                    return;
            ...
            if (id == 14) {
                try {
                    if (ProfileGroupActivity.this.currentEncryptedChat != null) {
                        did = ((long) ProfileGroupActivity.this.currentEncryptedChat.id) << 32;
                    ...
                    MediaDataController.getInstance(ProfileGroupActivity.this.currentAccount).installShortcut(did);
                    return;
                } catch (Exception e2) {
                    FileLog.e(e2);
                    return;
            ...
            if (id == 15) {
                ...
                if (user5 != null) {
                    VoIPHelper.startCall(user5, ProfileGroupActivity.this.getParentActivity(), ProfileGroupActivity.this.userInfo);
                    return;
                }
                return;
            }
            ...
            if (id == 19) {
                int did2 = ProfileGroupActivity.this.user_id != 0 ? ProfileGroupActivity.this.user_id : -ProfileGroupActivity.this.chat_id;
                final AlertDialog[] progressDialog = {new AlertDialog(ProfileGroupActivity.this.getParentActivity(), 3)};
                TLRPC.TL_messages_getStatsURL req = new TLRPC.TL_messages_getStatsURL();
                req.peer = MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).getInputPeer(did2);
                req.dark = Theme.getCurrentTheme().isDark();
                req.params = "";
                final int requestId = ConnectionsManager.getInstance(ProfileGroupActivity.this.currentAccount).sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$3$wpl7R8HQIIcPLIZbXZmfv9l1v7Y
                    @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        this.f$0.lambda$onItemClick$5$ProfileGroupActivity$3(progressDialog, tLObject, tL_error);
                    }
                });
                if (progressDialog[0] == null) {
                    return;
                }
                progressDialog[0].setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$3$y8ACHXfL-Qnh-YMTuku3A2Qpc40
                    @Override // android.content.DialogInterface.OnCancelListener
                    public final void onCancel(DialogInterface dialogInterface) {
                        this.f$0.lambda$onItemClick$6$ProfileGroupActivity$3(requestId, dialogInterface);
                    }
                });
        ...
        public /* synthetic */ void lambda$onItemClick$0$ProfileGroupActivity$3(int param) {
            if (param == 1) {
                ...
                ProfileGroupActivity.this.playProfileAnimation = false;
                ProfileGroupActivity.this.finishFragment();
                return;
            }
            ProfileGroupActivity.this.getNotificationCenter().postNotificationName(NotificationCenter.peerSettingsDidLoad, Long.valueOf(ProfileGroupActivity.this.user_id));
        }
        ...
        private /* synthetic */ void lambda$onItemClick$2(TLRPC.User user, DialogInterface dialogInterface, int i) {
        ...
        public /* synthetic */ void lambda$onItemClick$3$ProfileGroupActivity$3(TLRPC.User user, DialogsActivity fragment1, ArrayList dids, CharSequence message, boolean param) {
            ...
            if (MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).checkCanOpenChat(args1, fragment1)) {
                NotificationCenter.getInstance(ProfileGroupActivity.this.currentAccount).removeObserver(ProfileGroupActivity.this, NotificationCenter.closeChats);
                NotificationCenter.getInstance(ProfileGroupActivity.this.currentAccount).postNotificationName(NotificationCenter.closeChats, new Object[0]);
                MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).addUserToChat(-((int) did), user, null, 0, null, ProfileGroupActivity.this, null);
                ProfileGroupActivity.this.presentFragment(new ChatActivity(args1), true);
                ProfileGroupActivity.this.removeSelfFromStack();
            }
        }

        public /* synthetic */ void lambda$onItemClick$5$ProfileGroupActivity$3(final AlertDialog[] progressDialog, final TLObject response, TLRPC.TL_error error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$3$uFnVpxe5GNPG9ycngzpwebjlAlw
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$null$4$ProfileGroupActivity$3(progressDialog, response);
                }
            });
        }
        ...
        public /* synthetic */ void lambda$null$4$ProfileGroupActivity$3(AlertDialog[] progressDialog, TLObject response) {
            ...
            if (response != null) {
                ...
                ProfileGroupActivity.this.presentFragment(new WebviewActivity(url.url, -ProfileGroupActivity.this.chat_id));
            }
        }
    ...
    public /* synthetic */ void lambda$createView$4$ProfileGroupActivity(View view, int position, float x, float y) {
        ...
        if (position == this.photosRow || position == this.filesRow || position == this.linksRow || position == this.audioRow || position == this.voiceRow) {
            ...
            if (i != 0) {
                ...
                args.putLong("dialog_id", -this.chat_id);
            }
            int[] media = new int[5];
        ...
        if (position == this.groupsInCommonRow) {
        ...
        if (position != this.settingsKeyRow) {
            ...
            if (position != this.notificationsRow) {
                if (position != this.forbidAddContact) {
                    if (position != this.startSecretChatRow) {
                        ...
                        if (position < this.membersStartRow || position >= this.membersEndRow) {
                                ...
                                if (this.currentChat != null) {
                                    try {
                                        ...
                                        if (!TextUtils.isEmpty(this.chatInfo.about)) {
                                            intent.putExtra("android.intent.extra.TEXT", this.currentChat.title + ShellAdbUtils.COMMAND_LINE_END + this.chatInfo.about + "\nhttps://" + MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + this.currentChat.username);
                                        } else {
                            ...
                            if (position == this.qrCodeRow) {
                                if (this.userInfo != null) {
                                    BaseFragment qrCodeActivity = new QrCodeActivity(getUserConfig().getClientUserId());
                            ...
                            if (position == this.locationRow) {
                                boolean z = this.chatInfo.location instanceof TLRPC.TL_channelLocation;
                                return;
                            }
                            if (position == this.leaveChannelRow) {
                                leaveChatPressed();
                                return;
                            }
                            if (position == this.joinRow) {
                            ...
                            if (position != this.subscribersRow) {
                                if (position != this.administratorsRow) {
                                    if (position == this.blockedUsersRow) {
                                        Bundle args2 = new Bundle();
                                        args2.putInt("chat_id", this.chat_id);
                                        args2.putInt("type", 0);
                                        ChatUsersActivity fragment = new ChatUsersActivity(args2);
                                ...
                                Bundle args3 = new Bundle();
                                args3.putInt("chat_id", this.chat_id);
                                args3.putInt("type", 1);
                                ChatUsersActivity fragment2 = new ChatUsersActivity(args3);
                        ...
                        int user_id = !this.sortedUsers.isEmpty() ? this.chatInfo.participants.participants.get(this.sortedUsers.get(position - this.membersStartRow).intValue()).user_id : this.chatInfo.participants.participants.get(position - this.membersStartRow).user_id;
                        if (user_id == UserConfig.getInstance(this.currentAccount).getClientUserId()) {
                            return;
                        }
                        Bundle args5 = new Bundle();
                        args5.putInt("user_id", user_id);
                        presentFragment(new ProfileGroupActivity(args5));
                        return;
                    }
                    ...
                    builder.setPositiveButton(LocaleController.getString("Start", R.string.Start), new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$HtbnSbggfvyRcdlGkG7D1DB5VTU
                        @Override // android.content.DialogInterface.OnClickListener
                        public final void onClick(DialogInterface dialogInterface, int i2) {
                            this.f$0.lambda$null$3$ProfileGroupActivity(dialogInterface, i2);
                        }
                    });
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                ...
                boolean checked = !((NotificationsCheckCell) view).isChecked();
                TLRPCChats.CL_channel_setParticipantBanMode req = new TLRPCChats.CL_channel_setParticipantBanMode();
                req.flags = checked ? 1 : 0;
                req.peer = getMessagesController().getInputPeer((int) did);
                getConnectionsManager().sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$oRIDoc6OdjSsX97CChIR-2v1rUM
                    @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                        this.f$0.lambda$null$2$ProfileGroupActivity(tLObject, tL_error);
                    }
                });
                return;
            }
            ...
            boolean checked2 = !checkCell.isChecked();
            ...
            if (checked2) {
                ...
                MessagesStorage.getInstance(this.currentAccount).setDialogFlags(did2, 0L);
                editor.commit();
        ...
        Bundle args6 = new Bundle();
        args6.putInt("chat_id", (int) (this.dialog_id >> 32));
        presentFragment(new IdenticonActivity(args6));
    }
    ...
    public /* synthetic */ void lambda$null$2$ProfileGroupActivity(TLObject response, TLRPC.TL_error error) {
        if (error == null && (response instanceof TLRPC.Updates)) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$tv-4GqiF42lCTHerVeZKtFtPLVs
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$null$1$ProfileGroupActivity();
                }
            });
        }
    }
    ...
    public /* synthetic */ boolean lambda$createView$7$ProfileGroupActivity(View view, int position) {
        ...
        if (position >= this.membersStartRow && position < this.membersEndRow) {
            ...
            final TLRPC.User user = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(participant.user_id));
            ...
            if (ChatObject.isChannel(this.currentChat)) {
                ...
                MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(participant.user_id));
                ...
                boolean editingAdmin2 = channelParticipant2 instanceof TLRPC.TL_channelParticipantAdmin;
                channelParticipant = channelParticipant2;
                editingAdmin = editingAdmin2;
            ...
            boolean hasRemove2 = items.isEmpty();
            if (hasRemove2) {
                return false;
            }
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            ...
            builder.setItems((CharSequence[]) items.toArray(new CharSequence[0]), AndroidUtilities.toIntArray(icons), new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$0z2P18wFE3d6gOLcpy7cNiYxFyg
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i2) throws Exception {
                    this.f$0.lambda$null$6$ProfileGroupActivity(actions, channelParticipant3, chatParticipant, user, dialogInterface, i2);
                }
            });
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0035, code lost:
        ...
        if ((r19 instanceof im.uwrkaxlmjj.tgnet.TLRPC.TL_chatParticipantAdmin) != false) goto L13;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$null$6$ProfileGroupActivity(java.util.ArrayList r17, final im.uwrkaxlmjj.tgnet.TLRPC.ChannelParticipant r18, final im.uwrkaxlmjj.tgnet.TLRPC.ChatParticipant r19, final im.uwrkaxlmjj.tgnet.TLRPC.User r20, android.content.DialogInterface r21, int r22) throws java.lang.Exception {
        /*
            r16 = this;
            r7 = r16
            r8 = r17
        ...
        L20:
            ...
            r0 = 1
            if (r12 != r0) goto L99
            boolean r1 = r9 instanceof im.uwrkaxlmjj.tgnet.TLRPC.TL_channelParticipantAdmin
            if (r1 != 0) goto L38
            r13 = r19
            boolean r1 = r13 instanceof im.uwrkaxlmjj.tgnet.TLRPC.TL_chatParticipantAdmin
            if (r1 == 0) goto L9b
            goto L3a
        L38:
            r13 = r19
        L3a:
            im.uwrkaxlmjj.ui.actionbar.AlertDialog$Builder r1 = new im.uwrkaxlmjj.ui.actionbar.AlertDialog$Builder
            androidx.fragment.app.FragmentActivity r2 = r16.getParentActivity()
            r1.<init>(r2)
            r6 = r1
            r1 = 2131689830(0x7f0f0166, float:1.9008686E38)
            java.lang.String r2 = "AppName"
            java.lang.String r1 = im.uwrkaxlmjj.messenger.LocaleController.getString(r2, r1)
            r6.setTitle(r1)
            ...
            java.lang.String r3 = im.uwrkaxlmjj.messenger.ContactsController.formatName(r3, r4)
            r0[r2] = r3
            java.lang.String r2 = "AdminWillBeRemoved"
            java.lang.String r0 = im.uwrkaxlmjj.messenger.LocaleController.formatString(r2, r1, r0)
            r6.setMessage(r0)
            r0 = 2131692504(0x7f0f0bd8, float:1.901411E38)
            java.lang.String r1 = "OK"
            java.lang.String r14 = im.uwrkaxlmjj.messenger.LocaleController.getString(r1, r0)
            im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$gLBVpg2AGw5DPNAO95y0IzuJIoE r15 = new im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$gLBVpg2AGw5DPNAO95y0IzuJIoE
            r0 = r15
            r1 = r16
            r2 = r18
            r3 = r12
            ...
            im.uwrkaxlmjj.ui.actionbar.AlertDialog r0 = r6.create()
            r7.showDialog(r0)
            goto Lbc
        L99:
            r13 = r19
        L9b:
            if (r9 == 0) goto Lae
            int r2 = r10.id
            im.uwrkaxlmjj.tgnet.TLRPC$TL_chatAdminRights r4 = r9.admin_rights
            im.uwrkaxlmjj.tgnet.TLRPC$TL_chatBannedRights r5 = r9.banned_rights
        ...
        Lbc:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.lambda$null$6$ProfileGroupActivity(java.util.ArrayList, im.uwrkaxlmjj.tgnet.TLRPC$ChannelParticipant, im.uwrkaxlmjj.tgnet.TLRPC$ChatParticipant, im.uwrkaxlmjj.tgnet.TLRPC$User, android.content.DialogInterface, int):void");
    }
    ...
    public /* synthetic */ void lambda$createView$9$ProfileGroupActivity(final TLObject response, TLRPC.TL_error error) {
        if (response != null) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$XG-J3C_KxBRsX5mGthJMdbFhLqQ
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$null$8$ProfileGroupActivity(response);
                }
            });
        }
    }
    ...
    public /* synthetic */ void lambda$createView$10$ProfileGroupActivity(TLRPC.Chat chat, View v) {
        ...
        ChatRightsEditActivity fragment = new ChatRightsEditActivity(i, i2, null, tL_chatBannedRights, channelParticipant != null ? channelParticipant.banned_rights : null, "", 1, true, false);
        fragment.setDelegate(new ChatRightsEditActivity.ChatRightsEditActivityDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.8
            ...
            public void didChangeOwner(TLRPC.User user) {
                ProfileGroupActivity.this.undoView.showWithAction(-ProfileGroupActivity.this.chat_id, ProfileGroupActivity.this.currentChat.megagroup ? 10 : 9, user);
            }
        });
        presentFragment(fragment);
    }
    ...
    private void openRightsEdit(final int action, int user_id, final TLRPC.ChatParticipant participant, TLRPC.TL_chatAdminRights adminRights, TLRPC.TL_chatBannedRights bannedRights, String rank) {
        ChatRightsEditActivity fragment = new ChatRightsEditActivity(user_id, this.chat_id, adminRights, this.currentChat.default_banned_rights, bannedRights, rank, action, true, false);
        fragment.setDelegate(new ChatRightsEditActivity.ChatRightsEditActivityDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.11
            @Override // im.uwrkaxlmjj.ui.ChatRightsEditActivity.ChatRightsEditActivityDelegate
            public void didSetRights(int rights, TLRPC.TL_chatAdminRights rightsAdmin, TLRPC.TL_chatBannedRights rightsBanned, String rank2) {
                ...
                if (i == 1 && rights == 0 && ProfileGroupActivity.this.currentChat.megagroup && ProfileGroupActivity.this.chatInfo != null && ProfileGroupActivity.this.chatInfo.participants != null) {
                    ...
                    while (true) {
                        ...
                        TLRPC.ChannelParticipant p = ((TLRPC.TL_chatChannelParticipant) ProfileGroupActivity.this.chatInfo.participants.participants.get(a)).channelParticipant;
                    ...
                    if (ProfileGroupActivity.this.chatInfo != null && ProfileGroupActivity.this.chatInfo.participants != null) {
                        ...
                        while (true) {
                            ...
                            TLRPC.ChatParticipant p2 = ProfileGroupActivity.this.chatInfo.participants.participants.get(a2);
    ...
    private boolean processOnClickOrPress(final int position) {
        ...
        if (position == this.usernameRow) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setItems(new CharSequence[]{LocaleController.getString("Copy", R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$tRw3ASI0aB477avA-7nX_YC07Rs
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    ProfileGroupActivity.lambda$processOnClickOrPress$13(username, dialogInterface, i);
                }
            });
            showDialog(builder.create());
            return true;
        ...
        if (position == this.phoneRow) {
            ...
            actions.add(1);
            builder2.setItems((CharSequence[]) items.toArray(new CharSequence[0]), new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$2WJ6A1-HWdY9hDLYNwWZg77ZBrI
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$processOnClickOrPress$14$ProfileGroupActivity(actions, user2, dialogInterface, i);
                }
            });
            showDialog(builder2.create());
            return true;
        }
        if (position != this.channelInfoRow && position != this.userInfoRow && position != this.locationRow) {
            return false;
        }
        AlertDialog.Builder builder3 = new AlertDialog.Builder(getParentActivity());
        builder3.setItems(new CharSequence[]{LocaleController.getString("Copy", R.string.Copy)}, new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$ZiD6gZ6i-GcEmtVlG1d2zeu2BDY
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.lambda$processOnClickOrPress$15$ProfileGroupActivity(position, dialogInterface, i);
            }
        });
    ...
    public /* synthetic */ void lambda$processOnClickOrPress$14$ProfileGroupActivity(ArrayList actions, TLRPC.User user, DialogInterface dialogInterface, int i) {
        ...
        if (i2 == 1) {
            try {
                ClipboardManager clipboard = (ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard");
                ClipData clip = ClipData.newPlainText("label", Marker.ANY_NON_NULL_MARKER + user.phone);
                clipboard.setPrimaryClip(clip);
    ...
    public /* synthetic */ void lambda$processOnClickOrPress$15$ProfileGroupActivity(int position, DialogInterface dialogInterface, int i) {
        ...
        try {
            if (position == this.locationRow) {
                ...
                about = this.chatInfo != null ? this.chatInfo.about : null;
            } else {
                about = this.userInfo != null ? this.userInfo.about : null;
            }
    ...
    public void leaveChatPressed() {
        AlertsCreator.createClearOrDeleteDialogAlert(this, false, this.currentChat, null, false, new MessagesStorage.BooleanCallback() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$U4uIT7gfvbidy04u0oIhUNL3__U
            @Override // im.uwrkaxlmjj.messenger.MessagesStorage.BooleanCallback
            public final void run(boolean z) {
                this.f$0.lambda$leaveChatPressed$16$ProfileGroupActivity(z);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$leaveChatPressed$16$ProfileGroupActivity(boolean param) {
        ...
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.closeChats, new Object[0]);
        finishFragment();
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.needDeleteDialog, Long.valueOf(-this.currentChat.id), null, this.currentChat, Boolean.valueOf(param));
    }
    ...
    public void getChannelParticipants(boolean reload) {
        ...
        final int delay = (sparseArray.size() == 0 || !reload) ? 0 : 300;
        final TLRPC.TL_channels_getParticipants req = new TLRPC.TL_channels_getParticipants();
        req.channel = MessagesController.getInstance(this.currentAccount).getInputChannel(this.chat_id);
        req.filter = new TLRPC.TL_channelParticipantsRecent();
        req.offset = reload ? 0 : this.participantsMap.size();
        req.limit = ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION;
        int reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$rgFz5nN8LIN6T9bBTflVk0dcen8
            @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                this.f$0.lambda$getChannelParticipants$18$ProfileGroupActivity(req, delay, tLObject, tL_error);
            }
        });
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(reqId, this.classGuid);
    }

    public /* synthetic */ void lambda$getChannelParticipants$18$ProfileGroupActivity(final TLRPC.TL_channels_getParticipants req, int delay, final TLObject response, final TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$MIfuoDpcCSW7vuZ6ccx3uyAlKzc
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$null$17$ProfileGroupActivity(error, response, req);
            }
        }, delay);
    }
    ...
    public void openAddMember() {
        ...
        fragment.setDelegate(new GroupCreateActivity.ContactsAddActivityDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$mGfey9sL86mYabb0mLeFoFL8O6Y
            ...
            public final void didSelectUsers(ArrayList arrayList, int i) {
                this.f$0.lambda$openAddMember$19$ProfileGroupActivity(arrayList, i);
            }
    ...
    public /* synthetic */ void lambda$openAddMember$19$ProfileGroupActivity(ArrayList users, int fwdCount) {
        ...
        for (int a = 0; a < N; a++) {
            ...
            MessagesController.getInstance(this.currentAccount).addUserToChat(this.chat_id, user, this.chatInfo, fwdCount, null, this, null);
        }
    }
        ...
        if (this.avatarImage != null) {
            ...
            if (imageView != null) {
                ...
                if (!this.openAnimationInProgress) {
                    ...
                    if (setVisible != currentVisible) {
                        ...
                        this.writeButtonAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.12
                            ...
                            public void onAnimationEnd(Animator animation) {
                                if (ProfileGroupActivity.this.writeButtonAnimation != null && ProfileGroupActivity.this.writeButtonAnimation.equals(animation)) {
                                    ProfileGroupActivity.this.writeButtonAnimation = null;
                                }
                            }
                        });
            ...
            while (a < i) {
                ...
                if (simpleTextViewArr[a] != null) {
                    ...
                    this.nameTextView[a].setTranslationY(((float) Math.floor(avatarY)) + AndroidUtilities.dp(1.3f) + (AndroidUtilities.dp(7.0f) * diff));
                    this.onlineTextView[a].setTranslationX(AndroidUtilities.density * (-21.0f) * diff);
                    this.onlineTextView[a].setTranslationY(((float) Math.floor(avatarY)) + AndroidUtilities.dp(24.0f) + (((float) Math.floor(11.0f * AndroidUtilities.density)) * diff));
                    ...
                    if (a == i2 && !this.openAnimationInProgress) {
                        ...
                        int buttonsWidth = AndroidUtilities.dp(126 + 40 + ((this.callItem == null && this.editItem == null) ? 0 : 48));
                        int minWidth = viewWidth - buttonsWidth;
                        int width = (int) ((viewWidth - (buttonsWidth * Math.max(f, f2 - (diff != f2 ? (0.15f * diff) / (f2 - diff) : 1.0f)))) - this.nameTextView[a].getTranslationX());
                        float width2 = (this.nameTextView[a].getPaint().measureText(this.nameTextView[a].getText().toString()) * scale) + this.nameTextView[a].getSideDrawablesSize();
                        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.nameTextView[a].getLayoutParams();
                        if (width < width2) {
                            layoutParams2.width = Math.max(minWidth, (int) Math.ceil((width - AndroidUtilities.dp(24.0f)) / (((1.12f - scale) * 7.0f) + scale)));
                        } else {
                            layoutParams2.width = (int) Math.ceil(width2);
                        }
                        layoutParams2.width = (int) Math.min(((viewWidth - this.nameTextView[a].getX()) / scale) - AndroidUtilities.dp(8.0f), layoutParams2.width);
                        ...
                        layoutParams3.rightMargin = (int) Math.ceil(this.onlineTextView[a].getTranslationX() + AndroidUtilities.dp(8.0f) + (AndroidUtilities.dp(40.0f) * (1.0f - diff)));
                        if (width < width22) {
                            layoutParams3.width = (int) Math.ceil(width);
                        } else {
    ...
    private void fixLayout() {
        ...
        this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.13
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void didReceivedNotification(int r22, int r23, final java.lang.Object... r24) {
        /*
            Method dump skipped, instruction units count: 1183
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.didReceivedNotification(int, int, java.lang.Object[]):void");
    }
    ...
    public void setAnimationProgress(float progress) {
        ...
        int rD = (int) ((Color.red(color4) - r3) * progress);
        int gD = (int) ((Color.green(color4) - g3) * progress);
        int bD = (int) ((Color.blue(color4) - b) * progress);
        this.topView.setBackgroundColor(Color.rgb(r3 + rD, g3 + gD, b + bD));
        ...
        int rD2 = (int) ((Color.red(color5) - r4) * progress);
        int gD2 = (int) ((Color.green(color5) - g4) * progress);
        int bD2 = (int) ((Color.blue(color5) - b2) * progress);
        this.actionBar.setItemsColor(Color.rgb(r4 + rD2, g4 + gD2, b2 + bD2), false);
        ...
        int rD3 = (int) ((Color.red(color6) - r5) * progress);
        int gD3 = (int) ((Color.green(color6) - g5) * progress);
        int bD3 = (int) ((Color.blue(color6) - b3) * progress);
        int aD = (int) ((Color.alpha(color6) - a) * progress);
        int i2 = 0;
        while (true) {
            if (i2 >= 2) {
                break;
            ...
            if (simpleTextViewArr[i2] == null) {
                ...
                r2 = r5;
                g2 = g5;
                simpleTextViewArr[i2].setTextColor(Color.argb(a + aD, r5 + rD3, g5 + gD3, b3 + bD3));
            }
            i2++;
            color6 = color3;
        ...
        int rD4 = (int) ((Color.red(color) - r6) * progress);
        int gD4 = (int) ((Color.green(color) - g6) * progress);
        int bD4 = (int) ((Color.blue(color) - b4) * progress);
        int aD2 = (int) ((Color.alpha(color) - a2) * progress);
        int i3 = 0;
        for (i = 2; i3 < i; i = 2) {
            ...
            if (simpleTextViewArr2[i3] == null) {
                ...
                r = r6;
                g = g6;
                simpleTextViewArr2[i3].setTextColor(Color.argb(a2 + aD2, r6 + rD4, g6 + gD4, b4 + bD4));
            }
            i3++;
            color = color2;
        ...
        this.extraHeight = (int) (this.initialAnimationExtraHeight * progress);
        int i4 = this.user_id;
        if (i4 == 0) {
            i4 = this.chat_id;
        }
        int color7 = AvatarDrawable.getProfileColorForId(i4);
        int i5 = this.user_id;
        if (i5 == 0) {
            i5 = this.chat_id;
        }
        int color22 = AvatarDrawable.getColorForId(i5);
        if (color7 != color22) {
            int rD5 = (int) ((Color.red(color7) - Color.red(color22)) * progress);
            int gD5 = (int) ((Color.green(color7) - Color.green(color22)) * progress);
            int bD5 = (int) ((Color.blue(color7) - Color.blue(color22)) * progress);
            this.avatarDrawable.setColor(Color.rgb(Color.red(color22) + rD5, Color.green(color22) + gD5, Color.blue(color22) + bD5));
    ...
    protected AnimatorSet onCustomTransitionAnimation(boolean isOpen, final Runnable callback) {
        ...
        if (!isOpen) {
            ...
            ImageView imageView = this.writeButton;
            if (imageView != null) {
                animators.add(ObjectAnimator.ofFloat(imageView, (Property<ImageView, Float>) View.SCALE_X, 0.2f));
                animators.add(ObjectAnimator.ofFloat(this.writeButton, (Property<ImageView, Float>) View.SCALE_Y, 0.2f));
                animators.add(ObjectAnimator.ofFloat(this.writeButton, (Property<ImageView, Float>) View.ALPHA, 0.0f));
            }
            int a = 0;
            while (a < 2) {
                ...
                animators.add(ObjectAnimator.ofFloat(simpleTextView, (Property<SimpleTextView, Float>) property, fArr));
                SimpleTextView simpleTextView2 = this.nameTextView[a];
                Property property2 = View.ALPHA;
                float[] fArr2 = new float[1];
                fArr2[0] = a == 0 ? 1.0f : 0.0f;
                animators.add(ObjectAnimator.ofFloat(simpleTextView2, (Property<SimpleTextView, Float>) property2, fArr2));
                a++;
            }
            ActionBarMenuItem actionBarMenuItem = this.animatingItem;
            if (actionBarMenuItem != null) {
                actionBarMenuItem.setAlpha(0.0f);
                animators.add(ObjectAnimator.ofFloat(this.animatingItem, (Property<ActionBarMenuItem, Float>) View.ALPHA, 1.0f));
            }
            ActionBarMenuItem actionBarMenuItem2 = this.callItem;
            if (actionBarMenuItem2 != null) {
                actionBarMenuItem2.setAlpha(1.0f);
                animators.add(ObjectAnimator.ofFloat(this.callItem, (Property<ActionBarMenuItem, Float>) View.ALPHA, 0.0f));
            }
            ActionBarMenuItem actionBarMenuItem3 = this.editItem;
            if (actionBarMenuItem3 != null) {
                actionBarMenuItem3.setAlpha(1.0f);
                animators.add(ObjectAnimator.ofFloat(this.editItem, (Property<ActionBarMenuItem, Float>) View.ALPHA, 0.0f));
            }
            ...
            if (imageView2 != null) {
                ...
                animators2.add(ObjectAnimator.ofFloat(this.writeButton, (Property<ImageView, Float>) View.SCALE_X, 1.0f));
                animators2.add(ObjectAnimator.ofFloat(this.writeButton, (Property<ImageView, Float>) View.SCALE_Y, 1.0f));
                animators2.add(ObjectAnimator.ofFloat(this.writeButton, (Property<ImageView, Float>) View.ALPHA, 1.0f));
            }
            int a2 = 0;
            while (a2 < 2) {
                this.onlineTextView[a2].setAlpha(a2 == 0 ? 1.0f : 0.0f);
                this.nameTextView[a2].setAlpha(a2 == 0 ? 1.0f : 0.0f);
                SimpleTextView simpleTextView3 = this.onlineTextView[a2];
                Property property3 = View.ALPHA;
                float[] fArr3 = new float[1];
                fArr3[0] = a2 == 0 ? 0.0f : 1.0f;
                animators2.add(ObjectAnimator.ofFloat(simpleTextView3, (Property<SimpleTextView, Float>) property3, fArr3));
                SimpleTextView simpleTextView4 = this.nameTextView[a2];
                Property property4 = View.ALPHA;
                float[] fArr4 = new float[1];
                fArr4[0] = a2 == 0 ? 0.0f : 1.0f;
                animators2.add(ObjectAnimator.ofFloat(simpleTextView4, (Property<SimpleTextView, Float>) property4, fArr4));
                a2++;
            }
            ActionBarMenuItem actionBarMenuItem4 = this.animatingItem;
            if (actionBarMenuItem4 != null) {
                actionBarMenuItem4.setAlpha(1.0f);
                animators2.add(ObjectAnimator.ofFloat(this.animatingItem, (Property<ActionBarMenuItem, Float>) View.ALPHA, 0.0f));
            }
            ActionBarMenuItem actionBarMenuItem5 = this.callItem;
            if (actionBarMenuItem5 != null) {
                actionBarMenuItem5.setAlpha(0.0f);
                animators2.add(ObjectAnimator.ofFloat(this.callItem, (Property<ActionBarMenuItem, Float>) View.ALPHA, 1.0f));
            }
            ActionBarMenuItem actionBarMenuItem6 = this.editItem;
            if (actionBarMenuItem6 != null) {
                actionBarMenuItem6.setAlpha(0.0f);
                animators2.add(ObjectAnimator.ofFloat(this.editItem, (Property<ActionBarMenuItem, Float>) View.ALPHA, 1.0f));
            }
            animatorSet.playTogether(animators2);
        }
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.14
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
                ProfileGroupActivity.this.listView.setLayerType(0, null);
                if (ProfileGroupActivity.this.animatingItem != null) {
                    ActionBarMenu menu2 = ProfileGroupActivity.this.actionBar.createMenu();
                    menu2.clearItems();
                    ProfileGroupActivity.this.animatingItem = null;
                }
                callback.run();
            }
        });
        ...
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$V1ckApGFHcFeYW_JU7RAm0ElIv8
            @Override // java.lang.Runnable
            public final void run() {
                animatorSet.start();
            }
    ...
    public void updateOnlineCount() {
        ...
        if ((chatFull instanceof TLRPC.TL_chatFull) || ((chatFull instanceof TLRPC.TL_channelFull) && chatFull.participants_count <= 200 && this.chatInfo.participants != null)) {
            ...
            try {
                Collections.sort(this.sortedUsers, new Comparator() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$sjRPl2U5wRzdTohQcJRdutDJXnU
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return this.f$0.lambda$updateOnlineCount$21$ProfileGroupActivity(currentTime, (Integer) obj, (Integer) obj2);
                    }
                });
            } catch (Exception e) {
                FileLog.e(e);
    ...
    private void kickUser(int uid) throws Exception {
        if (uid != 0) {
    ...
    public void updateRowsIds() {
        ...
        int a2 = this.user_id;
        if (a2 != 0 && LocaleController.isRTL) {
            int i = this.rowCount;
            this.rowCount = i + 1;
            this.emptyRow = i;
        }
        if (this.user_id != 0) {
            ...
            boolean hasInfo = ((userFull2 == null || TextUtils.isEmpty(userFull2.about)) && (user == null || TextUtils.isEmpty(user.username))) ? false : true;
            boolean hasPhone = (user == null || TextUtils.isEmpty(user.phone)) ? false : true;
        ...
        if (i23 != 0) {
            ...
            if (!ChatObject.isChannel(this.currentChat) && (chatFull = this.chatInfo) != null && !(chatFull.participants instanceof TLRPC.TL_chatParticipantsForbidden)) {
    ...
    private Drawable getScamDrawable() {
        if (this.scamDrawable == null) {
            ...
            scamDrawable.setColor(AvatarDrawable.getProfileTextColorForId((this.user_id != 0 || (ChatObject.isChannel(this.chat_id, this.currentAccount) && !this.currentChat.megagroup)) ? 5 : this.chat_id));
        }
    ...
    private void updateProfileData() {
        ...
        if (this.user_id != 0) {
            ...
            FileLoader.getInstance(this.currentAccount).loadFile(ImageLocation.getForUser(user, true), user, null, 0, 1);
        ...
        if (this.chat_id != 0) {
            ...
            if (ChatObject.isChannel(chat)) {
                if (this.chatInfo == null || (!this.currentChat.megagroup && (this.chatInfo.participants_count == 0 || ChatObject.hasAdminRights(this.currentChat) || this.chatInfo.can_view_participants))) {
                    ...
                    if (this.onlineCount > 1 && this.chatInfo.participants_count != 0) {
                        newString = String.format("%s, %s", LocaleController.formatPluralString("Members", this.chatInfo.participants_count), LocaleController.formatPluralString("OnlineCount", Math.min(this.onlineCount, this.chatInfo.participants_count)));
                        ...
                        if (chat.has_geo) {
                            ...
                            String newString4 = chat.username;
                            if (!TextUtils.isEmpty(newString4)) {
                ...
                if (count != 0 && this.onlineCount > 1) {
                    newString = String.format("%s, %s", LocaleController.formatPluralString("Members", count), LocaleController.formatPluralString("OnlineCount", this.onlineCount));
                } else {
                    String newString5 = LocaleController.formatPluralString("Members", count);
                    newString = newString5;
                }
            }
            int a2 = 0;
            ...
            while (a2 < 2) {
                if (this.nameTextView[a2] == null) {
                    ...
                    if (a2 != 0) {
                        if (chat.scam) {
                            ...
                            currentConnectionState = currentConnectionState2;
                            this.nameTextView[a2].setRightDrawable(new CombinedDrawable(Theme.profile_verifiedDrawable, Theme.profile_verifiedCheckDrawable));
                            onlineTextOverride2 = onlineTextOverride;
                        } else {
                            currentConnectionState = currentConnectionState2;
                    ...
                    if (a2 != 0 || onlineTextOverride2 == null) {
                        String onlineTextOverride4 = onlineTextOverride2;
                        if (this.currentChat.megagroup && this.chatInfo != null && this.onlineCount > 0) {
                            if (this.onlineTextView[a2].getText().equals(newString)) {
                                onlineTextOverride3 = onlineTextOverride4;
                                changed2 = changed;
                                str = str2;
                            } else {
                                this.onlineTextView[a2].setText(newString);
                                onlineTextOverride3 = onlineTextOverride4;
                                changed2 = changed;
                                str = str2;
                            }
                                ...
                                if (this.currentChat.megagroup || this.currentChat.broadcast) {
                                    ...
                                    if (this.currentChat.megagroup) {
                                        if (this.chatInfo.participants_count != 0) {
                                            ...
                                            changed3 = changed;
                                            str = str2;
                                            this.onlineTextView[a2].setText(LocaleController.formatPluralString(str2, result[0]).replace(String.format("%d", Integer.valueOf(result[0])), shortNumber));
                                        ...
                                        changed3 = changed;
                                        str = str2;
                                        this.onlineTextView[a2].setText(LocaleController.formatPluralString("Subscribers", result[0]).replace(String.format("%d", Integer.valueOf(result[0])), shortNumber));
                                    }
                                    changed4 = changed3;
                                } else {
                                    onlineTextOverride3 = onlineTextOverride4;
                        ...
                        String onlineTextOverride5 = onlineTextOverride2;
                        this.onlineTextView[a2].setText(onlineTextOverride5);
                        onlineTextOverride3 = onlineTextOverride5;
                        changed2 = changed;
                        str = str2;
                    }
                    changed4 = changed2;
                ...
                a2++;
                onlineTextOverride = onlineTextOverride3;
            ...
            FileLoader.getInstance(this.currentAccount).loadFile(ImageLocation.getForChat(chat, true), chat, null, 0, 1);
    ...
    private void createActionBarMenu() {
        ...
        if (this.user_id != 0) {
            if (UserConfig.getInstance(this.currentAccount).getClientUserId() != this.user_id) {
                ...
                TLRPC.UserFull userFull = this.userInfo;
                if (userFull != null && userFull.phone_calls_available) {
                    this.callItem = menu.addItem(15, R.drawable.ic_call);
                }
                if (this.isBot || ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(this.user_id)) == null) {
                    ...
                    if (MessagesController.isSupportUser(user)) {
                        if (this.userBlocked) {
                            item.addSubItem(2, R.drawable.msg_block, LocaleController.getString("Unblock", R.string.Unblock));
                        }
                    } else {
                        if (this.isBot) {
                            if (!user.bot_nochats) {
                                item.addSubItem(9, R.drawable.msg_addbot, LocaleController.getString("BotInvite", R.string.BotInvite));
                            }
                            item.addSubItem(10, R.drawable.msg_share, LocaleController.getString("BotShare", R.string.BotShare));
                        } else {
                            item.addSubItem(1, R.drawable.msg_addcontact, LocaleController.getString("AddContact", R.string.AddContact));
                        }
                        if (!TextUtils.isEmpty(user.phone)) {
                            item.addSubItem(3, R.drawable.msg_share, LocaleController.getString("ShareContact", R.string.ShareContact));
                        }
                        if (this.isBot) {
                            int i2 = !this.userBlocked ? R.drawable.msg_block : R.drawable.msg_retry;
                            if (this.userBlocked) {
                            ...
                            item.addSubItem(2, i2, LocaleController.getString(str, i));
                        } else {
                            boolean z = this.userBlocked;
                            item.addSubItem(2, R.drawable.msg_block, !this.userBlocked ? LocaleController.getString("BlockContact", R.string.BlockContact) : LocaleController.getString("Unblock", R.string.Unblock));
                        }
                    }
                } else {
                    item = menu.addItem(10, R.drawable.ic_ab_other);
                    ...
                    item.addSubItem(2, R.drawable.msg_block, !this.userBlocked ? LocaleController.getString("BlockContact", R.string.BlockContact) : LocaleController.getString("Unblock", R.string.Unblock));
                    item.addSubItem(4, R.drawable.msg_edit, LocaleController.getString("EditContact", R.string.EditContact));
                    item.addSubItem(5, R.drawable.msg_delete, LocaleController.getString("DeleteContact", R.string.DeleteContact));
                }
            } else {
                item = menu.addItem(10, R.drawable.ic_ab_other);
                item.addSubItem(3, R.drawable.msg_share, LocaleController.getString("ShareContact", R.string.ShareContact));
            ...
            if (i3 != 0 && i3 > 0) {
                ...
                if (ChatObject.isChannel(chat)) {
                    if (ChatObject.hasAdminRights(chat) || (chat.megagroup && ChatObject.canChangeChatInfo(chat))) {
                        this.editItem = menu.addItem(12, R.drawable.group_edit_profile);
                    }
                    if (!chat.megagroup && (chatFull = this.chatInfo) != null && chatFull.can_view_stats) {
                        if (0 == 0) {
                            item = menu.addItem(10, R.drawable.ic_ab_other);
                        }
                        item.addSubItem(19, R.drawable.msg_stats, LocaleController.getString("Statistics", R.string.Statistics));
                    }
                    if (chat.megagroup) {
                        if (item == null) {
                            item = menu.addItem(10, R.drawable.ic_ab_other);
                        }
                        item.addSubItem(17, R.drawable.msg_search, LocaleController.getString("SearchMembers", R.string.SearchMembers));
                        if (!chat.creator && !chat.left && !chat.kicked) {
                            item.addSubItem(7, R.drawable.msg_leave, LocaleController.getString("LeaveMegaMenu", R.string.LeaveMegaMenu));
                        }
                    }
                } else {
                    ...
                    item = menu.addItem(10, R.drawable.ic_ab_other);
                    item.addSubItem(17, R.drawable.msg_search, LocaleController.getString("SearchMembers", R.string.SearchMembers));
                    item.addSubItem(7, R.drawable.msg_leave, LocaleController.getString("DeleteAndExit", R.string.DeleteAndExit));
                }
            }
        }
        if (item == null) {
        ...
        item.addSubItem(14, R.drawable.msg_home, LocaleController.getString("AddShortcut", R.string.AddShortcut));
    ...
    public void didSelectDialogs(DialogsActivity fragment, ArrayList<Long> dids, CharSequence message, boolean param) {
        ...
        if (MessagesController.getInstance(this.currentAccount).checkCanOpenChat(args, fragment)) {
            ...
            removeSelfFromStack();
            TLRPC.User user = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(this.user_id));
            SendMessagesHelper.getInstance(this.currentAccount).sendMessage(user, did, (MessageObject) null, (TLRPC.ReplyMarkup) null, (HashMap<String, String>) null, true, 0);
        }
    }
            ...
            if (viewType != 11) {
                switch (viewType) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        view = new AboutLinkCell(this.mContext) { // from class: im.uwrkaxlmjj.ui.hui.chats.ProfileGroupActivity.ListAdapter.1
                            @Override // im.uwrkaxlmjj.ui.cells.AboutLinkCell
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                case 1:
                    ...
                    if (position == ProfileGroupActivity.this.infoHeaderRow) {
                    ...
                    } else if (position != ProfileGroupActivity.this.sharedHeaderRow) {
                        if (position == ProfileGroupActivity.this.membersHeaderRow) {
                ...
                case 2:
                    ...
                    if (position == ProfileGroupActivity.this.phoneRow) {
                        TLRPC.User user = MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).getUser(Integer.valueOf(ProfileGroupActivity.this.user_id));
                        if (!TextUtils.isEmpty(user.phone)) {
                        ...
                        break;
                    } else if (position == ProfileGroupActivity.this.usernameRow) {
                        if (ProfileGroupActivity.this.user_id != 0) {
                            TLRPC.User user2 = MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).getUser(Integer.valueOf(ProfileGroupActivity.this.user_id));
                            String text2 = (user2 != null && !TextUtils.isEmpty(user2.username)) ? "@" + user2.username : "-";
                            detailCell.setTextAndValue(text2, LocaleController.getString("Username", R.string.Username), false);
                        ...
                        break;
                    } else if (position == ProfileGroupActivity.this.locationRow && ProfileGroupActivity.this.chatInfo != null && (ProfileGroupActivity.this.chatInfo.location instanceof TLRPC.TL_channelLocation)) {
                        TLRPC.TL_channelLocation location = (TLRPC.TL_channelLocation) ProfileGroupActivity.this.chatInfo.location;
                ...
                case 3:
                    ...
                    if (position == ProfileGroupActivity.this.userInfoRow) {
                    ...
                    } else if (position == ProfileGroupActivity.this.channelInfoRow) {
                ...
                case 4:
                    ...
                    if (position == ProfileGroupActivity.this.photosRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("SharedPhotosAndVideos", R.string.SharedPhotosAndVideos), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.lastMediaCount[0])), R.drawable.profile_photos, position != ProfileGroupActivity.this.sharedSectionRow - 1);
                    } else if (position == ProfileGroupActivity.this.filesRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("FilesDataUsage", R.string.FilesDataUsage), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.lastMediaCount[1])), R.drawable.profile_file, position != ProfileGroupActivity.this.sharedSectionRow - 1);
                    } else if (position == ProfileGroupActivity.this.linksRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("SharedLinks", R.string.SharedLinks), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.lastMediaCount[3])), R.drawable.profile_link, position != ProfileGroupActivity.this.sharedSectionRow - 1);
                    } else if (position == ProfileGroupActivity.this.audioRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("SharedAudioFiles", R.string.SharedAudioFiles), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.lastMediaCount[4])), R.drawable.profile_audio, position != ProfileGroupActivity.this.sharedSectionRow - 1);
                    } else if (position == ProfileGroupActivity.this.voiceRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("AudioAutodownload", R.string.AudioAutodownload), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.lastMediaCount[2])), R.drawable.profile_voice, position != ProfileGroupActivity.this.sharedSectionRow - 1);
                    } else if (position == ProfileGroupActivity.this.groupsInCommonRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("GroupsInCommonTitle", R.string.GroupsInCommonTitle), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.userInfo.common_chats_count)), R.drawable.actions_viewmembers, position != ProfileGroupActivity.this.sharedSectionRow - 1);
                    } else if (position == ProfileGroupActivity.this.settingsTimerRow) {
                    ...
                    } else if (position != ProfileGroupActivity.this.unblockRow) {
                        if (position != ProfileGroupActivity.this.startSecretChatRow) {
                            if (position != ProfileGroupActivity.this.settingsKeyRow) {
                                if (position != ProfileGroupActivity.this.leaveChannelRow) {
                                    if (position != ProfileGroupActivity.this.joinRow) {
                                        if (position == ProfileGroupActivity.this.subscribersRow) {
                                            if (ProfileGroupActivity.this.chatInfo != null) {
                                                if (!ChatObject.isChannel(ProfileGroupActivity.this.currentChat) || ProfileGroupActivity.this.currentChat.megagroup) {
                                                    textCell.setTextAndValueAndIcon(LocaleController.getString("ChannelMembers", R.string.ChannelMembers), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.chatInfo.participants_count)), R.drawable.actions_viewmembers, position != ProfileGroupActivity.this.membersSectionRow - 1);
                                                } else {
                                                    textCell.setTextAndValueAndIcon(LocaleController.getString("ChannelSubscribers", R.string.ChannelSubscribers), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.chatInfo.participants_count)), R.drawable.actions_viewmembers, position != ProfileGroupActivity.this.membersSectionRow - 1);
                                                }
                                            } else if (!ChatObject.isChannel(ProfileGroupActivity.this.currentChat) || ProfileGroupActivity.this.currentChat.megagroup) {
                                                textCell.setTextAndIcon(LocaleController.getString("ChannelMembers", R.string.ChannelMembers), R.drawable.actions_viewmembers, position != ProfileGroupActivity.this.membersSectionRow - 1);
                                            } else {
                                                textCell.setTextAndIcon(LocaleController.getString("ChannelSubscribers", R.string.ChannelSubscribers), R.drawable.actions_viewmembers, position != ProfileGroupActivity.this.membersSectionRow - 1);
                                            }
                                        } else if (position == ProfileGroupActivity.this.administratorsRow) {
                                            if (ProfileGroupActivity.this.chatInfo != null) {
                                                textCell.setTextAndValueAndIcon(LocaleController.getString("ChannelAdministrators", R.string.ChannelAdministrators), String.format("%d", Integer.valueOf(ProfileGroupActivity.this.chatInfo.admins_count)), R.drawable.actions_addadmin, position != ProfileGroupActivity.this.membersSectionRow - 1);
                                            } else {
                                                textCell.setTextAndIcon(LocaleController.getString("ChannelAdministrators", R.string.ChannelAdministrators), R.drawable.actions_addadmin, position != ProfileGroupActivity.this.membersSectionRow - 1);
                                            }
                                        } else if (position == ProfileGroupActivity.this.blockedUsersRow) {
                                            if (ProfileGroupActivity.this.chatInfo != null) {
                                                textCell.setTextAndValueAndIcon(LocaleController.getString("ChannelBlacklist", R.string.ChannelBlacklist), String.format("%d", Integer.valueOf(Math.max(ProfileGroupActivity.this.chatInfo.banned_count, ProfileGroupActivity.this.chatInfo.kicked_count))), R.drawable.actions_removed, position != ProfileGroupActivity.this.membersSectionRow - 1);
                                            } else {
                                                textCell.setTextAndIcon(LocaleController.getString("ChannelBlacklist", R.string.ChannelBlacklist), R.drawable.actions_removed, position != ProfileGroupActivity.this.membersSectionRow - 1);
                                            }
                                        } else if (position != ProfileGroupActivity.this.addMemberRow) {
                                            if (position == ProfileGroupActivity.this.qrCodeRow) {
                ...
                case 6:
                    ...
                    if (position == ProfileGroupActivity.this.notificationsRow) {
                        SharedPreferences preferences = MessagesController.getNotificationsSettings(ProfileGroupActivity.this.currentAccount);
                        long did = ProfileGroupActivity.this.dialog_id != 0 ? ProfileGroupActivity.this.dialog_id : ProfileGroupActivity.this.user_id != 0 ? ProfileGroupActivity.this.user_id : -ProfileGroupActivity.this.chat_id;
                        ...
                        if (value2 == 3 && delta != Integer.MAX_VALUE) {
                            ...
                            if (delta2 <= 0) {
                                ...
                                val = LocaleController.formatString("WillUnmuteIn", R.string.WillUnmuteIn, LocaleController.formatPluralString("Hours", (int) Math.ceil((delta2 / 60.0f) / 60.0f)));
                            } else if (delta2 < 31536000) {
                                val = LocaleController.formatString("WillUnmuteIn", R.string.WillUnmuteIn, LocaleController.formatPluralString("Days", (int) Math.ceil(((delta2 / 60.0f) / 60.0f) / 24.0f)));
                            } else {
                                val = null;
                            }
                        } else {
                    ...
                    if (position == ProfileGroupActivity.this.forbidAddContact) {
                        ...
                        String value3 = LocaleController.getString(str, i);
                        checkCell.setTextAndValueAndCheck(LocaleController.getString("ForbidAddContacts", R.string.ForbidAddContacts), value3, enabled2, false);
                    }
                    break;
                case 7:
                    View sectionCell = holder.itemView;
                    sectionCell.setTag(Integer.valueOf(position));
                    if ((position == ProfileGroupActivity.this.infoSectionRow && ProfileGroupActivity.this.sharedSectionRow == -1 && ProfileGroupActivity.this.lastSectionRow == -1 && ProfileGroupActivity.this.settingsSectionRow == -1) || ((position == ProfileGroupActivity.this.settingsSectionRow && ProfileGroupActivity.this.sharedSectionRow == -1) || ((position == ProfileGroupActivity.this.sharedSectionRow && ProfileGroupActivity.this.lastSectionRow == -1) || position == ProfileGroupActivity.this.lastSectionRow || (position == ProfileGroupActivity.this.membersSectionRow && ProfileGroupActivity.this.lastSectionRow == -1 && (ProfileGroupActivity.this.sharedSectionRow == -1 || ProfileGroupActivity.this.membersSectionRow > ProfileGroupActivity.this.sharedSectionRow))))) {
                ...
                case 8:
                    ...
                    TLRPC.ChatParticipant part = !ProfileGroupActivity.this.sortedUsers.isEmpty() ? ProfileGroupActivity.this.chatInfo.participants.participants.get(((Integer) ProfileGroupActivity.this.sortedUsers.get(position - ProfileGroupActivity.this.membersStartRow)).intValue()) : ProfileGroupActivity.this.chatInfo.participants.participants.get(position - ProfileGroupActivity.this.membersStartRow);
                    if (part != null) {
                        ...
                        userCell.setData(MessagesController.getInstance(ProfileGroupActivity.this.currentAccount).getUser(Integer.valueOf(part.user_id)), null, null, 0, position != ProfileGroupActivity.this.membersEndRow - 1);
                    }
                    break;
            }
        }
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescription.ThemeDescriptionDelegate cellDelegate = new ThemeDescription.ThemeDescriptionDelegate() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$ProfileGroupActivity$o4QZ0b32W1qXi_0GsyjwDEbZ2jA
            @Override // im.uwrkaxlmjj.ui.actionbar.ThemeDescription.ThemeDescriptionDelegate
            public final void didSetColor() {
                this.f$0.lambda$getThemeDescriptions$22$ProfileGroupActivity();
            }
        };
