...
public class DataUsageActivity extends BaseFragment {
    private static final Interpolator interpolator = new Interpolator() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$DataUsageActivity$jO6fo8JwvrQXo2TK5wV7vKj33YA
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: im.uwrkaxlmjj.ui.DataUsageActivity.1
        ...
        this.scrollSlidingTextTabStrip.setDelegate(new ScrollSlidingTextTabStrip.ScrollSlidingTabStripDelegate() { // from class: im.uwrkaxlmjj.ui.DataUsageActivity.2
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: im.uwrkaxlmjj.ui.DataUsageActivity.3
            ...
            public boolean onTouchEvent(MotionEvent ev) {
                ...
                if (ev != null && ev.getAction() == 0 && !this.startedTracking && !this.maybeStartTracking) {
                    ...
                    if (this.startedTracking) {
                        ...
                        DataUsageActivity.this.backAnimation = Math.abs(x) < ((float) DataUsageActivity.this.viewPages[0].getMeasuredWidth()) / 3.0f && (Math.abs(velX2) < 3500.0f || Math.abs(velX2) < Math.abs(velY2));
                        if (!DataUsageActivity.this.backAnimation) {
                        ...
                        DataUsageActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.DataUsageActivity.3.1
        ...
        while (true) {
            ...
            if (a == 0 && viewPageArr[a] != null && viewPageArr[a].layoutManager != null) {
                ...
                if (scrollToPositionOnRecreate != this.viewPages[a].layoutManager.getItemCount() - i && (holder = (RecyclerListView.Holder) this.viewPages[a].listView.findViewHolderForAdapterPosition(scrollToPositionOnRecreate)) != null) {
                    scrollToOffsetOnRecreate = holder.itemView.getTop();
                } else {
                    scrollToPositionOnRecreate = -1;
                }
            }
            ViewPage ViewPage2 = new ViewPage(context) { // from class: im.uwrkaxlmjj.ui.DataUsageActivity.4
                @Override // android.view.View
            ...
            LinearLayoutManager layoutManager = viewPageArr2[a].layoutManager = new LinearLayoutManager(context, i, z) { // from class: im.uwrkaxlmjj.ui.DataUsageActivity.5
            ...
            this.viewPages[a].listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$DataUsageActivity$96WFVIrosAiMD3swW8uRlfWvfmM
                @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemClickListener
                public final void onItemClick(View view, int i2) {
                    this.f$0.lambda$createView$2$DataUsageActivity(listView, view, i2);
                }
            });
            this.viewPages[a].listView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.DataUsageActivity.6
    ...
    public /* synthetic */ void lambda$createView$2$DataUsageActivity(RecyclerListView listView, View view, int position) {
        ...
        if (position == adapter.resetRow) {
            ...
            builder.setPositiveButton(LocaleController.getString("Reset", R.string.Reset), new DialogInterface.OnClickListener() { // from class: im.uwrkaxlmjj.ui.-$$Lambda$DataUsageActivity$gYOzIZUYlHqjomNP3eOzuY3ndzI
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$null$1$DataUsageActivity(adapter, dialogInterface, i);
                }
            });
    ...
    class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (position == this.callsTotalTimeRow) {
                ...
                if (hours != 0) {
                    time = String.format("%d:%02d:%02d", Integer.valueOf(hours), Integer.valueOf(minutes), Integer.valueOf(total3));
                } else {
                    time = String.format("%d:%02d", Integer.valueOf(minutes), Integer.valueOf(total3));
                }
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        while (true) {
            ViewPage[] viewPageArr = this.viewPages;
            if (a < viewPageArr.length) {
                arrayList.add(new ThemeDescription(viewPageArr[a].listView, ThemeDescription.FLAG_CELLBACKGROUNDCOLOR, new Class[]{TextSettingsCell.class, HeaderCell.class}, null, null, null, Theme.key_windowBackgroundWhite));
