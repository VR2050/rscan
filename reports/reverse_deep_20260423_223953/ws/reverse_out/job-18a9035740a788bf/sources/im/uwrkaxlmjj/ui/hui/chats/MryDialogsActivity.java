...
public class MryDialogsActivity extends BaseSearchViewFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        this.listView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.hui.chats.-$$Lambda$MryDialogsActivity$n_DKZYFBwfyCjBCmiCbVXUmKD-A
            ...
            public final void onItemClick(View view, int i3) throws Exception {
    ...
    public /* synthetic */ void lambda$createView$3$MryDialogsActivity(View view, int position) throws Exception {
        long dialog_id;
        TLRPC.Chat chat;
    ...
    public /* synthetic */ void lambda$perfromSelectedDialogsAction$7$MryDialogsActivity(ArrayList copy) throws Exception {
        getMessagesController().addDialogToFolder(copy, this.folderId == 0 ? 0 : 1, -1, null, 0L);
    }

    public /* synthetic */ void lambda$perfromSelectedDialogsAction$8$MryDialogsActivity(int action, DialogInterface dialog1, int which) throws Exception {
    ...
    public /* synthetic */ void lambda$perfromSelectedDialogsAction$9$MryDialogsActivity(int action, DialogInterface dialog1, int which) throws Exception {
        perfromSelectedDialogsAction(action, false);
    }

    public /* synthetic */ void lambda$perfromSelectedDialogsAction$10$MryDialogsActivity(int action, DialogInterface dialog1, int which) throws Exception {
        perfromSelectedDialogsAction(action, false);
    }

    public /* synthetic */ void lambda$perfromSelectedDialogsAction$12$MryDialogsActivity(final int action, final TLRPC.Chat chat, final long selectedDialog, final boolean isBot, final boolean param) throws Exception {
        hideActionMode(false);
    ...
    public /* synthetic */ void lambda$null$11$MryDialogsActivity(int action, long selectedDialog, boolean param, TLRPC.Chat chat, boolean isBot) throws Exception {
        if (action == 103) {
    ...
    public /* synthetic */ void lambda$perfromSelectedDialogsAction$13$MryDialogsActivity(DialogInterface dialog12) throws Exception {
        hideActionMode(true);
    }
    ...
    public /* synthetic */ void lambda$didReceivedNotification$14$MryDialogsActivity(TLRPC.Chat chat, long dialogId, boolean revoke) throws Exception {
