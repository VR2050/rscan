...
import im.uwrkaxlmjj.ui.ArticleViewer;
...
public class TableLayout extends View {
    ...
    static final Alignment UNDEFINED_ALIGNMENT = new Alignment() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.1
        @Override // im.uwrkaxlmjj.ui.components.TableLayout.Alignment
    ...
    private static final Alignment LEADING = new Alignment() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.2
        @Override // im.uwrkaxlmjj.ui.components.TableLayout.Alignment
        int getGravityOffset(Child view, int cellDelta) {
            return 0;
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (this.cell != null) {
                ...
                if (TableLayout.this.drawLines) {
                    ...
                    int i2 = this.x;
                    if (i2 != 0) {
                        canvas.drawLine(i2 - halfStrokeWidth, this.y, i2 - halfStrokeWidth, r3 + this.measuredHeight, halfLinePaint);
                    } else {
                        int i3 = this.y;
                        float start5 = i3;
                        float end3 = this.measuredHeight + i3;
                        if (i3 != 0) {
                            start4 = start5;
                        } else {
                            start4 = start5 + rad;
                        }
                        if (end3 != TableLayout.this.getMeasuredHeight()) {
                            end2 = end3;
                        } else {
                            end2 = end3 - rad;
                        }
                        int i4 = this.x;
                        canvas.drawLine(i4 + strokeWidth, start4, i4 + strokeWidth, end2, linePaint);
                    }
                    int i5 = this.y;
                    if (i5 == 0) {
                        int i6 = this.x;
                        float start6 = i6;
                        float end4 = this.measuredWidth + i6;
                        if (i6 != 0) {
                            start3 = start6;
                        } else {
                            start3 = start6 + rad;
                        }
                        if (end4 != TableLayout.this.getMeasuredWidth()) {
                            end = end4;
                        } else {
                            end = end4 - rad;
                        }
                        int i7 = this.y;
                        canvas.drawLine(start3, i7 + strokeWidth, end, i7 + strokeWidth, linePaint);
                    } else {
                        canvas.drawLine(this.x, i5 - halfStrokeWidth, r2 + this.measuredWidth, i5 - halfStrokeWidth, halfLinePaint);
                    }
                    ...
                    float end5 = (isLastX && isLastY) ? (this.y + this.measuredHeight) - rad : (this.y + this.measuredHeight) - strokeWidth;
                    int i8 = this.x;
                    int i9 = this.measuredWidth;
                    canvas.drawLine((i8 + i9) - strokeWidth, start, (i8 + i9) - strokeWidth, end5, linePaint);
                    int i10 = this.x;
                    if (i10 == 0 && isLastY) {
                        start2 = i10 + rad;
                    } else {
                        start2 = this.x - strokeWidth;
                    }
                    float end6 = (isLastX && isLastY) ? (this.x + this.measuredWidth) - rad : (this.x + this.measuredWidth) - strokeWidth;
                    int i11 = this.y;
                    int i12 = this.measuredHeight;
                    canvas.drawLine(start2, (i11 + i12) - strokeWidth, end6, (i11 + i12) - strokeWidth, linePaint);
                    if (this.x == 0 && this.y == 0) {
                        RectF rectF = TableLayout.this.rect;
                        int i13 = this.x;
                        int i14 = this.y;
                        rectF.set(i13 + strokeWidth, i14 + strokeWidth, i13 + strokeWidth + (rad * 2), i14 + strokeWidth + (rad * 2));
                    ...
                    if (isLastX && this.y == 0) {
                        ...
                        int i17 = this.y;
                        rectF2.set(((i15 + i16) - strokeWidth) - (rad * 2), i17 + strokeWidth, (i15 + i16) - strokeWidth, i17 + strokeWidth + (rad * 2));
                    ...
                    if (this.x == 0 && isLastY) {
                        ...
                        rectF3.set(i18 + strokeWidth, ((i19 + i20) - strokeWidth) - (rad * 2), i18 + strokeWidth + (rad * 2), (i19 + i20) - strokeWidth);
                        canvas.drawArc(TableLayout.this.rect, 180.0f, -90.0f, false, linePaint);
                    }
                    if (isLastX && isLastY) {
                        ...
                        rectF4.set(((i21 + i22) - strokeWidth) - (rad * 2), ((i23 + i24) - strokeWidth) - (rad * 2), (i21 + i22) - strokeWidth, (i23 + i24) - strokeWidth);
                        canvas.drawArc(TableLayout.this.rect, 0.0f, 90.0f, false, linePaint);
                    }
                }
            }
    ...
    public void addChild(TLRPC.TL_pageTableCell cell, int x, int y, int colspan) {
        ...
        child.cell = cell;
        LayoutParams layoutParams = new LayoutParams();
        layoutParams.rowSpec = new Spec(false, new Interval(y, (cell.rowspan != 0 ? cell.rowspan : 1) + y), FILL, 0.0f);
        layoutParams.columnSpec = new Spec(false, new Interval(x, x + colspan2), FILL, 1.0f);
        child.layoutParams = layoutParams;
        this.childrens.add(child);
        if (cell.rowspan > 1) {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        while (height < N2) {
            ...
            int widthSansPadding3 = pWidth + sumMarginsX;
            int N3 = N2;
            int widthSansPadding4 = widthSansPadding;
            int alignmentOffsetX = boundsX.getOffset(this, c, hAlign, widthSansPadding3, true);
            ...
            widthSansPadding = widthSansPadding4;
            N2 = N3;
        }
        int widthSansPadding5 = measuredWidth2;
        int a4 = 0;
                ...
                for (int i4 = 0; i4 < size5; i4++) {
                    ...
                    if (child != next3) {
                        if (child.layoutParams.rowSpec.span.min == next3.layoutParams.rowSpec.span.min) {
                            ...
                            next3.measuredHeight -= heightDiff;
        ...
        setMeasuredDimension(widthSansPadding5, fixedHeight);
    }
    ...
    final class Axis {
        ...
        /* JADX WARN: Type inference failed for: r0v0, types: [im.uwrkaxlmjj.ui.components.TableLayout$Axis$1] */
        private Arc[] topologicalSort(final Arc[] arcs) {
            return new Object() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.Axis.1
                Arc[][] arcsByVertex;
                int cursor;
                Arc[] result;
                int[] visited;
    ...
    static {
        Alignment alignment = new Alignment() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.3
            @Override // im.uwrkaxlmjj.ui.components.TableLayout.Alignment
            int getGravityOffset(Child view, int cellDelta) {
                return cellDelta;
            }
        ...
        TRAILING = alignment;
        Alignment alignment2 = LEADING;
        TOP = alignment2;
        BOTTOM = alignment;
        START = alignment2;
        END = alignment;
        LEFT = createSwitchingAlignment(alignment2);
        RIGHT = createSwitchingAlignment(END);
        CENTER = new Alignment() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.5
            @Override // im.uwrkaxlmjj.ui.components.TableLayout.Alignment
            int getGravityOffset(Child view, int cellDelta) {
                return cellDelta >> 1;
            }
        ...
        BASELINE = new Alignment() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.6
            @Override // im.uwrkaxlmjj.ui.components.TableLayout.Alignment
            int getGravityOffset(Child view, int cellDelta) {
                return 0;
            }
            ...
            public Bounds getBounds() {
                return new Bounds() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.6.1
                    private int size;

                    @Override // im.uwrkaxlmjj.ui.components.TableLayout.Bounds
                    protected void reset() {
                        super.reset();
        ...
        FILL = new Alignment() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.7
            @Override // im.uwrkaxlmjj.ui.components.TableLayout.Alignment
            int getGravityOffset(Child view, int cellDelta) {
                return 0;
            }
    ...
    private static Alignment createSwitchingAlignment(final Alignment ltr) {
        return new Alignment() { // from class: im.uwrkaxlmjj.ui.components.TableLayout.4
            @Override // im.uwrkaxlmjj.ui.components.TableLayout.Alignment
            int getGravityOffset(Child view, int cellDelta) {
