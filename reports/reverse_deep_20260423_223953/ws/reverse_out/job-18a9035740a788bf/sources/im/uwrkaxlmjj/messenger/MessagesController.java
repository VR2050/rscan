...
public class MessagesController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$loadFullChat$29$MessagesController(TLRPC.Chat chat, long dialog_id, final int chat_id, final int classGuid, TLObject response, final TLRPC.TL_error error) {
        Integer value;
        Integer value2;
        if (error != null) {
    ...
    public /* synthetic */ void lambda$setUserBannedRole$52$MessagesController(final int chatId, final BaseFragment parentFragment, final TLRPC.TL_channels_editBanned req, final boolean isChannel, TLObject response, final TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void lambda$setChannelSlowMode$54$MessagesController(final int chatId, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void lambda$setDefaultBannedRole$57$MessagesController(final int chatId, final BaseFragment parentFragment, final TLRPC.TL_messages_editChatDefaultBannedRights req, final boolean isChannel, TLObject response, final TLRPC.TL_error error) {
        if (error == null) {
            processUpdates((TLRPC.Updates) response, false);
    ...
    public /* synthetic */ void lambda$setUserAdminRole$60$MessagesController(final int chatId, final BaseFragment parentFragment, final TLRPC.TL_channels_editAdmin req, final boolean isChannel, TLObject response, final TLRPC.TL_error error) {
        if (error == null) {
            processUpdates((TLRPC.Updates) response, false);
    ...
    public void deleteDialog(long did, int onlyHistory) throws Exception {
        deleteDialog(did, onlyHistory, false);
    }

    public void deleteDialog(long did, int onlyHistory, boolean revoke) throws Exception {
    ...
    */
    protected void deleteDialog(final long r34, boolean r36, final int r37, int r38, final boolean r39, im.uwrkaxlmjj.tgnet.TLRPC.InputPeer r40, long r41) throws java.lang.Exception {
        /*
    ...
    public /* synthetic */ void lambda$deleteDialog$88$MessagesController(long newTaskId, long did, int onlyHistory, int max_id_delete_final, boolean revoke, TLRPC.InputPeer peerFinal, TLObject response, TLRPC.TL_error error) throws Exception {
        if (newTaskId != 0) {
            getMessagesStorage().removePendingTask(newTaskId);
        }
        if (error == null) {
    ...
    */
    ...
    public int addDialogToFolder(ArrayList<Long> dialogIds, int folderId, int pinnedNum, ArrayList<TLRPC.TL_inputFolderPeer> peers, long taskId) throws Exception {
        final long newTaskId;
        long newTaskId2;
        TLRPC.Dialog dialog;
    ...
    */
    ...
    public /* synthetic */ void lambda$null$151$MessagesController(TLRPC.Dialog dialog) throws Exception {
    ...
    */
    ...
    public /* synthetic */ void lambda$createChat$174$MessagesController(final BaseFragment fragment, final TLRPC.TL_messages_createChat req, TLObject response, final TLRPC.TL_error error) {
        if (error != null) {
    ...
    public /* synthetic */ void lambda$createChat$177$MessagesController(final BaseFragment fragment, final TLRPC.TL_channels_createChannel req, TLObject response, final TLRPC.TL_error error) {
        if (error != null) {
    ...
    public /* synthetic */ void lambda$createMegaGroup$180$MessagesController(final BaseFragment fragment, final TLRPCChats.TL_channels_createChannel_v1 req, ArrayList selectedContacts, TLObject response, final TLRPC.TL_error error) {
        if (error != null) {
    ...
    public /* synthetic */ void lambda$addUsersToChannelWithCreate$182$MessagesController(final BaseFragment fragment, final TLRPC.TL_channels_inviteToChannel req, TLObject response, final TLRPC.TL_error error) {
        if (error != null) {
    ...
    public /* synthetic */ void lambda$convertToMegaGroup$186$MessagesController(final Context context, final AlertDialog progressDialog, final MessagesStorage.IntCallback convertRunnable, final BaseFragment fragment, final TLRPC.TL_messages_migrateChat req, TLObject response, final TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void lambda$addUsersToChannel$189$MessagesController(final BaseFragment fragment, final TLRPC.TL_channels_inviteToChannel req, TLObject response, final TLRPC.TL_error error) {
        if (error != null) {
    ...
    public /* synthetic */ void lambda$addUserToChat$202$MessagesController(final boolean isChannel, final TLRPC.InputUser inputUser, final int chat_id, final BaseFragment fragment, final TLObject request, final boolean isMegagroup, Runnable onFinishRunnable, TLObject response, final TLRPC.TL_error error) {
    ...
    public void deleteUserFromChat(int chat_id, TLRPC.User user, TLRPC.ChatFull info) throws Exception {
        deleteUserFromChat(chat_id, user, info, false, false);
    }

    public void deleteUserFromChat(final int i, TLRPC.User user, TLRPC.ChatFull chatFull, boolean z, boolean z2) throws Exception {
        TLObject tLObject;
        if (user == null) {
            return;
        }
    ...
    public /* synthetic */ void lambda$deleteUserFromChat$204$MessagesController(boolean isChannel, TLRPC.InputUser inputUser, final int chat_id, TLObject response, TLRPC.TL_error error) {
        if (error != null) {
            return;
        }
        TLRPC.Updates updates = (TLRPC.Updates) response;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$null$227$MessagesController(final im.uwrkaxlmjj.tgnet.TLRPC.updates_ChannelDifference r22, int r23, im.uwrkaxlmjj.tgnet.TLRPC.Chat r24, android.util.SparseArray r25, int r26, long r27) {
        /*
    ...
    */
    ...
    public /* synthetic */ void lambda$null$237$MessagesController(final TLRPC.updates_Difference res, SparseArray usersDict, SparseArray chatsDict) {
        TLRPC.User user;
    ...
    public void markDialogAsUnread(long did, TLRPC.InputPeer peer, long taskId) throws Exception {
        final long newTaskId;
    ...
    public void reorderPinnedDialogs(int folderId, ArrayList<TLRPC.InputDialogPeer> order, long taskId) throws Exception {
        final long newTaskId;
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public void processUpdates(final im.uwrkaxlmjj.tgnet.TLRPC.Updates r34, boolean r35) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean processUpdateArray(java.util.ArrayList<im.uwrkaxlmjj.tgnet.TLRPC.Update> r62, final java.util.ArrayList<im.uwrkaxlmjj.tgnet.TLRPC.User> r63, final java.util.ArrayList<im.uwrkaxlmjj.tgnet.TLRPC.Chat> r64, boolean r65, int r66) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$processUpdateArray$286$MessagesController(int r32, java.util.ArrayList r33, android.util.LongSparseArray r34, android.util.LongSparseArray r35, android.util.LongSparseArray r36, android.util.LongSparseArray r37, boolean r38, java.util.ArrayList r39, java.util.ArrayList r40, android.util.SparseArray r41) throws java.lang.Exception {
        /*
