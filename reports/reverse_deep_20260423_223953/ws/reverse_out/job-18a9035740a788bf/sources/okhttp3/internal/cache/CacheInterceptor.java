...
public final class CacheInterceptor implements Interceptor {
    ...
    static boolean isContentSpecificHeader(String fieldName) {
        return "Content-Length".equalsIgnoreCase(fieldName) || com.ding.rtc.http.HttpHeaders.CONTENT_ENCODING.equalsIgnoreCase(fieldName) || "Content-Type".equalsIgnoreCase(fieldName);
    }
}
