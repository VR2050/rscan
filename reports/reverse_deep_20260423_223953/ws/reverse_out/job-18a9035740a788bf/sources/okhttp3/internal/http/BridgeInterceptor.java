...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (transparentGzip && "gzip".equalsIgnoreCase(networkResponse.header(com.ding.rtc.http.HttpHeaders.CONTENT_ENCODING)) && HttpHeaders.hasBody(networkResponse)) {
            GzipSource responseBody = new GzipSource(networkResponse.body().source());
            Headers strippedHeaders = networkResponse.headers().newBuilder().removeAll(com.ding.rtc.http.HttpHeaders.CONTENT_ENCODING).removeAll("Content-Length").build();
