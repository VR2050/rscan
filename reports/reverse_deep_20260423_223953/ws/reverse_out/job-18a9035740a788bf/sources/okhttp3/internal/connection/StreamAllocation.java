    ...
    */
    public void streamFailed(java.io.IOException r7) {
        /*
            ...
            monitor-enter(r1)
            boolean r2 = r7 instanceof okhttp3.internal.http2.StreamResetException     // Catch: java.lang.Throwable -> L6a
            r3 = 0
            r4 = 1
            if (r2 == 0) goto L26
            r2 = r7
            okhttp3.internal.http2.StreamResetException r2 = (okhttp3.internal.http2.StreamResetException) r2     // Catch: java.lang.Throwable -> L6a
            okhttp3.internal.http2.ErrorCode r2 = r2.errorCode     // Catch: java.lang.Throwable -> L6a
            okhttp3.internal.http2.ErrorCode r5 = okhttp3.internal.http2.ErrorCode.REFUSED_STREAM     // Catch: java.lang.Throwable -> L6a
            if (r2 != r5) goto L1e
            int r5 = r6.refusedStreamCount     // Catch: java.lang.Throwable -> L6a
            int r5 = r5 + r4
            r6.refusedStreamCount = r5     // Catch: java.lang.Throwable -> L6a
            if (r5 <= r4) goto L25
            r0 = 1
            r6.route = r3     // Catch: java.lang.Throwable -> L6a
            goto L25
        L1e:
            okhttp3.internal.http2.ErrorCode r5 = okhttp3.internal.http2.ErrorCode.CANCEL     // Catch: java.lang.Throwable -> L6a
            if (r2 == r5) goto L25
            r0 = 1
            r6.route = r3     // Catch: java.lang.Throwable -> L6a
        L25:
        ...
        L26:
            ...
            if (r2 == 0) goto L36
            boolean r2 = r7 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch: java.lang.Throwable -> L6a
            if (r2 == 0) goto L4c
        L36:
            r0 = 1
            okhttp3.internal.connection.RealConnection r2 = r6.connection     // Catch: java.lang.Throwable -> L6a
            int r2 = r2.successCount     // Catch: java.lang.Throwable -> L6a
            if (r2 != 0) goto L4c
            okhttp3.Route r2 = r6.route     // Catch: java.lang.Throwable -> L6a
            if (r2 == 0) goto L4a
            if (r7 == 0) goto L4a
            okhttp3.internal.connection.RouteSelector r2 = r6.routeSelector     // Catch: java.lang.Throwable -> L6a
            okhttp3.Route r5 = r6.route     // Catch: java.lang.Throwable -> L6a
            r2.connectFailed(r5, r7)     // Catch: java.lang.Throwable -> L6a
        L4a:
            r6.route = r3     // Catch: java.lang.Throwable -> L6a
        L4c:
            okhttp3.internal.connection.RealConnection r2 = r6.connection     // Catch: java.lang.Throwable -> L6a
            r3 = 0
            java.net.Socket r3 = r6.deallocate(r0, r3, r4)     // Catch: java.lang.Throwable -> L6a
            okhttp3.internal.connection.RealConnection r4 = r6.connection     // Catch: java.lang.Throwable -> L6a
            if (r4 != 0) goto L5b
            boolean r4 = r6.reportedAcquired     // Catch: java.lang.Throwable -> L6a
            if (r4 != 0) goto L5c
        L5b:
            r2 = 0
        L5c:
