...
public final class HardwareConfigState {
    ...
    public boolean isHardwareConfigAllowed(int targetWidth, int targetHeight, boolean isHardwareConfigAllowed, boolean isExifOrientationRequired) {
        return isHardwareConfigAllowed && this.isHardwareConfigAllowedByDeviceModel && Build.VERSION.SDK_INT >= 26 && !isExifOrientationRequired && targetWidth >= minHardwareDimension && targetHeight >= minHardwareDimension && isFdSizeBelowHardwareLimit();
    }
