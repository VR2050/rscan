    ...
    */
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r12, R r13, com.bumptech.glide.load.DataSource r14) {
        ...
        L6b:
            ...
            r0 = 0
            r8 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r1 = r11.requestListeners     // Catch: java.lang.Throwable -> Lc0
            if (r1 == 0) goto L94
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r1 = r11.requestListeners     // Catch: java.lang.Throwable -> Lc0
            java.util.Iterator r9 = r1.iterator()     // Catch: java.lang.Throwable -> Lc0
            r10 = r0
        L7b:
            boolean r0 = r9.hasNext()     // Catch: java.lang.Throwable -> Lc0
            if (r0 == 0) goto L95
            java.lang.Object r0 = r9.next()     // Catch: java.lang.Throwable -> Lc0
            com.bumptech.glide.request.RequestListener r0 = (com.bumptech.glide.request.RequestListener) r0     // Catch: java.lang.Throwable -> Lc0
            java.lang.Object r2 = r11.model     // Catch: java.lang.Throwable -> Lc0
            com.bumptech.glide.request.target.Target<R> r3 = r11.target     // Catch: java.lang.Throwable -> Lc0
            r1 = r13
            r4 = r14
            r5 = r6
            boolean r1 = r0.onResourceReady(r1, r2, r3, r4, r5)     // Catch: java.lang.Throwable -> Lc0
            r10 = r10 | r1
            goto L7b
        L94:
            r10 = r0
        L95:
            com.bumptech.glide.request.RequestListener<R> r0 = r11.targetListener     // Catch: java.lang.Throwable -> Lc0
            if (r0 == 0) goto La9
            com.bumptech.glide.request.RequestListener<R> r0 = r11.targetListener     // Catch: java.lang.Throwable -> Lc0
            java.lang.Object r2 = r11.model     // Catch: java.lang.Throwable -> Lc0
            com.bumptech.glide.request.target.Target<R> r3 = r11.target     // Catch: java.lang.Throwable -> Lc0
            ...
            r4 = r14
            r5 = r6
            boolean r0 = r0.onResourceReady(r1, r2, r3, r4, r5)     // Catch: java.lang.Throwable -> Lc0
            if (r0 == 0) goto La9
            goto Laa
        La9:
            r7 = 0
        Laa:
            r0 = r10 | r7
            if (r0 != 0) goto Lb9
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r1 = r11.animationFactory     // Catch: java.lang.Throwable -> Lc0
            com.bumptech.glide.request.transition.Transition r1 = r1.build(r14, r6)     // Catch: java.lang.Throwable -> Lc0
            com.bumptech.glide.request.target.Target<R> r2 = r11.target     // Catch: java.lang.Throwable -> Lc0
            r2.onResourceReady(r13, r1)     // Catch: java.lang.Throwable -> Lc0
        Lb9:
