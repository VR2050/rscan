...
public class PriotityRangeBox extends AbstractBox {
    ...
    protected void _parseDetails(ByteBuffer content) {
        int uInt8 = IsoTypeReader.readUInt8(content);
        this.min_priorityId = uInt8;
        this.reserved1 = (uInt8 & PsExtractor.AUDIO_STREAM) >> 6;
        this.min_priorityId = uInt8 & 63;
        int uInt82 = IsoTypeReader.readUInt8(content);
        this.max_priorityId = uInt82;
        this.reserved2 = (uInt82 & PsExtractor.AUDIO_STREAM) >> 6;
