...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        float f;
        TypedArray ta = context.obtainStyledAttributes(attrs, im.uwrkaxlmjj.messenger.R.styleable.CommonTabLayout);
        ...
        this.mIndicatorHeight = ta.getDimension(15, dp2px(f));
        this.mIndicatorWidth = ta.getDimension(21, dp2px(this.mIndicatorStyle == 1 ? 10.0f : -1.0f));
        this.mIndicatorCornerRadius = ta.getDimension(12, dp2px(this.mIndicatorStyle == 2 ? -1.0f : 0.0f));
        this.mIndicatorMarginLeft = ta.getDimension(17, dp2px(0.0f));
        this.mIndicatorMarginTop = ta.getDimension(19, dp2px(this.mIndicatorStyle == 2 ? 7.0f : 0.0f));
        this.mIndicatorMarginRight = ta.getDimension(18, dp2px(0.0f));
        this.mIndicatorMarginBottom = ta.getDimension(16, dp2px(this.mIndicatorStyle != 2 ? 0.0f : 7.0f));
        this.mIndicatorAnimEnable = ta.getBoolean(9, true);
        this.mIndicatorBounceEnable = ta.getBoolean(10, true);
        this.mIndicatorAnimDuration = ta.getInt(8, -1);
        this.mIndicatorGravity = ta.getInt(14, 80);
        this.mUnderlineColor = ta.getColor(33, Color.parseColor("#ffffff"));
        this.mUnderlineHeight = ta.getDimension(35, dp2px(0.0f));
        ...
        this.mTextsize = ta.getDimension(29, sp2px(13.0f));
        ...
        this.mIconWidth = ta.getDimension(7, dp2px(0.0f));
        this.mIconHeight = ta.getDimension(4, dp2px(0.0f));
        this.mIconMargin = ta.getDimension(5, dp2px(2.5f));
        this.mTabSpaceEqual = ta.getBoolean(25, true);
        float dimension = ta.getDimension(26, dp2px(-1.0f));
        this.mTabWidth = dimension;
        this.mTabPadding = ta.getDimension(24, (this.mTabSpaceEqual || dimension > 0.0f) ? dp2px(0.0f) : dp2px(10.0f));
        ta.recycle();
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < this.mTabCount; i++) {
            ...
            if (i2 == 3) {
                tabView = View.inflate(this.mContext, mpEIGo.juqQQs.esbSDO.R.layout.layout_tab_left, null);
            } else if (i2 == 5) {
                tabView = View.inflate(this.mContext, mpEIGo.juqQQs.esbSDO.R.layout.layout_tab_right, null);
            } else if (i2 == 80) {
                tabView = View.inflate(this.mContext, mpEIGo.juqQQs.esbSDO.R.layout.layout_tab_bottom, null);
            } else {
                tabView = View.inflate(this.mContext, mpEIGo.juqQQs.esbSDO.R.layout.layout_tab_top, null);
            }
    ...
    private void addTab(int position, View tabView) {
        ...
        tv_tab_title.setText(this.mTabEntitys.get(position).getTabTitle());
        ImageView iv_tab_icon = (ImageView) tabView.findViewById(mpEIGo.juqQQs.esbSDO.R.attr.iv_tab_icon);
        iv_tab_icon.setImageResource(this.mTabEntitys.get(position).getTabUnselectedIcon());
        tabView.setOnClickListener(new View.OnClickListener() { // from class: com.tablayout.CommonTabLayout.1
            @Override // android.view.View.OnClickListener
            public void onClick(View v) {
                int position2 = ((Integer) v.getTag()).intValue();
                if (CommonTabLayout.this.mCurrentTab == position2) {
                    if (CommonTabLayout.this.mListener != null) {
                        CommonTabLayout.this.mListener.onTabReselect(position2);
                    }
                } else {
                    CommonTabLayout.this.setCurrentTab(position2);
                    if (CommonTabLayout.this.mListener != null) {
                        CommonTabLayout.this.mListener.onTabSelect(position2);
                    }
                }
            }
        });
    ...
    private void updateTabStyles() {
        ...
        while (i < this.mTabCount) {
            ...
            if (this.mIconVisible) {
                ...
                LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(i3, f3 > 0.0f ? (int) f3 : -2);
    ...
    public void onAnimationUpdate(ValueAnimator animation) {
        ...
        if (this.mIndicatorWidth >= 0.0f) {
            float indicatorLeft = p.left + ((currentTabView.getWidth() - this.mIndicatorWidth) / 2.0f);
            this.mIndicatorRect.left = (int) indicatorLeft;
    ...
    public void setMsgMargin(int position, float leftPadding, float bottomPadding) {
        ...
        if (tipView != null) {
            ...
            if (i2 == 48 || i2 == 80) {
                ...
                int i3 = this.mHeight;
                lp.topMargin = i3 > 0 ? (((int) (((i3 - textHeight) - iconH) - margin)) / 2) - dp2px(bottomPadding) : dp2px(bottomPadding);
            } else {
                lp.leftMargin = dp2px(leftPadding);
                int i4 = this.mHeight;
                lp.topMargin = i4 > 0 ? (((int) (i4 - Math.max(textHeight, iconH))) / 2) - dp2px(bottomPadding) : dp2px(bottomPadding);
            }
