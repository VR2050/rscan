...
public class ITelephonyUtil {
    ...
    public static String getDeviceIdLevel0(Context context) {
        ...
        try {
            ...
            Method asBinder = binderProxy.getClass().getDeclaredMethod("asBinder", new Class[0]);
    ...
    public static String getDeviceIdLevel1(Context context) {
        try {
            ...
            Method asInterface = Class.forName("com.android.internal.telephony.ITelephony$Stub").getDeclaredMethod("asInterface", IBinder.class);
