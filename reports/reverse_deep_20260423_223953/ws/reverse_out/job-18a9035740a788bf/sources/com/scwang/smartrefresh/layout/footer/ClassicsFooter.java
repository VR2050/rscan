...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter(Context context, AttributeSet attrs) {
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextSizeTitle)) {
            this.mTitleText.setTextSize(0, ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlTextSizeTitle, SmartUtil.dp2px(16.0f)));
        }
    ...
    /* JADX INFO: renamed from: com.scwang.smartrefresh.layout.footer.ClassicsFooter$1, reason: invalid class name */
