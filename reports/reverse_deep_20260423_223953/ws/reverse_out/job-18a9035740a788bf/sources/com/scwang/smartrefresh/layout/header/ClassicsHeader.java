...
public class ClassicsHeader extends InternalClassics<ClassicsHeader> implements RefreshHeader {
    ...
    public ClassicsHeader(Context context, AttributeSet attrs) {
        ...
        lpUpdateText.topMargin = ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextTimeMarginTop, SmartUtil.dp2px(0.0f));
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            this.mTitleText.setTextSize(0, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTitle, SmartUtil.dp2px(16.0f)));
        }
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            this.mLastUpdateText.setTextSize(0, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTime, SmartUtil.dp2px(12.0f)));
        }
        ...
        try {
            if ((context instanceof FragmentActivity) && (manager = ((FragmentActivity) context).getSupportFragmentManager()) != null) {
    ...
    /* JADX INFO: renamed from: com.scwang.smartrefresh.layout.header.ClassicsHeader$1, reason: invalid class name */
