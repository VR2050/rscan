...
public class ShadowUtils {
    ...
    public static class ShadowDrawable extends DrawableWrapper {
        ...
        private void drawShadow(Canvas canvas) {
            ...
            canvas.scale(shadowScaleHorizontal4, shadowScaleBottom4);
            ...
            canvas.scale(shadowScaleHorizontal2, shadowScaleBottom2);
        ...
        private void buildShadowCorners() {
            if (!this.isCircle) {
                ...
                this.mEdgeShadowPaint.setShader(new LinearGradient(0.0f, innerBounds.top, 0.0f, outerBounds.top, new int[]{this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP));
            ...
            this.mCornerShadowPath.arcTo(outerBounds2, 360.0f, 180.0f, false);
            this.mCornerShadowPath.arcTo(innerBounds2, 540.0f, -180.0f, false);
            this.mCornerShadowPath.arcTo(innerBounds2, 360.0f, -180.0f, false);
            this.mCornerShadowPath.close();
