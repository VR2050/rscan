...
public class AbtRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        return Arrays.asList(Component.builder(AbtComponent.class).add(Dependency.required(Context.class)).add(Dependency.optional(AnalyticsConnector.class)).factory(AbtRegistrar$$Lambda$1.instance).build(), LibraryVersionComponent.create("fire-abt", BuildConfig.VERSION_NAME));
    }
