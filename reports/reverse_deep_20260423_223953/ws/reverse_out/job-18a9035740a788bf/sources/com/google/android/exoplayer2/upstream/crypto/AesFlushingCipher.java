...
public final class AesFlushingCipher {
    ...
    public AesFlushingCipher(int mode, byte[] secretKey, long nonce, long offset) {
        try {
            ...
            long counter = offset / ((long) blockSize);
            int startPadding = (int) (offset % ((long) blockSize));
    ...
    public void update(byte[] in, int inOffset, int length, byte[] out, int outOffset) {
        ...
        do {
            ...
            if (i > 0) {
                ...
                Assertions.checkState(nonFlushingUpdate(this.zerosBlock, 0, i2, this.flushedBlock, 0) == this.blockSize);
                int i3 = 0;
