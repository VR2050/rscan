...
public final class DashUtil {
    ...
    public static Format loadSampleFormat(DataSource dataSource, int trackType, Representation representation) throws InterruptedException, IOException {
    ...
    public static ChunkIndex loadChunkIndex(DataSource dataSource, int trackType, Representation representation) throws InterruptedException, IOException {
    ...
    private static ChunkExtractorWrapper loadInitializationData(DataSource dataSource, int trackType, Representation representation, boolean loadIndex) throws InterruptedException, IOException {
