...
public enum zzcm {
    ...
    static {
        zzcm[] zzcmVarArrValues = values();
        zzkd = new zzcm[zzcmVarArrValues.length];
        for (zzcm zzcmVar : zzcmVarArrValues) {
    ...
    zzcm(int i, zzco zzcoVar, zzcz zzczVar) {
        ...
        this.zzkc = (zzcoVar != zzco.SCALAR || (i2 = zzcn.zzkh[zzczVar.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : true;
    }
