...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class Parameters implements Parcelable {
        ...
        private Parameters() {
            this(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, true, false, true, Integer.MAX_VALUE, Integer.MAX_VALUE, true, null, Integer.MAX_VALUE, Integer.MAX_VALUE, true, false, false, null, false, 0, false, false, true, 0, new SparseArray(), new SparseBooleanArray());
        }

        Parameters(int maxVideoWidth, int maxVideoHeight, int maxVideoFrameRate, int maxVideoBitrate, boolean exceedVideoConstraintsIfNecessary, boolean allowVideoMixedMimeTypeAdaptiveness, boolean allowVideoNonSeamlessAdaptiveness, int viewportWidth, int viewportHeight, boolean viewportOrientationMayChange, String preferredAudioLanguage, int maxAudioChannelCount, int maxAudioBitrate, boolean exceedAudioConstraintsIfNecessary, boolean allowAudioMixedMimeTypeAdaptiveness, boolean allowAudioMixedSampleRateAdaptiveness, String preferredTextLanguage, boolean selectUndeterminedTextLanguage, int disabledTextTrackSelectionFlags, boolean forceLowestBitrate, boolean forceHighestSupportedBitrate, boolean exceedRendererCapabilitiesIfNecessary, int tunnelingAudioSessionId, SparseArray<Map<TrackGroupArray, SelectionOverride>> selectionOverrides, SparseBooleanArray rendererDisabledFlags) {
            this.maxVideoWidth = maxVideoWidth;
            this.maxVideoHeight = maxVideoHeight;
            this.maxVideoFrameRate = maxVideoFrameRate;
            this.maxVideoBitrate = maxVideoBitrate;
        ...
        public int hashCode() {
            int i = ((((((((((((((((((((1 * 31) + this.maxVideoWidth) * 31) + this.maxVideoHeight) * 31) + this.maxVideoFrameRate) * 31) + this.maxVideoBitrate) * 31) + (this.exceedVideoConstraintsIfNecessary ? 1 : 0)) * 31) + (this.allowVideoMixedMimeTypeAdaptiveness ? 1 : 0)) * 31) + (this.allowVideoNonSeamlessAdaptiveness ? 1 : 0)) * 31) + (this.viewportOrientationMayChange ? 1 : 0)) * 31) + this.viewportWidth) * 31) + this.viewportHeight) * 31;
            String str = this.preferredAudioLanguage;
            int iHashCode = (((((((((((i + (str == null ? 0 : str.hashCode())) * 31) + this.maxAudioChannelCount) * 31) + this.maxAudioBitrate) * 31) + (this.exceedAudioConstraintsIfNecessary ? 1 : 0)) * 31) + (this.allowAudioMixedMimeTypeAdaptiveness ? 1 : 0)) * 31) + (this.allowAudioMixedSampleRateAdaptiveness ? 1 : 0)) * 31;
            String str2 = this.preferredTextLanguage;
            return ((((((((((((iHashCode + (str2 != null ? str2.hashCode() : 0)) * 31) + (this.selectUndeterminedTextLanguage ? 1 : 0)) * 31) + this.disabledTextTrackSelectionFlags) * 31) + (this.forceLowestBitrate ? 1 : 0)) * 31) + (this.forceHighestSupportedBitrate ? 1 : 0)) * 31) + (this.exceedRendererCapabilitiesIfNecessary ? 1 : 0)) * 31) + this.tunnelingAudioSessionId;
        }
        ...
        while (true) {
            ...
            if (params.getRendererDisabled(i)) {
                ...
                if (params.hasSelectionOverride(i, rendererTrackGroups)) {
                    ...
                    definitions[i] = override != null ? new TrackSelection.Definition(rendererTrackGroups.get(override.groupIndex), override.tracks) : null;
                }
            }
            i++;
        }
        ...
        while (i4 < rendererCount) {
            ...
            if (trackType != z) {
                if (trackType == i) {
                    ...
                    Pair<TrackSelection.Definition, Integer> textSelection = defaultTrackSelector.selectTextTrack(mappedTrackInfo.getTrackGroups(i4), rendererFormatSupports[i4], params);
                    if (textSelection == null || ((Integer) textSelection.second).intValue() <= selectedTextTrackScore2) {
                        ...
                        int selectedTextTrackScore3 = ((Integer) textSelection.second).intValue();
                        selectedTextRendererIndex2 = i4;
                        selectedTextTrackScore2 = selectedTextTrackScore3;
                        i2 = i4;
                    }
                } else {
                    definitions[i4] = defaultTrackSelector.selectOtherTrack(trackType, mappedTrackInfo.getTrackGroups(i4), rendererFormatSupports[i4], params);
                    i2 = i4;
                    selectedTextRendererIndex = selectedTextRendererIndex2;
                    selectedTextTrackScore = selectedTextTrackScore2;
                    selectedAudioRendererIndex = selectedAudioRendererIndex2;
                ...
                int selectedTextTrackScore4 = rendererMixedMimeTypeAdaptationSupports[i4];
                i2 = i4;
                selectedTextRendererIndex = selectedTextRendererIndex2;
                selectedTextTrackScore = selectedTextTrackScore2;
                selectedAudioRendererIndex = selectedAudioRendererIndex2;
                Pair<TrackSelection.Definition, AudioTrackScore> audioSelection = selectAudioTrack(trackGroups, iArr, selectedTextTrackScore4, params, !seenVideoRendererWithMappedTracks);
                ...
                if (!isSupported(trackFormatSupport[trackIndex], params.exceedRendererCapabilitiesIfNecessary)) {
                    ...
                    if (!isWithinConstraints && !params.exceedVideoConstraintsIfNecessary) {
                        ...
                        if (trackScore == selectedTrackScore) {
                            ...
                            selectedGroup = selectedGroup2;
                            if (params.forceLowestBitrate && bitrateComparison2 != 0) {
                                ...
                                boolean selectTrack2 = !(isWithinCapabilities && isWithinConstraints) ? bitrateComparison >= 0 : bitrateComparison <= 0;
    ...
    protected Pair<TrackSelection.Definition, Integer> selectTextTrack(TrackGroupArray trackGroupArray, int[][] iArr, Parameters parameters) throws ExoPlaybackException {
        int i;
        int i2;
    ...
    protected static final class AudioTrackScore implements Comparable<AudioTrackScore> {
        ...
        public int compareTo(AudioTrackScore other) {
            ...
            if (this.parameters.forceLowestBitrate && (bitrateComparison = DefaultTrackSelector.compareFormatValues(this.bitrate, other.bitrate)) != 0) {
            ...
            return i9 != i10 ? DefaultTrackSelector.compareInts(i9, i10) * resultSign : DefaultTrackSelector.compareInts(this.bitrate, other.bitrate) * resultSign;
        }
    }
