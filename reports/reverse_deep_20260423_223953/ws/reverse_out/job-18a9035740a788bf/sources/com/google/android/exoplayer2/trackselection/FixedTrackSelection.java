...
public final class FixedTrackSelection extends BaseTrackSelection {
    ...
    public static final class Factory implements TrackSelection.Factory {
        ...
        public TrackSelection[] createTrackSelections(TrackSelection.Definition[] definitions, BandwidthMeter bandwidthMeter) {
            return TrackSelectionUtil.createTrackSelectionsForDefinitions(definitions, new TrackSelectionUtil.AdaptiveTrackSelectionFactory() { // from class: com.google.android.exoplayer2.trackselection.-$$Lambda$FixedTrackSelection$Factory$d-V02I3wOe22WO-hap3_K4f4jI0
                @Override // com.google.android.exoplayer2.trackselection.TrackSelectionUtil.AdaptiveTrackSelectionFactory
                public final TrackSelection createAdaptiveTrackSelection(TrackSelection.Definition definition) {
                    return this.f$0.lambda$createTrackSelections$0$FixedTrackSelection$Factory(definition);
                }
            });
        }
