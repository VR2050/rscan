...
interface zzfz {
    ...
    void zza(int i, zzbo zzboVar) throws IOException;

    <K, V> void zza(int i, zzdq<K, V> zzdqVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzen zzenVar) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzen zzenVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzen zzenVar) throws IOException;

    void zzb(int i, List<zzbo> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzen zzenVar) throws IOException;
