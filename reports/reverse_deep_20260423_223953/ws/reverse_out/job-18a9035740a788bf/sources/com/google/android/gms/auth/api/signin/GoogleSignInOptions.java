...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x0055 A[Catch: ClassCastException -> 0x008a, TryCatch #0 {ClassCastException -> 0x008a, blocks: (B:5:0x0004, B:7:0x000e, B:10:0x0018, B:12:0x0028, B:15:0x0035, B:17:0x0039, B:23:0x004d, B:25:0x0055, B:30:0x006c, B:32:0x0074, B:34:0x007c, B:28:0x0060, B:20:0x0040), top: B:44:0x0004 }] */
    /* JADX WARN: Removed duplicated region for block: B:28:0x0060 A[Catch: ClassCastException -> 0x008a, TryCatch #0 {ClassCastException -> 0x008a, blocks: (B:5:0x0004, B:7:0x000e, B:10:0x0018, B:12:0x0028, B:15:0x0035, B:17:0x0039, B:23:0x004d, B:25:0x0055, B:30:0x006c, B:32:0x0074, B:34:0x007c, B:28:0x0060, B:20:0x0040), top: B:44:0x0004 }] */
    ...
    */
    public boolean equals(java.lang.Object r4) {
        ...
        L4:
            ...
            java.util.ArrayList<com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable> r1 = r3.zaad     // Catch: java.lang.ClassCastException -> L8a
            int r1 = r1.size()     // Catch: java.lang.ClassCastException -> L8a
            if (r1 > 0) goto L89
            java.util.ArrayList<com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable> r1 = r4.zaad     // Catch: java.lang.ClassCastException -> L8a
            int r1 = r1.size()     // Catch: java.lang.ClassCastException -> L8a
            if (r1 <= 0) goto L18
            goto L89
        L18:
            java.util.ArrayList<com.google.android.gms.common.api.Scope> r1 = r3.zaw     // Catch: java.lang.ClassCastException -> L8a
            int r1 = r1.size()     // Catch: java.lang.ClassCastException -> L8a
            java.util.ArrayList r2 = r4.getScopes()     // Catch: java.lang.ClassCastException -> L8a
            ...
            goto L88
        L35:
            android.accounts.Account r1 = r3.zax     // Catch: java.lang.ClassCastException -> L8a
            if (r1 != 0) goto L40
            android.accounts.Account r1 = r4.getAccount()     // Catch: java.lang.ClassCastException -> L8a
            if (r1 != 0) goto L86
        L3f:
            goto L4d
        L40:
            android.accounts.Account r1 = r3.zax     // Catch: java.lang.ClassCastException -> L8a
            android.accounts.Account r2 = r4.getAccount()     // Catch: java.lang.ClassCastException -> L8a
            boolean r1 = r1.equals(r2)     // Catch: java.lang.ClassCastException -> L8a
            if (r1 == 0) goto L86
            goto L3f
        L4d:
            java.lang.String r1 = r3.zaab     // Catch: java.lang.ClassCastException -> L8a
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch: java.lang.ClassCastException -> L8a
            if (r1 == 0) goto L60
            java.lang.String r1 = r4.getServerClientId()     // Catch: java.lang.ClassCastException -> L8a
            boolean r1 = android.text.TextUtils.isEmpty(r1)     // Catch: java.lang.ClassCastException -> L8a
            if (r1 == 0) goto L86
            goto L6c
        L60:
            java.lang.String r1 = r3.zaab     // Catch: java.lang.ClassCastException -> L8a
            java.lang.String r2 = r4.getServerClientId()     // Catch: java.lang.ClassCastException -> L8a
            boolean r1 = r1.equals(r2)     // Catch: java.lang.ClassCastException -> L8a
            if (r1 == 0) goto L86
        L6c:
            boolean r1 = r3.zaaa     // Catch: java.lang.ClassCastException -> L8a
            boolean r2 = r4.isForceCodeForRefreshToken()     // Catch: java.lang.ClassCastException -> L8a
            if (r1 != r2) goto L86
            boolean r1 = r3.zay     // Catch: java.lang.ClassCastException -> L8a
            boolean r2 = r4.isIdTokenRequested()     // Catch: java.lang.ClassCastException -> L8a
            if (r1 != r2) goto L86
            boolean r1 = r3.zaz     // Catch: java.lang.ClassCastException -> L8a
            boolean r4 = r4.isServerAuthCodeRequested()     // Catch: java.lang.ClassCastException -> L8a
            if (r1 != r4) goto L86
            r4 = 1
            return r4
        L86:
