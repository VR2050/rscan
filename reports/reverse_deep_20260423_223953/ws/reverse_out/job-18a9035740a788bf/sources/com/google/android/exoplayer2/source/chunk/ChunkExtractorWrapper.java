...
public final class ChunkExtractorWrapper implements ExtractorOutput {
    ...
    private static final class BindingTrackOutput implements TrackOutput {
        ...
        public void format(Format format) {
            ...
            Format formatCopyWithManifestFormatInfo = format2 != null ? format.copyWithManifestFormatInfo(format2) : format;
            this.sampleFormat = formatCopyWithManifestFormatInfo;
            this.trackOutput.format(formatCopyWithManifestFormatInfo);
        }
