    ...
    public final boolean zza(com.google.android.gms.clearcut.zze zzeVar) {
        ...
        if (!zzaw.get().booleanValue()) {
            ...
            if (context != null && zzc(context)) {
                zzae<String> zzaeVarZza = zzat.get(strValueOf);
                if (zzaeVarZza == null) {
                    zzaeVarZza = zzar.zza(strValueOf, null);
                    zzat.put(strValueOf, zzaeVarZza);
                }
                str = zzaeVarZza.get();
            }
        ...
        if (this.zzh == null) {
            ...
            zzae<zzgw.zza> zzaeVarZza2 = zzas.get(strValueOf);
            if (zzaeVarZza2 == null && (zzaeVarPutIfAbsent = zzas.putIfAbsent(strValueOf, (zzaeVarZza2 = zzaq.zza(strValueOf, zzgw.zza.zzft(), zzq.zzax)))) != null) {
