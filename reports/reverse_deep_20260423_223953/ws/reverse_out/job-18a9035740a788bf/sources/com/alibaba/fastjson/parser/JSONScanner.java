        ...
        if (rest >= this.ISO8601_LEN_0 && charAt(this.bp + 4) == '-' && charAt(this.bp + 7) == '-') {
            ...
            if (checkDate(y02, y12, y22, y32, M02, M12, d02, d12)) {
                ...
                if (t == 'T' || (t == ' ' && !strict)) {
                    ...
                    if (rest >= this.ISO8601_LEN_2 && (S0 = charAt(this.bp + 20)) >= '0' && S0 <= '9') {
                        int millis3 = digits[S0];
                        int millisLen = 1;
                        ...
                        int i5 = this.bp + millisLen + 20 + timzeZoneLength;
                        this.bp = i5;
                        this.ch = charAt(i5);
                        this.token = 5;
                        return true;
