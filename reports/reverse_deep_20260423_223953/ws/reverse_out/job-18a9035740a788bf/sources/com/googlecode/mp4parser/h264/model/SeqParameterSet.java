...
public class SeqParameterSet extends BitstreamElement {
    ...
    public static SeqParameterSet read(InputStream is) throws IOException {
        ...
        if (i == 100 || i == 110 || i == 122 || i == 144) {
            ChromaFormat chromaFormatFromId = ChromaFormat.fromId(reader.readUE("SPS: chroma_format_idc"));
            sps.chroma_format_idc = chromaFormatFromId;
        ...
        int ue = reader.readUE("SPS: pic_order_cnt_type");
        ...
        if (ue == 0) {
            ...
            int ue2 = reader.readUE("SPS: num_ref_frames_in_pic_order_cnt_cycle");
            sps.num_ref_frames_in_pic_order_cnt_cycle = ue2;
            sps.offsetForRefFrame = new int[ue2];
            for (int i2 = 0; i2 < sps.num_ref_frames_in_pic_order_cnt_cycle; i2++) {
                sps.offsetForRefFrame[i2] = reader.readSE("SPS: offsetForRefFrame [" + i2 + "]");
            }
        }
        ...
        boolean bool = reader.readBool("SPS: frame_mbs_only_flag");
        sps.frame_mbs_only_flag = bool;
        if (!bool) {
        ...
        boolean bool2 = reader.readBool("SPS: frame_cropping_flag");
        sps.frame_cropping_flag = bool2;
        if (bool2) {
    ...
    public void write(OutputStream out) throws IOException {
        ...
        writer.writeBool(this.vuiParams != null, "SPS: ");
