...
public class H265TrackImplOld {
    ...
    public void profile_tier_level(int maxNumSubLayersMinus1, CAVLCReader r) throws IOException {
        ...
        iArr[1] = i3;
        iArr[0] = i;
        boolean[][] sub_layer_profile_compatibility_flag = (boolean[][]) Array.newInstance((Class<?>) boolean.class, iArr);
    ...
    public int getFrameRate(ByteBuffer vps) throws IOException {
        ...
        boolean[][] layer_id_included_flag = (boolean[][]) Array.newInstance((Class<?>) boolean.class, iArr);
    ...
    /*  JADX ERROR: UnsupportedOperationException in pass: RegionMakerVisitor
        ...
        */
    boolean isFirstOfAU(int r7, java.nio.ByteBuffer r8, java.util.List<java.nio.ByteBuffer> r9) {
        /*
            r6 = this;
        ...
        L8:
            ...
            com.googlecode.mp4parser.authoring.tracks.H265TrackImplOld$NalUnitHeader r0 = r6.getNalUnitHeader(r0)
        ...
        L2f:
            ...
            r4 = 2
            r8.position(r4)
            int r4 = com.coremedia.iso.IsoTypeReader.readUInt8(r8)
            if (r0 == 0) goto L48
        ...
        L48:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.googlecode.mp4parser.authoring.tracks.H265TrackImplOld.isFirstOfAU(int, java.nio.ByteBuffer, java.util.List):boolean");
    }
    ...
    class LookAhead {
        ...
        boolean nextThreeEquals001() throws IOException {
            ...
            if (this.bufferStartPos + ((long) i) == this.dataSource.size()) {
