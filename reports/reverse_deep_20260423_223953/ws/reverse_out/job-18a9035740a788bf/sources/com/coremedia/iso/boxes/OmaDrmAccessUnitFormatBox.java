...
public final class OmaDrmAccessUnitFormatBox extends AbstractFullBox {
    ...
    public void setAllBits(byte allBits) {
        ...
        this.selectiveEncryption = (allBits & ByteCompanionObject.MIN_VALUE) == 128;
    }

    @Override // com.googlecode.mp4parser.AbstractBox
    public void _parseDetails(ByteBuffer content) {
        parseVersionAndFlags(content);
        byte uInt8 = (byte) IsoTypeReader.readUInt8(content);
        this.allBits = uInt8;
        this.selectiveEncryption = (uInt8 & ByteCompanionObject.MIN_VALUE) == 128;
