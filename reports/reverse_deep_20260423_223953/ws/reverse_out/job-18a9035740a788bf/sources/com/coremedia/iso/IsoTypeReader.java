...
public final class IsoTypeReader {
    ...
    public static double readFixedPoint1616(ByteBuffer bb) {
        ...
        return ((double) (((result | ((bytes[1] << 16) & 16711680)) | ((bytes[2] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK)) | (bytes[3] & UByte.MAX_VALUE))) / 65536.0d;
    }
    ...
    public static double readFixedPoint0230(ByteBuffer bb) {
        ...
        bb.get(bytes);
        int result = 0 | ((bytes[0] << 24) & (-16777216));
        return ((double) (((result | ((bytes[1] << 16) & 16711680)) | ((bytes[2] << 8) & MotionEventCompat.ACTION_POINTER_INDEX_MASK)) | (bytes[3] & UByte.MAX_VALUE))) / 1.073741824E9d;
    }
    ...
    public static float readFixedPoint88(ByteBuffer bb) {
        ...
        return ((short) ((bytes[1] & UByte.MAX_VALUE) | result)) / 256.0f;
    }
