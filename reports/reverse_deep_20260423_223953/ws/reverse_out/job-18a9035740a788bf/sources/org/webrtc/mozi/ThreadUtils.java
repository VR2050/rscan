...
public class ThreadUtils {
    ...
    public static void joinUninterruptibly(final Thread thread) {
        executeUninterruptibly(new BlockingOperation() { // from class: org.webrtc.mozi.ThreadUtils.1
            @Override // org.webrtc.mozi.ThreadUtils.BlockingOperation
    ...
    public static void awaitUninterruptibly(final CountDownLatch latch) {
        executeUninterruptibly(new BlockingOperation() { // from class: org.webrtc.mozi.ThreadUtils.2
            @Override // org.webrtc.mozi.ThreadUtils.BlockingOperation
            public void run() throws InterruptedException {
                latch.await();
            }
    ...
    public static <V> V invokeAtFrontUninterruptibly(Handler handler, final Callable<V> callable) {
        ...
        handler.post(new Runnable() { // from class: org.webrtc.mozi.ThreadUtils.3
    ...
    /* JADX INFO: renamed from: org.webrtc.mozi.ThreadUtils$1CaughtException, reason: invalid class name */
    ...
    /* JADX INFO: renamed from: org.webrtc.mozi.ThreadUtils$1Result, reason: invalid class name */
    class C1Result {
        public V value;
    ...
    public static void invokeAtFrontUninterruptibly(Handler handler, final Runnable runner) {
        invokeAtFrontUninterruptibly(handler, new Callable<Void>() { // from class: org.webrtc.mozi.ThreadUtils.4
