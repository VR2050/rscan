...
final /* synthetic */ class Camera1Session$4$$Lambda$1 implements Runnable {
    ...
    public void run() {
        Camera1Session.AnonymousClass4 anonymousClass4 = this.arg$1;
        Camera1Session.this.cameraThreadHandler.post(Camera1Session$4$$Lambda$2.lambdaFactory$(anonymousClass4, this.arg$2));
    }
}
