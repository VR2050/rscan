...
public abstract class AbstractDoubleClock implements Clock {
    ...
    private static final class DoubleClockMark extends ClockMark {
        ...
        public double elapsedNow() {
            return Duration.m982minusLRDsOJo(DurationKt.toDuration(this.clock.read() - this.startedAt, this.clock.getUnit()), this.offset);
        }

        @Override // kotlin.time.ClockMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ClockMark mo955plusLRDsOJo(double duration) {
            return new DoubleClockMark(this.startedAt, this.clock, Duration.m983plusLRDsOJo(this.offset, duration), null);
        }
    }
