...
public final class TestClock extends AbstractLongClock {
    ...
    public final void m1006plusAssignLRDsOJo(double duration) {
        long newReading;
        double delta = Duration.m991toDoubleimpl(duration, getUnit());
    ...
    private final void m1005overflowLRDsOJo(double duration) {
        throw new IllegalStateException("TestClock will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m997toStringimpl(duration) + '.');
    }
}
