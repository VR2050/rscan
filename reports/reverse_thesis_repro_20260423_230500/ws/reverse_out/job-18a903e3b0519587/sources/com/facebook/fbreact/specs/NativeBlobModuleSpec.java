...
public abstract class NativeBlobModuleSpec extends ReactContextBaseJavaModule implements TurboModule {
    ...
    @ReactMethod
    public abstract void addWebSocketHandler(double d3);
    ...
    @ReactMethod
    public abstract void removeWebSocketHandler(double d3);

    @ReactMethod
    public abstract void sendOverSocket(ReadableMap readableMap, double d3);
}
