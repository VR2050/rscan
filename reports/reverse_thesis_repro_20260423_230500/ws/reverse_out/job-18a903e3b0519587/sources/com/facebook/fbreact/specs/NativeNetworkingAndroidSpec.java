...
public abstract class NativeNetworkingAndroidSpec extends ReactContextBaseJavaModule implements TurboModule {
    ...
    @ReactMethod
    public abstract void abortRequest(double d3);
    ...
    @ReactMethod
    public abstract void sendRequest(String str, String str2, double d3, ReadableArray readableArray, ReadableMap readableMap, String str3, boolean z3, double d4, boolean z4);
}
