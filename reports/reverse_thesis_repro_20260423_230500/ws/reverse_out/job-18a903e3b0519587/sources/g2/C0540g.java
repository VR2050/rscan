...
public final class C0540g extends O1.d {

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static final a f9223i = new a(null);

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private final WritableMap f9224h;
    ...
    public C0540g(int i3, WritableMap writableMap) {
        super(i3);
        t2.j.f(writableMap, "mEventData");
        this.f9224h = writableMap;
    }
    ...
    public void c(RCTEventEmitter rCTEventEmitter) {
        ...
        rCTEventEmitter.receiveEvent(o(), "topMessage", this.f9224h);
    }
