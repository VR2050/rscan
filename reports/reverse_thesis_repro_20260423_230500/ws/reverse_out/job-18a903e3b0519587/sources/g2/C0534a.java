...
public final class C0534a extends O1.d {

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static final C0127a f9211i = new C0127a(null);

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private final WritableMap f9212h;
    ...
    public C0534a(int i3, WritableMap writableMap) {
        super(i3);
        t2.j.f(writableMap, "mEventData");
        this.f9212h = writableMap;
    }
    ...
    public void c(RCTEventEmitter rCTEventEmitter) {
        ...
        rCTEventEmitter.receiveEvent(o(), k(), this.f9212h);
    }
