...
public final class DurationKt {
    ...
    public static final double toDuration(double $this$toDuration, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m959constructorimpl(DurationUnitKt.convertDurationUnit($this$toDuration, unit, TimeUnit.NANOSECONDS));
    }
    ...
    private static final double m1004timesmvk6XK0(int $this$times, double duration) {
        return Duration.m986timesimpl(duration, $this$times);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m1003timeskIfJnKk(double $this$times, double duration) {
