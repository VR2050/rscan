...
public final class UnsignedKt {
    ...
    public static final int m348uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m122constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m349uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m122constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m350ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m191constructorimpl(ulongCompare(v1, v2) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m191constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m191constructorimpl(((long) (ulongCompare(ULong.m191constructorimpl(rem), ULong.m191constructorimpl(v2)) < 0 ? 0 : 1)) + quotient);
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m351ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (ulongCompare(ULong.m191constructorimpl(rem), ULong.m191constructorimpl(v2)) >= 0) {
            j = v2;
        }
        return ULong.m191constructorimpl(rem - j);
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= d ? UInt.m122constructorimpl((int) v) : UInt.m122constructorimpl(UInt.m122constructorimpl((int) (v - d)) + UInt.m122constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        if (!Double.isNaN(v) && v > ulongToDouble(0L)) {
            ...
            return v < ((double) Long.MAX_VALUE) ? ULong.m191constructorimpl((long) v) : ULong.m191constructorimpl(ULong.m191constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
        }
        return 0L;
    }
