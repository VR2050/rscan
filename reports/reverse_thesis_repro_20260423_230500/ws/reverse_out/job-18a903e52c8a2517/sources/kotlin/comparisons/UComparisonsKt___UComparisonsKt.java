...
public class UComparisonsKt___UComparisonsKt {
    ...
    public static final short m880maxOf5PvTz6A(short a, short b) {
        return Intrinsics.compare(a & 65535, 65535 & b) >= 0 ? a : b;
    }

    /* JADX INFO: renamed from: maxOf-WZ9TVnA, reason: not valid java name */
    private static final int m884maxOfWZ9TVnA(int a, int b, int c) {
        return UComparisonsKt.m881maxOfJ1ME1BU(a, UComparisonsKt.m881maxOfJ1ME1BU(b, c));
    }

    /* JADX INFO: renamed from: maxOf-sambcqE, reason: not valid java name */
    private static final long m887maxOfsambcqE(long a, long b, long c) {
        return UComparisonsKt.m886maxOfeb3DHEI(a, UComparisonsKt.m886maxOfeb3DHEI(b, c));
    }

    /* JADX INFO: renamed from: maxOf-b33U2AM, reason: not valid java name */
    private static final byte m885maxOfb33U2AM(byte a, byte b, byte c) {
        return UComparisonsKt.m882maxOfKr8caGY(a, UComparisonsKt.m882maxOfKr8caGY(b, c));
    }

    /* JADX INFO: renamed from: maxOf-VKSA0NQ, reason: not valid java name */
    private static final short m883maxOfVKSA0NQ(short a, short b, short c) {
        return UComparisonsKt.m880maxOf5PvTz6A(a, UComparisonsKt.m880maxOf5PvTz6A(b, c));
    }

    /* JADX INFO: renamed from: minOf-J1ME1BU, reason: not valid java name */
    public static final int m889minOfJ1ME1BU(int a, int b) {
        return UnsignedKt.uintCompare(a, b) <= 0 ? a : b;
    }

    /* JADX INFO: renamed from: minOf-eb3DHEI, reason: not valid java name */
    public static final long m894minOfeb3DHEI(long a, long b) {
        return UnsignedKt.ulongCompare(a, b) <= 0 ? a : b;
    }

    /* JADX INFO: renamed from: minOf-Kr8caGY, reason: not valid java name */
    public static final byte m890minOfKr8caGY(byte a, byte b) {
        return Intrinsics.compare(a & UByte.MAX_VALUE, b & UByte.MAX_VALUE) <= 0 ? a : b;
    }

    /* JADX INFO: renamed from: minOf-5PvTz6A, reason: not valid java name */
    public static final short m888minOf5PvTz6A(short a, short b) {
        return Intrinsics.compare(a & 65535, 65535 & b) <= 0 ? a : b;
    }

    /* JADX INFO: renamed from: minOf-WZ9TVnA, reason: not valid java name */
    private static final int m892minOfWZ9TVnA(int a, int b, int c) {
        return UComparisonsKt.m889minOfJ1ME1BU(a, UComparisonsKt.m889minOfJ1ME1BU(b, c));
    }

    /* JADX INFO: renamed from: minOf-sambcqE, reason: not valid java name */
    private static final long m895minOfsambcqE(long a, long b, long c) {
        return UComparisonsKt.m894minOfeb3DHEI(a, UComparisonsKt.m894minOfeb3DHEI(b, c));
    }

    /* JADX INFO: renamed from: minOf-b33U2AM, reason: not valid java name */
    private static final byte m893minOfb33U2AM(byte a, byte b, byte c) {
        return UComparisonsKt.m890minOfKr8caGY(a, UComparisonsKt.m890minOfKr8caGY(b, c));
    }

    /* JADX INFO: renamed from: minOf-VKSA0NQ, reason: not valid java name */
    private static final short m891minOfVKSA0NQ(short a, short b, short c) {
        return UComparisonsKt.m888minOf5PvTz6A(a, UComparisonsKt.m888minOf5PvTz6A(b, c));
    }
}
