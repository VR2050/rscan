...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Removed duplicated region for block: B:45:0x00fc A[ORIG_RETURN, RETURN] */
    ...
    */
    ...
    private void startHttp2(int pingIntervalMillis) throws IOException {
        ...
        Http2Connection http2ConnectionBuild = new Http2Connection.Builder(true).socket(this.socket, this.route.address().url().host(), this.source, this.sink).listener(this).pingIntervalMillis(pingIntervalMillis).build();
