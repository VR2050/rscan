...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    */
    ...
    private Request followUpRequest(Response userResponse, Route route) throws IOException {
        ...
        if (!this.client.followRedirects() || (location = userResponse.header(AgentWebPermissions.ACTION_LOCATION)) == null || (url = userResponse.request().url().resolve(location)) == null) {
            return null;
        }
