...
public class ViewUtil {
    ...
    public static boolean refreshHeight(View view, int aimHeight) {
        ...
        Log.d(TAG, String.format("refresh Height %d %d", Integer.valueOf(view.getHeight()), Integer.valueOf(aimHeight)));
    ...
    public static boolean isTranslucentStatus(Activity activity) {
        return Build.VERSION.SDK_INT >= 19 && (activity.getWindow().getAttributes().flags & ConnectionsManager.FileTypeFile) != 0;
    }
