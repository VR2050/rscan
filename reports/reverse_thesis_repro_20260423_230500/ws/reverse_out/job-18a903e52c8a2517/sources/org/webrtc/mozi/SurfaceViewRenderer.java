...
public class SurfaceViewRenderer extends SurfaceView implements SurfaceHolder.Callback, VideoSink, RendererCommon.RendererEvents {
    ...
    public SurfaceViewRenderer(Context context) {
        ...
        this.eglRenderer = createEglRender(resourceName);
    ...
    protected SurfaceEglRenderer createEglRender(String resourceName) {
        return new SurfaceEglRenderer(resourceName);
    }
    ...
    public void onFrameResolutionChanged(int videoWidth, int videoHeight, int rotation) {
        ...
        postOrRun(SurfaceViewRenderer$$Lambda$1.lambdaFactory$(this, rotatedWidth, rotatedHeight));
    }

    static /* synthetic */ void lambda$onFrameResolutionChanged$0(SurfaceViewRenderer surfaceViewRenderer, int i, int i2) {
