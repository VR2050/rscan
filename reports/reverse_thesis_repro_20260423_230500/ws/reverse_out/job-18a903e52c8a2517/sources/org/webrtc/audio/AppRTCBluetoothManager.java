...
public class AppRTCBluetoothManager {
    ...
    private final Runnable bluetoothTimeoutRunnable = new Runnable() { // from class: org.webrtc.audio.AppRTCBluetoothManager.1
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals("android.bluetooth.headset.profile.action.CONNECTION_STATE_CHANGED")) {
                ...
                if (state == 2) {
                    ...
                    AppRTCBluetoothManager.this.mHandler.postDelayed(new Runnable() { // from class: org.webrtc.audio.AppRTCBluetoothManager.BluetoothHeadsetBroadcastReceiver.1
                        @Override // java.lang.Runnable
                        public void run() {
                            AppRTCBluetoothManager.this.updateAudioDeviceState();
                        }
