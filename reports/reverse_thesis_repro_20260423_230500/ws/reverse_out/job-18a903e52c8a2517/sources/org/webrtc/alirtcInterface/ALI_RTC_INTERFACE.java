...
public abstract class ALI_RTC_INTERFACE {
    ...
    public enum AliRTCSdk_VideSource_Type {
        ...
        AliRTCSdk_VideSource_Type(int videoSourceType) {
    ...
    public enum AliRTCImageFormat {
        ...
        AliRTCImageFormat(int imageFormat) {
        ...
        public static AliRTCImageFormat GetAliRTCImageFormat(int format) {
            for (AliRTCImageFormat imageFormat : values()) {
                if (imageFormat.getValue() == format) {
                    return imageFormat;
                }
            }
    ...
    public enum AliRTCSDKLogLevel {
        ...
        AliRTCSDKLogLevel(int logLevel) {
    ...
    public enum TransportStatus {
        ...
        public static TransportStatus fromNativeIndex(int i) {
            try {
                TransportStatus ret = values()[i];
                return ret;
            } catch (Exception e) {
                TransportStatus ret2 = Network_Unknow;
                return ret2;
            }
        }
    }
    ...
    public enum Ali_RTC_Device_Orientation_Mode {
        ...
        Ali_RTC_Device_Orientation_270(JavaScreenCapturer.DEGREE_270),
        Ali_RTC_Device_Orientation_Adaptive(1000);

        private int mode;

        Ali_RTC_Device_Orientation_Mode(int mode) {
            this.mode = mode;
        }
    ...
    public enum TransportType {
        ...
        TransportType(int transportTyoe) {
            this.transportTyoe = transportTyoe;
        }
        ...
        public static TransportType fromNativeIndex(int i) {
            if (i == 0) {
                TransportType ret = Transport_Video_TYPE;
                return ret;
            }
            if (i == 1) {
                TransportType ret2 = Transport_Audio_TYPE;
                return ret2;
            }
            if (i != 2) {
                return null;
            }
            TransportType ret3 = Transport_Mix_TYPE;
            return ret3;
        }
    }
    ...
    public enum AliRTCMediaConnectionReConnectState {
        ...
        AliRTCMediaConnectionReConnectState(int state) {
            this.state = state;
        }
        ...
        public static AliRTCMediaConnectionReConnectState fromNativeIndex(int i) {
            try {
                AliRTCMediaConnectionReConnectState ret = values()[i];
                return ret;
            } catch (Exception e) {
                return null;
            }
    ...
    public enum AliCaptureType {
        ...
        AliCaptureType(int captureType) {
    ...
    public static class AliRtcStats {
        ...
        public void setSystem_cpu_usage(float system_cpu_usage) {
    ...
    public enum AliRTCSDK_Channel_Profile {
        ...
        AliRTCSDK_Channel_Profile(int val) {
            this.val = val;
        }
        ...
        public static AliRTCSDK_Channel_Profile fromNativeIndex(int index) {
            try {
                AliRTCSDK_Channel_Profile ret = values()[index];
                return ret;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
    ...
    public enum AliRTCSDK_Client_Role {
        ...
        public static AliRTCSDK_Client_Role fromNativeIndex(int index) {
            try {
                AliRTCSDK_Client_Role ret = values()[index];
                return ret;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
