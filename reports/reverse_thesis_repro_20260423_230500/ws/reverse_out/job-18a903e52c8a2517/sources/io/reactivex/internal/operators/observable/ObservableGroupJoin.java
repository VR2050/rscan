        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (z2) {
                    ...
                    if (num == LEFT_VALUE) {
                        UnicastSubject<TRight> unicastSubjectCreate = UnicastSubject.create();
                        ...
                        try {
                            ...
                            if (this.error.get() == null) {
                                try {
                                    Object obj = (Object) ObjectHelper.requireNonNull(this.resultSelector.apply(objPoll, unicastSubjectCreate), "The resultSelector returned a null value");
                                    observer.onNext(obj);
