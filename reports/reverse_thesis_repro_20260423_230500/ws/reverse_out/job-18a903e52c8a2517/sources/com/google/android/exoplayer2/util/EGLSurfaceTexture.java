...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public void init(int secureMode) {
        ...
        EGLContext eGLContextCreateEGLContext = createEGLContext(this.display, config, secureMode);
        this.context = eGLContextCreateEGLContext;
        this.surface = createEGLSurface(this.display, config, eGLContextCreateEGLContext, secureMode);
