...
public final class HlsPlaylistParser implements ParsingLoadable.Parser<HlsPlaylist> {
    ...
    */
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMasterPlaylist masterPlaylist, LineIterator iterator, String baseUri) throws IOException {
        ...
        int version = 1;
        long segmentDurationUs = C.TIME_UNSET;
        ...
        String segmentTitle = "";
        long segmentDurationUs2 = 0;
        String segmentTitle2 = null;
        ...
        while (true) {
            ...
            if (line.startsWith(TAG_PLAYLIST_TYPE)) {
                ...
                if (line.startsWith(TAG_START)) {
                    long targetDurationUs = segmentDurationUs;
                    ...
                    long targetDurationUs2 = segmentDurationUs;
                    if (line.startsWith(TAG_INIT_SEGMENT)) {
                        ...
                        hasEndTag2 = hasEndTag;
                        hasIndependentSegmentsTag = hasIndependentSegmentsTag2;
                        segmentDurationUs = targetDurationUs2;
                    } else if (line.startsWith(TAG_TARGET_DURATION)) {
                        segmentDurationUs = ((long) parseIntAttr(line, REGEX_TARGET_DURATION)) * 1000000;
                        tags = tags3;
                        hasEndTag2 = hasEndTag;
                        hasIndependentSegmentsTag = hasIndependentSegmentsTag2;
                        ...
                        if (line.startsWith(TAG_DEFINE)) {
                            ...
                            long segmentDurationUs3 = (long) (parseDoubleAttr(line, REGEX_MEDIA_DURATION) * 1000000.0d);
                            segmentTitle = parseOptionalStringAttr(line, REGEX_MEDIA_TITLE, "", variableDefinitions);
                            segmentDurationUs2 = segmentDurationUs3;
                            tags = tags3;
                            hasEndTag2 = hasEndTag;
                            hasIndependentSegmentsTag = hasIndependentSegmentsTag2;
                            segmentDurationUs = targetDurationUs2;
                            ...
                            if (METHOD_NONE.equals(method)) {
                                ...
                                if (KEYFORMAT_IDENTITY.equals(keyFormat)) {
                                    ...
                                    if (segmentTitle2 == null) {
                                        segmentTitle2 = (METHOD_SAMPLE_AES_CENC.equals(method) || METHOD_SAMPLE_AES_CTR.equals(method)) ? C.CENC_TYPE_cenc : C.CENC_TYPE_cbcs;
                                    }
                            ...
                            if (line.startsWith(TAG_BYTERANGE)) {
                                ...
                                if (cachedDrmInitData2 != null || currentSchemeDatas3.isEmpty()) {
                                    ...
                                    DrmInitData cachedDrmInitData3 = new DrmInitData(segmentTitle2, schemeDatas);
                                    if (playlistProtectionSchemes != null) {
                                        ...
                                        playlistProtectionSchemes = new DrmInitData(segmentTitle2, playlistSchemeDatas);
                                        cachedDrmInitData2 = cachedDrmInitData;
                                    }
                                }
                                segments.add(new HlsMediaPlaylist.Segment(replaceVariableReferences(line, variableDefinitions), initializationSegment, segmentTitle, segmentDurationUs2, relativeDiscontinuitySequence, segmentStartTimeUs, cachedDrmInitData2, encryptionKeyUri, segmentEncryptionIV, segmentByteRangeOffset, segmentByteRangeLength, hasGapTag));
                                segmentStartTimeUs += segmentDurationUs2;
                                segmentDurationUs2 = 0;
                                segmentTitle = "";
                                if (segmentByteRangeLength != -1) {
        ...
        long targetDurationUs3 = segmentDurationUs;
        return new HlsMediaPlaylist(playlistType, baseUri, tags, startOffsetUs, playlistStartTimeUs, hasDiscontinuitySequence, playlistDiscontinuitySequence, mediaSequence, version, targetDurationUs3, hasIndependentSegmentsTag, hasEndTag, playlistStartTimeUs != 0, playlistProtectionSchemes, segments);
    }
    ...
    private static DrmInitData.SchemeData parsePlayReadySchemeData(String line, Map<String, String> variableDefinitions) throws ParserException {
        ...
        byte[] data = Base64.decode(uriString.substring(uriString.indexOf(44)), 0);
