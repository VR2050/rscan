...
public final class DashDownloader extends SegmentDownloader<DashManifest> {
    ...
    private static void addSegmentsForAdaptationSet(DataSource dataSource, AdaptationSet adaptationSet, long periodStartUs, long periodDurationUs, boolean allowIncompleteList, ArrayList<SegmentDownloader.Segment> out) throws InterruptedException, IOException {
    ...
    private static DashSegmentIndex getSegmentIndex(DataSource dataSource, int trackType, Representation representation) throws InterruptedException, IOException {
