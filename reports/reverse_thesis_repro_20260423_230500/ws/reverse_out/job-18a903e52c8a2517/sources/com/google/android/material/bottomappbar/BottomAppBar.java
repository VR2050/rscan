...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public BottomAppBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(appBarModel);
    ...
    private void maybeAnimateModeChange(int targetMode) {
        ...
        set.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.1
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    public void maybeAnimateMenuView(int targetMode, boolean newFabAttached) {
        ...
        set.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
    ...
    public void maybeAnimateAttachChange(boolean targetAttached) {
        ...
        set.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.5
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animation) {
