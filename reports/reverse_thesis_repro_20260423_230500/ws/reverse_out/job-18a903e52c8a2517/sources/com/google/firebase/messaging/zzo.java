...
public final class zzo {
    ...
    private static void zza(String str, Intent intent) {
        ...
        if (stringExtra2 != null) {
            bundle.putString("_nmid", stringExtra2);
        }
        String stringExtra3 = intent.getStringExtra("google.c.a.c_l");
        if (stringExtra3 != null) {
            bundle.putString("_nmn", stringExtra3);
        }
        ...
        if (!TextUtils.isEmpty(stringExtra5)) {
            bundle.putString("message_channel", stringExtra5);
        }
        ...
        if (intent.hasExtra("google.c.a.udt")) {
            stringExtra = intent.getStringExtra("google.c.a.udt");
        } else {
            stringExtra = null;
        }
        if (stringExtra != null) {
            try {
                bundle.putInt("_ndt", Integer.parseInt(stringExtra));
    ...
    static String zzd() {
        ...
        String[] strArrSplit = applicationId.split(LogUtils.COLON);
