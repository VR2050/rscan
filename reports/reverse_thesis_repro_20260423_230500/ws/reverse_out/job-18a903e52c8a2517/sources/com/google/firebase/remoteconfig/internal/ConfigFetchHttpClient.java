...
public class ConfigFetchHttpClient {
    ...
    ConfigFetchHandler.FetchResponse fetch(HttpURLConnection urlConnection, String instanceId, String instanceIdToken, Map<String, String> analyticsUserProperties, String lastFetchETag, Map<String, String> customHeaders, Date currentTime) throws FirebaseRemoteConfigException {
        setUpUrlConnection(urlConnection, lastFetchETag, customHeaders);
        try {
            try {
                byte[] requestBody = createFetchRequestBody(instanceId, instanceIdToken, analyticsUserProperties).toString().getBytes("utf-8");
                ...
                String fetchResponseETag = urlConnection.getHeaderField("ETag");
    ...
    private void setUpUrlConnection(HttpURLConnection urlConnection, String lastFetchEtag, Map<String, String> customHeaders) {
        ...
        urlConnection.setRequestProperty("If-None-Match", lastFetchEtag);
    ...
    private static ConfigContainer extractConfigs(JSONObject fetchResponse, Date fetchTime) throws JSONException, FirebaseRemoteConfigClientException {
        try {
