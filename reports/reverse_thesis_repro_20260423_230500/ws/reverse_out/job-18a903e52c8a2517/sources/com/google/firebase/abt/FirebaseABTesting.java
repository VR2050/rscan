...
public class FirebaseABTesting {
    ...
    public FirebaseABTesting(Context unusedAppContext, AnalyticsConnector analyticsConnector, String originService) {
    ...
    private AnalyticsConnector.ConditionalUserProperty createConditionalUserProperty(AbtExperimentInfo experimentInfo) {
        ...
        if (TextUtils.isEmpty(experimentInfo.getTriggerEventName())) {
            ...
            triggerEventName = experimentInfo.getTriggerEventName();
        }
        conditionalUserProperty.triggerEventName = triggerEventName;
    ...
    void removeExperimentFromAnalytics(String experimentId) {
        this.analyticsConnector.clearConditionalUserProperty(experimentId, null, null);
    }
