...
public class GooglePlayServicesUtilLight {
    ...
    public static boolean isRestrictedUserProfile(Context context) {
        ...
        if (PlatformVersion.isAtLeastJellyBeanMR2() && (applicationRestrictions = ((UserManager) context.getSystemService(AudioDeviceSwitcher.AUDIO_DEVICE_SWITCH_SOURCE_USER)).getApplicationRestrictions(context.getPackageName())) != null && "true".equals(applicationRestrictions.getString("restricted_profile"))) {
            return true;
        }
        return false;
    }
