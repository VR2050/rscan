...
public final class Phenotype {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [com.google.android.gms.internal.phenotype.zzd, com.google.android.gms.phenotype.zzm] */
    static {
        zzl zzlVar = new zzl();
        CLIENT_BUILDER = zzlVar;
        API = new Api<>("Phenotype.API", zzlVar, CLIENT_KEY);
