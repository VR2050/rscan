    ...
    private static class SmoothStreamingMediaParser extends ElementParser {
        ...
        public Object build() {
            ...
            if (protectionElement != null) {
                DrmInitData.SchemeData schemeData = new DrmInitData.SchemeData(protectionElement.uuid, MimeTypes.VIDEO_MP4, this.protectionElement.data);
    ...
    private static class QualityLevelParser extends ElementParser {
        ...
        public void parseStartTag(XmlPullParser parser) throws ParserException {
            ...
            if (type == 2) {
                ...
                this.format = Format.createVideoContainerFormat(id, name, MimeTypes.VIDEO_MP4, sampleMimeType, null, bitrate, width, height, -1.0f, buildCodecSpecificData(parser.getAttributeValue(null, KEY_CODEC_PRIVATE_DATA)), 0);
                return;
            }
            if (type != 1) {
                if (type != 3) {
                    ...
                    this.format = Format.createTextContainerFormat(id, name, MimeTypes.APPLICATION_MP4, sampleMimeType, null, bitrate, 0, language);
                    return;
                }
            }
            ...
            this.format = Format.createAudioContainerFormat(id, name, MimeTypes.AUDIO_MP4, sampleMimeType2, null, bitrate, channels, samplingRate, codecSpecificData, 0, language2);
        }
