...
public class FileCache implements Cache {
    ...
    public synchronized int read(byte[] buffer, long offset, int length) throws ProxyCacheException {
        try {
            ...
            throw new ProxyCacheException(String.format("Error reading %d bytes with offset %d from file[%d bytes] to buffer[%d bytes]", Integer.valueOf(length), Long.valueOf(offset), Long.valueOf(available()), Integer.valueOf(buffer.length)), e);
        }
