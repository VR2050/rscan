...
public class XMLSubtitleSampleEntry extends AbstractSampleEntry {
    ...
    public long getSize() {
        ...
        return s + t + ((long) ((this.largeBox || (s + t) + 8 >= 4294967296L) ? 16 : 8));
    }
    ...
    public void parse(DataSource dataSource, ByteBuffer header, long contentSize, BoxParser boxParser) throws IOException {
        ...
        String string = IsoTypeReader.readString((ByteBuffer) content.rewind());
        this.namespace = string;
        dataSource.position(((long) string.length()) + start + 1);
        dataSource.read((ByteBuffer) content.rewind());
