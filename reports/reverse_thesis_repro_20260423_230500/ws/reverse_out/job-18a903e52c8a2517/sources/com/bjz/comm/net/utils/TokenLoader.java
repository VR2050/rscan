...
public class TokenLoader {
    ...
    private TokenLoader() {
        ...
        this.mTokenObservable = Observable.create(new ObservableOnSubscribe() { // from class: com.bjz.comm.net.utils.-$$Lambda$TokenLoader$XuXb2hd7gTRKNPKG0MG8keR3jhs
            @Override // io.reactivex.ObservableOnSubscribe
            public final void subscribe(ObservableEmitter observableEmitter) throws Exception {
                this.f$0.lambda$new$0$TokenLoader(observableEmitter);
            }
        }).doOnNext(new Consumer() { // from class: com.bjz.comm.net.utils.-$$Lambda$TokenLoader$Tn-bL4evdANTsmds_gf9tEbMrFU
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) throws Exception {
                this.f$0.lambda$new$1$TokenLoader((String) obj);
            }
        }).doOnError(new Consumer() { // from class: com.bjz.comm.net.utils.-$$Lambda$TokenLoader$mWi2QK4WdmlLaShjrdx2VvnylAE
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) throws Exception {
                this.f$0.lambda$new$2$TokenLoader((Throwable) obj);
            }
    ...
    private void startTokenRequest() {
        ...
        this.mPublishSubject = publishSubjectCreate;
        this.mTokenObservable.subscribe(publishSubjectCreate);
    }

    public void setCallBack(GetHttpTokenCallBack callBack) {
