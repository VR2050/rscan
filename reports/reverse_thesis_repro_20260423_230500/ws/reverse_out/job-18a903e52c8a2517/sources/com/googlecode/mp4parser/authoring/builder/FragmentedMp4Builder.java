...
public class FragmentedMp4Builder implements Mp4Builder {
    ...
    protected void createTraf(long startSample, long endSample, Track track, int sequenceNumber, MovieFragmentBox movieFragmentBox) {
                        ...
                        while (true) {
                            ...
                            while (k2 < trun.getEntries().size()) {
                                ...
                                if (k2 == 0 && trun.isFirstSampleFlagsPresent()) {
                                    SampleFlags sf2 = trun.getFirstSampleFlags();
                                    sf = sf2;
                                } else if (trun.isSampleFlagsPresent()) {
                                    SampleFlags sf3 = trunEntry2.getSampleFlags();
                                    sf = sf3;
                                } else {
                                    SampleFlags sf4 = trex3.getDefaultSampleFlags();
                                    sf = sf4;
                                }
                                if (sf == null) {
