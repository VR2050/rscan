...
public class StripeApiHandler {
    ...
    public static Token createToken(Map<String, Object> cardParams, RequestOptions options) throws CardException, APIConnectionException, AuthenticationException, InvalidRequestException, APIException {
        return requestToken(POST, getApiUrl(), cardParams, options);
    }

    public static Token retrieveToken(RequestOptions options, String tokenId) throws APIConnectionException, AuthenticationException, InvalidRequestException, APIException {
        try {
    ...
    static String createQuery(Map<String, Object> params) throws InvalidRequestException, UnsupportedEncodingException {
    ...
    private static Token requestToken(String method, String url, Map<String, Object> params, RequestOptions options) throws CardException, APIConnectionException, AuthenticationException, InvalidRequestException, APIException {
        if (options == null) {
            return null;
        }
    ...
    private static StripeResponse getStripeResponse(String method, String url, Map<String, Object> params, RequestOptions options) throws APIConnectionException, InvalidRequestException, APIException {
        try {
    ...
    private static void handleAPIError(String rBody, int rCode, String requestId) throws CardException, AuthenticationException, InvalidRequestException, APIException {
    ...
    */
    private static com.stripe.android.net.StripeResponse makeURLConnectionRequest(java.lang.String r8, java.lang.String r9, java.lang.String r10, com.stripe.android.net.RequestOptions r11) throws com.stripe.android.exception.APIConnectionException {
        /*
            ...
            r2 = 0
            r3 = 1
            int r4 = r8.hashCode()     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
        ...
        L13:
            ...
            boolean r4 = r8.equals(r4)     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            if (r4 == 0) goto L12
            r1 = 1
            goto L26
        L1d:
        ...
        L26:
            if (r1 == 0) goto L40
            if (r1 != r3) goto L30
            java.net.HttpURLConnection r1 = createPostConnection(r9, r10, r11)     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            r0 = r1
            goto L46
        L30:
            com.stripe.android.exception.APIConnectionException r1 = new com.stripe.android.exception.APIConnectionException     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            ...
            java.lang.Object[] r5 = new java.lang.Object[r3]     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            r5[r2] = r8     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            java.lang.String r4 = java.lang.String.format(r4, r5)     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            r1.<init>(r4)     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            throw r1     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
        L40:
            java.net.HttpURLConnection r1 = createGetConnection(r9, r10, r11)     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            r0 = r1
        L46:
            int r1 = r0.getResponseCode()     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            r4 = 200(0xc8, float:2.8E-43)
            if (r1 < r4) goto L5b
            r4 = 300(0x12c, float:4.2E-43)
            if (r1 >= r4) goto L5b
            java.io.InputStream r4 = r0.getInputStream()     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            java.lang.String r4 = getResponseBody(r4)     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            goto L63
        L5b:
            java.io.InputStream r4 = r0.getErrorStream()     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            java.lang.String r4 = getResponseBody(r4)     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
        L63:
            java.util.Map r5 = r0.getHeaderFields()     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            com.stripe.android.net.StripeResponse r6 = new com.stripe.android.net.StripeResponse     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            r6.<init>(r1, r4, r5)     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L74
            if (r0 == 0) goto L71
            r0.disconnect()
        L71:
            return r6
        ...
        L74:
            r1 = move-exception
            com.stripe.android.exception.APIConnectionException r4 = new com.stripe.android.exception.APIConnectionException     // Catch: java.lang.Throwable -> L72
            ...
            java.lang.String r7 = getApiUrl()     // Catch: java.lang.Throwable -> L72
            r6[r2] = r7     // Catch: java.lang.Throwable -> L72
            java.lang.String r2 = r1.getMessage()     // Catch: java.lang.Throwable -> L72
            r6[r3] = r2     // Catch: java.lang.Throwable -> L72
            java.lang.String r2 = java.lang.String.format(r5, r6)     // Catch: java.lang.Throwable -> L72
