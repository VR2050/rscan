...
public abstract class BaseDecoration extends RecyclerView.ItemDecoration {
    ...
    private GestureDetector.OnGestureListener gestureListener = new GestureDetector.OnGestureListener() { // from class: com.library.BaseDecoration.3
    ...
    public void resetSpan(RecyclerView recyclerView, GridLayoutManager gridLayoutManager) {
        ...
        GridLayoutManager.SpanSizeLookup lookup = new GridLayoutManager.SpanSizeLookup() { // from class: com.library.BaseDecoration.1
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        if (this.gestureDetector == null) {
            ...
            parent.setOnTouchListener(new View.OnTouchListener() { // from class: com.library.BaseDecoration.2
