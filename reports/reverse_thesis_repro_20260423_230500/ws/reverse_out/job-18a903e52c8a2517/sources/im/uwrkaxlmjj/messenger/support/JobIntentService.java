...
public abstract class JobIntentService extends Service {
    ...
    static final class CompatWorkEnqueuer extends WorkEnqueuer {
        ...
        CompatWorkEnqueuer(Context context, ComponentName cn2) {
            ...
            PowerManager.WakeLock wakeLockNewWakeLock = pm.newWakeLock(1, cn2.getClassName() + ":launch");
            this.mLaunchWakeLock = wakeLockNewWakeLock;
            wakeLockNewWakeLock.setReferenceCounted(false);
            PowerManager.WakeLock wakeLockNewWakeLock2 = pm.newWakeLock(1, cn2.getClassName() + ":run");
            this.mRunWakeLock = wakeLockNewWakeLock2;
            wakeLockNewWakeLock2.setReferenceCounted(false);
        }

        @Override // im.uwrkaxlmjj.messenger.support.JobIntentService.WorkEnqueuer
    ...
    static final class JobServiceEngineImpl extends JobServiceEngine implements CompatJobEngine {
        ...
        final class WrapperWorkItem implements GenericWorkItem {
            ...
            @Override // im.uwrkaxlmjj.messenger.support.JobIntentService.GenericWorkItem
        ...
        @Override // im.uwrkaxlmjj.messenger.support.JobIntentService.CompatJobEngine
