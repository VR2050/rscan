...
public class AddContactsInfoActivity extends BaseFragment implements View.OnClickListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$null$2$AddContactsInfoActivity(final XAlertDialog progressDialog, final int applyId, TLObject response, TLRPC.TL_error error) {
        if (error != null) {
    ...
    public /* synthetic */ void lambda$null$8$AddContactsInfoActivity(TLRPC.TL_error error, final XAlertDialog progressDialog, TLObject response) {
