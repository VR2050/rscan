...
public class ZoomControlView extends View {
    ...
    public ZoomControlView(Context context) {
        super(context);
        this.ZOOM_PROPERTY = new AnimationProperties.FloatProperty<ZoomControlView>("clipProgress") { // from class: im.uwrkaxlmjj.ui.components.ZoomControlView.1
            ...
            if (x >= knobX - AndroidUtilities.dp(20.0f) && x <= AndroidUtilities.dp(20.0f) + knobX && y >= knobY - AndroidUtilities.dp(25.0f) && y <= AndroidUtilities.dp(25.0f) + knobY) {
                ...
                if (x >= this.progressStartX && x <= this.progressEndX) {
                    if (action == 0) {
                        ...
                        float f2 = (x - this.progressStartX) / (this.progressEndX - r6);
                        this.zoom = f2;
                ...
                if (action == 1) {
                    ...
                    float f3 = (y - this.progressStartY) / (this.progressEndY - r6);
                    this.zoom = f3;
    ...
    private boolean animateToZoom(float zoom) {
        ...
        this.animatorSet.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.ZoomControlView.2
