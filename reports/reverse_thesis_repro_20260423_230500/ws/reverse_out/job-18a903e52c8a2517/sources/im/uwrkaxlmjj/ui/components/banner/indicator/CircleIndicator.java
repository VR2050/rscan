...
public class CircleIndicator extends BaseIndicator {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = (int) (((count - 1) * this.config.getIndicatorSpace()) + this.config.getSelectedWidth() + (this.config.getNormalWidth() * (count - 1)));
        setMeasuredDimension(width, (int) Math.max(this.config.getNormalWidth(), this.config.getSelectedWidth()));
    }
