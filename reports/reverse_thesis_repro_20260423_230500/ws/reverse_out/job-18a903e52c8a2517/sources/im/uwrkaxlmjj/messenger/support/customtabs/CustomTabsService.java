...
public abstract class CustomTabsService extends Service {
    ...
    private ICustomTabsService.Stub mBinder = new ICustomTabsService.Stub() { // from class: im.uwrkaxlmjj.messenger.support.customtabs.CustomTabsService.1
        ...
        public boolean newSession(ICustomTabsCallback callback) {
            ...
            try {
                IBinder.DeathRecipient deathRecipient = new IBinder.DeathRecipient() { // from class: im.uwrkaxlmjj.messenger.support.customtabs.CustomTabsService.1.1
