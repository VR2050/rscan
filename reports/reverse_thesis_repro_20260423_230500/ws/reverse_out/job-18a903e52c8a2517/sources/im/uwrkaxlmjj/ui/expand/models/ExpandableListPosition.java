...
public class ExpandableListPosition {
    ...
    public boolean equals(Object o) {
        ...
        return this.groupPos == that.groupPos && this.childPos == that.childPos && this.flatListPos == that.flatListPos && this.type == that.type;
    }

    public int hashCode() {
        int result = this.groupPos;
        return (((((result * 31) + this.childPos) * 31) + this.flatListPos) * 31) + this.type;
    }
