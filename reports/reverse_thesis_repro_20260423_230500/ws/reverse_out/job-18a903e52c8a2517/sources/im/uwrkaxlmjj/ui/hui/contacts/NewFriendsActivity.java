...
public class NewFriendsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    class ListAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public /* synthetic */ void lambda$null$4$NewFriendsActivity$ListAdapter(TLRPC.TL_error error, final XAlertDialog progressDialog, TLObject response, TLRPCContacts.ContactApplyInfo info) {
            if (error != null) {
