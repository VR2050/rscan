...
public class PayPasswordDialog extends BottomSheetDialog {
    ...
    private void init(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_pay_password, (ViewGroup) null);
        setContentView(view);
        setCancelable(false);
        Window window = getWindow();
        window.findViewById(R.attr.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
    ...
    private void initView(Window window) {
        ImageView imageView = (ImageView) window.findViewById(R.attr.iv_back);
        this.mIvBack = imageView;
        imageView.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.dialogs.-$$Lambda$PayPasswordDialog$quMKOjujGyghv0TMAX9uq1PTviI
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$initView$0$PayPasswordDialog(view);
            }
        });
        TextView tvTitle = (TextView) window.findViewById(R.attr.tv_title);
        tvTitle.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        TextView textView = (TextView) window.findViewById(R.attr.tv_forgot_password);
        this.mTvForgotPassword = textView;
        textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        this.mTvForgotPassword.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.dialogs.-$$Lambda$PayPasswordDialog$yvPUwUA-mbVB_scx9_cDXmNfepY
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$initView$1$PayPasswordDialog(view);
            }
        });
        this.mTvPasswords[0] = (TextView) window.findViewById(R.attr.tv_password_1);
        this.mTvPasswords[1] = (TextView) window.findViewById(R.attr.tv_password_2);
        this.mTvPasswords[2] = (TextView) window.findViewById(R.attr.tv_password_3);
        this.mTvPasswords[3] = (TextView) window.findViewById(R.attr.tv_password_4);
        this.mTvPasswords[4] = (TextView) window.findViewById(R.attr.tv_password_5);
        this.mTvPasswords[5] = (TextView) window.findViewById(R.attr.tv_password_6);
        GridView gridView = (GridView) window.findViewById(R.attr.gv_btn);
        this.mGvBtn = gridView;
        gridView.setAdapter((ListAdapter) new MyAdapter());
        this.mGvBtn.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.dialogs.-$$Lambda$PayPasswordDialog$8BLKt1e_GZ7mdSTrDRQwHBBfe7o
            @Override // android.widget.AdapterView.OnItemClickListener
            public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                this.f$0.lambda$initView$2$PayPasswordDialog(adapterView, view, i, j);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$initView$2$PayPasswordDialog(AdapterView parent, View view, int position, long id) {
        ...
        if (position != 11 || this.notEmptyTvCount == 0) {
            return;
        }
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(PayPasswordDialog.this.mContext, R.layout.item_password_number, null);
                holder = PayPasswordDialog.this.new ViewHolder();
