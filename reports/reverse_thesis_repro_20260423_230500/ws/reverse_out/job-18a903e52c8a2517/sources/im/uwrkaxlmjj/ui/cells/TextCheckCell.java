...
public class TextCheckCell extends FrameLayout {
    public static final Property<TextCheckCell, Float> ANIMATION_PROGRESS = new AnimationProperties.FloatProperty<TextCheckCell>("animationProgress") { // from class: im.uwrkaxlmjj.ui.cells.TextCheckCell.1
    ...
    public void setBackgroundColorAnimated(boolean checked, int color) {
        ...
        objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.cells.TextCheckCell.2
