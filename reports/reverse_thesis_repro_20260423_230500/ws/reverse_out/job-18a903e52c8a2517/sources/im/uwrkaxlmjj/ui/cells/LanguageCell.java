...
public class LanguageCell extends FrameLayout {
    ...
    public LanguageCell(Context context, boolean dialog) {
        ...
        addView(this.textView, LayoutHelper.createFrame(-1.0f, -1.0f, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 71.0f : 23.0f, this.isDialog ? 4 : 7, LocaleController.isRTL ? 23.0f : 71.0f, 0.0f));
        ...
        addView(this.textView2, LayoutHelper.createFrame(-1.0f, -1.0f, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 71.0f : 23.0f, this.isDialog ? 25 : 29, LocaleController.isRTL ? 23.0f : 71.0f, 0.0f));
        ...
        addView(this.checkImage, LayoutHelper.createFrame(19.0f, 14.0f, (LocaleController.isRTL ? 3 : 5) | 16, 23.0f, 0.0f, 23.0f, 0.0f));
    }
