...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView {
    ...
    public ScrollSlidingTextTabStrip(Context context) {
        ...
        this.animationRunnable = new Runnable() { // from class: im.uwrkaxlmjj.ui.components.ScrollSlidingTextTabStrip.1
            ...
            public void run() {
                ...
                ScrollSlidingTextTabStrip.this.animationTime += dt / 200.0f;
        ...
        this.mIndicatorCornerRadius = fDpf2;
    ...
    public ScrollSlidingTextTabStrip(Context context, int mIndicatorStyle) {
        super(context);
        this.selectedTabId = -1;
        this.tabLineColorKey = Theme.key_actionBarTabLine;
        this.activeTextColorKey = Theme.key_actionBarTabUnactiveText;
    ...
    public void addTextTab(final int id, CharSequence text) {
        ...
        tab.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$ScrollSlidingTextTabStrip$Kd4Hed89FenqDDG2cKdyzIHKLn8
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$addTextTab$0$ScrollSlidingTextTabStrip(id, view);
            }
        });
        int tabWidth = ((int) Math.ceil(tab.getPaint().measureText(text, 0, text.length()))) + AndroidUtilities.dp(16.0f);
        this.allTextWidth += tabWidth;
        this.positionToWidth.put(position, tabWidth);
        LinearLayout.LayoutParams layoutParams = LayoutHelper.createLinear(0, -1);
        this.tabsContainer.addView(tab, layoutParams);
    }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (child == this.tabsContainer) {
            ...
            if (i == 0) {
                ...
                this.mIndicatorCornerRadius = height / 2;
