...
public class AddGroupingUserAdapter extends RecyclerListView.SectionsAdapter {
    ...
    public AddGroupingUserAdapter(Context context, int type) {
    ...
    public void sortOnlineContacts() {
        ...
        try {
            ...
            Collections.sort(this.onlineContacts, new Comparator() { // from class: im.uwrkaxlmjj.ui.hui.adapter.grouping.-$$Lambda$AddGroupingUserAdapter$le6FBkxkjLbw-e0TweV-0MPKV2w
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    return AddGroupingUserAdapter.lambda$sortOnlineContacts$0(messagesController, currentTime, (TLRPC.Contact) obj, (TLRPC.Contact) obj2);
                }
            });
            notifyDataSetChanged();
        } catch (Exception e) {
    ...
    public void onBindViewHolder(int section, int position, RecyclerView.ViewHolder holder) {
        if (holder.getItemViewType() == 0) {
            ...
            if (sparseArray != null) {
                ...
                if (this.type == 2) {
                    userCell.setShadow(this.checkedMap.indexOfKey(user.id) >= 0);
                }
            }
        }
    }
