...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    private static final FormatCache<FastDateFormat> cache = new FormatCache<FastDateFormat>() { // from class: im.uwrkaxlmjj.messenger.time.FastDateFormat.1
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // im.uwrkaxlmjj.messenger.time.FormatCache
    ...
    @Override // java.text.Format, im.uwrkaxlmjj.messenger.time.DatePrinter
    ...
    @Override // java.text.Format, im.uwrkaxlmjj.messenger.time.DateParser
