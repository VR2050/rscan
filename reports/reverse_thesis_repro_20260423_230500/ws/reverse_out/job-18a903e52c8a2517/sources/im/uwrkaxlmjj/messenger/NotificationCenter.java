...
public class NotificationCenter {
    ...
    public void postNotificationName(int id, Object... args) {
        ...
        int a2 = startAllHeavyOperations;
        if (id == a2) {
            Integer flags = (Integer) args[0];
            this.currentHeavyOperationFlags &= ~flags.intValue();
    ...
    public void postNotificationNameInternal(int id, boolean allowDuringAnimation, Object... args) {
        ...
        if (!allowDuringAnimation && this.animationInProgress) {
        ...
        if (objects != null && !objects.isEmpty()) {
            for (int a = 0; a < objects.size(); a++) {
                ...
                ((NotificationCenterDelegate) obj).didReceivedNotification(id, this.currentAccount, args);
            }
        }
