...
public class HotGroupRecommendActivity extends BaseFragment {
    ...
    public /* synthetic */ void lambda$joinChannel$6$HotGroupRecommendActivity(final AlertDialog progressDialog, final int currentAccount, final TLRPC.Chat channel, TLObject response, TLRPC.TL_error error) {
        if (error != null) {
