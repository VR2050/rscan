...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public void sortOnlineContacts(boolean notify) {
        if (this.onlineContacts != null) {
            ...
            try {
                ...
                Collections.sort(this.onlineContacts, new Comparator() { // from class: im.uwrkaxlmjj.ui.adapters.-$$Lambda$DialogsAdapter$Bet4G0sZxmCp-N7Hl879AJ8nC80
                    @Override // java.util.Comparator
                    public final int compare(Object obj, Object obj2) {
                        return DialogsAdapter.lambda$sortOnlineContacts$0(messagesController, currentTime, (TLRPC.Contact) obj, (TLRPC.Contact) obj2);
                    }
                });
                if (notify) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        switch (i) {
            case 0:
                DialogCell dialogCell = new DialogCell(this.mContext, true, false);
                dialogCell.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                loadingCell = dialogCell;
                break;
            case 1:
            ...
            case 2:
                ...
                textView.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.adapters.-$$Lambda$DialogsAdapter$jjZsM6WcTua6qe5sICQ1TGmHU8A
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f$0.lambda$onCreateViewHolder$1$DialogsAdapter(view);
                    }
                });
                loadingCell = headerCell;
                break;
            case 3:
                FrameLayout frameLayout = new FrameLayout(this.mContext) { // from class: im.uwrkaxlmjj.ui.adapters.DialogsAdapter.1
                ...
                break;
            case 4:
                loadingCell = new DialogMeUrlCell(this.mContext);
                break;
            case 5:
                loadingCell = new DialogsEmptyCell(this.mContext);
                break;
            case 6:
                loadingCell = new UserCell(this.mContext, 8, 0, false);
                break;
            case 7:
            ...
            case 9:
                ...
                break;
            default:
                loadingCell = new View(this.mContext) { // from class: im.uwrkaxlmjj.ui.adapters.DialogsAdapter.2
        ...
        loadingCell.setLayoutParams(new RecyclerView.LayoutParams(-1, i == 5 ? -1 : -2));
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
        ...
        if (itemViewType != 0) {
            ...
            if (itemViewType == 5) {
                ((DialogsEmptyCell) holder.itemView).setType(this.onlineContacts != null ? 1 : 0);
                return;
            } else {
                if (itemViewType == 6) {
        ...
        if (this.folderId == 0) {
            ...
            if (getItemCount() == 2) {
                ...
                cell2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), 0.0f, 0.0f, Theme.getColor(Theme.key_windowBackgroundWhite)));
            } else if (i == getItemCount() - 2) {
                cell2.setBackground(Theme.createRoundRectDrawable(0.0f, 0.0f, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f), Theme.getColor(Theme.key_windowBackgroundWhite)));
            }
        } else {
