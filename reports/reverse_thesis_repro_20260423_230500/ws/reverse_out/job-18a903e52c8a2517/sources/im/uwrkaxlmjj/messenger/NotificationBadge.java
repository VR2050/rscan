...
public class NotificationBadge {
    ...
    public static class AdwHomeBadger implements Badger {
        ...
        @Override // im.uwrkaxlmjj.messenger.NotificationBadge.Badger
        public void executeBadge(int badgeCount) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.AdwHomeBadger.1
    ...
    public static class ApexHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.ApexHomeBadger.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ApplicationLoader.applicationContext.sendBroadcast(intent);
                    }
    ...
    public static class AsusHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.AsusHomeBadger.1
                    @Override // java.lang.Runnable
                    public void run() {
                        ApplicationLoader.applicationContext.sendBroadcast(intent);
                    }
    ...
    public static class DefaultBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            intent.putExtra(INTENT_EXTRA_PACKAGENAME, NotificationBadge.componentName.getPackageName());
            intent.putExtra(INTENT_EXTRA_ACTIVITY_NAME, NotificationBadge.componentName.getClassName());
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.DefaultBadger.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
                        ApplicationLoader.applicationContext.sendBroadcast(intent);
    ...
    public static class HuaweiHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.HuaweiHomeBadger.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
    ...
    public static class NewHtcHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent1) || NotificationBadge.canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.NewHtcHomeBadger.1
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    public static class SonyHomeBadger implements Badger {
        ...
        private static void executeBadgeByBroadcast(int badgeCount) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.SonyHomeBadger.1
                @Override // java.lang.Runnable
                public void run() {
                    ApplicationLoader.applicationContext.sendBroadcast(intent);
                }
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            ...
            if (mQueryHandler == null) {
                mQueryHandler = new AsyncQueryHandler(ApplicationLoader.applicationContext.getApplicationContext().getContentResolver()) { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.SonyHomeBadger.2
        ...
        public void executeBadge(int badgeCount) {
            try {
                ...
                if (NotificationBadge.canResolveBroadcast(localIntent)) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.XiaomiHomeBadger.1
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public static class ZukHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.messenger.NotificationBadge.ZukHomeBadger.1
                @Override // java.lang.Runnable
                public void run() {
                    try {
