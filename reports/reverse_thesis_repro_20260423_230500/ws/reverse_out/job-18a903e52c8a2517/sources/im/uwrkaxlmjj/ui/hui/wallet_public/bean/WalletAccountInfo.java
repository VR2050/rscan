...
public class WalletAccountInfo {
    ...
    public void setIsSetPayWord(String isSetPayWord) {
    ...
    public int getAuthNormalStatus() {
        ...
        int state = Integer.valueOf(this.basicsStatus).intValue();
        return state;
    }
    ...
    public int getAuthVipStatus() {
        ...
        int state = Integer.valueOf(this.seniorStatus).intValue();
        return state;
    }
    ...
    public int getBindBankStatus() {
        ...
        int state = Integer.valueOf(this.bindBankStatus).intValue();
        return state;
    }
