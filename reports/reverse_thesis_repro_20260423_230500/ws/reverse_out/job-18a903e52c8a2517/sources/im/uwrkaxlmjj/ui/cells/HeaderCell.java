...
public class HeaderCell extends FrameLayout {
    ...
    public HeaderCell(Context context, boolean dialog, int padding, int topMargin, boolean text2) {
        ...
        addView(this.textView, LayoutHelper.createFrame(-1.0f, -1.0f, (LocaleController.isRTL ? 5 : 3) | 48, padding, topMargin, padding, 0.0f));
        if (text2) {
            ...
            addView(this.textView2, LayoutHelper.createFrame(-1.0f, -1.0f, (LocaleController.isRTL ? 3 : 5) | 48, padding, 21.0f, padding, 0.0f));
        }
    }
