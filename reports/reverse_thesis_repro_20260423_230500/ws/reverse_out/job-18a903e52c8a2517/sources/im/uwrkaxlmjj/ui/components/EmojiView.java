...
public class EmojiView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface EmojiViewDelegate {
        ...
        void lambda$onGifSelected$0$ChatActivityEnterView$35(View view, Object obj, Object obj2, boolean z, int i);
        ...
        /* JADX INFO: renamed from: im.uwrkaxlmjj.ui.components.EmojiView$EmojiViewDelegate$-CC, reason: invalid class name */
    ...
    static {
        ...
        NOP = new ViewTreeObserver.OnScrollChangedListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$GdhPYCKYni7hNs3Qgz8oIn7h1a8
    ...
    class SearchField extends FrameLayout {
        ...
        public SearchField(Context context, final int type) {
            ...
            this.clearSearchImageView.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$SearchField$KZyjEAtWkADXFXPSeHCc-As79OM
                @Override // android.view.View.OnClickListener
                public final void onClick(View view4) {
                    this.f$0.lambda$new$0$EmojiView$SearchField(view4);
                }
            });
            EditTextBoldCursor editTextBoldCursor = new EditTextBoldCursor(context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.SearchField.1
            ...
            this.searchEditText.addTextChangedListener(new TextWatcher() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.SearchField.2
        ...
        public void showShadow(boolean show, boolean animated) {
            ...
            if (animated) {
                ...
                this.shadowAnimator.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.SearchField.3
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.currentEmoji != null) {
                for (int a = 0; a < 6; a++) {
                    ...
                    if (drawable != null) {
                        drawable.setBounds(x, y, EmojiView.this.emojiSize + x, EmojiView.this.emojiSize + y);
    ...
    public EmojiView(boolean needStickers, boolean needGif, Context context, boolean needSearch, TLRPC.ChatFull chatFull) {
        super(context);
        ...
        this.contentPreviewViewerDelegate = new ContentPreviewViewer.ContentPreviewViewerDelegate() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.1
            ...
            public void sendSticker(TLRPC.Document sticker, Object parent, boolean notify, int scheduleDate) {
                EmojiView.this.delegate.onStickerSelected(null, sticker, parent, notify, scheduleDate);
            }
            ...
            public void sendGif(Object gif, boolean notify, int scheduleDate) {
                if (EmojiView.this.gifGridView.getAdapter() == EmojiView.this.gifAdapter) {
                    EmojiView.this.delegate.lambda$onGifSelected$0$ChatActivityEnterView$35(null, gif, "gif", notify, scheduleDate);
                } else {
                    if (EmojiView.this.gifGridView.getAdapter() != EmojiView.this.gifSearchAdapter) {
                        return;
                    }
                    EmojiView.this.delegate.lambda$onGifSelected$0$ChatActivityEnterView$35(null, gif, EmojiView.this.gifSearchAdapter.bot, notify, scheduleDate);
                }
            }
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            this.outlineProvider = new ViewOutlineProvider() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.2
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.3
            ...
            protected void onMeasure(int widthSpec, int heightSpec) {
                ...
                try {
                    EmojiView.this.emojiLayoutManager.setSpanCount(width / AndroidUtilities.dp(AndroidUtilities.isTablet() ? 60.0f : 45.0f));
                    ...
                    if (event.getAction() == 1 || event.getAction() == 3) {
                        if (EmojiView.this.pickerViewPopup != null && EmojiView.this.pickerViewPopup.isShowing()) {
                            ...
                            if (!EmojiView.this.emojiTouchedView.isRecent) {
                                ...
                                if (color != null) {
                                    EmojiView.this.emojiTouchedView.sendEmoji(EmojiView.addColorToCode(code2, color));
                                } else {
        ...
        this.emojiLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.4
        ...
        this.emojiGridView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.5
        ...
        this.emojiGridView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.6
        ...
        this.emojiGridView.setOnItemLongClickListener(new RecyclerListView.OnItemLongClickListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.7
            ...
            */
            public boolean onItemClick(android.view.View r20, int r21) {
                ...
                */
                throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.ui.components.EmojiView.AnonymousClass7.onItemClick(android.view.View, int):boolean");
            }
        });
        ...
        if (needSearch) {
            ...
            this.emojiSearchField.searchEditText.setOnFocusChangeListener(new View.OnFocusChangeListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.8
        ...
        this.emojiTabs.setDelegate(new ScrollSlidingTabStrip.ScrollSlidingTabStripDelegate() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.9
        ...
        if (needStickers) {
            if (needGif) {
                ...
                RecyclerListView recyclerListView4 = new RecyclerListView(context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.10
                    private boolean ignoreLayout;
                ...
                ExtendedGridLayoutManager extendedGridLayoutManager = new ExtendedGridLayoutManager(context, 100) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.11
                    ...
                    protected Size getSizeForItem(int i) {
                        ...
                        if (EmojiView.this.gifGridView.getAdapter() == EmojiView.this.gifAdapter) {
                            ...
                            TLRPC.BotInlineResult result = (TLRPC.BotInlineResult) EmojiView.this.gifSearchAdapter.results.get(i);
                ...
                this.gifLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.12
                    @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
                    public int getSpanSize(int position) {
                        return (position == 0 || (EmojiView.this.gifGridView.getAdapter() == EmojiView.this.gifSearchAdapter && EmojiView.this.gifSearchAdapter.results.isEmpty())) ? EmojiView.this.gifLayoutManager.getSpanCount() : EmojiView.this.gifLayoutManager.getSpanSizeForItem(position - 1);
                    }
                });
                this.gifGridView.addItemDecoration(new RecyclerView.ItemDecoration() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.13
                    ...
                    public void getItemOffsets(android.graphics.Rect outRect, View view2, RecyclerView parent, RecyclerView.State state) {
                        ...
                        if (position != 0) {
                            ...
                            outRect.right = EmojiView.this.gifLayoutManager.isLastInRow(position + (-1)) ? 0 : AndroidUtilities.dp(2.0f);
                            return;
                        }
                        outRect.left = 0;
                        outRect.top = 0;
                ...
                this.gifGridView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.14
                    @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
                    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                        if (newState == 1) {
                ...
                this.gifGridView.setOnTouchListener(new View.OnTouchListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$Ysv3FMEIgVAM1etU9XdQkIrtfa0
                    @Override // android.view.View.OnTouchListener
                    public final boolean onTouch(View view2, MotionEvent motionEvent) {
                        return this.f$0.lambda$new$1$EmojiView(view2, motionEvent);
                    }
                });
                RecyclerListView.OnItemClickListener onItemClickListener = new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$CAmnyDaL6rSsiUfu_UfOJgsSZ9E
                    @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemClickListener
                    public final void onItemClick(View view2, int i) {
                        this.f$0.lambda$new$2$EmojiView(view2, i);
                    }
                };
            ...
            RecyclerListView recyclerListView7 = new RecyclerListView(context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.15
                boolean ignoreLayout;

                @Override // im.uwrkaxlmjj.ui.components.RecyclerListView, androidx.recyclerview.widget.RecyclerView, android.view.ViewGroup
                public boolean onInterceptTouchEvent(MotionEvent event) {
                    boolean result = ContentPreviewViewer.getInstance().onInterceptTouchEvent(event, EmojiView.this.stickersGridView, EmojiView.this.getMeasuredHeight(), EmojiView.this.contentPreviewViewerDelegate);
                    return super.onInterceptTouchEvent(event) || result;
                }
            ...
            this.stickersLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.16
                @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
                public int getSpanSize(int position) {
            ...
            this.stickersGridView.setOnTouchListener(new View.OnTouchListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$XlF0OAOlJjwgJM3yZsbLpQ65U0c
                @Override // android.view.View.OnTouchListener
                public final boolean onTouch(View view2, MotionEvent motionEvent) {
                    return this.f$0.lambda$new$3$EmojiView(view2, motionEvent);
                }
            });
            RecyclerListView.OnItemClickListener onItemClickListener2 = new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$u_oBgWGxrnl4iSGfRkLQkIKaj7Y
                @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemClickListener
                public final void onItemClick(View view2, int i) {
                    this.f$0.lambda$new$4$EmojiView(view2, i);
                }
            };
            ...
            this.stickersTab = new ScrollSlidingTabStrip(context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.17
                float downX;
                float downY;
            ...
            GridLayoutManager gridLayoutManager3 = new GridLayoutManager(context, 5) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.18
            ...
            this.trendingLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.19
                @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
                public int getSpanSize(int position) {
            ...
            this.trendingGridView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.20
                @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            this.trendingGridView.setOnItemClickListener(new RecyclerListView.OnItemClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$5ZTuSMg4Cj2A-_Z6wE4kH25qYis
                @Override // im.uwrkaxlmjj.ui.components.RecyclerListView.OnItemClickListener
                public final void onItemClick(View view2, int i) {
                    this.f$0.lambda$new$5$EmojiView(view2, i);
                }
            });
            ...
            updateStickerTabs();
            this.stickersTab.setDelegate(new ScrollSlidingTabStrip.ScrollSlidingTabStripDelegate() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$-0yOv1499IT8xaGyMcUYazlNoWY
                @Override // im.uwrkaxlmjj.ui.components.ScrollSlidingTabStrip.ScrollSlidingTabStripDelegate
                public final void onPageSelected(int i) {
                    this.f$0.lambda$new$6$EmojiView(i);
                }
            });
            this.stickersGridView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.21
                @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    if (newState == 1) {
        ...
        ViewPager viewPager = new ViewPager(context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.22
        ...
        ImageView imageView = new ImageView(context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.23
            @Override // android.view.View
            public boolean onTouchEvent(MotionEvent event) {
                if (event.getAction() == 0) {
        ...
        this.bottomTabContainer = new FrameLayout(context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.24
        ...
        if (needSearch) {
            ...
            this.stickerSettingsButton.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.25
                @Override // android.view.View.OnClickListener
            ...
            this.typeTabs.setOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.26
                ...
                public void onPageSelected(int position) {
                    ...
                    EmojiView.this.showStickerSettingsButton(position == 2, true);
                    if (EmojiView.this.delegate.isSearchOpened()) {
                        if (position == 0) {
            ...
            this.searchButton.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.27
                @Override // android.view.View.OnClickListener
                public void onClick(View v) {
                    SearchField currentField;
            ...
            if (Build.VERSION.SDK_INT < 21) {
                ...
                this.backspaceButton.setOutlineProvider(new ViewOutlineProvider() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.28
                    @Override // android.view.ViewOutlineProvider
        ...
        this.pickerViewPopup.getContentView().setOnKeyListener(new View.OnKeyListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$4AGnoh-QzLrsRtu8KYQ2EooiBwI
            @Override // android.view.View.OnKeyListener
            public final boolean onKey(View view5, int i, KeyEvent keyEvent) {
                return this.f$0.lambda$new$7$EmojiView(view5, i, keyEvent);
            }
        });
    ...
    public /* synthetic */ void lambda$new$2$EmojiView(View view, int position) {
        ...
        if (this.gifGridView.getAdapter() == this.gifAdapter) {
            ...
            this.delegate.lambda$onGifSelected$0$ChatActivityEnterView$35(view, this.recentGifs.get(position2), "gif", true, 0);
            return;
        }
        ...
        this.delegate.lambda$onGifSelected$0$ChatActivityEnterView$35(view, this.gifSearchAdapter.results.get(position2), this.gifSearchAdapter.bot, true, 0);
        ...
        for (int a = 0; a < 3; a++) {
            ...
            if (currentField != null) {
                if (currentField != this.gifSearchField && searchField == currentField && (emojiViewDelegate = this.delegate) != null && emojiViewDelegate.isExpanded()) {
                    ...
                    this.searchAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.29
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animation) {
    ...
    private void showEmojiShadow(boolean show, boolean animated) {
        ...
        if (animated) {
            ...
            this.emojiTabShadowAnimator.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.30
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
        ...
        for (int a = 0; a < 3; a++) {
            ...
            if (currentField != null) {
                ...
                if (a == currentItem && animated) {
                    ...
                    this.searchAnimation.setDuration(200L);
                    this.searchAnimation.setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT);
                    this.searchAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.31
                        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                        public void onAnimationEnd(Animator animation) {
                            if (animation.equals(EmojiView.this.searchAnimation)) {
    ...
    public void showBackspaceButton(final boolean show, boolean animated) {
        ...
        if (animated) {
            ...
            this.backspaceButtonAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.32
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
                    if (!show) {
    ...
    public void showStickerSettingsButton(final boolean show, boolean animated) {
        ...
        if (animated) {
            ...
            this.stickersButtonAnimation.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.33
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
                    if (!show) {
    ...
    public void postBackspaceRunnable(final int time) {
        AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$8U-soj6PESFEPNjb37BJrRN1czI
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$postBackspaceRunnable$8$EmojiView(time);
            }
        }, time);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (this.stickersGridAdapter != null) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$VSn3OjtOxnYBpG6txN3RujyOw68
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onAttachedToWindow$9$EmojiView();
                }
            });
        }
    }
    ...
    /* JADX INFO: renamed from: im.uwrkaxlmjj.ui.components.EmojiView$34, reason: invalid class name */
    class AnonymousClass34 extends AnimatorListenerAdapter {
        ...
        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animation) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$34$SsF2cLg8mGE_iJUrYYpS0vBjWjo
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onAnimationEnd$0$EmojiView$34();
                }
        ...
        public /* synthetic */ void lambda$onAnimationEnd$0$EmojiView$34() {
            ...
            AnimatorSet1.playTogether(ObjectAnimator.ofFloat(EmojiView.this.mediaBanTooltip, (Property<TextView, Float>) View.ALPHA, 0.0f));
            AnimatorSet1.addListener(new AnimatorListenerAdapter() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.34.1
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
    ...
    class TrendingGridAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = null;
            if (viewType == 0) {
                view = new StickerEmojiCell(this.context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.TrendingGridAdapter.1
                    @Override // android.widget.FrameLayout, android.view.View
                    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                ((FeaturedStickerSetInfoCell) view).setAddOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$TrendingGridAdapter$uOzjtPbJdeklibQV59uhoT9U8v8
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        this.f$0.lambda$onCreateViewHolder$0$EmojiView$TrendingGridAdapter(view2);
                    }
                });
            }
    ...
    class StickersGridAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public int getTabForPosition(int position) {
            ...
            if (pack instanceof String) {
                return "recent".equals(pack) ? EmojiView.this.recentTabBum : EmojiView.this.favTabBum;
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = null;
            if (viewType == 0) {
                view = new StickerEmojiCell(this.context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.StickersGridAdapter.1
                    @Override // android.widget.FrameLayout, android.view.View
                    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                        super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(82.0f), 1073741824));
                    }
                ...
                ((StickerSetNameCell) view).setOnIconClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$StickersGridAdapter$loM-3UhTDOwwJMJ9dimAHU9ZEVA
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        this.f$0.lambda$onCreateViewHolder$0$EmojiView$StickersGridAdapter(view2);
                    }
                });
            } else if (viewType == 3) {
                view = new StickerSetGroupInfoCell(this.context);
                ((StickerSetGroupInfoCell) view).setAddOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$StickersGridAdapter$nwqBXQ7RongZSt-T8oTC9ntt38Q
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        this.f$0.lambda$onCreateViewHolder$1$EmojiView$StickersGridAdapter(view2);
                    }
                });
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (itemViewType == 0) {
                ...
                cell.setRecent(EmojiView.this.recentStickers.contains(sticker) || EmojiView.this.favouriteStickers.contains(sticker));
                return;
            }
            if (itemViewType == 1) {
        ...
        */
        public void notifyDataSetChanged() {
            /*
                ...
                To view this dump add '--comments-level debug' option
            */
            throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.ui.components.EmojiView.StickersGridAdapter.notifyDataSetChanged():void");
        }
    }
    ...
    private class EmojiGridAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                EmojiView emojiView = EmojiView.this;
                view = emojiView.new ImageViewEmoji(emojiView.getContext());
            } else if (viewType == 1) {
    ...
    class EmojiSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                ...
                FrameLayout frameLayout = new FrameLayout(EmojiView.this.getContext()) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.EmojiSearchAdapter.1
                    @Override // android.widget.FrameLayout, android.view.View
                ...
                imageView.setOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.EmojiSearchAdapter.2
                    @Override // android.view.View.OnClickListener
                    public void onClick(View v) {
                        Object obj;
                    ...
                    /* JADX INFO: renamed from: im.uwrkaxlmjj.ui.components.EmojiView$EmojiSearchAdapter$2$1, reason: invalid class name */
                    class AnonymousClass1 implements View.OnClickListener {
                        ...
                        public void onClick(View v) {
                            ...
                            final int requestId = connectionsManager.sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$EmojiSearchAdapter$2$1$Nx7p_bnmrXXzc_iEB6TH_tSNTS4
                                @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                    this.f$0.lambda$onClick$1$EmojiView$EmojiSearchAdapter$2$1(progressDialog, builder, tLObject, tL_error);
                                }
                            });
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$EmojiSearchAdapter$2$1$Zq7flGtqtM6Y8_O3NXTKeUGpF90
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.lambda$onClick$3$EmojiView$EmojiSearchAdapter$2$1(progressDialog, requestId);
                                }
                            }, 1000L);
                        }

                        public /* synthetic */ void lambda$onClick$1$EmojiView$EmojiSearchAdapter$2$1(final AlertDialog[] progressDialog, final BottomSheet.Builder builder, final TLObject response, TLRPC.TL_error error) {
                            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$EmojiSearchAdapter$2$1$PDDhq7eIcZo0CteJRTUbDa3BjfE
                                @Override // java.lang.Runnable
                                public final void run() {
                                    this.f$0.lambda$null$0$EmojiView$EmojiSearchAdapter$2$1(progressDialog, response, builder);
                                }
                            });
                        }
                        ...
                        public /* synthetic */ void lambda$onClick$3$EmojiView$EmojiSearchAdapter$2$1(AlertDialog[] progressDialog, final int requestId) {
                            if (progressDialog[0] == null) {
                                return;
                            }
                            progressDialog[0].setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$EmojiSearchAdapter$2$1$0nIUT4Fwa-fJ3u3UJyWc1kqDSlw
                                @Override // android.content.DialogInterface.OnCancelListener
                                public final void onCancel(DialogInterface dialogInterface) {
                                    this.f$0.lambda$null$2$EmojiView$EmojiSearchAdapter$2$1(requestId, dialogInterface);
                                }
                            });
        ...
        public void search(String text) {
            ...
            if (!TextUtils.isEmpty(this.lastSearchEmojiString)) {
                Runnable runnable2 = new Runnable() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.EmojiSearchAdapter.3
                    @Override // java.lang.Runnable
                    public void run() {
                        ...
                        MediaDataController.getInstance(EmojiView.this.currentAccount).getEmojiSuggestions(EmojiView.this.lastSearchKeyboardLanguage, EmojiSearchAdapter.this.lastSearchEmojiString, false, new MediaDataController.KeywordResultCallback() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.EmojiSearchAdapter.3.1
    ...
    class GifSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                ...
                FrameLayout frameLayout = new FrameLayout(EmojiView.this.getContext()) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.GifSearchAdapter.1
                    @Override // android.widget.FrameLayout, android.view.View
                    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                        int height = EmojiView.this.gifGridView.getMeasuredHeight();
                        super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec((int) ((((height - EmojiView.this.searchFieldHeight) - AndroidUtilities.dp(8.0f)) / 3) * 1.7f), 1073741824));
                    }
                };
                ImageView imageView = new ImageView(EmojiView.this.getContext());
                imageView.setScaleType(ImageView.ScaleType.CENTER);
        ...
        public void search(final String text) {
            ...
            if (!TextUtils.isEmpty(this.lastSearchImageString)) {
                Runnable runnable2 = new Runnable() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.GifSearchAdapter.2
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        private void searchBotUser() {
            ...
            ConnectionsManager.getInstance(EmojiView.this.currentAccount).sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$GifSearchAdapter$E1dFHxvoYLqGFO8oOFOyMjexuJ4
                @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        public /* synthetic */ void lambda$searchBotUser$1$EmojiView$GifSearchAdapter(final TLObject response, TLRPC.TL_error error) {
            if (response != null) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$GifSearchAdapter$IVjbZrhKScJ1Cob3znm2ge3Bvmw
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$null$0$EmojiView$GifSearchAdapter(response);
                    }
                });
            }
        }
        ...
        public void search(String query, final String offset, boolean searchUser) {
            ...
            this.reqId = ConnectionsManager.getInstance(EmojiView.this.currentAccount).sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$GifSearchAdapter$FosukW_Lq4On_p29sRBBdFdDTKI
                @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    this.f$0.lambda$search$3$EmojiView$GifSearchAdapter(req, offset, tLObject, tL_error);
                }
            }, 2);
        }

        public /* synthetic */ void lambda$search$3$EmojiView$GifSearchAdapter(final TLRPC.TL_messages_getInlineBotResults req, final String offset, final TLObject response, TLRPC.TL_error error) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$GifSearchAdapter$fPLeJJ02ErQdP0TtdGwS8ElzhcQ
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$null$2$EmojiView$GifSearchAdapter(req, offset, response);
                }
            });
        }
    ...
    class StickersSearchGridAdapter extends RecyclerListView.SelectionAdapter {
        ...
        /* JADX INFO: renamed from: im.uwrkaxlmjj.ui.components.EmojiView$StickersSearchGridAdapter$1, reason: invalid class name */
        class AnonymousClass1 implements Runnable {
            ...
            public void run() {
                ...
                if (!TextUtils.isEmpty(StickersSearchGridAdapter.this.searchQuery)) {
                    ...
                    if (allStickers != null && !allStickers.isEmpty() && StickersSearchGridAdapter.this.searchQuery.length() > 1) {
                        ...
                        EmojiView.this.lastSearchKeyboardLanguage = newLanguage;
                        MediaDataController.getInstance(EmojiView.this.currentAccount).getEmojiSuggestions(EmojiView.this.lastSearchKeyboardLanguage, StickersSearchGridAdapter.this.searchQuery, false, new MediaDataController.KeywordResultCallback() { // from class: im.uwrkaxlmjj.ui.components.EmojiView.StickersSearchGridAdapter.1.1
                            @Override // im.uwrkaxlmjj.messenger.MediaDataController.KeywordResultCallback
                            public void run(ArrayList<MediaDataController.KeywordResult> param, String alias) {
                    ...
                    stickersSearchGridAdapter.reqId = ConnectionsManager.getInstance(EmojiView.this.currentAccount).sendRequest(req, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$StickersSearchGridAdapter$1$8QzzRAlklZPpR4h9UvkLTd3cvCI
                        @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                        public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                            this.f$0.lambda$run$1$EmojiView$StickersSearchGridAdapter$1(req, tLObject, tL_error);
                        }
                    });
                    if (Emoji.isValidEmoji(StickersSearchGridAdapter.this.searchQuery)) {
                        ...
                        stickersSearchGridAdapter2.reqId2 = ConnectionsManager.getInstance(EmojiView.this.currentAccount).sendRequest(req2, new RequestDelegate() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$StickersSearchGridAdapter$1$P3fo3Fi6iFubNIgkP2rxfjfWetg
                            @Override // im.uwrkaxlmjj.tgnet.RequestDelegate
                            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                                this.f$0.lambda$run$3$EmojiView$StickersSearchGridAdapter$1(req2, emojiStickersArray, emojiStickersMap, tLObject, tL_error);
                            }
                        });
                    }
                    StickersSearchGridAdapter.this.notifyDataSetChanged();
            ...
            public /* synthetic */ void lambda$run$1$EmojiView$StickersSearchGridAdapter$1(final TLRPC.TL_messages_searchStickerSets req, final TLObject response, TLRPC.TL_error error) {
                if (response instanceof TLRPC.TL_messages_foundStickerSets) {
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$StickersSearchGridAdapter$1$ocomElf_dbtAcsFfEVpsaybsNHw
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f$0.lambda$null$0$EmojiView$StickersSearchGridAdapter$1(req, response);
                        }
                    });
                }
            }
            ...
            public /* synthetic */ void lambda$run$3$EmojiView$StickersSearchGridAdapter$1(final TLRPC.TL_messages_getStickers req2, final ArrayList emojiStickersArray, final LongSparseArray emojiStickersMap, final TLObject response, TLRPC.TL_error error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$StickersSearchGridAdapter$1$EH8GKMe29ek5oPx9_bp-ABV4e_E
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$null$2$EmojiView$StickersSearchGridAdapter$1(req2, response, emojiStickersArray, emojiStickersMap);
                    }
                });
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = null;
            if (viewType == 0) {
                view = new StickerEmojiCell(this.context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.StickersSearchGridAdapter.2
                    @Override // android.widget.FrameLayout, android.view.View
                    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                        super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(82.0f), 1073741824));
                    }
                ...
                view = new FeaturedStickerSetInfoCell(this.context, 17);
                ((FeaturedStickerSetInfoCell) view).setAddOnClickListener(new View.OnClickListener() { // from class: im.uwrkaxlmjj.ui.components.-$$Lambda$EmojiView$StickersSearchGridAdapter$aoeWSquSrSy4GfAkYNY993sVO6A
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view2) {
                        this.f$0.lambda$onCreateViewHolder$0$EmojiView$StickersSearchGridAdapter(view2);
                    }
                });
            } else if (viewType == 4) {
                view = new View(this.context);
                ...
                FrameLayout frameLayout = new FrameLayout(this.context) { // from class: im.uwrkaxlmjj.ui.components.EmojiView.StickersSearchGridAdapter.3
                    @Override // android.widget.FrameLayout, android.view.View
                    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 3) {
                ...
                boolean z4 = EmojiView.this.removingStickerSets.indexOfKey(stickerSetCovered.set.id) >= 0;
                if (z3 || z4) {
                ...
                if (i3 == -1) {
                        ...
                        if (i7 < i4) {
                            ...
                            for (int i9 = 0; i9 < size3; i9++) {
                                ...
                                while (i10 < size4) {
                                    ...
                                    String str3 = str;
                                    int i13 = (i8 / EmojiView.this.stickersGridAdapter.stickersPerRow) + i2;
                                    int i14 = size3;
                    ...
                    if (!arrayList.isEmpty()) {
                        ...
                        for (int i17 = 0; i17 < size5; i17++) {
                            ...
                            int i19 = i2 + 1 + (i17 / EmojiView.this.stickersGridAdapter.stickersPerRow);
                        ...
                        this.totalItems += (EmojiView.this.stickersGridAdapter.stickersPerRow * iCeil2) + 1;
                        i2 += iCeil2 + 1;
                    }
                }
                i3++;
