    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        /*
            ...
            float r0 = r8.getX()
            float r1 = r8.getY()
            im.uwrkaxlmjj.ui.components.SeekBar r2 = r7.seekBar
            int r3 = r8.getAction()
            float r4 = r8.getX()
            int r5 = r7.seekBarX
            float r5 = (float) r5
        ...
        Lb4:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: im.uwrkaxlmjj.ui.components.PopupAudioView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    private void didPressedButton() {
        ...
        if (i == 1) {
            boolean result2 = MediaController.getInstance().lambda$startAudioAgain$5$MediaController(this.currentMessageObject);
            if (result2) {
                this.buttonState = 0;
                invalidate();
                return;
    ...
    public void updateProgress() {
        ...
        String timeString = String.format("%02d:%02d", Integer.valueOf(duration / 60), Integer.valueOf(duration % 60));
