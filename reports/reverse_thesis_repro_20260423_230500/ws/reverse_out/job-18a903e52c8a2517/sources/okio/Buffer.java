...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x00a7 A[EDGE_INSN: B:43:0x00a7->B:37:0x00a7 BREAK  A[LOOP:0: B:5:0x000c->B:45:?], SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b0 & 128) == 0) {
            ...
            if (codePoint2 == 192) {
                ...
                int codePoint3 = b0 & PsExtractor.VIDEO_STREAM_MASK;
                if (codePoint3 == 224) {
                    codePoint = b0 & 15;
                    byteCount = 3;
                    min = 2048;
    ...
    */
    ...
    public long indexOfElement(ByteString targetBytes, long fromIndex) {
        ...
        while (offset3 < buffer.size) {
            byte[] data2 = s.data;
            int pos2 = (int) ((((long) s.pos) + fromIndex3) - offset3);
            int limit3 = s.limit;
            while (pos2 < limit3) {
                byte b2 = data2[pos2];
                ...
                while (i < length) {
                    ...
                    if (b2 == t) {
                        return ((long) (pos2 - s.pos)) + offset3;
                    }
                    i++;
                }
                pos2++;
