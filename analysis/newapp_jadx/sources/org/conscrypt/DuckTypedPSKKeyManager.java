        ...
        for (Method method : PSKKeyManager.class.getMethods()) {
            if (!method.isSynthetic()) {
                ...
                if (!returnType2.isAssignableFrom(returnType)) {
                    throw new NoSuchMethodException(method2 + " return value (" + returnType + ") incompatible with target return value (" + returnType2 + ChineseToPinyinResource.Field.RIGHT_BRACKET);
                }
            }
        }
