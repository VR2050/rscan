...
public final class OpenSSLECGroupContext {
    ...
    public static OpenSSLECGroupContext getInstance(ECParameterSpec eCParameterSpec) {
        ...
        if (!(field instanceof ECFieldFp)) {
            StringBuilder m586H = C1499a.m586H("unhandled field class ");
            m586H.append(field.getClass().getName());
            throw new InvalidParameterException(m586H.toString());
        }
        ...
        try {
            long EC_GROUP_new_arbitrary = NativeCrypto.EC_GROUP_new_arbitrary(p.toByteArray(), a.toByteArray(), b2.toByteArray(), affineX.toByteArray(), affineY.toByteArray(), order.toByteArray(), eCParameterSpec.getCofactor());
