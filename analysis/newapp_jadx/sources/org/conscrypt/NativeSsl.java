...
public final class NativeSsl {
    ...
    private void verifyWithSniMatchers(String str) {
        if (AddressUtils.isValidSniHostname(str) && !Platform.serverNamePermitted(this.parameters, str)) {
            throw new SSLHandshakeException(C1499a.m637w("SNI match failed: ", str));
        }
    }
    ...
    public void initialize(String str, OpenSSLKey openSSLKey) {
        ...
        if (this.parameters.useSessionTickets) {
            NativeCrypto.SSL_clear_options(this.ssl, this, IjkMediaMeta.AV_CH_TOP_FRONT_RIGHT);
        } else {
            NativeCrypto.SSL_set_options(this.ssl, this, NativeCrypto.SSL_get_options(this.ssl, this) | IjkMediaMeta.AV_CH_TOP_FRONT_RIGHT);
        }
