...
public final class NativeCrypto {
    ...
    public static native void SSL_set_session_creation_enabled(long j2, NativeSsl nativeSsl, boolean z);
    ...
    public static String[] checkEnabledCipherSuites(String[] strArr) {
        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            if (strArr[i2] == null) {
                throw new IllegalArgumentException(C1499a.m628n("cipherSuites[", i2, "] == null"));
            }
            if (!strArr[i2].equals(TLS_EMPTY_RENEGOTIATION_INFO_SCSV) && !strArr[i2].equals(TLS_FALLBACK_SCSV) && !SUPPORTED_TLS_1_2_CIPHER_SUITES_SET.contains(strArr[i2]) && !SUPPORTED_LEGACY_CIPHER_SUITES_SET.contains(strArr[i2])) {
                throw new IllegalArgumentException(C1499a.m582D(C1499a.m586H("cipherSuite "), strArr[i2], " is not supported."));
            }
        }
        return strArr;
    }
    ...
    public static String[] checkEnabledProtocols(String[] strArr) {
        ...
        for (String str : strArr) {
            ...
            if (!str.equals(SUPPORTED_PROTOCOL_TLSV1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_1) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_2) && !str.equals(SUPPORTED_PROTOCOL_TLSV1_3) && !str.equals(OBSOLETE_PROTOCOL_SSLV3)) {
                throw new IllegalArgumentException(C1499a.m639y("protocol ", str, " is not supported"));
            }
        }
        return strArr;
    }
    ...
    private static int getProtocolConstant(String str) {
        ...
        throw new AssertionError(C1499a.m637w("Unknown protocol encountered: ", str));
    }
    ...
    public static native void setApplicationProtocols(long j2, NativeSsl nativeSsl, boolean z, byte[] bArr);
        ...
        for (String str2 : strArr) {
            if (!str2.equals(TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) {
                if (str2.equals(TLS_FALLBACK_SCSV) && (str.equals(SUPPORTED_PROTOCOL_TLSV1) || str.equals(SUPPORTED_PROTOCOL_TLSV1_1))) {
                    SSL_set_mode(j2, nativeSsl, IjkMediaMeta.AV_CH_SIDE_RIGHT);
                } else {
    ...
    public static native void setHasApplicationProtocolSelector(long j2, NativeSsl nativeSsl, boolean z);
