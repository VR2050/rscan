...
public abstract class OpenSSLCipherRSA extends CipherSpi {
    ...
    public byte[] engineDoFinal(byte[] bArr, int i2, int i3) {
        ...
        if (this.inputTooLarge) {
            throw new IllegalBlockSizeException(C1499a.m580B(C1499a.m586H("input must be under "), this.buffer.length, " bytes"));
        }
    ...
    public void engineSetMode(String str) {
        ...
        if (!"NONE".equals(upperCase) && !"ECB".equals(upperCase)) {
            throw new NoSuchAlgorithmException(C1499a.m637w("mode not supported: ", str));
        }
    }
    ...
    public void engineSetPadding(String str) {
        ...
        if ("PKCS1PADDING".equals(upperCase)) {
            ...
            if (!"NOPADDING".equals(upperCase)) {
                throw new NoSuchPaddingException(C1499a.m637w("padding not supported: ", str));
            }
            this.padding = 3;
        }
    }
    ...
    public void engineInit(int i2, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) {
        if (algorithmParameters == null) {
            ...
            StringBuilder m586H = C1499a.m586H("unknown param type: ");
            m586H.append(algorithmParameters.getClass().getName());
            throw new InvalidAlgorithmParameterException(m586H.toString());
        }
    }
    ...
    public int engineDoFinal(byte[] bArr, int i2, int i3, byte[] bArr2, int i4) {
        ...
        StringBuilder m586H = C1499a.m586H("output buffer is too small ");
        m586H.append(bArr2.length);
        m586H.append(" < ");
        m586H.append(length);
