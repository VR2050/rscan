...
public abstract class NativeSslSession {
    ...
    private static void checkRemaining(ByteBuffer byteBuffer, int i2) {
        if (i2 < 0) {
            throw new IOException(C1499a.m626l("Length is negative: ", i2));
        }
        if (i2 <= byteBuffer.remaining()) {
            return;
        }
        StringBuilder m588J = C1499a.m588J("Length of blob is longer than available: ", i2, " > ");
        m588J.append(byteBuffer.remaining());
        throw new IOException(m588J.toString());
    }
