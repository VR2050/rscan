...
public class ConscryptEngineSocket extends OpenSSLSocketImpl {
    ...
    public void doHandshake() {
        ...
        while (!z) {
            try {
                int i2 = C50473.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[this.engine.getHandshakeStatus().ordinal()];
                if (i2 != 1) {
                    if (i2 == 2) {
                ...
                } else if (this.f12984in.processDataFromSocket(EmptyArray.BYTE, 0, 0) < 0) {
    ...
    public final void close() {
        ...
        synchronized (obj) {
            ...
            try {
                ...
                SSLInputStream sSLInputStream = this.f12984in;
                ...
                this.engine.closeInbound();
                this.engine.closeOutbound();
                if (this.f12984in != null) {
                    this.f12984in.release();
                }
                throw th;
            }
        }
            ...
            synchronized (this.handshakeLock) {
                synchronized (this.stateLock) {
                    if (this.state == 0) {
                        ...
                        this.f12984in = new SSLInputStream();
        ...
        public void writeInternal(ByteBuffer byteBuffer) {
            ...
            do {
                ...
                if (wrap.getStatus() != SSLEngineResult.Status.OK && wrap.getStatus() != SSLEngineResult.Status.CLOSED) {
                    StringBuilder m586H = C1499a.m586H("Unexpected engine result ");
                    m586H.append(wrap.getStatus());
                    throw new SSLException(m586H.toString());
                }
                if (this.target.position() != wrap.bytesProduced()) {
                    StringBuilder m586H2 = C1499a.m586H("Engine bytesProduced ");
                    m586H2.append(wrap.bytesProduced());
                    m586H2.append(" does not match bytes written ");
                    m586H2.append(this.target.position());
                    throw new SSLException(m586H2.toString());
                }
    ...
    public final class SSLInputStream extends InputStream {
        ...
        private boolean isHandshaking(SSLEngineResult.HandshakeStatus handshakeStatus) {
            int i2 = C50473.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[handshakeStatus.ordinal()];
        ...
        */
        public int processDataFromSocket(byte[] r7, int r8, int r9) {
            ...
            L23:
                ...
                r2.flip()
                int[] r2 = org.conscrypt.ConscryptEngineSocket.C50473.$SwitchMap$javax$net$ssl$SSLEngineResult$Status
            ...
            L6b:
                ...
                java.lang.String r8 = "Unexpected engine result "
                java.lang.StringBuilder r8 = p005b.p131d.p132a.p133a.C1499a.m586H(r8)
