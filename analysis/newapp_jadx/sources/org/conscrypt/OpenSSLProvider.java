...
public final class OpenSSLProvider extends Provider {
    ...
    private void putECDHKeyAgreementImplClass(String str) {
        ...
        String str2 = PREFIX;
        putImplClassWithKeyConstraints("KeyAgreement.ECDH", C1499a.m637w(str2, str), C1499a.m583E(sb, str2, "OpenSSLKeyHolder|", STANDARD_EC_PRIVATE_KEY_INTERFACE_CLASS_NAME), "PKCS#8");
    }
    ...
    private void putMacImplClass(String str, String str2) {
        StringBuilder sb = new StringBuilder();
        String str3 = PREFIX;
        putImplClassWithKeyConstraints(C1499a.m637w("Mac.", str), C1499a.m637w(str3, str2), C1499a.m582D(sb, str3, "OpenSSLKeyHolder"), "RAW");
    }

    private void putRAWRSASignatureImplClass(String str) {
        StringBuilder sb = new StringBuilder();
        String str2 = PREFIX;
        C1499a.m608b0(sb, str2, "OpenSSLRSAPrivateKey|", STANDARD_RSA_PRIVATE_KEY_INTERFACE_CLASS_NAME, "|");
        putImplClassWithKeyConstraints("Signature.NONEwithRSA", C1499a.m637w(str2, str), C1499a.m583E(sb, str2, "OpenSSLRSAPublicKey|", STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME), null);
    }

    private void putRSACipherImplClass(String str, String str2) {
        StringBuilder sb = new StringBuilder();
        String str3 = PREFIX;
        C1499a.m608b0(sb, str3, "OpenSSLRSAPrivateKey|", STANDARD_RSA_PRIVATE_KEY_INTERFACE_CLASS_NAME, "|");
        putImplClassWithKeyConstraints(C1499a.m637w("Cipher.", str), C1499a.m637w(str3, str2), C1499a.m583E(sb, str3, "OpenSSLRSAPublicKey|", STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME), null);
    }

    private void putSignatureImplClass(String str, String str2) {
        StringBuilder sb = new StringBuilder();
        String str3 = PREFIX;
        C1499a.m608b0(sb, str3, "OpenSSLKeyHolder|", STANDARD_RSA_PRIVATE_KEY_INTERFACE_CLASS_NAME, "|");
        putImplClassWithKeyConstraints(C1499a.m637w("Signature.", str), C1499a.m637w(str3, str2), C1499a.m583E(sb, STANDARD_EC_PRIVATE_KEY_INTERFACE_CLASS_NAME, "|", STANDARD_RSA_PUBLIC_KEY_INTERFACE_CLASS_NAME), "PKCS#8|X.509");
    }

    private void putSymmetricCipherImplClass(String str, String str2) {
        putImplClassWithKeyConstraints(C1499a.m637w("Cipher.", str), C1499a.m582D(new StringBuilder(), PREFIX, str2), null, "RAW");
    }
    ...
    public OpenSSLProvider(String str, boolean z, String str2) {
        ...
        if (str2.equals("TLSv1.2")) {
            ...
            if (!str2.equals(NativeCrypto.SUPPORTED_PROTOCOL_TLSV1_3)) {
                throw new IllegalArgumentException(C1499a.m637w("Choice of default protocol is unsupported: ", str2));
            }
            str3 = "$TLSv13";
        }
        ...
        sb3.append(str4);
        C1499a.m610c0(sb3, "DefaultSSLContextImpl", str3, this, "SSLContext.Default");
        if (z) {
        ...
        StringBuilder m592N = C1499a.m592N(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.22", "AES", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.42", "AES");
        m592N.append(str4);
        m592N.append("IvParameters$ChaCha20");
        put("AlgorithmParameters.ChaCha20", m592N.toString());
        C1499a.m610c0(new StringBuilder(), str4, "IvParameters$DESEDE", this, "AlgorithmParameters.DESEDE");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.AlgorithmParameters.TDEA", "DESEDE", "Alg.Alias.AlgorithmParameters.1.2.840.113549.3.7", "DESEDE"), str4, "GCMParameters", this, "AlgorithmParameters.GCM");
        put("Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.6", "GCM");
        StringBuilder m592N2 = C1499a.m592N(this, "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.26", "GCM", "Alg.Alias.AlgorithmParameters.2.16.840.1.101.3.4.1.46", "GCM");
        m592N2.append(str4);
        m592N2.append("OAEPParameters");
        put("AlgorithmParameters.OAEP", m592N2.toString());
        put("AlgorithmParameters.PSS", str4 + "PSSParameters");
        put("AlgorithmParameters.EC", str4 + "ECParameters");
        C1499a.m610c0(new StringBuilder(), str4, "OpenSSLMessageDigestJDK$SHA1", this, "MessageDigest.SHA-1");
        put("Alg.Alias.MessageDigest.SHA1", EvpMdRef.SHA1.JCA_NAME);
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.MessageDigest.SHA", EvpMdRef.SHA1.JCA_NAME, "Alg.Alias.MessageDigest.1.3.14.3.2.26", EvpMdRef.SHA1.JCA_NAME), str4, "OpenSSLMessageDigestJDK$SHA224", this, "MessageDigest.SHA-224");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.MessageDigest.SHA224", EvpMdRef.SHA224.JCA_NAME, "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.4", EvpMdRef.SHA224.JCA_NAME), str4, "OpenSSLMessageDigestJDK$SHA256", this, "MessageDigest.SHA-256");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.MessageDigest.SHA256", EvpMdRef.SHA256.JCA_NAME, "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.1", EvpMdRef.SHA256.JCA_NAME), str4, "OpenSSLMessageDigestJDK$SHA384", this, "MessageDigest.SHA-384");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.MessageDigest.SHA384", EvpMdRef.SHA384.JCA_NAME, "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.2", EvpMdRef.SHA384.JCA_NAME), str4, "OpenSSLMessageDigestJDK$SHA512", this, "MessageDigest.SHA-512");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.MessageDigest.SHA512", EvpMdRef.SHA512.JCA_NAME, "Alg.Alias.MessageDigest.2.16.840.1.101.3.4.2.3", EvpMdRef.SHA512.JCA_NAME), str4, "OpenSSLMessageDigestJDK$MD5", this, "MessageDigest.MD5");
        put("Alg.Alias.MessageDigest.1.2.840.113549.2.5", EvpMdRef.MD5.JCA_NAME);
        put("KeyGenerator.ARC4", str4 + "KeyGeneratorImpl$ARC4");
        StringBuilder m592N3 = C1499a.m592N(this, "Alg.Alias.KeyGenerator.RC4", "ARC4", "Alg.Alias.KeyGenerator.1.2.840.113549.3.4", "ARC4");
        m592N3.append(str4);
        m592N3.append("KeyGeneratorImpl$AES");
        put("KeyGenerator.AES", m592N3.toString());
        put("KeyGenerator.ChaCha20", str4 + "KeyGeneratorImpl$ChaCha20");
        C1499a.m610c0(new StringBuilder(), str4, "KeyGeneratorImpl$DESEDE", this, "KeyGenerator.DESEDE");
        ...
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyGenerator.HMAC-MD5", "HmacMD5", "Alg.Alias.KeyGenerator.HMAC/MD5", "HmacMD5"), str4, "KeyGeneratorImpl$HmacSHA1", this, "KeyGenerator.HmacSHA1");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.7", "HmacSHA1");
        put("Alg.Alias.KeyGenerator.1.3.6.1.5.5.8.1.2", "HmacSHA1");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyGenerator.HMAC-SHA1", "HmacSHA1", "Alg.Alias.KeyGenerator.HMAC/SHA1", "HmacSHA1"), str4, "KeyGeneratorImpl$HmacSHA224", this, "KeyGenerator.HmacSHA224");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.8", "HmacSHA224");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyGenerator.HMAC-SHA224", "HmacSHA224", "Alg.Alias.KeyGenerator.HMAC/SHA224", "HmacSHA224"), str4, "KeyGeneratorImpl$HmacSHA256", this, "KeyGenerator.HmacSHA256");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.9", "HmacSHA256");
        put("Alg.Alias.KeyGenerator.2.16.840.1.101.3.4.2.1", "HmacSHA256");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyGenerator.HMAC-SHA256", "HmacSHA256", "Alg.Alias.KeyGenerator.HMAC/SHA256", "HmacSHA256"), str4, "KeyGeneratorImpl$HmacSHA384", this, "KeyGenerator.HmacSHA384");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.10", "HmacSHA384");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyGenerator.HMAC-SHA384", "HmacSHA384", "Alg.Alias.KeyGenerator.HMAC/SHA384", "HmacSHA384"), str4, "KeyGeneratorImpl$HmacSHA512", this, "KeyGenerator.HmacSHA512");
        put("Alg.Alias.KeyGenerator.1.2.840.113549.2.11", "HmacSHA512");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyGenerator.HMAC-SHA512", "HmacSHA512", "Alg.Alias.KeyGenerator.HMAC/SHA512", "HmacSHA512"), str4, "OpenSSLRSAKeyPairGenerator", this, "KeyPairGenerator.RSA");
        put("Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.1", "RSA");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyPairGenerator.1.2.840.113549.1.1.7", "RSA", "Alg.Alias.KeyPairGenerator.2.5.8.1.1", "RSA"), str4, "OpenSSLECKeyPairGenerator", this, "KeyPairGenerator.EC");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyPairGenerator.1.2.840.10045.2.1", "EC", "Alg.Alias.KeyPairGenerator.1.3.133.16.840.63.0.2", "EC"), str4, "OpenSSLRSAKeyFactory", this, "KeyFactory.RSA");
        put("Alg.Alias.KeyFactory.1.2.840.113549.1.1.1", "RSA");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyFactory.1.2.840.113549.1.1.7", "RSA", "Alg.Alias.KeyFactory.2.5.8.1.1", "RSA"), str4, "OpenSSLECKeyFactory", this, "KeyFactory.EC");
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.KeyFactory.1.2.840.10045.2.1", "EC", "Alg.Alias.KeyFactory.1.3.133.16.840.63.0.2", "EC"), str4, "DESEDESecretKeyFactory", this, "SecretKeyFactory.DESEDE");
        ...
        C1499a.m610c0(C1499a.m592N(this, "Alg.Alias.Mac.HMAC/SHA512", "HmacSHA512", "Alg.Alias.Mac.PBEWITHHMACSHA512", "HmacSHA512"), str4, "OpenSSLX509CertificateFactory", this, "CertificateFactory.X509");
