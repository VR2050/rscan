    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        if (type != InetSocketAddress.class) {
            ...
            if (!(type instanceof Class)) {
                StringBuilder m586H = C1499a.m586H("MiscCodec not support ");
                m586H.append(type.toString());
            ...
            throw new JSONException(C1499a.m637w("MiscCodec not support ", name));
        }
            ...
            if (obj instanceof File) {
                ...
                if (obj.getClass().getName().equals("net.sf.json.JSONNull")) {
                    ...
                    if (!(obj instanceof Node)) {
                        throw new JSONException(C1499a.m635u("not support class : ", cls));
                    }
