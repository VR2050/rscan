...
public class UTF8Decoder extends CharsetDecoder {
    ...
    */
    ...
    private static boolean isMalformed2(int i2, int i3) {
        return (i2 & 30) == 0 || (i3 & Opcodes.CHECKCAST) != 128;
    }

    private static boolean isMalformed3(int i2, int i3, int i4) {
        return ((i2 != -32 || (i3 & 224) != 128) && (i3 & Opcodes.CHECKCAST) == 128 && (i4 & Opcodes.CHECKCAST) == 128) ? false : true;
    }

    private static boolean isMalformed4(int i2, int i3, int i4) {
        return ((i2 & Opcodes.CHECKCAST) == 128 && (i3 & Opcodes.CHECKCAST) == 128 && (i4 & Opcodes.CHECKCAST) == 128) ? false : true;
    }

    private static boolean isNotContinuation(int i2) {
        return (i2 & Opcodes.CHECKCAST) != 128;
    }
