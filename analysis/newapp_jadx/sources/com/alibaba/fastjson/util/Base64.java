...
public class Base64 {
    ...
    /* renamed from: CA */
    public static final char[] f8511CA;

    /* renamed from: IA */
    public static final int[] f8512IA;
    ...
    public static byte[] decodeFast(char[] cArr, int i2, int i3) {
        ...
        int i6 = (i2 + i3) - 1;
        while (i2 < i6 && f8512IA[cArr[i2]] < 0) {
            i2++;
        }
        while (i6 > 0 && f8512IA[cArr[i6]] < 0) {
            i6--;
        }
    ...
    public static byte[] decodeFast(String str, int i2, int i3) {
        ...
        int i6 = (i2 + i3) - 1;
        while (i2 < i6 && f8512IA[str.charAt(i2)] < 0) {
            i2++;
        }
        while (i6 > 0 && f8512IA[str.charAt(i6)] < 0) {
            i6--;
        }
        ...
        if (i11 < i9) {
            int i23 = 0;
            while (i2 <= i6 - i7) {
                i5 |= f8512IA[str.charAt(i2)] << (18 - (i23 * 6));
                i23++;
                i2++;
            }
            int i24 = 16;
    ...
    public static byte[] decodeFast(String str) {
        ...
        int i4 = length - 1;
        int i5 = 0;
        while (i5 < i4 && f8512IA[str.charAt(i5) & 255] < 0) {
            i5++;
        }
        while (i4 > 0 && f8512IA[str.charAt(i4) & 255] < 0) {
            i4--;
        }
        ...
        if (i10 < i8) {
            int i22 = 0;
            while (i5 <= i4 - i6) {
                i3 |= f8512IA[str.charAt(i5)] << (18 - (i22 * 6));
                i22++;
                i5++;
            }
            int i23 = 16;
