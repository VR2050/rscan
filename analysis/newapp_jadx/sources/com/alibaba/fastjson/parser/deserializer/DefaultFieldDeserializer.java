...
public class DefaultFieldDeserializer extends FieldDeserializer {
    ...
    public void parseField(DefaultJSONParser defaultJSONParser, Object obj, Type type, Map<String, Object> map) {
        ...
        if (!(objectDeserializer instanceof JavaBeanDeserializer) || (i2 = (fieldInfo = this.fieldInfo).parserFeatures) == 0) {
            ...
            deserialze = (str == null || !(objectDeserializer instanceof ContextObjectDeserializer)) ? objectDeserializer.deserialze(defaultJSONParser, type3, fieldInfo2.name) : ((ContextObjectDeserializer) objectDeserializer).deserialze(defaultJSONParser, type3, fieldInfo2.name, str, fieldInfo2.parserFeatures);
        } else {
