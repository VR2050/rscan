        ...
        try {
            ...
            if (method != null) {
                if (fieldInfo2.getOnly) {
                    ...
                    if (Map.class.isAssignableFrom(method.getReturnType())) {
                        ...
                        if (map != null && map != Collections.emptyMap() && !map.getClass().getName().startsWith("java.util.Collections$Unmodifiable")) {
                            if (map.getClass().getName().equals("kotlin.collections.EmptyMap")) {
                                ...
                                this.fieldInfo.field.set(obj, obj2);
                                return;
                            }
                            map.putAll((Map) obj2);
                            return;
                    ...
                    if (collection != Collections.emptySet() && collection != Collections.emptyList() && !name.startsWith("java.util.Collections$Unmodifiable")) {
                        if (!collection.isEmpty()) {
                            collection.clear();
                        }
                        if (!name.equals("kotlin.collections.EmptyList") && !name.equals("kotlin.collections.EmptySet")) {
                            collection.addAll((Collection) obj2);
                            return;
                        }
                        Field field2 = this.fieldInfo.field;
                        if (field2 == null || Modifier.isFinal(field2.getModifiers())) {
                            return;
                        }
                        this.fieldInfo.field.set(obj, (Collection) obj2);
                        return;
                    }
                    return;
                }
            ...
            if (cls2 == AtomicInteger.class) {
                AtomicInteger atomicInteger2 = (AtomicInteger) field3.get(obj);
            ...
            if (cls2 == AtomicLong.class) {
                AtomicLong atomicLong2 = (AtomicLong) field3.get(obj);
                if (atomicLong2 != null) {
            ...
            if (cls2 == AtomicBoolean.class) {
                AtomicBoolean atomicBoolean2 = (AtomicBoolean) field3.get(obj);
            ...
            Collection collection2 = (Collection) field3.get(obj);
            ...
            StringBuilder m586H = C1499a.m586H("set property error, ");
            m586H.append(this.clazz.getName());
            m586H.append("#");
            m586H.append(this.fieldInfo.name);
