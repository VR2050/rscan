...
public final class Item {
    ...
    public void set(int i2, String str, String str2, String str3) {
        ...
        if (i2 != 1 && i2 != 7 && i2 != 8) {
            if (i2 == 12) {
                this.hashCode = ((str2.hashCode() * str.hashCode()) + i2) & Integer.MAX_VALUE;
                return;
            } else if (i2 != 13) {
                this.hashCode = ((str3.hashCode() * str2.hashCode() * str.hashCode()) + i2) & Integer.MAX_VALUE;
                return;
            }
        }
        this.hashCode = (str.hashCode() + i2) & Integer.MAX_VALUE;
    }
