...
public class ClassReader {
    ...
    public ClassReader(InputStream inputStream, boolean z) {
        int i2;
        ...
        inputStream.close();
        this.f8504b = byteArrayOutputStream.toByteArray();
    ...
    public void accept(TypeCollector typeCollector) {
        ...
        for (int readUnsignedShort3 = readUnsignedShort(i5); readUnsignedShort3 > 0; readUnsignedShort3--) {
            i8 += 8;
            for (int readUnsignedShort4 = readUnsignedShort(i8 + 6); readUnsignedShort4 > 0; readUnsignedShort4--) {
                i8 += readInt(i8 + 2) + 6;
            }
        }
        int i9 = i8 + 2;
        for (int readUnsignedShort5 = readUnsignedShort(i8); readUnsignedShort5 > 0; readUnsignedShort5--) {
            i9 += 8;
            for (int readUnsignedShort6 = readUnsignedShort(i9 + 6); readUnsignedShort6 > 0; readUnsignedShort6--) {
                i9 += readInt(i9 + 2) + 6;
            }
        }
        int i10 = i9 + 2;
        ...
        for (int readUnsignedShort9 = readUnsignedShort(i5); readUnsignedShort9 > 0; readUnsignedShort9--) {
            i7 += 8;
            for (int readUnsignedShort10 = readUnsignedShort(i7 + 6); readUnsignedShort10 > 0; readUnsignedShort10--) {
                i7 += readInt(i7 + 2) + 6;
            }
        }
        int i12 = i7 + 2;
        for (int readUnsignedShort11 = readUnsignedShort(i7); readUnsignedShort11 > 0; readUnsignedShort11--) {
            i12 = readMethod(typeCollector, cArr, i12);
        }
    }
}
