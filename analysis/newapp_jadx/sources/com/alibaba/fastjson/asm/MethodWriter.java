...
public class MethodWriter implements MethodVisitor {
    ...
    /* renamed from: cw */
    public final ClassWriter f8505cw;
    ...
    public final int getSize() {
        ...
        this.f8505cw.newUTF8("Exceptions");
    ...
    public final void put(ByteVector byteVector) {
        ...
        if (i3 > 0) {
            byteVector.putShort(this.f8505cw.newUTF8("Code")).putInt(i3 + 12 + 0);
        ...
        if (this.exceptionCount > 0) {
            byteVector.putShort(this.f8505cw.newUTF8("Exceptions")).putInt((this.exceptionCount * 2) + 2);
    ...
    public void visitFieldInsn(int i2, String str, String str2, String str3) {
        this.code.put12(i2, this.f8505cw.newFieldItem(str, str2, str3).index);
    }
    ...
    public void visitLdcInsn(Object obj) {
        Item newConstItem = this.f8505cw.newConstItem(obj);
    ...
    public void visitMethodInsn(int i2, String str, String str2, String str3) {
        boolean z = i2 == 185;
        Item newMethodItem = this.f8505cw.newMethodItem(str, str2, str3, z);
    ...
    public void visitTypeInsn(int i2, String str) {
        this.code.put12(i2, this.f8505cw.newClassItem(str).index);
    }
