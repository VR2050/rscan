...
public class Constants {
    ...
    public static final int IMMERSION_ID_STATUS_BAR_VIEW = C3614R.id.immersion_status_bar_view;
    public static final int IMMERSION_ID_NAVIGATION_BAR_VIEW = C3614R.id.immersion_navigation_bar_view;
}
