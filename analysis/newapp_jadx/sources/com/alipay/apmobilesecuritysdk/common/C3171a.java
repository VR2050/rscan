...
public final class C3171a {
    ...
    public static boolean m3742a(Context context) {
        ...
        arrayList.add(C3184h.m3794e(context));
        return m3743a(arrayList) || m3743a(new ArrayList<String>() { // from class: com.alipay.apmobilesecuritysdk.common.RushTimeUtil$1
            {
    ...
    /* renamed from: a */
    private static boolean m3743a(List<String> list) {
