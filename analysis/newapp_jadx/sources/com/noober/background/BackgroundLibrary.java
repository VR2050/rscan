...
public class BackgroundLibrary {
    ...
    /* renamed from: com.noober.background.BackgroundLibrary$a */
    public static class LayoutInflaterFactoryC4027a implements LayoutInflater.Factory {

        /* renamed from: c */
        public final /* synthetic */ AppCompatDelegate f10255c;

        public LayoutInflaterFactoryC4027a(AppCompatDelegate appCompatDelegate) {
            this.f10255c = appCompatDelegate;
        }

        @Override // android.view.LayoutInflater.Factory
        public View onCreateView(String str, Context context, AttributeSet attributeSet) {
            return this.f10255c.createView(null, str, context, attributeSet);
        }
    }
    ...
    private static BackgroundFactory setDelegateFactory(Context context) {
        ...
        if (context instanceof AppCompatActivity) {
            backgroundFactory.setInterceptFactory(new LayoutInflaterFactoryC4027a(((AppCompatActivity) context).getDelegate()));
        }
