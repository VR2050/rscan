...
public final class ItemComicLayoutVerticalBinding implements ViewBinding {
    ...
    private ItemComicLayoutVerticalBinding(@NonNull LinearLayout linearLayout, @NonNull ShapeableImageView shapeableImageView, @NonNull RelativeLayout relativeLayout, @NonNull RelativeLayout relativeLayout2, @NonNull TextView textView, @NonNull ImageTextView imageTextView, @NonNull ImageTextView imageTextView2, @NonNull ImageTextView imageTextView3, @NonNull ImageTextView imageTextView4, @NonNull ImageTextView imageTextView5, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull RelativeLayout relativeLayout3, @NonNull LinearLayout linearLayout2, @NonNull LinearLayout linearLayout3, @NonNull TextView textView2, @NonNull GradientTextView gradientTextView, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull TextView textView5, @NonNull TextView textView6) {
        ...
        this.tvComicsCategorySubtitle = textView3;
        this.tvComicsName = textView4;
        this.tvDuration = textView5;
        this.tvSlideMore = textView6;
    }

    @NonNull
    public static ItemComicLayoutVerticalBinding bind(@NonNull View view) {
                                                            ...
                                                            if (linearLayout2 != null) {
                                                                ...
                                                                if (textView2 != null) {
                                                                    ...
                                                                    if (gradientTextView != null) {
                                                                        i2 = R.id.tv_comics_category_subtitle;
                                                                        TextView textView3 = (TextView) view.findViewById(R.id.tv_comics_category_subtitle);
                                                                        if (textView3 != null) {
                                                                            i2 = R.id.tv_comics_name;
                                                                            TextView textView4 = (TextView) view.findViewById(R.id.tv_comics_name);
                                                                            if (textView4 != null) {
                                                                                i2 = R.id.tv_duration;
    ...
    @NonNull
    public static ItemComicLayoutVerticalBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ItemComicLayoutVerticalBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.item_comic_layout_vertical, viewGroup, false);
        if (z) {
