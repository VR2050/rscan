...
public final class ItemOrderLayoutBinding implements ViewBinding {
    ...
    private ItemOrderLayoutBinding(@NonNull LinearLayout linearLayout, @NonNull TextView textView) {
    ...
    public static ItemOrderLayoutBinding bind(@NonNull View view) {
        ...
        if (textView != null) {
            return new ItemOrderLayoutBinding((LinearLayout) view, textView);
        }
    ...
    @NonNull
    public static ItemOrderLayoutBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
