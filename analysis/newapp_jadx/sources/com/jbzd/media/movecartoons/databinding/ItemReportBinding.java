...
public final class ItemReportBinding implements ViewBinding {
    ...
    private ItemReportBinding(@NonNull TextView textView, @NonNull TextView textView2) {
    ...
    @NonNull
    public static ItemReportBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
