...
public final class FullVideoPlayerBinding implements ViewBinding {
    ...
    private FullVideoPlayerBinding(@NonNull RelativeLayout relativeLayout, @NonNull ImageView imageView, @NonNull ProgressBar progressBar, @NonNull ImageView imageView2, @NonNull TextView textView, @NonNull ImageView imageView3, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull ENDownloadView eNDownloadView, @NonNull ImageView imageView4, @NonNull ImageView imageView5, @NonNull SeekBar seekBar, @NonNull ImageView imageView6, @NonNull FrameLayout frameLayout, @NonNull RelativeLayout relativeLayout2, @NonNull ImageView imageView7, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull TextView textView5) {
        ...
        this.tvSpeedVideo = textView4;
        this.velocityView = textView5;
    }

    @NonNull
    public static FullVideoPlayerBinding bind(@NonNull View view) {
        int i2 = R.id.back;
                            ...
                            if (linearLayout != null) {
                                ...
                                if (linearLayout2 != null) {
                                    ...
                                    if (eNDownloadView != null) {
                                        ...
                                        if (imageView4 != null) {
                                            i2 = R.id.player;
                                            ImageView imageView5 = (ImageView) view.findViewById(R.id.player);
                                            if (imageView5 != null) {
                                                i2 = R.id.progress;
                                                    ...
                                                    if (imageView6 != null) {
                                                        ...
                                                        if (frameLayout != null) {
                                                            ...
                                                            if (relativeLayout != null) {
                                                                i2 = R.id.thumbImage;
                                                                ImageView imageView7 = (ImageView) view.findViewById(R.id.thumbImage);
                                                                if (imageView7 != null) {
                                                                    i2 = R.id.title;
                                                                    ...
                                                                    if (textView2 != null) {
                                                                        ...
                                                                        if (textView3 != null) {
                                                                            i2 = R.id.tv_speed_video;
                                                                            TextView textView4 = (TextView) view.findViewById(R.id.tv_speed_video);
                                                                            if (textView4 != null) {
                                                                                i2 = R.id.velocityView;
                                                                                TextView textView5 = (TextView) view.findViewById(R.id.velocityView);
                                                                                if (textView5 != null) {
                                                                                    return new FullVideoPlayerBinding((RelativeLayout) view, imageView, progressBar, imageView2, textView, imageView3, linearLayout, linearLayout2, eNDownloadView, imageView4, imageView5, seekBar, imageView6, frameLayout, relativeLayout, imageView7, textView2, textView3, textView4, textView5);
                                                                                }
                                                                            }
                                                                        }
                                                                    }
    ...
    @NonNull
    public static FullVideoPlayerBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FullVideoPlayerBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.full_video_player, viewGroup, false);
        if (z) {
