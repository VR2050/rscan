...
public final class DialogSubmitBinding implements ViewBinding {
    ...
    private DialogSubmitBinding(@NonNull FrameLayout frameLayout, @NonNull GradientRoundCornerButton gradientRoundCornerButton, @NonNull ImageView imageView, @NonNull TextView textView, @NonNull View view) {
    ...
    @NonNull
    public static DialogSubmitBinding bind(@NonNull View view) {
            ...
            if (imageView != null) {
                ...
                if (textView != null) {
                    ...
                    if (findViewById != null) {
                        return new DialogSubmitBinding((FrameLayout) view, gradientRoundCornerButton, imageView, textView, findViewById);
                    }
                }
            }
        }
    ...
    @NonNull
    public static DialogSubmitBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static DialogSubmitBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
