...
public final class ItemCommunityItemBinding implements ViewBinding {
    ...
    @NonNull
    public static ItemCommunityItemBinding bind(@NonNull View view) {
    ...
    @NonNull
    public static ItemCommunityItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ItemCommunityItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.item_community_item, viewGroup, false);
        if (z) {
