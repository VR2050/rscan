...
public final class ActHistoryPageBinding implements ViewBinding {
    ...
    @NonNull
    public static ActHistoryPageBinding bind(@NonNull View view) {
                                        ...
                                        if (relativeLayout4 != null) {
                                            ...
                                            if (textView != null) {
                                                ...
                                                if (textView2 != null) {
                                                    ...
                                                    if (myViewPager != null) {
                                                        return new ActHistoryPageBinding((LinearLayout) view, appBarLayout, relativeLayout, relativeLayout2, relativeLayout3, imageView, imageView2, slidingTabLayout, findViewById, relativeLayout4, textView, textView2, myViewPager);
                                                    }
                                                }
                                            }
                                        }
    ...
    @NonNull
    public static ActHistoryPageBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ActHistoryPageBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.act_history_page, viewGroup, false);
        if (z) {
