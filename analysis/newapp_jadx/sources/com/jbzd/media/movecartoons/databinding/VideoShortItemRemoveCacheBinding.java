...
public final class VideoShortItemRemoveCacheBinding implements ViewBinding {
    ...
    @NonNull
    public static VideoShortItemRemoveCacheBinding bind(@NonNull View view) {
        int i2 = R.id.btn;
                                                                ...
                                                                if (textView3 != null) {
                                                                    ...
                                                                    if (textView4 != null) {
                                                                        ...
                                                                        if (textView5 != null) {
                                                                            ...
                                                                            if (textView6 != null) {
                                                                                return new VideoShortItemRemoveCacheBinding(swipeMenuLayout, textView, circleImageView, imageView, relativeLayout, imageView2, shapeableImageView, imageView3, linearLayout, linearLayout2, linearLayout3, constraintLayout, relativeLayout2, swipeMenuLayout, linearLayout4, textView2, textView3, textView4, textView5, textView6);
                                                                            }
                                                                        }
                                                                    }
                                                                }
    ...
    @NonNull
    public static VideoShortItemRemoveCacheBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static VideoShortItemRemoveCacheBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.video_short_item_remove_cache, viewGroup, false);
        if (z) {
