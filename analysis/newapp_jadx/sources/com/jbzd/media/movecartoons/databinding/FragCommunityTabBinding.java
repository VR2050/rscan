...
public final class FragCommunityTabBinding implements ViewBinding {
    ...
    @NonNull
    public static FragCommunityTabBinding bind(@NonNull View view) {
    ...
    @NonNull
    public static FragCommunityTabBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static FragCommunityTabBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
