...
public final class ActLongVideoListBinding implements ViewBinding {
    ...
    private ActLongVideoListBinding(@NonNull LinearLayout linearLayout, @NonNull RelativeLayout relativeLayout, @NonNull RelativeLayout relativeLayout2, @NonNull RelativeLayout relativeLayout3, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull View view, @NonNull RelativeLayout relativeLayout4, @NonNull TextView textView, @NonNull TextView textView2, @NonNull ViewPager viewPager) {
    ...
    @NonNull
    public static ActLongVideoListBinding bind(@NonNull View view) {
                                ...
                                if (relativeLayout4 != null) {
                                    ...
                                    if (textView != null) {
                                        ...
                                        if (textView2 != null) {
                                            ...
                                            if (viewPager != null) {
                                                return new ActLongVideoListBinding((LinearLayout) view, relativeLayout, relativeLayout2, relativeLayout3, imageView, imageView2, findViewById, relativeLayout4, textView, textView2, viewPager);
                                            }
                                        }
                                    }
                                }
    ...
    @NonNull
    public static ActLongVideoListBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ActLongVideoListBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.act_long_video_list, viewGroup, false);
        if (z) {
