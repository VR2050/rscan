...
public final class ItemPictureBinding implements ViewBinding {
    ...
    private ItemPictureBinding(@NonNull LinearLayout linearLayout, @NonNull ScaleImageView scaleImageView) {
    ...
    public static ItemPictureBinding bind(@NonNull View view) {
        ...
        if (scaleImageView != null) {
            return new ItemPictureBinding((LinearLayout) view, scaleImageView);
        }
