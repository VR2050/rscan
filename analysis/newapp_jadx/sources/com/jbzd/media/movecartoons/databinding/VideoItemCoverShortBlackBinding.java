...
public final class VideoItemCoverShortBlackBinding implements ViewBinding {
    ...
    @NonNull
    public static VideoItemCoverShortBlackBinding bind(@NonNull View view) {
                        ...
                        if (imageTextView5 != null) {
                            ...
                            if (imageTextView6 != null) {
                                ...
                                if (relativeLayout != null) {
                                    ...
                                    if (textView != null) {
                                        return new VideoItemCoverShortBlackBinding((RelativeLayout) view, imageTextView, imageTextView2, imageTextView3, imageTextView4, imageTextView5, imageTextView6, relativeLayout, textView);
                                    }
                                }
                            }
                        }
    ...
    @NonNull
    public static VideoItemCoverShortBlackBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static VideoItemCoverShortBlackBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.video_item_cover_short_black, viewGroup, false);
        if (z) {
