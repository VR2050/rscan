...
public final class PopupMenuBinding implements ViewBinding {
    ...
    /* renamed from: rv */
    @NonNull
    public final RecyclerView f10059rv;

    private PopupMenuBinding(@NonNull LinearLayout linearLayout, @NonNull RecyclerView recyclerView) {
        this.rootView = linearLayout;
        this.f10059rv = recyclerView;
    }
    ...
    public static PopupMenuBinding bind(@NonNull View view) {
        ...
        if (recyclerView != null) {
            return new PopupMenuBinding((LinearLayout) view, recyclerView);
        }
