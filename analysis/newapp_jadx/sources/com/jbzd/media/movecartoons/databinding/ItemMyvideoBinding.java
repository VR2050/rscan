...
public final class ItemMyvideoBinding implements ViewBinding {
    ...
    @NonNull
    public final TextView tvDelMyvideo;
    ...
    private ItemMyvideoBinding(@NonNull SwipeMenuLayout swipeMenuLayout, @NonNull CircleImageView circleImageView, @NonNull ImageView imageView, @NonNull RelativeLayout relativeLayout, @NonNull ImageView imageView2, @NonNull ShapeableImageView shapeableImageView, @NonNull ImageView imageView3, @NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull LinearLayout linearLayout3, @NonNull ConstraintLayout constraintLayout, @NonNull RelativeLayout relativeLayout2, @NonNull SwipeMenuLayout swipeMenuLayout2, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull TextView textView5, @NonNull TextView textView6) {
        ...
        this.tvDelMyvideo = textView2;
        this.tvDesc = textView3;
        this.tvHisDesc = textView4;
        this.tvName = textView5;
        this.tvTitle = textView6;
    }

    @NonNull
    public static ItemMyvideoBinding bind(@NonNull View view) {
                                        ...
                                        if (linearLayout3 != null) {
                                            ...
                                            if (constraintLayout != null) {
                                                ...
                                                if (relativeLayout2 != null) {
                                                    ...
                                                    if (textView != null) {
                                                        i2 = R.id.tv_del_myvideo;
                                                        TextView textView2 = (TextView) view.findViewById(R.id.tv_del_myvideo);
                                                        if (textView2 != null) {
                                                            i2 = R.id.tv_desc;
                                                            TextView textView3 = (TextView) view.findViewById(R.id.tv_desc);
                                                            if (textView3 != null) {
                                                                i2 = R.id.tv_hisDesc;
                                                                TextView textView4 = (TextView) view.findViewById(R.id.tv_hisDesc);
                                                                if (textView4 != null) {
                                                                    i2 = R.id.tv_name;
                                                                    ...
                                                                    if (textView5 != null) {
                                                                        ...
                                                                        if (textView6 != null) {
                                                                            return new ItemMyvideoBinding(swipeMenuLayout, circleImageView, imageView, relativeLayout, imageView2, shapeableImageView, imageView3, linearLayout, linearLayout2, linearLayout3, constraintLayout, relativeLayout2, swipeMenuLayout, textView, textView2, textView3, textView4, textView5, textView6);
                                                                        }
                                                                    }
                                                                }
                                                            }
    ...
    @NonNull
    public static ItemMyvideoBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ItemMyvideoBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.item_myvideo, viewGroup, false);
        if (z) {
