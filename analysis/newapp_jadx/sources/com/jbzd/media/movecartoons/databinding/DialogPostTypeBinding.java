...
public final class DialogPostTypeBinding implements ViewBinding {
    ...
    @NonNull
    public static DialogPostTypeBinding bind(@NonNull View view) {
                                        ...
                                        if (linearLayout2 != null) {
                                            ...
                                            if (linearLayout3 != null) {
                                                ...
                                                if (linearLayout4 != null) {
                                                    return new DialogPostTypeBinding((LinearLayout) view, textView, imageView, imageView2, imageView3, imageView4, textView2, imageView5, linearLayout, linearLayout2, linearLayout3, linearLayout4);
                                                }
                                            }
                                        }
                                    }
    ...
    @NonNull
    public static DialogPostTypeBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static DialogPostTypeBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.dialog_post_type, viewGroup, false);
        if (z) {
