...
public final class VideoLongItem1Binding implements ViewBinding {
    ...
    private VideoLongItem1Binding(@NonNull LinearLayout linearLayout, @NonNull TextView textView, @NonNull ImageTextView imageTextView, @NonNull ImageTextView imageTextView2, @NonNull ImageView imageView, @NonNull ShapeableImageView shapeableImageView, @NonNull ShapeableImageView shapeableImageView2, @NonNull LinearLayout linearLayout2, @NonNull LinearLayout linearLayout3, @NonNull LinearLayout linearLayout4, @NonNull LinearLayout linearLayout5, @NonNull ScaleRelativeLayout scaleRelativeLayout, @NonNull ScaleRelativeLayout scaleRelativeLayout2, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull TextView textView5) {
    ...
    @NonNull
    public static VideoLongItem1Binding bind(@NonNull View view) {
                        ...
                        if (shapeableImageView != null) {
                            ...
                            if (shapeableImageView2 != null) {
                                ...
                                if (linearLayout != null) {
                                    ...
                                    LinearLayout linearLayout2 = (LinearLayout) view.findViewById(R.id.ll_item_video);
                                    if (linearLayout2 != null) {
                                        i2 = R.id.ll_money_vip;
                                        LinearLayout linearLayout3 = (LinearLayout) view.findViewById(R.id.ll_money_vip);
                                                        ...
                                                        if (textView2 != null) {
                                                            ...
                                                            if (textView3 != null) {
                                                                ...
                                                                if (textView4 != null) {
                                                                    ...
                                                                    if (textView5 != null) {
                                                                        return new VideoLongItem1Binding((LinearLayout) view, textView, imageTextView, imageTextView2, imageView, shapeableImageView, shapeableImageView2, linearLayout, linearLayout2, linearLayout3, linearLayout4, scaleRelativeLayout, scaleRelativeLayout2, textView2, textView3, textView4, textView5);
                                                                    }
                                                                }
                                                            }
                                                        }
    ...
    @NonNull
    public static VideoLongItem1Binding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static VideoLongItem1Binding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.video_long_item1, viewGroup, false);
        if (z) {
