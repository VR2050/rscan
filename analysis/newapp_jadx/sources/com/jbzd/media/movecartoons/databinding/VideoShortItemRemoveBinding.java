...
public final class VideoShortItemRemoveBinding implements ViewBinding {
    ...
    @NonNull
    public static VideoShortItemRemoveBinding bind(@NonNull View view) {
                                                            ...
                                                            if (textView2 != null) {
                                                                ...
                                                                if (textView3 != null) {
                                                                    ...
                                                                    if (textView4 != null) {
                                                                        ...
                                                                        if (textView5 != null) {
                                                                            return new VideoShortItemRemoveBinding(swipeMenuLayout, circleImageView, imageView, relativeLayout, imageView2, shapeableImageView, imageView3, linearLayout, linearLayout2, linearLayout3, constraintLayout, relativeLayout2, swipeMenuLayout, linearLayout4, textView, textView2, textView3, textView4, textView5);
                                                                        }
                                                                    }
                                                                }
                                                            }
    ...
    @NonNull
    public static VideoShortItemRemoveBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static VideoShortItemRemoveBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.video_short_item_remove, viewGroup, false);
        if (z) {
