...
public final class DialogTimingBottomLightBinding implements ViewBinding {
    ...
    @NonNull
    public static DialogTimingBottomLightBinding bind(@NonNull View view) {
                                ...
                                if (textView6 != null) {
                                    ...
                                    if (textView7 != null) {
                                        ...
                                        if (textView8 != null) {
                                            ...
                                            if (textView9 != null) {
                                                return new DialogTimingBottomLightBinding((LinearLayout) view, textView, textView2, textView3, textView4, imageView, textView5, textView6, textView7, textView8, textView9);
                                            }
                                        }
                                    }
                                }
    ...
    @NonNull
    public static DialogTimingBottomLightBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static DialogTimingBottomLightBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.dialog_timing_bottom_light, viewGroup, false);
        if (z) {
