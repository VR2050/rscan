...
public final class VideoItemCoverShortBinding implements ViewBinding {
    ...
    private VideoItemCoverShortBinding(@NonNull RelativeLayout relativeLayout, @NonNull TextView textView, @NonNull ImageTextView imageTextView, @NonNull ImageTextView imageTextView2, @NonNull ImageTextView imageTextView3, @NonNull ImageTextView imageTextView4, @NonNull ImageTextView imageTextView5, @NonNull ImageTextView imageTextView6, @NonNull TextView textView2) {
    ...
    @NonNull
    public static VideoItemCoverShortBinding bind(@NonNull View view) {
        int i2 = R.id.itv_ad;
                        ...
                        if (imageTextView4 != null) {
                            ...
                            if (imageTextView5 != null) {
                                ...
                                if (imageTextView6 != null) {
                                    ...
                                    if (textView2 != null) {
                                        return new VideoItemCoverShortBinding((RelativeLayout) view, textView, imageTextView, imageTextView2, imageTextView3, imageTextView4, imageTextView5, imageTextView6, textView2);
                                    }
                                }
                            }
                        }
    ...
    @NonNull
    public static VideoItemCoverShortBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static VideoItemCoverShortBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.video_item_cover_short, viewGroup, false);
        if (z) {
