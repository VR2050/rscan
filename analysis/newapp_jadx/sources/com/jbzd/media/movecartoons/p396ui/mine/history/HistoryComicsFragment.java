...
public final class HistoryComicsFragment extends BaseListFragment<ComicsItemBean> {
    ...
    public void addItemListType(@NotNull BindingAdapter adapter, @NotNull RecyclerView rv) {
        ...
        if (m616f0) {
            adapter.f8910l.put(Reflection.typeOf(ComicsItemBean.class), new Function2<Object, Integer, Integer>() { // from class: com.jbzd.media.movecartoons.ui.mine.history.HistoryComicsFragment$addItemListType$$inlined$addType$1
            ...
            adapter.f8909k.put(Reflection.typeOf(ComicsItemBean.class), new Function2<Object, Integer, Integer>() { // from class: com.jbzd.media.movecartoons.ui.mine.history.HistoryComicsFragment$addItemListType$$inlined$addType$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }
    ...
    public InterfaceC3006b<List<ComicsItemBean>> initFlow(int page) {
        return ((InterfaceC0921e) LazyKt__LazyJVMKt.lazy(C0944a.a.f472c).getValue()).m250i(page);
    }

    @Override // com.jbzd.media.movecartoons.p396ui.BaseListFragment
    public void onViewClick(@NotNull BindingAdapter adapter) {
        Intrinsics.checkNotNullParameter(adapter, "adapter");
        adapter.m3937n(new int[]{R.id.root}, new Function2<BindingAdapter.BindingViewHolder, Integer, Unit>() { // from class: com.jbzd.media.movecartoons.ui.mine.history.HistoryComicsFragment$onViewClick$1
            {
                super(2);
            }
            ...
            public final void invoke(@NotNull BindingAdapter.BindingViewHolder onClick, int i2) {
                ...
                Context requireContext = HistoryComicsFragment.this.requireContext();
