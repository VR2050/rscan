...
import com.jbzd.media.movecartoons.p396ui.post.topic.PostAiChangeFaceVideoFragment$gridImageAdapter$2;
...
public final class PostAiChangeFaceVideoFragment$gridImageAdapter$2 extends Lambda implements Function0<MediaSelectAdapter> {
    public final /* synthetic */ PostAiChangeFaceVideoFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PostAiChangeFaceVideoFragment$gridImageAdapter$2(PostAiChangeFaceVideoFragment postAiChangeFaceVideoFragment) {
        super(0);
        this.this$0 = postAiChangeFaceVideoFragment;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: invoke$lambda-2$lambda-0, reason: not valid java name */
    public static final void m5960invoke$lambda2$lambda0(PostAiChangeFaceVideoFragment this$0, BaseQuickAdapter noName_0, View noName_1, int i2) {
    ...
    public static final void m5961invoke$lambda2$lambda1(PostAiChangeFaceVideoFragment this$0, MediaSelectAdapter this_apply, BaseQuickAdapter adapter, View view, int i2) {
        int i3;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final MediaSelectAdapter invoke() {
        ...
        final PostAiChangeFaceVideoFragment postAiChangeFaceVideoFragment = this.this$0;
        ...
        mediaSelectAdapter.setOnItemClickListener(new InterfaceC1304d() { // from class: b.a.a.a.t.k.f.l
            @Override // p005b.p067b.p068a.p069a.p070a.p076k.InterfaceC1304d
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                PostAiChangeFaceVideoFragment$gridImageAdapter$2.m5960invoke$lambda2$lambda0(PostAiChangeFaceVideoFragment.this, baseQuickAdapter, view, i2);
            }
        });
        mediaSelectAdapter.setOnItemChildClickListener(new InterfaceC1302b() { // from class: b.a.a.a.t.k.f.m
            ...
            public final void mo215a(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                PostAiChangeFaceVideoFragment$gridImageAdapter$2.m5961invoke$lambda2$lambda1(PostAiChangeFaceVideoFragment.this, mediaSelectAdapter, baseQuickAdapter, view, i2);
            }
        });
