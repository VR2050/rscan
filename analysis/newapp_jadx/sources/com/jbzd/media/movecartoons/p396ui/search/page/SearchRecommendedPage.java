...
import com.jbzd.media.movecartoons.p396ui.search.page.SearchRecommendedPage;
...
public final class SearchRecommendedPage extends MyThemeViewModelFragment<SearchInfoModel> {
    ...
    @Metadata(m5309bv = {1, 0, 3}, m5310d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u000b\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\r\u0010\u000eJ\u0015\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0005\u0010\u0006R\"\u0010\u0007\u001a\u00020\u00028\u0006@\u0006X\u0086.¢\u0006\u0012\n\u0004\b\u0007\u0010\b\u001a\u0004\b\t\u0010\n\"\u0004\b\u000b\u0010\f¨\u0006\u000f"}, m5311d2 = {"Lcom/jbzd/media/movecartoons/ui/search/page/SearchRecommendedPage$Companion;", "", "", "position", "Lcom/jbzd/media/movecartoons/ui/search/page/SearchRecommendedPage;", "newInstance", "(Ljava/lang/String;)Lcom/jbzd/media/movecartoons/ui/search/page/SearchRecommendedPage;", "mPosition", "Ljava/lang/String;", "getMPosition", "()Ljava/lang/String;", "setMPosition", "(Ljava/lang/String;)V", "<init>", "()V", "app_release"}, m5312k = 1, m5313mv = {1, 5, 1})
    public static final class Companion {
        ...
        public final String getMPosition() {
            String str = SearchRecommendedPage.mPosition;
            if (str != null) {
                return str;
            }
        ...
        @NotNull
        public final SearchRecommendedPage newInstance(@NotNull String position) {
            Intrinsics.checkNotNullParameter(position, "position");
            setMPosition(position);
            return new SearchRecommendedPage();
        }

        public final void setMPosition(@NotNull String str) {
            Intrinsics.checkNotNullParameter(str, "<set-?>");
            SearchRecommendedPage.mPosition = str;
        }
    }

    @Metadata(m5309bv = {1, 0, 3}, m5310d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\r\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\f\u001a\u00020\u000b¢\u0006\u0004\b\u0016\u0010\u0017J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0007¢\u0006\u0004\b\u0005\u0010\u0006J\u0017\u0010\t\u001a\u00020\u00042\u0006\u0010\b\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\t\u0010\nR\"\u0010\f\u001a\u00020\u000b8\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\f\u0010\r\u001a\u0004\b\u000e\u0010\u000f\"\u0004\b\u0010\u0010\u0011R\"\u0010\u0003\u001a\u00020\u00028\u0006@\u0006X\u0086\u000e¢\u0006\u0012\n\u0004\b\u0003\u0010\u0012\u001a\u0004\b\u0013\u0010\u0014\"\u0004\b\u0015\u0010\u0006¨\u0006\u0018"}, m5311d2 = {"Lcom/jbzd/media/movecartoons/ui/search/page/SearchRecommendedPage$SearchCheck;", "Lcom/jbzd/media/movecartoons/ui/search/adapter/CheckChange;", "Lcom/jbzd/media/movecartoons/bean/response/LibraryBean;", "bean", "", "doSearch", "(Lcom/jbzd/media/movecartoons/bean/response/LibraryBean;)V", "Lcom/jbzd/media/movecartoons/bean/response/FilterData;", "item", "change", "(Lcom/jbzd/media/movecartoons/bean/response/FilterData;)V", "Landroidx/fragment/app/FragmentActivity;", "act", "Landroidx/fragment/app/FragmentActivity;", "getAct", "()Landroidx/fragment/app/FragmentActivity;", "setAct", "(Landroidx/fragment/app/FragmentActivity;)V", "Lcom/jbzd/media/movecartoons/bean/response/LibraryBean;", "getBean", "()Lcom/jbzd/media/movecartoons/bean/response/LibraryBean;", "setBean", "<init>", "(Lcom/jbzd/media/movecartoons/bean/response/LibraryBean;Landroidx/fragment/app/FragmentActivity;)V", "app_release"}, m5312k = 1, m5313mv = {1, 5, 1})
    public static final class SearchCheck extends CheckChange {
        ...
        public final void doSearch(@NotNull LibraryBean bean) {
            ...
            Companion companion = SearchRecommendedPage.INSTANCE;
            hashMap.put("position", companion.getMPosition());
            if (Intrinsics.areEqual(companion.getMPosition(), "cartoon")) {
                hashMap.put("search_method", "cartoon");
                this.act.getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, SearchResultListLong.INSTANCE.newInstance(hashMap, true)).commit();
            } else {
                hashMap.put("search_method", "normal");
                this.act.getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, SearchResultListLong.INSTANCE.newInstance(hashMap, false)).commit();
            }
        }
    ...
    public SearchRecommendedPage() {
        final Function0<Fragment> function0 = new Function0<Fragment>() { // from class: com.jbzd.media.movecartoons.ui.search.page.SearchRecommendedPage$special$$inlined$viewModels$default$1
            {
                super(0);
            }
        ...
        this.viewModel = FragmentViewModelLazyKt.createViewModelLazy(this, Reflection.getOrCreateKotlinClass(SearchInfoModel.class), new Function0<ViewModelStore>() { // from class: com.jbzd.media.movecartoons.ui.search.page.SearchRecommendedPage$special$$inlined$viewModels$default$2
            {
                super(0);
            }
    ...
    public static final void m5994initViews$lambda0(SearchRecommendedPage this$0, HashMap hashMap) {
        ...
        if (arrayList.size() == 4) {
            ...
            SearchCheck searchCheck = new SearchCheck(libraryBean, requireActivity);
        ...
        if (arrayList.size() == 3) {
            ...
            SearchCheck searchCheck2 = new SearchCheck(libraryBean, requireActivity2);
    ...
    public void initViews() {
        super.initViews();
        SearchInfoModel.getLibrary$default(getViewModel(), INSTANCE.getMPosition(), false, 2, null);
        getViewModel().getLibrary().observe(getViewLifecycleOwner(), new Observer() { // from class: b.a.a.a.t.m.k.h
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                SearchRecommendedPage.m5994initViews$lambda0(SearchRecommendedPage.this, (HashMap) obj);
            }
        });
    }
