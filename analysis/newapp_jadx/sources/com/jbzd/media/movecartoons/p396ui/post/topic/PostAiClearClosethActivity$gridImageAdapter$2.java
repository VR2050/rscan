...
import com.jbzd.media.movecartoons.p396ui.post.topic.PostAiClearClosethActivity$gridImageAdapter$2;
...
public final class PostAiClearClosethActivity$gridImageAdapter$2 extends Lambda implements Function0<MediaSelectAdapter> {
    public final /* synthetic */ PostAiClearClosethActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PostAiClearClosethActivity$gridImageAdapter$2(PostAiClearClosethActivity postAiClearClosethActivity) {
        super(0);
        this.this$0 = postAiClearClosethActivity;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: invoke$lambda-2$lambda-0, reason: not valid java name */
    public static final void m5964invoke$lambda2$lambda0(PostAiClearClosethActivity this$0, BaseQuickAdapter noName_0, View noName_1, int i2) {
    ...
    public static final void m5965invoke$lambda2$lambda1(PostAiClearClosethActivity this$0, MediaSelectAdapter this_apply, BaseQuickAdapter adapter, View view, int i2) {
    ...
    public final MediaSelectAdapter invoke() {
        ...
        final PostAiClearClosethActivity postAiClearClosethActivity = this.this$0;
        ...
        mediaSelectAdapter.setOnItemClickListener(new InterfaceC1304d() { // from class: b.a.a.a.t.k.f.r
            @Override // p005b.p067b.p068a.p069a.p070a.p076k.InterfaceC1304d
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                PostAiClearClosethActivity$gridImageAdapter$2.m5964invoke$lambda2$lambda0(PostAiClearClosethActivity.this, baseQuickAdapter, view, i2);
            }
        });
        mediaSelectAdapter.setOnItemChildClickListener(new InterfaceC1302b() { // from class: b.a.a.a.t.k.f.q
            ...
            public final void mo215a(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                PostAiClearClosethActivity$gridImageAdapter$2.m5965invoke$lambda2$lambda1(PostAiClearClosethActivity.this, mediaSelectAdapter, baseQuickAdapter, view, i2);
            }
        });
