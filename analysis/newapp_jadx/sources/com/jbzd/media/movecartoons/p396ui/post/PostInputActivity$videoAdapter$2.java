...
import com.jbzd.media.movecartoons.p396ui.post.PostInputActivity$videoAdapter$2;
...
public final class PostInputActivity$videoAdapter$2 extends Lambda implements Function0<MediaSelectAdapter> {
    public final /* synthetic */ PostInputActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PostInputActivity$videoAdapter$2(PostInputActivity postInputActivity) {
        super(0);
    ...
    public static final void m5946invoke$lambda2$lambda0(PostInputActivity this$0, BaseQuickAdapter noName_0, View noName_1, int i2) {
    ...
    public static final void m5947invoke$lambda2$lambda1(PostInputActivity this$0, MediaSelectAdapter this_apply, BaseQuickAdapter noName_0, View view, int i2) {
        ...
        if (view.getId() == R.id.iv_delete) {
            ...
            gridImageAdapter = this$0.getGridImageAdapter();
            this$0.removeItem(gridImageAdapter, 0);
    ...
    public final MediaSelectAdapter invoke() {
        ...
        mediaSelectAdapter.setupMedia(MediaSelectAdapter.MediaType.Video.INSTANCE);
        mediaSelectAdapter.addChildClickViewIds(R.id.iv_delete);
        mediaSelectAdapter.setOnItemClickListener(new InterfaceC1304d() { // from class: b.a.a.a.t.k.e
            @Override // p005b.p067b.p068a.p069a.p070a.p076k.InterfaceC1304d
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                PostInputActivity$videoAdapter$2.m5946invoke$lambda2$lambda0(PostInputActivity.this, baseQuickAdapter, view, i2);
            }
        });
        mediaSelectAdapter.setOnItemChildClickListener(new InterfaceC1302b() { // from class: b.a.a.a.t.k.d
            ...
            public final void mo215a(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                PostInputActivity$videoAdapter$2.m5947invoke$lambda2$lambda1(PostInputActivity.this, mediaSelectAdapter, baseQuickAdapter, view, i2);
            }
        });
