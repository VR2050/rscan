...
import com.jbzd.media.movecartoons.p396ui.post.topic.PostAIChangeFacePicFragment$gridSourceImageAdapter$2;
...
public final class PostAIChangeFacePicFragment$gridSourceImageAdapter$2 extends Lambda implements Function0<MediaSelectAdapter> {
    public final /* synthetic */ PostAIChangeFacePicFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PostAIChangeFacePicFragment$gridSourceImageAdapter$2(PostAIChangeFacePicFragment postAIChangeFacePicFragment) {
        super(0);
    ...
    public static final void m5952invoke$lambda2$lambda0(PostAIChangeFacePicFragment this$0, BaseQuickAdapter noName_0, View noName_1, int i2) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(noName_0, "$noName_0");
        Intrinsics.checkNotNullParameter(noName_1, "$noName_1");
        this$0.selectImageSource();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: invoke$lambda-2$lambda-1, reason: not valid java name */
    public static final void m5953invoke$lambda2$lambda1(PostAIChangeFacePicFragment this$0, MediaSelectAdapter this_apply, BaseQuickAdapter adapter, View view, int i2) {
        int i3;
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public final MediaSelectAdapter invoke() {
        ...
        mediaSelectAdapter.setOnItemClickListener(new InterfaceC1304d() { // from class: b.a.a.a.t.k.f.e
            @Override // p005b.p067b.p068a.p069a.p070a.p076k.InterfaceC1304d
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                PostAIChangeFacePicFragment$gridSourceImageAdapter$2.m5952invoke$lambda2$lambda0(PostAIChangeFacePicFragment.this, baseQuickAdapter, view, i2);
            }
        });
        mediaSelectAdapter.setOnItemChildClickListener(new InterfaceC1302b() { // from class: b.a.a.a.t.k.f.f
            ...
            public final void mo215a(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
                PostAIChangeFacePicFragment$gridSourceImageAdapter$2.m5953invoke$lambda2$lambda1(PostAIChangeFacePicFragment.this, mediaSelectAdapter, baseQuickAdapter, view, i2);
            }
        });
