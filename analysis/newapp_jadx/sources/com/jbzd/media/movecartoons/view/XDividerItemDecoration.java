...
public class XDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public XDividerItemDecoration(Context context, int i2) {
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView recyclerView) {
        ...
        for (int i3 = this.isHeader; i3 < childCount - 2; i3++) {
    ...
    private void drawVertical(Canvas canvas, RecyclerView recyclerView) {
        ...
        int childCount = recyclerView.getChildCount();
        for (int i3 = this.isHeader; i3 < childCount - 1; i3++) {
            View childAt = recyclerView.getChildAt(i3);
    ...
    public XDividerItemDecoration(Context context, int i2, boolean z) {
        this.mBounds = new Rect();
        this.isHeader = false;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(ATTRS);
        this.isHeader = z;
