...
public class BadgeUtils {
    ...
    public static void detachBadgeDrawable(@Nullable BadgeDrawable badgeDrawable, @NonNull Toolbar toolbar, @IdRes int i2) {
        ...
        if (badgeDrawable == null || (actionMenuItemView = ToolbarUtils.getActionMenuItemView(toolbar, i2)) == null) {
            return;
        }
        ...
        toolbar.post(new Runnable() { // from class: com.google.android.material.badge.BadgeUtils.1
            ...
            public void run() {
                ...
                if (actionMenuItemView != null) {
                    ...
                    badgeDrawable2.setHorizontalOffset(Toolbar.this.getResources().getDimensionPixelOffset(C3336R.dimen.mtrl_badge_toolbar_action_menu_item_horizontal_offset) + badgeDrawable2.getHorizontalOffset());
                    BadgeDrawable badgeDrawable3 = badgeDrawable;
                    badgeDrawable3.setVerticalOffset(Toolbar.this.getResources().getDimensionPixelOffset(C3336R.dimen.mtrl_badge_toolbar_action_menu_item_vertical_offset) + badgeDrawable3.getVerticalOffset());
