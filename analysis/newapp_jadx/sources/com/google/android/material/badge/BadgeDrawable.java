...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    @StyleRes
    private static final int DEFAULT_STYLE = C3336R.style.Widget_MaterialComponents_Badge;

    @AttrRes
    private static final int DEFAULT_THEME_ATTR = C3336R.attr.badgeStyle;
    ...
    private BadgeDrawable(@NonNull Context context) {
        ...
        this.badgeRadius = resources.getDimensionPixelSize(C3336R.dimen.mtrl_badge_radius);
        this.badgeWidePadding = resources.getDimensionPixelSize(C3336R.dimen.mtrl_badge_long_text_horizontal_padding);
        this.badgeWithTextRadius = resources.getDimensionPixelSize(C3336R.dimen.mtrl_badge_with_text_radius);
        TextDrawableHelper textDrawableHelper = new TextDrawableHelper(this);
        this.textDrawableHelper = textDrawableHelper;
        textDrawableHelper.getTextPaint().setTextAlign(Paint.Align.CENTER);
        this.savedState = new SavedState(context);
        setTextAppearanceResource(C3336R.style.TextAppearance_MaterialComponents_Badge);
    }
    ...
    private void calculateCenterAndBounds(@NonNull Context context, @NonNull Rect rect, @NonNull View view) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(hasNumber() ? C3336R.dimen.mtrl_badge_text_horizontal_edge_offset : C3336R.dimen.mtrl_badge_horizontal_edge_offset);
    ...
    private String getBadgeText() {
        ...
        return context == null ? "" : context.getString(C3336R.string.mtrl_exceed_max_badge_number_suffix, Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }

    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, @AttrRes int i2, @StyleRes int i3) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C3336R.styleable.Badge, i2, i3, new int[0]);
        setMaxCharacterCount(obtainStyledAttributes.getInt(C3336R.styleable.Badge_maxCharacterCount, 4));
        int i4 = C3336R.styleable.Badge_number;
        if (obtainStyledAttributes.hasValue(i4)) {
            setNumber(obtainStyledAttributes.getInt(i4, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, obtainStyledAttributes, C3336R.styleable.Badge_backgroundColor));
        int i5 = C3336R.styleable.Badge_badgeTextColor;
        if (obtainStyledAttributes.hasValue(i5)) {
            setBadgeTextColor(readColorFromAttributes(context, obtainStyledAttributes, i5));
        }
        setBadgeGravity(obtainStyledAttributes.getInt(C3336R.styleable.Badge_badgeGravity, TOP_END));
        setHorizontalOffset(obtainStyledAttributes.getDimensionPixelOffset(C3336R.styleable.Badge_horizontalOffset, 0));
        setVerticalOffset(obtainStyledAttributes.getDimensionPixelOffset(C3336R.styleable.Badge_verticalOffset, 0));
    ...
    private void tryWrapAnchorInCompatParent(final View view) {
        ...
        if (viewGroup == null || viewGroup.getId() != C3336R.id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != viewGroup) {
                updateAnchorParentToNotClip(view);
                final FrameLayout frameLayout = new FrameLayout(view.getContext());
                frameLayout.setId(C3336R.id.mtrl_anchor_parent);
    ...
    public static final class SavedState implements Parcelable {
        ...
        public SavedState(@NonNull Context context) {
            this.alpha = 255;
            this.number = -1;
            this.badgeTextColor = new TextAppearance(context, C3336R.style.TextAppearance_MaterialComponents_Badge).textColor.getDefaultColor();
            this.contentDescriptionNumberless = context.getString(C3336R.string.mtrl_badge_numberless_content_description);
            this.contentDescriptionQuantityStrings = C3336R.plurals.mtrl_badge_content_description;
            this.contentDescriptionExceedsMaxBadgeNumberRes = C3336R.string.mtrl_exceed_max_badge_number_content_description;
            this.isVisible = true;
        }
