...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C3336R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = obtainStyledAttributes.getDimensionPixelSize(C3336R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = obtainStyledAttributes.getDimensionPixelSize(C3336R.styleable.FlowLayout_itemSpacing, 0);
    ...
    public int getRowIndex(@NonNull View view) {
        Object tag = view.getTag(C3336R.id.row_index_key);
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        for (int i11 = 0; i11 < getChildCount(); i11++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(C3336R.id.row_index_key, -1);
            } else {
                ...
                childAt.setTag(C3336R.id.row_index_key, Integer.valueOf(this.rowCount - 1));
                int i12 = i9 + i7;
