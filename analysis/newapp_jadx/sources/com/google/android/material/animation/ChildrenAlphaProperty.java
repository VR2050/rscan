...
public class ChildrenAlphaProperty extends Property<ViewGroup, Float> {
    ...
    public Float get(@NonNull ViewGroup viewGroup) {
        Float f2 = (Float) viewGroup.getTag(C3336R.id.mtrl_internal_children_alpha_tag);
    ...
    public void set(@NonNull ViewGroup viewGroup, @NonNull Float f2) {
        ...
        viewGroup.setTag(C3336R.id.mtrl_internal_children_alpha_tag, Float.valueOf(floatValue));
