...
public class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int i2, ColorStateList colorStateList) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C3336R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C3336R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C3336R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C3336R.color.design_fab_stroke_end_outer_color));
