...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createTranslationAppearAnimator(View view, View view2, int i2, @Px int i3) {
        ...
        throw new IllegalArgumentException(C1499a.m626l("Invalid slide direction: ", i2));
    }
    ...
    private int getSlideDistanceOrDefault(Context context) {
        ...
        return i2 != -1 ? i2 : context.getResources().getDimensionPixelSize(C3336R.dimen.mtrl_transition_shared_axis_slide_distance);
    }
