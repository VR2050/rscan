...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeThroughAnimator(final View view, final float f2, final float f3, @FloatRange(from = 0.0d, m110to = 1.0d) final float f4, @FloatRange(from = 0.0d, m110to = 1.0d) final float f5, final float f6) {
