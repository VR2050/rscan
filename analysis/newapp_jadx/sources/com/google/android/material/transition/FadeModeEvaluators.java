...
public class FadeModeEvaluators {
    ...
    /* renamed from: IN */
    private static final FadeModeEvaluator f9865IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int i2, boolean z) {
        if (i2 == 0) {
            return z ? f9865IN : OUT;
        }
        if (i2 == 1) {
            return z ? OUT : f9865IN;
        }
        if (i2 == 2) {
            return CROSS;
        }
