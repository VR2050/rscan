...
public class TransitionUtils {
    ...
    public static View findAncestorById(View view, @IdRes int i2) {
        ...
        throw new IllegalArgumentException(C1499a.m637w(resourceName, " is not a valid ancestor"));
    }
    ...
    public static float lerp(float f2, float f3, @FloatRange(from = 0.0d, m110to = 1.0d) float f4, @FloatRange(from = 0.0d, m110to = 1.0d) float f5, @FloatRange(from = 0.0d) float f6, boolean z) {
        return (!z || (f6 >= 0.0f && f6 <= 1.0f)) ? f6 < f4 ? f2 : f6 > f5 ? f3 : lerp(f2, f3, (f6 - f4) / (f5 - f4)) : lerp(f2, f3, f6);
    }

    public static int lerp(int i2, int i3, @FloatRange(from = 0.0d, m110to = 1.0d) float f2, @FloatRange(from = 0.0d, m110to = 1.0d) float f3, @FloatRange(from = 0.0d, m110to = 1.0d) float f4) {
        return f4 < f2 ? i2 : f4 > f3 ? i3 : (int) lerp(i2, i3, (f4 - f2) / (f3 - f2));
    }

    public static ShapeAppearanceModel lerp(ShapeAppearanceModel shapeAppearanceModel, ShapeAppearanceModel shapeAppearanceModel2, final RectF rectF, final RectF rectF2, @FloatRange(from = 0.0d, m110to = 1.0d) final float f2, @FloatRange(from = 0.0d, m110to = 1.0d) final float f3, @FloatRange(from = 0.0d, m110to = 1.0d) final float f4) {
