...
public abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    public void setGrowFraction(@FloatRange(from = 0.0d, m110to = 1.0d) float f2) {
    ...
    @VisibleForTesting
    public void setMockHideAnimationRunning(boolean z, @FloatRange(from = 0.0d, m110to = 1.0d) float f2) {
        this.mockHideAnimationRunning = z;
        this.mockGrowFraction = f2;
    }

    @VisibleForTesting
    public void setMockShowAnimationRunning(boolean z, @FloatRange(from = 0.0d, m110to = 1.0d) float f2) {
