...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
        ...
        if (i2 != -1) {
            if (i2 == 0) {
                if (z) {
                    ...
                    updateViewPaddingBottom(viewGroup, ((Integer) viewGroup.getTag(C3336R.id.mtrl_view_tag_bottom_padding)).intValue());
                ...
                updateViewPaddingBottom(viewGroup2, ((Integer) viewGroup2.getTag(C3336R.id.mtrl_view_tag_bottom_padding)).intValue());
                if (z) {
            ...
            if (z) {
                ...
                updateViewPaddingBottom(viewGroup3, ((Integer) viewGroup3.getTag(C3336R.id.mtrl_view_tag_bottom_padding)).intValue());
                this.largeLabel.setVisibility(0);
            } else {
                setViewLayoutParams(this.icon, this.defaultMargin, 17);
                updateViewPaddingBottom(this.labelGroup, 0);
            ...
            updateViewPaddingBottom(viewGroup4, ((Integer) viewGroup4.getTag(C3336R.id.mtrl_view_tag_bottom_padding)).intValue());
            if (z) {
                setViewLayoutParams(this.icon, (int) (this.defaultMargin + this.shiftAmount), 49);
                setViewScaleValues(this.largeLabel, 1.0f, 1.0f, 0);
    ...
    public BottomNavigationItemView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        LayoutInflater.from(context).inflate(C3336R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(C3336R.drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C3336R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C3336R.id.icon);
        ViewGroup viewGroup = (ViewGroup) findViewById(C3336R.id.labelGroup);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C3336R.id.smallLabel);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C3336R.id.largeLabel);
        this.largeLabel = textView2;
        viewGroup.setTag(C3336R.id.mtrl_view_tag_bottom_padding, Integer.valueOf(viewGroup.getPaddingBottom()));
