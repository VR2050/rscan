...
public class BottomNavigationView extends FrameLayout {
    private static final int DEF_STYLE_RES = C3336R.style.Widget_Design_BottomNavigationView;
    ...
    private void addCompatibilityTopDivider(Context context) {
        ...
        view.setBackgroundColor(ContextCompat.getColor(context, C3336R.color.design_bottom_navigation_shadow_color));
        view.setLayoutParams(new FrameLayout.LayoutParams(-1, getResources().getDimensionPixelSize(C3336R.dimen.design_bottom_navigation_shadow_height)));
        addView(view);
    }
    ...
    public BottomNavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C3336R.attr.bottomNavigationStyle);
    }
    ...
    public BottomNavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        int[] iArr = C3336R.styleable.BottomNavigationView;
        int i3 = C3336R.style.Widget_Design_BottomNavigationView;
        int i4 = C3336R.styleable.BottomNavigationView_itemTextAppearanceInactive;
        int i5 = C3336R.styleable.BottomNavigationView_itemTextAppearanceActive;
        ...
        int i6 = C3336R.styleable.BottomNavigationView_itemIconTint;
        ...
        setItemIconSize(obtainTintedStyledAttributes.getDimensionPixelSize(C3336R.styleable.BottomNavigationView_itemIconSize, getResources().getDimensionPixelSize(C3336R.dimen.design_bottom_navigation_icon_size)));
        ...
        int i7 = C3336R.styleable.BottomNavigationView_itemTextColor;
        ...
        if (obtainTintedStyledAttributes.hasValue(C3336R.styleable.BottomNavigationView_elevation)) {
            setElevation(obtainTintedStyledAttributes.getDimensionPixelSize(r2, 0));
        }
        DrawableCompat.setTintList(getBackground().mutate(), MaterialResources.getColorStateList(context2, obtainTintedStyledAttributes, C3336R.styleable.BottomNavigationView_backgroundTint));
        setLabelVisibilityMode(obtainTintedStyledAttributes.getInteger(C3336R.styleable.BottomNavigationView_labelVisibilityMode, -1));
        setItemHorizontalTranslationEnabled(obtainTintedStyledAttributes.getBoolean(C3336R.styleable.BottomNavigationView_itemHorizontalTranslationEnabled, true));
        int resourceId = obtainTintedStyledAttributes.getResourceId(C3336R.styleable.BottomNavigationView_itemBackground, 0);
        if (resourceId != 0) {
            bottomNavigationMenuView.setItemBackgroundRes(resourceId);
        } else {
            setItemRippleColor(MaterialResources.getColorStateList(context2, obtainTintedStyledAttributes, C3336R.styleable.BottomNavigationView_itemRippleColor));
        }
        int i8 = C3336R.styleable.BottomNavigationView_menu;
