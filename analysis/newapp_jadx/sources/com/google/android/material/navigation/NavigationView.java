...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    private static final int DEF_STYLE_RES = C3336R.style.Widget_Design_NavigationView;
    ...
    private final Drawable createDefaultItemBackground(@NonNull TintTypedArray tintTypedArray) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(getContext(), tintTypedArray.getResourceId(C3336R.styleable.NavigationView_itemShapeAppearance, 0), tintTypedArray.getResourceId(C3336R.styleable.NavigationView_itemShapeAppearanceOverlay, 0)).build());
        materialShapeDrawable.setFillColor(MaterialResources.getColorStateList(getContext(), tintTypedArray, C3336R.styleable.NavigationView_itemShapeFillColor));
        return new InsetDrawable((Drawable) materialShapeDrawable, tintTypedArray.getDimensionPixelSize(C3336R.styleable.NavigationView_itemShapeInsetStart, 0), tintTypedArray.getDimensionPixelSize(C3336R.styleable.NavigationView_itemShapeInsetTop, 0), tintTypedArray.getDimensionPixelSize(C3336R.styleable.NavigationView_itemShapeInsetEnd, 0), tintTypedArray.getDimensionPixelSize(C3336R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
    ...
    private boolean hasShapeAppearance(@NonNull TintTypedArray tintTypedArray) {
        return tintTypedArray.hasValue(C3336R.styleable.NavigationView_itemShapeAppearance) || tintTypedArray.hasValue(C3336R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    public NavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C3336R.attr.navigationViewStyle);
    }
