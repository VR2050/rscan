...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f2, float f3, float f4) {
        ...
        this.shadowStartColor = ContextCompat.getColor(context, C3336R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = ContextCompat.getColor(context, C3336R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = ContextCompat.getColor(context, C3336R.color.design_fab_shadow_end_color);
    ...
    public float getMinHeight() {
        float f2 = this.rawMaxShadowSize;
        return (this.rawMaxShadowSize * 1.5f * 2.0f) + (Math.max(f2, ((f2 * 1.5f) / 2.0f) + this.cornerRadius) * 2.0f);
    }
