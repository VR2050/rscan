...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C3336R.style.Widget_Design_AppBarLayout;
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull T t, int i2) {
            ...
            if (i3 >= 0 && (pendingAction & 8) == 0) {
                ...
                setHeaderTopBottomOffset(coordinatorLayout, t, this.offsetToChildIndexOnLayoutIsMinHeight ? t.getTopInset() + ViewCompat.getMinimumHeight(childAt) + i4 : Math.round(childAt.getHeight() * this.offsetToChildIndexOnLayoutPerc) + i4);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C3336R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(obtainStyledAttributes.getDimensionPixelSize(C3336R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
    ...
    private void startLiftOnScrollElevationOverlayAnimation(@NonNull final MaterialShapeDrawable materialShapeDrawable, boolean z) {
        float dimension = getResources().getDimension(C3336R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration(getResources().getInteger(C3336R.integer.app_bar_elevation_anim_duration));
    ...
    public int[] onCreateDrawableState(int i2) {
        ...
        int i3 = C3336R.attr.state_liftable;
        if (!z) {
            i3 = -i3;
        }
        iArr[0] = i3;
        iArr[1] = (z && this.lifted) ? C3336R.attr.state_lifted : -C3336R.attr.state_lifted;
        int i4 = C3336R.attr.state_collapsible;
        if (!z) {
            i4 = -i4;
        }
        iArr[2] = i4;
        iArr[3] = (z && this.lifted) ? C3336R.attr.state_collapsed : -C3336R.attr.state_collapsed;
    ...
    public AppBarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C3336R.attr.appBarLayoutStyle);
    }
    ...
    */
    public AppBarLayout(@androidx.annotation.NonNull android.content.Context r10, @androidx.annotation.Nullable android.util.AttributeSet r11, int r12) {
        /*
            ...
            int[] r2 = com.google.android.material.C3336R.styleable.AppBarLayout
            int[] r5 = new int[r6]
            r0 = r7
            r1 = r11
            r3 = r12
            ...
            int r12 = com.google.android.material.C3336R.styleable.AppBarLayout_android_background
        ...
        L5b:
            int r12 = com.google.android.material.C3336R.styleable.AppBarLayout_expanded
            boolean r0 = r11.hasValue(r12)
            if (r0 == 0) goto L6a
            boolean r12 = r11.getBoolean(r12, r6)
            r9.setExpanded(r12, r6, r6)
        L6a:
            int r12 = com.google.android.material.C3336R.styleable.AppBarLayout_elevation
            boolean r0 = r11.hasValue(r12)
            if (r0 == 0) goto L7a
        ...
        L7a:
            r12 = 26
            if (r8 < r12) goto L9c
            int r12 = com.google.android.material.C3336R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r0 = r11.hasValue(r12)
            if (r0 == 0) goto L8d
            boolean r12 = r11.getBoolean(r12, r6)
            r9.setKeyboardNavigationCluster(r12)
        L8d:
            int r12 = com.google.android.material.C3336R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r0 = r11.hasValue(r12)
            if (r0 == 0) goto L9c
            boolean r12 = r11.getBoolean(r12, r6)
            r9.setTouchscreenBlocksFocus(r12)
        L9c:
            int r12 = com.google.android.material.C3336R.styleable.AppBarLayout_liftOnScroll
            boolean r12 = r11.getBoolean(r12, r6)
            r9.liftOnScroll = r12
            int r12 = com.google.android.material.C3336R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r10 = r11.getResourceId(r12, r10)
            r9.liftOnScrollTargetViewId = r10
            int r10 = com.google.android.material.C3336R.styleable.AppBarLayout_statusBarForeground
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            this.scrollFlags = 1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C3336R.styleable.AppBarLayout_Layout);
            this.scrollFlags = obtainStyledAttributes.getInt(C3336R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            int i2 = C3336R.styleable.AppBarLayout_Layout_layout_scrollInterpolator;
