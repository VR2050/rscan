...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int DEF_STYLE_RES = C3336R.style.Widget_Design_TabLayout;
    ...
    public final class TabView extends LinearLayout {
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C3336R.layout.design_layout_tab_icon, (ViewGroup) frameLayout, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C3336R.layout.design_layout_tab_text, (ViewGroup) frameLayout, false);
        ...
        public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            wrap.setRoleDescription(getResources().getString(C3336R.string.item_view_role_description));
        }
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f9864id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f9864id);
        }
    ...
    */
    ...
    public TabLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C3336R.attr.tabStyle);
    }
