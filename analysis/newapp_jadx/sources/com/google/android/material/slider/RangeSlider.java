...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C3336R.styleable.RangeSlider, i2, BaseSlider.DEF_STYLE_RES, new int[0]);
        int i3 = C3336R.styleable.RangeSlider_values;
        ...
        this.minSeparation = obtainStyledAttributes.getDimension(C3336R.styleable.RangeSlider_minSeparation, 0.0f);
