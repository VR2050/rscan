...
public class TextInputEditText extends AppCompatEditText {
    ...
    private String getAccessibilityNodeInfoText(@NonNull TextInputLayout textInputLayout) {
        ...
        setLabelFor(C3336R.id.textinput_helper_text);
        ...
        sb.append(TextUtils.isEmpty(charSequence) ? "" : C1499a.m637w(", ", charSequence));
        return sb.toString();
    }
    ...
    public boolean requestRectangleOnScreen(@Nullable Rect rect) {
        ...
        if (textInputLayout != null && this.textInputLayoutFocusedRectEnabled) {
            this.parentRect.set(0, textInputLayout.getHeight() - getResources().getDimensionPixelOffset(C3336R.dimen.mtrl_edittext_rectangle_top_offset), textInputLayout.getWidth(), textInputLayout.getHeight());
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C3336R.attr.editTextStyle);
    }
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C3336R.styleable.TextInputEditText, i2, C3336R.style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(obtainStyledAttributes.getBoolean(C3336R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
