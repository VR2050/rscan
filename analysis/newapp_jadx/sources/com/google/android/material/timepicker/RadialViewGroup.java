...
public class RadialViewGroup extends ConstraintLayout {
    ...
    public void updateLayoutParams() {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            int i5 = C3336R.id.circle_center;
    ...
    public RadialViewGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        LayoutInflater.from(context).inflate(C3336R.layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C3336R.styleable.RadialViewGroup, i2, 0);
        this.radius = obtainStyledAttributes.getDimensionPixelSize(C3336R.styleable.RadialViewGroup_materialCircleRadius, 0);
