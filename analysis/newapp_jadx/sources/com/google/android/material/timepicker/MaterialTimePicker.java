...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setHour(@IntRange(from = 0, m111to = 23) int i2) {
        ...
        @NonNull
        public Builder setMinute(@IntRange(from = 0, m111to = 60) int i2) {
    ...
    private Pair<Integer, Integer> dataForMode(int i2) {
        if (i2 == 0) {
            return new Pair<>(Integer.valueOf(this.keyboardIcon), Integer.valueOf(C3336R.string.material_timepicker_text_input_mode_description));
        }
        if (i2 == 1) {
            return new Pair<>(Integer.valueOf(this.clockIcon), Integer.valueOf(C3336R.string.material_timepicker_clock_mode_description));
        }
        throw new IllegalArgumentException(C1499a.m626l("no icon for mode: ", i2));
    }
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        TypedValue resolve = MaterialAttributes.resolve(requireContext(), C3336R.attr.materialTimePickerTheme);
        Dialog dialog = new Dialog(requireContext(), resolve == null ? 0 : resolve.data);
        Context context = dialog.getContext();
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C3336R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        int i2 = C3336R.attr.materialTimePickerStyle;
        int i3 = C3336R.style.Widget_MaterialComponents_TimePicker;
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, i2, i3);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C3336R.styleable.MaterialTimePicker, i2, i3);
        this.clockIcon = obtainStyledAttributes.getResourceId(C3336R.styleable.MaterialTimePicker_clockIcon, 0);
        this.keyboardIcon = obtainStyledAttributes.getResourceId(C3336R.styleable.MaterialTimePicker_keyboardIcon, 0);
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(C3336R.layout.material_timepicker_dialog, viewGroup);
        TimePickerView timePickerView = (TimePickerView) viewGroup2.findViewById(C3336R.id.material_timepicker_view);
        ...
        this.textInputStub = (ViewStub) viewGroup2.findViewById(C3336R.id.material_textinput_timepicker);
        this.modeButton = (MaterialButton) viewGroup2.findViewById(C3336R.id.material_timepicker_mode_button);
        TextView textView = (TextView) viewGroup2.findViewById(C3336R.id.header_title);
        ...
        ((Button) viewGroup2.findViewById(C3336R.id.material_timepicker_ok_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.2
        ...
        ((Button) viewGroup2.findViewById(C3336R.id.material_timepicker_cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
