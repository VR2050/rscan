...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        Chip chip = (Chip) from.inflate(C3336R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = chip;
        TextInputLayout textInputLayout = (TextInputLayout) from.inflate(C3336R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C3336R.id.material_label);
