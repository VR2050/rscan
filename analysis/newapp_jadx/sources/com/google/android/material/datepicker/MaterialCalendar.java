...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C3336R.id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                accessibilityNodeInfoCompat.setHintText(MaterialCalendar.this.dayFrame.getVisibility() == 0 ? MaterialCalendar.this.getString(C3336R.string.mtrl_picker_toggle_to_year_selection) : MaterialCalendar.this.getString(C3336R.string.mtrl_picker_toggle_to_day_selection));
            }
        });
        MaterialButton materialButton2 = (MaterialButton) view.findViewById(C3336R.id.month_navigation_previous);
        materialButton2.setTag(NAVIGATION_PREV_TAG);
        MaterialButton materialButton3 = (MaterialButton) view.findViewById(C3336R.id.month_navigation_next);
        materialButton3.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C3336R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C3336R.id.mtrl_calendar_day_selector_frame);
                        ...
                        if (l2 != null && pair.second != null) {
                            ...
                            for (int i2 = spanCount; i2 <= spanCount2; i2++) {
                                ...
                                if (findViewByPosition3 != null) {
                                    ...
                                    canvas.drawRect(i2 == spanCount ? (findViewByPosition.getWidth() / 2) + findViewByPosition.getLeft() : 0, topInset, i2 == spanCount2 ? (findViewByPosition2.getWidth() / 2) + findViewByPosition2.getLeft() : recyclerView.getWidth(), bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
    ...
    public static int getDayHeight(@NonNull Context context) {
        return context.getResources().getDimensionPixelSize(C3336R.dimen.mtrl_calendar_day_height);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i2 = C3336R.layout.mtrl_calendar_vertical;
            i3 = 1;
        } else {
            i2 = C3336R.layout.mtrl_calendar_horizontal;
            i3 = 0;
        }
        View inflate = cloneInContext.inflate(i2, viewGroup, false);
        GridView gridView = (GridView) inflate.findViewById(C3336R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) inflate.findViewById(C3336R.id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C3336R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) inflate.findViewById(C3336R.id.mtrl_calendar_year_selector_frame);
        ...
        if (inflate.findViewById(C3336R.id.month_navigation_fragment_toggle) != null) {
