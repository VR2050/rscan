...
public class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i2) {
        ...
        String string = viewHolder.textView.getContext().getString(C3336R.string.mtrl_picker_navigate_to_year_description);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i2) {
        return new ViewHolder((TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C3336R.layout.mtrl_calendar_year, viewGroup, false));
    }
}
