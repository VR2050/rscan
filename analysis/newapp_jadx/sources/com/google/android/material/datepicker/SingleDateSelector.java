...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C3336R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }

    @Override // com.google.android.material.datepicker.DateSelector
    public int getDefaultTitleResId() {
        return C3336R.string.mtrl_picker_date_header_title;
    }
    ...
    public String getSelectionDisplayString(@NonNull Context context) {
        ...
        Long l2 = this.selectedItem;
        if (l2 == null) {
            return resources.getString(C3336R.string.mtrl_picker_date_header_unselected);
        }
        return resources.getString(C3336R.string.mtrl_picker_date_header_selected, DateStrings.getYearMonthDay(l2.longValue()));
    }
    ...
    public View onCreateTextInputView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle, CalendarConstraints calendarConstraints, @NonNull final OnSelectionChangedListener<Long> onSelectionChangedListener) {
        View inflate = layoutInflater.inflate(C3336R.layout.mtrl_picker_text_input_date, viewGroup, false);
        TextInputLayout textInputLayout = (TextInputLayout) inflate.findViewById(C3336R.id.mtrl_picker_text_input_date);
