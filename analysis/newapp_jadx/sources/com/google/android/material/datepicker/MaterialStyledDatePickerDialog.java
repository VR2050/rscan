...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    @StyleRes
    private static final int DEF_STYLE_RES = C3336R.style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    ...
    public MaterialStyledDatePickerDialog(@NonNull Context context, int i2, @Nullable DatePickerDialog.OnDateSetListener onDateSetListener, int i3, int i4, int i5) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(getContext(), C3336R.attr.colorSurface, getClass().getCanonicalName());
