...
public abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    public DateFormatTextWatcher(final String str, DateFormat dateFormat, @NonNull TextInputLayout textInputLayout, CalendarConstraints calendarConstraints) {
        ...
        this.outOfRange = textInputLayout.getContext().getString(C3336R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher.1
            ...
            public void run() {
                ...
                textInputLayout2.setError(context.getString(C3336R.string.mtrl_picker_invalid_format) + "\n" + String.format(context.getString(C3336R.string.mtrl_picker_invalid_format_use), str) + "\n" + String.format(context.getString(C3336R.string.mtrl_picker_invalid_format_example), dateFormat2.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))));
