...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    static {
        int i2 = C3336R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{i2};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{i2, C3336R.attr.snackbarTextViewStyle};
    }
    ...
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i2) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? C3336R.layout.mtrl_layout_snackbar_include : C3336R.layout.design_layout_snackbar_include, findSuitableParent, false);
