...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C3336R.attr.snackbarStyle};
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        private Drawable createThemedBackground() {
            float dimension = getResources().getDimension(C3336R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable gradientDrawable = new GradientDrawable();
            gradientDrawable.setShape(0);
            gradientDrawable.setCornerRadius(dimension);
            gradientDrawable.setColor(MaterialColors.layer(this, C3336R.attr.colorSurface, C3336R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));
        ...
        public SnackbarBaseLayout(@NonNull Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C3336R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C3336R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, obtainStyledAttributes.getDimensionPixelSize(r1, 0));
            }
            this.animationMode = obtainStyledAttributes.getInt(C3336R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = obtainStyledAttributes.getFloat(C3336R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, obtainStyledAttributes, C3336R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C3336R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = obtainStyledAttributes.getFloat(C3336R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C3336R.layout.mtrl_layout_snackbar : C3336R.layout.design_layout_snackbar;
    }
    ...
    public B setAnchorView(@IdRes int i2) {
        ...
        throw new IllegalArgumentException(C1499a.m626l("Unable to find anchor view with id: ", i2));
    }
}
