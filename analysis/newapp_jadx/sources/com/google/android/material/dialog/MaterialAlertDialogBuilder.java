...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    ...
    @AttrRes
    private static final int DEF_STYLE_ATTR = C3336R.attr.alertDialogStyle;

    @StyleRes
    private static final int DEF_STYLE_RES = C3336R.style.MaterialAlertDialog_MaterialComponents;

    @AttrRes
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C3336R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(@NonNull Context context, int i2) {
        ...
        int color = MaterialColors.getColor(context2, C3336R.attr.colorSurface, getClass().getCanonicalName());
