...
public class MaterialColors {
    ...
    @ColorInt
    public static int compositeARGBWithAlpha(@ColorInt int i2, @IntRange(from = 0, m111to = 255) int i3) {
    ...
    @ColorInt
    public static int layer(@NonNull View view, @AttrRes int i2, @AttrRes int i3, @FloatRange(from = 0.0d, m110to = 1.0d) float f2) {
    ...
    @ColorInt
    public static int layer(@ColorInt int i2, @ColorInt int i3, @FloatRange(from = 0.0d, m110to = 1.0d) float f2) {
