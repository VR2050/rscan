...
public class UCropView extends FrameLayout {
    ...
    private void setListenersToViews() {
        ...
        this.mViewOverlay.setOverlayViewChangeListener(new OverlayViewChangeListener() { // from class: com.yalantis.ucrop.view.UCropView.2
            ...
            public void postTranslate(float f2, float f3) {
                UCropView.this.mGestureCropImageView.postTranslate(f2, f3);
            }
        });
    }
    ...
    public UCropView(Context context, AttributeSet attributeSet, int i2) {
        ...
        LayoutInflater.from(context).inflate(C4161R.layout.ucrop_view, (ViewGroup) this, true);
        this.mGestureCropImageView = (GestureCropImageView) findViewById(C4161R.id.image_view_crop);
        OverlayView overlayView = (OverlayView) findViewById(C4161R.id.view_overlay);
        this.mViewOverlay = overlayView;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C4161R.styleable.ucrop_UCropView);
