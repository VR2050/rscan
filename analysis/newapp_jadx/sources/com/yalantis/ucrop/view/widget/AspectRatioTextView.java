...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    private void applyActiveColor(@ColorInt int i2) {
        ...
        setTextColor(new ColorStateList(new int[][]{new int[]{R.attr.state_selected}, new int[]{0}}, new int[]{i2, ContextCompat.getColor(getContext(), C4161R.color.ucrop_color_widget)}));
    }

    private void init(@NonNull TypedArray typedArray) {
        setGravity(1);
        this.mAspectRatioTitle = typedArray.getString(C4161R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_title);
        this.mAspectRatioX = typedArray.getFloat(C4161R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_x, 0.0f);
        float f2 = typedArray.getFloat(C4161R.styleable.ucrop_AspectRatioTextView_ucrop_artv_ratio_y, 0.0f);
        ...
        this.mDotSize = getContext().getResources().getDimensionPixelSize(C4161R.dimen.ucrop_size_dot_scale_text_view);
        Paint paint = new Paint(1);
        this.mDotPaint = paint;
        paint.setStyle(Paint.Style.FILL);
        setTitle();
        applyActiveColor(getResources().getColor(C4161R.color.ucrop_color_widget_active));
        typedArray.recycle();
    }
    ...
    public AspectRatioTextView(Context context, AttributeSet attributeSet, int i2) {
        ...
        init(context.obtainStyledAttributes(attributeSet, C4161R.styleable.ucrop_AspectRatioTextView));
    }
