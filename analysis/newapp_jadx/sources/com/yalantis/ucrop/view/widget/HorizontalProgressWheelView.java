...
public class HorizontalProgressWheelView extends View {
    ...
    private void init() {
        this.mMiddleLineColor = ContextCompat.getColor(getContext(), C4161R.color.ucrop_color_widget_rotate_mid_line);
        this.mProgressLineWidth = getContext().getResources().getDimensionPixelSize(C4161R.dimen.ucrop_width_horizontal_wheel_progress_line);
        this.mProgressLineHeight = getContext().getResources().getDimensionPixelSize(C4161R.dimen.ucrop_height_horizontal_wheel_progress_line);
        this.mProgressLineMargin = getContext().getResources().getDimensionPixelSize(C4161R.dimen.ucrop_margin_horizontal_wheel_progress_line);
        Paint paint = new Paint(1);
        this.mProgressLinePaint = paint;
        paint.setStyle(Paint.Style.STROKE);
        this.mProgressLinePaint.setStrokeWidth(this.mProgressLineWidth);
        this.mProgressLinePaint.setColor(getResources().getColor(C4161R.color.ucrop_color_progress_wheel_line));
        ...
        this.mProgressMiddleLinePaint.setStrokeWidth(getContext().getResources().getDimensionPixelSize(C4161R.dimen.ucrop_width_middle_wheel_progress_line));
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < width; i2++) {
            ...
            canvas.drawLine(f4, centerY, f3 + rect2.left + ((this.mProgressLineWidth + this.mProgressLineMargin) * i2), (this.mProgressLineHeight / 4.0f) + rect2.centerY(), this.mProgressLinePaint);
        }
