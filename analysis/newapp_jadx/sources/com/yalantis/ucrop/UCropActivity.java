...
public class UCropActivity extends AppCompatActivity {
    ...
    private void changeSelectedTab(int i2) {
        TransitionManager.beginDelayedTransition((ViewGroup) findViewById(C4161R.id.ucrop_photobox), this.mControlsTransition);
        this.mWrapperStateScale.findViewById(C4161R.id.text_view_scale).setVisibility(i2 == C4161R.id.state_scale ? 0 : 8);
        this.mWrapperStateAspectRatio.findViewById(C4161R.id.text_view_crop).setVisibility(i2 == C4161R.id.state_aspect_ratio ? 0 : 8);
        this.mWrapperStateRotate.findViewById(C4161R.id.text_view_rotate).setVisibility(i2 != C4161R.id.state_rotate ? 8 : 0);
    }
    ...
    private void getCustomOptionsData(@NonNull Intent intent) {
        ...
        int i2 = C4161R.color.ucrop_color_statusbar;
        this.mStatusBarColor = intent.getIntExtra(UCrop.Options.EXTRA_STATUS_BAR_COLOR, ContextCompat.getColor(this, i2));
        int i3 = C4161R.color.ucrop_color_toolbar;
        int intExtra = intent.getIntExtra(UCrop.Options.EXTRA_TOOL_BAR_COLOR, ContextCompat.getColor(this, i3));
        this.mToolbarColor = intExtra;
        if (intExtra == 0) {
            this.mToolbarColor = ContextCompat.getColor(this, i3);
        }
        if (this.mStatusBarColor == 0) {
            this.mStatusBarColor = ContextCompat.getColor(this, i2);
        }
    }

    private void initiateRootViews() {
        this.uCropPhotoBox = (RelativeLayout) findViewById(C4161R.id.ucrop_photobox);
        UCropView uCropView = (UCropView) findViewById(C4161R.id.ucrop);
        this.mUCropView = uCropView;
        this.mGestureCropImageView = uCropView.getCropImageView();
        this.mOverlayView = this.mUCropView.getOverlayView();
        this.mGestureCropImageView.setTransformImageListener(this.mImageListener);
        ((ImageView) findViewById(C4161R.id.image_view_logo)).setColorFilter(this.mLogoColor, PorterDuff.Mode.SRC_ATOP);
        findViewById(C4161R.id.ucrop_frame).setBackgroundColor(this.mRootViewBackgroundColor);
    }
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        int i2 = C4161R.color.ucrop_color_default_crop_frame;
        overlayView.setDimmedBorderColor(intent.getIntExtra(UCrop.Options.EXTRA_DIMMED_LAYER_BORDER_COLOR, resources.getColor(i2)));
        ...
        this.mOverlayView.setDimmedColor(intent.getIntExtra(UCrop.Options.EXTRA_DIMMED_LAYER_COLOR, getResources().getColor(C4161R.color.ucrop_color_default_dimmed)));
        ...
        this.mOverlayView.setCropFrameColor(intent.getIntExtra(UCrop.Options.EXTRA_CROP_FRAME_COLOR, getResources().getColor(i2)));
        this.mOverlayView.setCropFrameStrokeWidth(intent.getIntExtra(UCrop.Options.EXTRA_CROP_FRAME_STROKE_WIDTH, getResources().getDimensionPixelSize(C4161R.dimen.ucrop_default_crop_frame_stoke_width)));
        ...
        this.mOverlayView.setCropGridColor(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_COLOR, getResources().getColor(C4161R.color.ucrop_color_default_crop_grid)));
        this.mOverlayView.setCropGridStrokeWidth(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_STROKE_WIDTH, getResources().getDimensionPixelSize(C4161R.dimen.ucrop_default_crop_grid_stoke_width)));
    ...
    private void setupAppBar() {
        ...
        Toolbar toolbar = (Toolbar) findViewById(C4161R.id.toolbar);
        toolbar.setBackgroundColor(this.mToolbarColor);
        toolbar.setTitleTextColor(this.mToolbarWidgetColor);
        TextView textView = (TextView) toolbar.findViewById(C4161R.id.toolbar_title);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        if (parcelableArrayListExtra == null || parcelableArrayListExtra.isEmpty()) {
            ...
            parcelableArrayListExtra.add(new AspectRatio(getString(C4161R.string.ucrop_label_original).toUpperCase(), 0.0f, 0.0f));
            parcelableArrayListExtra.add(new AspectRatio(null, 3.0f, 2.0f));
            parcelableArrayListExtra.add(new AspectRatio(null, 16.0f, 9.0f));
        }
        LinearLayout linearLayout = (LinearLayout) findViewById(C4161R.id.layout_aspect_ratio);
        int i2 = -1;
        ...
        while (it.hasNext()) {
            ...
            FrameLayout frameLayout = (FrameLayout) getLayoutInflater().inflate(C4161R.layout.ucrop_aspect_ratio, (ViewGroup) null);
    ...
    private void setupRotateWidget() {
        this.mTextViewRotateAngle = (TextView) findViewById(C4161R.id.text_view_rotate);
        int i2 = C4161R.id.rotate_scroll_wheel;
        ...
        findViewById(C4161R.id.wrapper_reset_rotate).setOnClickListener(new View.OnClickListener() { // from class: com.yalantis.ucrop.UCropActivity.4
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                UCropActivity.this.resetRotation();
            }
        });
        findViewById(C4161R.id.wrapper_rotate_by_angle).setOnClickListener(new View.OnClickListener() { // from class: com.yalantis.ucrop.UCropActivity.5
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
    ...
    private void setupScaleWidget() {
        this.mTextViewScalePercent = (TextView) findViewById(C4161R.id.text_view_scale);
        int i2 = C4161R.id.scale_scroll_wheel;
    ...
    private void setupStatesWrapper() {
        ImageView imageView = (ImageView) findViewById(C4161R.id.image_view_state_scale);
        ImageView imageView2 = (ImageView) findViewById(C4161R.id.image_view_state_rotate);
        ImageView imageView3 = (ImageView) findViewById(C4161R.id.image_view_state_aspect_ratio);
    ...
    public void addBlockingView() {
        if (this.mBlockingView == null) {
            ...
            layoutParams.addRule(3, C4161R.id.toolbar);
            this.mBlockingView.setLayoutParams(layoutParams);
            this.mBlockingView.setClickable(true);
        }
        ((RelativeLayout) findViewById(C4161R.id.ucrop_photobox)).addView(this.mBlockingView);
    }
    ...
    public void exitAnimation() {
        ...
        int i2 = C4161R.anim.ucrop_anim_fade_in;
        if (intExtra == 0) {
            intExtra = C4161R.anim.ucrop_close;
        }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C4161R.layout.ucrop_activity_photobox);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(C4161R.menu.ucrop_menu_activity, menu);
        MenuItem findItem = menu.findItem(C4161R.id.menu_loader);
        ...
        if (icon != null) {
            try {
                ...
                String.format("%s - %s", e2.getMessage(), getString(C4161R.string.ucrop_mutate_exception_hint));
            }
            ((Animatable) findItem.getIcon()).start();
        }
        MenuItem findItem2 = menu.findItem(C4161R.id.menu_crop);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        if (menuItem.getItemId() == C4161R.id.menu_crop) {
            cropAndSaveImage();
            return true;
        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        menu.findItem(C4161R.id.menu_crop).setVisible(!this.mShowLoader);
        menu.findItem(C4161R.id.menu_loader).setVisible(this.mShowLoader);
    ...
    public void setImageData(@NonNull Intent intent) {
        ...
        if (uri == null || uri2 == null) {
            setResultError(new NullPointerException(getString(C4161R.string.ucrop_error_input_data_is_absent)));
            onBackPressed();
            return;
        }
        try {
    ...
    public void setInitialState() {
        if (!this.mShowBottomControls) {
            ...
            setWidgetState(C4161R.id.state_aspect_ratio);
        } else {
            setWidgetState(C4161R.id.state_scale);
        }
    }
    ...
    public void setupViews(@NonNull Intent intent) {
        this.mStatusBarColor = intent.getIntExtra(UCrop.Options.EXTRA_STATUS_BAR_COLOR, ContextCompat.getColor(this, C4161R.color.ucrop_color_statusbar));
        this.mToolbarColor = intent.getIntExtra(UCrop.Options.EXTRA_TOOL_BAR_COLOR, ContextCompat.getColor(this, C4161R.color.ucrop_color_toolbar));
        this.mActiveWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_WIDGET_ACTIVE, ContextCompat.getColor(this, C4161R.color.ucrop_color_widget_background));
        this.mActiveControlsWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_COLOR_CONTROLS_WIDGET_ACTIVE, ContextCompat.getColor(this, C4161R.color.ucrop_color_active_controls_color));
        this.mToolbarWidgetColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_COLOR_TOOLBAR, ContextCompat.getColor(this, C4161R.color.ucrop_color_toolbar_widget));
        this.mToolbarCancelDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, C4161R.drawable.ucrop_ic_cross);
        this.mToolbarCropDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, C4161R.drawable.ucrop_ic_done);
        String stringExtra = intent.getStringExtra(UCrop.Options.EXTRA_UCROP_TITLE_TEXT_TOOLBAR);
        this.mToolbarTitle = stringExtra;
        if (stringExtra == null) {
            stringExtra = getResources().getString(C4161R.string.ucrop_label_edit_photo);
        }
        this.mToolbarTitle = stringExtra;
        this.mLogoColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_LOGO_COLOR, ContextCompat.getColor(this, C4161R.color.ucrop_color_default_logo));
        this.mShowBottomControls = !intent.getBooleanExtra(UCrop.Options.EXTRA_HIDE_BOTTOM_CONTROLS, false);
        this.mRootViewBackgroundColor = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_ROOT_VIEW_BACKGROUND_COLOR, ContextCompat.getColor(this, C4161R.color.ucrop_color_crop_background));
        setupAppBar();
        initiateRootViews();
        if (this.mShowBottomControls) {
            ViewGroup viewGroup = (ViewGroup) ((ViewGroup) findViewById(C4161R.id.ucrop_photobox)).findViewById(C4161R.id.controls_wrapper);
            viewGroup.setVisibility(0);
            viewGroup.setBackgroundColor(this.mRootViewBackgroundColor);
            LayoutInflater.from(this).inflate(C4161R.layout.ucrop_controls, viewGroup, true);
            AutoTransition autoTransition = new AutoTransition();
            this.mControlsTransition = autoTransition;
            autoTransition.setDuration(CONTROLS_ANIMATION_DURATION);
            ViewGroup viewGroup2 = (ViewGroup) findViewById(C4161R.id.state_aspect_ratio);
            this.mWrapperStateAspectRatio = viewGroup2;
            viewGroup2.setOnClickListener(this.mStateClickListener);
            ViewGroup viewGroup3 = (ViewGroup) findViewById(C4161R.id.state_rotate);
            this.mWrapperStateRotate = viewGroup3;
            viewGroup3.setOnClickListener(this.mStateClickListener);
            ViewGroup viewGroup4 = (ViewGroup) findViewById(C4161R.id.state_scale);
            this.mWrapperStateScale = viewGroup4;
            viewGroup4.setOnClickListener(this.mStateClickListener);
            this.mLayoutAspectRatio = (ViewGroup) findViewById(C4161R.id.layout_aspect_ratio);
            this.mLayoutRotate = (ViewGroup) findViewById(C4161R.id.layout_rotate_wheel);
            this.mLayoutScale = (ViewGroup) findViewById(C4161R.id.layout_scale_wheel);
