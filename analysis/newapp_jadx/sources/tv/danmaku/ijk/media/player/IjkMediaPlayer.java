...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer != null) {
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i2 != 0) {
                        ...
                        if (i2 == 200) {
                            if (message.arg1 == 3) {
                                DebugLog.m5718i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                            }
                            ...
                            StringBuilder m586H2 = C1499a.m586H("Unknown message type ");
                            m586H2.append(message.what);
                            DebugLog.m5716e(str2, m586H2.toString());
                            return;
                        }
                    }
                    return;
            ...
            DebugLog.m5722w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
        }
    }
    ...
    public MediaInfo getMediaInfo() {
        ...
        if (!TextUtils.isEmpty(_getVideoCodecInfo)) {
            String[] split = _getVideoCodecInfo.split(ChineseToPinyinResource.Field.COMMA);
            if (split.length >= 2) {
        ...
        if (!TextUtils.isEmpty(_getAudioCodecInfo)) {
            String[] split2 = _getAudioCodecInfo.split(ChineseToPinyinResource.Field.COMMA);
            if (split2.length >= 2) {
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m5722w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m5722w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    public void setWakeMode(Context context, int i2) {
        ...
        PowerManager.WakeLock newWakeLock = ((PowerManager) context.getSystemService("power")).newWakeLock(i2 | Label.FORWARD_REFERENCE_TYPE_WIDE, IjkMediaPlayer.class.getName());
