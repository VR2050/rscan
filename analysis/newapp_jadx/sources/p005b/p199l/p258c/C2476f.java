...
/* renamed from: b.l.c.f */
/* loaded from: classes2.dex */
public class C2476f extends AbstractC2496z<Number> {
    public C2476f(C2480j c2480j) {
    }
    ...
    public Number mo2766b(C2472a c2472a) {
        if (c2472a.mo2777Z() != EnumC2473b.NULL) {
            return Float.valueOf((float) c2472a.mo2771E());
        }
        c2472a.mo2775V();
        return null;
    }
    ...
    public void mo2767c(C2474c c2474c, Number number) {
        ...
        if (number2 == null) {
            ...
            C2480j.m2847a(number2.floatValue());
