...
public final class RawTypeImpl extends FlexibleType implements RawType {
    ...
    public MemberScope getMemberScope() {
        ClassifierDescriptor mo7311getDeclarationDescriptor = getConstructor().mo7311getDeclarationDescriptor();
        ...
        if (classDescriptor == null) {
            throw new IllegalStateException(Intrinsics.stringPlus("Incorrect classifier: ", getConstructor().mo7311getDeclarationDescriptor()).toString());
        }
