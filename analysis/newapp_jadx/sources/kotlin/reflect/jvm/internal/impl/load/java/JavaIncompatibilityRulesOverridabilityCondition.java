...
public final class JavaIncompatibilityRulesOverridabilityCondition implements ExternalOverridabilityCondition {
    ...
    public static final class Companion {
        ...
        private final boolean isPrimitiveCompareTo(FunctionDescriptor functionDescriptor) {
            ...
            ClassifierDescriptor mo7311getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt___CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo7311getDeclarationDescriptor();
            ClassDescriptor classDescriptor2 = mo7311getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo7311getDeclarationDescriptor : null;
    ...
    private final boolean isIncompatibleInAccordanceWithBuiltInOverridabilityRules(CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, ClassDescriptor classDescriptor) {
        if ((callableDescriptor instanceof CallableMemberDescriptor) && (callableDescriptor2 instanceof FunctionDescriptor) && !KotlinBuiltIns.isBuiltIn(callableDescriptor2)) {
            ...
            if ((!Intrinsics.areEqual(valueOf, (z ? (FunctionDescriptor) callableDescriptor : null) == null ? null : Boolean.valueOf(r5.isHiddenToOvercomeSignatureClash()))) && (overriddenSpecialBuiltin == null || !functionDescriptor.isHiddenToOvercomeSignatureClash())) {
                return true;
            }
