...
public final class NotFoundClasses {
    ...
    public static final class ClassRequest {
        ...
        public String toString() {
            StringBuilder m586H = C1499a.m586H("ClassRequest(classId=");
            m586H.append(this.classId);
            m586H.append(", typeParametersCount=");
            m586H.append(this.typeParametersCount);
            m586H.append(')');
    ...
    public NotFoundClasses(@NotNull StorageManager storageManager, @NotNull ModuleDescriptor module) {
        ...
        this.classes = storageManager.createMemoizedFunction(new Function1<ClassRequest, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.NotFoundClasses$classes$1
            ...
            public final ClassDescriptor invoke(@NotNull NotFoundClasses.ClassRequest dstr$classId$typeParametersCount) {
                ...
                ClassOrPackageFragmentDescriptor classOrPackageFragmentDescriptor = outerClassId == null ? null : NotFoundClasses.this.getClass(outerClassId, CollectionsKt___CollectionsKt.drop(component2, 1));
                ...
                return new NotFoundClasses.MockClassDescriptor(storageManager2, classOrPackageFragmentDescriptor2, shortClassName, isNestedClass, num == null ? 0 : num.intValue());
            }
        });
    }
