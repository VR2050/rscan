...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: c */
    @NotNull
    private final DeserializationContext f12105c;
    ...
    */
    ...
    public List<KotlinType> resolveUpperBounds() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.proto, this.f12105c.getTypeTable());
        if (upperBounds.isEmpty()) {
            return CollectionsKt__CollectionsJVMKt.listOf(DescriptorUtilsKt.getBuiltIns(this).getDefaultBound());
        }
        TypeDeserializer typeDeserializer = this.f12105c.getTypeDeserializer();
