...
public final class AnnotationUtilKt {
    ...
    public static final AnnotationDescriptor createDeprecatedAnnotation(@NotNull final KotlinBuiltIns kotlinBuiltIns, @NotNull String message, @NotNull String replaceWith, @NotNull String level) {
        ...
        BuiltInAnnotationDescriptor builtInAnnotationDescriptor = new BuiltInAnnotationDescriptor(kotlinBuiltIns, StandardNames.FqNames.replaceWith, MapsKt__MapsKt.mapOf(TuplesKt.m5318to(REPLACE_WITH_EXPRESSION_NAME, new StringValue(replaceWith)), TuplesKt.m5318to(REPLACE_WITH_IMPORTS_NAME, new ArrayValue(CollectionsKt__CollectionsKt.emptyList(), new Function1<ModuleDescriptor, KotlinType>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.annotations.AnnotationUtilKt$createDeprecatedAnnotation$replaceWithAnnotation$1
            {
                super(1);
            }
        ...
        return new BuiltInAnnotationDescriptor(kotlinBuiltIns, fqName, MapsKt__MapsKt.mapOf(TuplesKt.m5318to(DEPRECATED_MESSAGE_NAME, new StringValue(message)), TuplesKt.m5318to(DEPRECATED_REPLACE_WITH_NAME, new AnnotationValue(builtInAnnotationDescriptor)), TuplesKt.m5318to(name, new EnumValue(classId, identifier))));
    }
