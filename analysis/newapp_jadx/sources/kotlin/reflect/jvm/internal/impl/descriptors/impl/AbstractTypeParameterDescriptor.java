...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    public class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        public void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo7314reportSupertypeLoopError(kotlinType);
        }
            ...
            public SimpleType invoke() {
                return KotlinTypeFactory.simpleTypeWithNonTrivialMemberScope(Annotations.Companion.getEMPTY(), AbstractTypeParameterDescriptor.this.getTypeConstructor(), Collections.emptyList(), false, new LazyScopeAdapter(new Function0<MemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeParameterDescriptor.2.1
                    ...
                    public MemberScope invoke() {
                        StringBuilder m586H = C1499a.m586H("Scope for type parameter ");
                        m586H.append(name.asString());
                        return TypeIntersectionScope.create(m586H.toString(), AbstractTypeParameterDescriptor.this.getUpperBounds());
                    }
                }));
            }
        });
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> mo7312getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo7312getSupertypes();
    ...
    public abstract void mo7314reportSupertypeLoopError(@NotNull KotlinType kotlinType);
