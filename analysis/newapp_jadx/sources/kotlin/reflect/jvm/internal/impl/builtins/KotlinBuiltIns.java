...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(@NotNull StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor mo7313getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo7313getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                if (mo7313getContributedClassifier == null) {
                    StringBuilder m586H = C1499a.m586H("Built-in class ");
                    m586H.append(StandardNames.BUILT_INS_PACKAGE_FQ_NAME.child(name));
                    m586H.append(" is not found");
                ...
                throw new AssertionError("Must be a class descriptor " + name + ", but was " + mo7313getContributedClassifier);
            }
        });
    }
    ...
    public static boolean isPrimitiveArray(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo7311getDeclarationDescriptor = kotlinType.getConstructor().mo7311getDeclarationDescriptor();
        return (mo7311getDeclarationDescriptor == null || getPrimitiveArrayType(mo7311getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo7311getDeclarationDescriptor = kotlinType.getConstructor().mo7311getDeclarationDescriptor();
        return (mo7311getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo7311getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(@NotNull TypeConstructor typeConstructor, @NotNull FqNameUnsafe fqNameUnsafe) {
        ...
        return (mo7311getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo7311getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public void setBuiltInsModule(@NotNull final ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        this.storageManager.compute(new Function0<Void>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.4
            ...
            public Void invoke() {
                ...
                StringBuilder m586H = C1499a.m586H("Built-ins module is already set: ");
                m586H.append(KotlinBuiltIns.this.builtInsModule);
                m586H.append(" (attempting to reset to ");
                m586H.append(moduleDescriptorImpl);
