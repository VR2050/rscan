...
public class TypeParameterDescriptorImpl extends AbstractTypeParameterDescriptor {
    ...
    private void checkInitialized() {
        ...
        StringBuilder m586H = C1499a.m586H("Type parameter descriptor is not initialized: ");
        m586H.append(nameForAssertions());
        throw new IllegalStateException(m586H.toString());
    }

    private void checkUninitialized() {
        if (this.initialized) {
            StringBuilder m586H = C1499a.m586H("Type parameter descriptor is already initialized: ");
            m586H.append(nameForAssertions());
            throw new IllegalStateException(m586H.toString());
        }
    }

    public static TypeParameterDescriptorImpl createForFurtherModification(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Annotations annotations, boolean z, @NotNull Variance variance, @NotNull Name name, int i2, @NotNull SourceElement sourceElement, @NotNull StorageManager storageManager) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(6);
        }
        if (annotations == null) {
    ...
    @NotNull
    public static TypeParameterDescriptor createWithDefaultBound(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Annotations annotations, boolean z, @NotNull Variance variance, @NotNull Name name, int i2, @NotNull StorageManager storageManager) {
        if (declarationDescriptor == null) {
            $$$reportNull$$$0(0);
        }
        if (annotations == null) {
    ...
    public void mo7314reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
        if (kotlinType == null) {
            $$$reportNull$$$0(27);
        }
    ...
    public static TypeParameterDescriptorImpl createForFurtherModification(@NotNull DeclarationDescriptor declarationDescriptor, @NotNull Annotations annotations, boolean z, @NotNull Variance variance, @NotNull Name name, int i2, @NotNull SourceElement sourceElement, @Nullable Function1<KotlinType, Void> function1, @NotNull SupertypeLoopChecker supertypeLoopChecker, @NotNull StorageManager storageManager) {
        ...
        return new TypeParameterDescriptorImpl(declarationDescriptor, annotations, z, variance, name, i2, sourceElement, function1, supertypeLoopChecker, storageManager);
    }
}
