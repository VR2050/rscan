...
public abstract class GivenFunctionsMemberScope extends MemberScopeImpl {
    ...
    public final List<DeclarationDescriptor> createFakeOverrides(List<? extends FunctionDescriptor> list) {
        ...
        Collection<KotlinType> mo7312getSupertypes = this.containingClass.getTypeConstructor().mo7312getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo7312getSupertypes, "containingClass.typeConstructor.supertypes");
