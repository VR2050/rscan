...
public final class LazyJavaAnnotationDescriptor implements AnnotationDescriptor, PossiblyExternalAnnotationDescriptor {
    ...
    /* renamed from: c */
    @NotNull
    private final LazyJavaResolverContext f12080c;
    ...
    public LazyJavaAnnotationDescriptor(@NotNull LazyJavaResolverContext c2, @NotNull JavaAnnotation javaAnnotation, boolean z) {
        ...
        this.type$delegate = c2.getStorageManager().createLazyValue(new Function0<SimpleType>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaAnnotationDescriptor$type$2
            ...
            public final SimpleType invoke() {
                ...
                lazyJavaResolverContext = LazyJavaAnnotationDescriptor.this.f12080c;
                ...
                if (mapJavaToKotlin$default == null) {
                    ...
                    if (resolve == null) {
                        ...
                        lazyJavaResolverContext2 = LazyJavaAnnotationDescriptor.this.f12080c;
        ...
        this.allValueArguments$delegate = c2.getStorageManager().createLazyValue(new Function0<Map<Name, ? extends ConstantValue<?>>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaAnnotationDescriptor$allValueArguments$2
            ...
            public final Map<Name, ? extends ConstantValue<?>> invoke() {
                ...
                for (JavaAnnotationArgument javaAnnotationArgument : arguments) {
                    ...
                    Pair m5318to = resolveAnnotationArgument == null ? null : TuplesKt.m5318to(name, resolveAnnotationArgument);
                    if (m5318to != null) {
    ...
    public final ClassDescriptor createTypeForMissingDependencies(FqName fqName) {
        ModuleDescriptor module = this.f12080c.getModule();
        ClassId classId = ClassId.topLevel(fqName);
        Intrinsics.checkNotNullExpressionValue(classId, "topLevel(fqName)");
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(module, classId, this.f12080c.getComponents().getDeserializedDescriptorResolver().getComponents().getNotFoundClasses());
    }
    ...
    private final ConstantValue<?> resolveFromAnnotation(JavaAnnotation javaAnnotation) {
        return new AnnotationValue(new LazyJavaAnnotationDescriptor(this.f12080c, javaAnnotation, false, 4, null));
    }
    ...
    private final ConstantValue<?> resolveFromArray(Name name, List<? extends JavaAnnotationArgument> list) {
        ...
        if (type2 == null) {
            type2 = this.f12080c.getComponents().getModule().getBuiltIns().getArrayType(Variance.INVARIANT, ErrorUtils.createErrorType("Unknown array element type"));
        }
    ...
    private final ConstantValue<?> resolveFromJavaClassObjectType(JavaType javaType) {
        return KClassValue.Companion.create(this.f12080c.getTypeResolver().transformJavaType(javaType, JavaTypeResolverKt.toAttributes$default(TypeUsage.COMMON, false, null, 3, null)));
    }
