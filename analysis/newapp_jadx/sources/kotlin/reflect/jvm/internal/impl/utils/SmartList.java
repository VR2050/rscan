...
public class SmartList<E> extends AbstractList<E> implements RandomAccess {
    ...
    public class SingletonIterator extends SingletonIteratorBase<E> {
        ...
        public void checkCoModification() {
            ...
            StringBuilder m586H = C1499a.m586H("ModCount: ");
            m586H.append(((AbstractList) SmartList.this).modCount);
            m586H.append("; expected: ");
            m586H.append(this.myInitialModCount);
            throw new ConcurrentModificationException(m586H.toString());
        }
