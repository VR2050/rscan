...
public final class ReflectClassUtilKt {
    ...
    static {
        ...
        while (it.hasNext()) {
            ...
            arrayList.add(TuplesKt.m5318to(JvmClassMappingKt.getJavaObjectType(kClass), JvmClassMappingKt.getJavaPrimitiveType(kClass)));
        }
        ...
        while (it2.hasNext()) {
            ...
            arrayList2.add(TuplesKt.m5318to(JvmClassMappingKt.getJavaPrimitiveType(kClass2), JvmClassMappingKt.getJavaObjectType(kClass2)));
        }
        ...
        for (Object obj : listOf2) {
            ...
            arrayList3.add(TuplesKt.m5318to((Class) obj, Integer.valueOf(i2)));
            i2 = i3;
        }
    ...
    public static final String getDesc(@NotNull Class<?> cls) {
        ...
        if (!cls.isPrimitive()) {
            ...
            return C1499a.m581C(m584F, StringsKt__StringsJVMKt.replace$default(name2, '.', '/', false, 4, (Object) null), ';');
        }
