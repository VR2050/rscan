...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    /* renamed from: c */
    @NotNull
    private final LazyJavaResolverContext f12081c;
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public LazyJavaClassTypeConstructor(final LazyJavaClassDescriptor this$0) {
            super(this$0.f12081c.getStorageManager());
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            this.this$0 = this$0;
            this.parameters = this$0.f12081c.getStorageManager().createLazyValue(new Function0<List<? extends TypeParameterDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$LazyJavaClassTypeConstructor$parameters$1
                {
                    super(0);
                }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:37:0x001b, code lost:
            ...
            if ((!r0.isRoot() && r0.startsWith(kotlin.reflect.jvm.internal.impl.builtins.StandardNames.BUILT_INS_PACKAGE_NAME)) != false) goto L12;
         */
        /*
        ...
        */
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo7305findAnnotation = annotations.mo7305findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                KotlinType enhanceSuperType = this.this$0.f12081c.getComponents().getSignatureEnhancement().enhanceSuperType(this.this$0.f12081c.getTypeResolver().transformJavaType(next, JavaTypeResolverKt.toAttributes$default(TypeUsage.SUPERTYPE, false, null, 3, null)), this.this$0.f12081c);
                if (enhanceSuperType.getConstructor().mo7311getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ErrorReporter errorReporter = this.this$0.f12081c.getComponents().getErrorReporter();
                ClassDescriptor mo7311getDeclarationDescriptor = mo7311getDeclarationDescriptor();
                ArrayList arrayList3 = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(arrayList2, 10));
                Iterator it2 = arrayList2.iterator();
                while (it2.hasNext()) {
                    arrayList3.add(((JavaClassifierType) ((JavaType) it2.next())).getPresentableText());
                }
                errorReporter.reportIncompleteHierarchy(mo7311getDeclarationDescriptor, arrayList3);
            }
            return arrayList.isEmpty() ^ true ? CollectionsKt___CollectionsKt.toList(arrayList) : CollectionsKt__CollectionsJVMKt.listOf(this.this$0.f12081c.getModule().getBuiltIns().getAnyType());
        }
        ...
        public SupertypeLoopChecker getSupertypeLoopChecker() {
            return this.this$0.f12081c.getComponents().getSupertypeLoopChecker();
        }
        ...
        public ClassDescriptor mo7311getDeclarationDescriptor() {
            return this.this$0;
        }
    }
    ...
    public final LazyJavaClassDescriptor copy$descriptors_jvm(@NotNull JavaResolverCache javaResolverCache, @Nullable ClassDescriptor classDescriptor) {
        ...
        LazyJavaResolverContext lazyJavaResolverContext = this.f12081c;
    ...
    public ClassDescriptor mo7303getCompanionObjectDescriptor() {
        return null;
    }
    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        ...
        while (it.hasNext()) {
            ClassifierDescriptor mo7311getDeclarationDescriptor = this.f12081c.getTypeResolver().transformJavaType((JavaClassifierType) it.next(), attributes$default).getConstructor().mo7311getDeclarationDescriptor();
    ...
    public ClassConstructorDescriptor mo7304getUnsubstitutedPrimaryConstructor() {
        return null;
    }
    ...
    public LazyJavaClassDescriptor(@NotNull LazyJavaResolverContext outerContext, @NotNull DeclarationDescriptor containingDeclaration, @NotNull JavaClass jClass, @Nullable ClassDescriptor classDescriptor) {
        ...
        this.f12081c = childForClassOrPackage$default;
        ...
        this.scopeHolder = ScopesHolderForClass.Companion.create(this, childForClassOrPackage$default.getStorageManager(), childForClassOrPackage$default.getComponents().getKotlinTypeChecker().getKotlinTypeRefiner(), new Function1<KotlinTypeRefiner, LazyJavaClassMemberScope>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$scopeHolder$1
            ...
            public final LazyJavaClassMemberScope invoke(@NotNull KotlinTypeRefiner it) {
                ...
                LazyJavaResolverContext lazyJavaResolverContext = LazyJavaClassDescriptor.this.f12081c;
        ...
        this.declaredParameters = childForClassOrPackage$default.getStorageManager().createLazyValue(new Function0<List<? extends TypeParameterDescriptor>>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor$declaredParameters$1
            ...
            public final List<? extends TypeParameterDescriptor> invoke() {
                ...
                for (JavaTypeParameter javaTypeParameter : typeParameters) {
                    TypeParameterDescriptor resolveTypeParameter = lazyJavaClassDescriptor.f12081c.getTypeParameterResolver().resolveTypeParameter(javaTypeParameter);
