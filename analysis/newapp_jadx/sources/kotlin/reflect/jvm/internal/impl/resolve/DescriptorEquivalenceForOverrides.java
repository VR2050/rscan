...
public final class DescriptorEquivalenceForOverrides {
    ...
    public static /* synthetic */ boolean areCallableDescriptorsEquivalent$default(DescriptorEquivalenceForOverrides descriptorEquivalenceForOverrides, CallableDescriptor callableDescriptor, CallableDescriptor callableDescriptor2, boolean z, boolean z2, boolean z3, KotlinTypeRefiner kotlinTypeRefiner, int i2, Object obj) {
        return descriptorEquivalenceForOverrides.areCallableDescriptorsEquivalent(callableDescriptor, callableDescriptor2, z, (i2 & 8) != 0 ? true : z2, (i2 & 16) != 0 ? false : z3, kotlinTypeRefiner);
    }
    ...
    public static /* synthetic */ boolean areTypeParametersEquivalent$default(DescriptorEquivalenceForOverrides descriptorEquivalenceForOverrides, TypeParameterDescriptor typeParameterDescriptor, TypeParameterDescriptor typeParameterDescriptor2, boolean z, Function2 function2, int i2, Object obj) {
        if ((i2 & 8) != 0) {
    ...
    public final boolean areCallableDescriptorsEquivalent(@NotNull final CallableDescriptor a, @NotNull final CallableDescriptor b2, final boolean z, boolean z2, boolean z3, @NotNull KotlinTypeRefiner kotlinTypeRefiner) {
        Intrinsics.checkNotNullParameter(a, "a");
        Intrinsics.checkNotNullParameter(b2, "b");
        Intrinsics.checkNotNullParameter(kotlinTypeRefiner, "kotlinTypeRefiner");
        if (Intrinsics.areEqual(a, b2)) {
            return true;
        }
        if (!Intrinsics.areEqual(a.getName(), b2.getName())) {
            return false;
        }
        ...
        if ((Intrinsics.areEqual(a.getContainingDeclaration(), b2.getContainingDeclaration()) && (!z || !Intrinsics.areEqual(singleSource(a), singleSource(b2)))) || DescriptorUtils.isLocal(a) || DescriptorUtils.isLocal(b2) || !ownersEquivalent(a, b2, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$1
            @Override // kotlin.jvm.functions.Function2
            public /* bridge */ /* synthetic */ Boolean invoke(DeclarationDescriptor declarationDescriptor, DeclarationDescriptor declarationDescriptor2) {
                return Boolean.valueOf(invoke2(declarationDescriptor, declarationDescriptor2));
            }
        ...
        OverridingUtil create = OverridingUtil.create(kotlinTypeRefiner, new KotlinTypeChecker.TypeConstructorEquality() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1
            ...
            public final boolean equals(@NotNull TypeConstructor c1, @NotNull TypeConstructor c2) {
                ...
                ClassifierDescriptor mo7311getDeclarationDescriptor = c1.mo7311getDeclarationDescriptor();
                ClassifierDescriptor mo7311getDeclarationDescriptor2 = c2.mo7311getDeclarationDescriptor();
                if (!(mo7311getDeclarationDescriptor instanceof TypeParameterDescriptor) || !(mo7311getDeclarationDescriptor2 instanceof TypeParameterDescriptor)) {
                    return false;
                }
                boolean z4 = z;
                final CallableDescriptor callableDescriptor = a;
                final CallableDescriptor callableDescriptor2 = b2;
                return DescriptorEquivalenceForOverrides.INSTANCE.areTypeParametersEquivalent((TypeParameterDescriptor) mo7311getDeclarationDescriptor, (TypeParameterDescriptor) mo7311getDeclarationDescriptor2, z4, new Function2<DeclarationDescriptor, DeclarationDescriptor, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.resolve.DescriptorEquivalenceForOverrides$areCallableDescriptorsEquivalent$overridingUtil$1.1
                    ...
                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
                    public final boolean invoke2(@Nullable DeclarationDescriptor declarationDescriptor, @Nullable DeclarationDescriptor declarationDescriptor2) {
                        return Intrinsics.areEqual(declarationDescriptor, CallableDescriptor.this) && Intrinsics.areEqual(declarationDescriptor2, callableDescriptor2);
                    }
                });
            }
        });
    ...
    @JvmOverloads
    public final boolean areTypeParametersEquivalent(@NotNull TypeParameterDescriptor a, @NotNull TypeParameterDescriptor b2, boolean z) {
        Intrinsics.checkNotNullParameter(a, "a");
        Intrinsics.checkNotNullParameter(b2, "b");
        return areTypeParametersEquivalent$default(this, a, b2, z, null, 8, null);
    }

    @JvmOverloads
    public final boolean areTypeParametersEquivalent(@NotNull TypeParameterDescriptor a, @NotNull TypeParameterDescriptor b2, boolean z, @NotNull Function2<? super DeclarationDescriptor, ? super DeclarationDescriptor, Boolean> equivalentCallables) {
        Intrinsics.checkNotNullParameter(a, "a");
        Intrinsics.checkNotNullParameter(b2, "b");
        ...
        return !Intrinsics.areEqual(a.getContainingDeclaration(), b2.getContainingDeclaration()) && ownersEquivalent(a, b2, equivalentCallables, z) && a.getIndex() == b2.getIndex();
    }
}
