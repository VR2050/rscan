...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    */
    ...
    private final JDKMemberStatus getJdkMethodStatus(FunctionDescriptor functionDescriptor) {
        ...
        Object dfs = DFS.dfs(CollectionsKt__CollectionsJVMKt.listOf(classDescriptor), new DFS.Neighbors<ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer$getJdkMethodStatus$1
            ...
            public final Iterable<ClassDescriptor> getNeighbors(ClassDescriptor classDescriptor2) {
                ...
                while (it.hasNext()) {
                    ClassifierDescriptor mo7311getDeclarationDescriptor = ((KotlinType) it.next()).getConstructor().mo7311getDeclarationDescriptor();
                    ClassifierDescriptor original = mo7311getDeclarationDescriptor == null ? null : mo7311getDeclarationDescriptor.getOriginal();
    ...
    private final boolean isMutabilityViolation(SimpleFunctionDescriptor simpleFunctionDescriptor, boolean z) {
        ...
        Boolean ifAny = DFS.ifAny(CollectionsKt__CollectionsJVMKt.listOf(simpleFunctionDescriptor), new DFS.Neighbors<CallableMemberDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.jvm.JvmBuiltInsCustomizer$isMutabilityViolation$1
            @Override // kotlin.reflect.jvm.internal.impl.utils.DFS.Neighbors
            @NotNull
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            if (Intrinsics.areEqual(mo7311getDeclarationDescriptor == null ? null : DescriptorUtilsKt.getFqNameUnsafe(mo7311getDeclarationDescriptor), DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.util.Collection<kotlin.reflect.jvm.internal.impl.descriptors.SimpleFunctionDescriptor> getFunctions(@org.jetbrains.annotations.NotNull final kotlin.reflect.jvm.internal.impl.name.Name r6, @org.jetbrains.annotations.NotNull kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor r7) {
        /*
