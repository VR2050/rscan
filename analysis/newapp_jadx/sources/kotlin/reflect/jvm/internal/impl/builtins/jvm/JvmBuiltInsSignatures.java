...
public final class JvmBuiltInsSignatures {
    ...
    static {
        ...
        Set plus = SetsKt___SetsKt.plus((Set) buildPrimitiveStringConstructorsSet, (Iterable) signatureBuildingComponents.inJavaLang("Float", strArr));
        ...
        HIDDEN_CONSTRUCTOR_SIGNATURES = SetsKt___SetsKt.plus(plus, (Iterable) signatureBuildingComponents.inJavaLang("String", strArr2));
    ...
    private final Set<String> buildPrimitiveStringConstructorsSet() {
        ...
        while (it.hasNext()) {
            ...
            String[] strArr = new String[constructors.length];
            System.arraycopy(constructors, 0, strArr, 0, constructors.length);
            CollectionsKt__MutableCollectionsKt.addAll(linkedHashSet, signatureBuildingComponents.inJavaLang(asString, strArr));
        }
