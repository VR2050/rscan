...
public class Intrinsics {
    ...
    public static void checkExpressionValueIsNotNull(Object obj, String str) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException(C1499a.m637w(str, " must not be null"))));
        }
    }
    ...
    public static void checkHasClass(String str) {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException(C1499a.m639y("Class ", replace, " is not found. Please update the Kotlin runtime to the latest version"), e2)));
        }
    }
    ...
    public static void checkNotNullExpressionValue(Object obj, String str) {
        if (obj == null) {
            throw ((NullPointerException) sanitizeStackTrace(new NullPointerException(C1499a.m637w(str, " must not be null"))));
        }
    }
