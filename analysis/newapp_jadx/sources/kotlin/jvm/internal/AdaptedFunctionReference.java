...
public class AdaptedFunctionReference implements FunctionBase, Serializable {
    ...
    public int hashCode() {
        ...
        Class cls = this.owner;
        return ((((C1499a.m598T(this.signature, C1499a.m598T(this.name, (hashCode + (cls != null ? cls.hashCode() : 0)) * 31, 31), 31) + (this.isTopLevel ? 1231 : 1237)) * 31) + this.arity) * 31) + this.flags;
    }
