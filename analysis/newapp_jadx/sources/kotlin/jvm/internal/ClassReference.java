...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    @Metadata(m5310d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\u000f\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u001c\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u00012\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005R&\u0010\u0003\u001a\u001a\u0012\u0010\u0012\u000e\u0012\n\b\u0001\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005\u0012\u0004\u0012\u00020\u00070\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R*\u0010\b\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R*\u0010\f\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R*\u0010\r\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0015"}, m5311d2 = {"Lkotlin/jvm/internal/ClassReference$Companion;", "", "()V", "FUNCTION_CLASSES", "", "Ljava/lang/Class;", "Lkotlin/Function;", "", "classFqNames", "Ljava/util/HashMap;", "", "Lkotlin/collections/HashMap;", "primitiveFqNames", "primitiveWrapperFqNames", "simpleNames", "getClassQualifiedName", "jClass", "getClassSimpleName", "isInstance", "", "value", "kotlin-stdlib"}, m5312k = 1, m5313mv = {1, 6, 0}, m5315xi = 48)
    ...
    static {
        ...
        for (Object obj : listOf) {
            ...
            arrayList.add(TuplesKt.m5318to((Class) obj, Integer.valueOf(i2)));
            i2 = i3;
        }
        FUNCTION_CLASSES = MapsKt__MapsKt.toMap(arrayList);
        HashMap<String, String> m596R = C1499a.m596R("boolean", "kotlin.Boolean", "char", "kotlin.Char");
        m596R.put("byte", "kotlin.Byte");
        m596R.put("short", "kotlin.Short");
        m596R.put("int", "kotlin.Int");
        m596R.put("float", "kotlin.Float");
        m596R.put("long", "kotlin.Long");
        m596R.put("double", "kotlin.Double");
        primitiveFqNames = m596R;
        HashMap<String, String> m596R2 = C1499a.m596R("java.lang.Boolean", "kotlin.Boolean", "java.lang.Character", "kotlin.Char");
        m596R2.put("java.lang.Byte", "kotlin.Byte");
        m596R2.put("java.lang.Short", "kotlin.Short");
        m596R2.put("java.lang.Integer", "kotlin.Int");
        m596R2.put("java.lang.Float", "kotlin.Float");
        m596R2.put("java.lang.Long", "kotlin.Long");
        m596R2.put("java.lang.Double", "kotlin.Double");
        primitiveWrapperFqNames = m596R2;
        HashMap<String, String> m596R3 = C1499a.m596R("java.lang.Object", "kotlin.Any", "java.lang.String", "kotlin.String");
        m596R3.put("java.lang.CharSequence", "kotlin.CharSequence");
        m596R3.put("java.lang.Throwable", "kotlin.Throwable");
        m596R3.put("java.lang.Cloneable", "kotlin.Cloneable");
        m596R3.put("java.lang.Number", "kotlin.Number");
        m596R3.put("java.lang.Comparable", "kotlin.Comparable");
        m596R3.put("java.lang.Enum", "kotlin.Enum");
        m596R3.put("java.lang.annotation.Annotation", "kotlin.Annotation");
        m596R3.put("java.lang.Iterable", "kotlin.collections.Iterable");
        m596R3.put("java.util.Iterator", "kotlin.collections.Iterator");
        m596R3.put("java.util.Collection", "kotlin.collections.Collection");
        m596R3.put("java.util.List", "kotlin.collections.List");
        m596R3.put("java.util.Set", "kotlin.collections.Set");
        m596R3.put("java.util.ListIterator", "kotlin.collections.ListIterator");
        m596R3.put("java.util.Map", "kotlin.collections.Map");
        m596R3.put("java.util.Map$Entry", "kotlin.collections.Map.Entry");
        m596R3.put("kotlin.jvm.internal.StringCompanionObject", "kotlin.String.Companion");
        m596R3.put("kotlin.jvm.internal.EnumCompanionObject", "kotlin.Enum.Companion");
        m596R3.putAll(m596R);
        m596R3.putAll(m596R2);
        Collection<String> values = m596R.values();
        ...
        for (String kotlinName : values) {
            ...
            Pair m5318to = TuplesKt.m5318to(sb.toString(), kotlinName + ".Companion");
            m596R3.put(m5318to.getFirst(), m5318to.getSecond());
        }
        for (Map.Entry<Class<? extends Function<?>>, Integer> entry : FUNCTION_CLASSES.entrySet()) {
            m596R3.put(entry.getKey().getName(), "kotlin.Function" + entry.getValue().intValue());
        }
        classFqNames = m596R3;
        LinkedHashMap linkedHashMap = new LinkedHashMap(MapsKt__MapsJVMKt.mapCapacity(m596R3.size()));
        for (Map.Entry entry2 : m596R3.entrySet()) {
