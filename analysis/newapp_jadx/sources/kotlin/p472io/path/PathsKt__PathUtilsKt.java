...
public class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static /* synthetic */ Path copyTo$default(Path path, Path target, boolean z, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static /* synthetic */ Path createTempDirectory$default(String str, FileAttribute[] attributes, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = null;
        }
        Intrinsics.checkNotNullParameter(attributes, "attributes");
    ...
    public static /* synthetic */ Path createTempFile$default(String str, String str2, FileAttribute[] attributes, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            str = null;
        }
        if ((i2 & 2) != 0) {
    ...
    public static /* synthetic */ void forEachDirectoryEntry$default(Path path, String glob, Function1 action, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            glob = "*";
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static /* synthetic */ Path moveTo$default(Path path, Path target, boolean z, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            z = false;
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
    ...
    public static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            glob = "*";
        }
        Intrinsics.checkNotNullParameter(path, "<this>");
