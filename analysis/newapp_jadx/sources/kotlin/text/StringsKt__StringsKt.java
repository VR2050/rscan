...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final String commonSuffixWith(@NotNull CharSequence charSequence, @NotNull CharSequence other, boolean z) {
        ...
        int i2 = 0;
        while (i2 < min && CharsKt__CharKt.equals(charSequence.charAt((length - i2) - 1), other.charAt((r1 - i2) - 1), z)) {
            i2++;
        }
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence charSequence, Collection<String> collection, int i2, boolean z, boolean z2) {
        ...
        if (!z && collection.size() == 1) {
            ...
            return TuplesKt.m5318to(Integer.valueOf(indexOf$default), str);
        }
            ...
            if ((step > 0 && first <= last) || (step < 0 && last <= first)) {
                while (true) {
                    ...
                    if (str3 == null) {
                        ...
                        return TuplesKt.m5318to(Integer.valueOf(first), str3);
                    }
                }
            }
        } else {
            ...
            if ((step2 > 0 && first2 <= last2) || (step2 < 0 && last2 <= first2)) {
                while (true) {
                    ...
                    if (str5 == null) {
                        ...
                        return TuplesKt.m5318to(Integer.valueOf(first2), str5);
                    }
                }
            }
        }
    ...
    private static final <C extends CharSequence & R, R> R ifBlank(C c2, Function0<? extends R> defaultValue) {
        ...
        return StringsKt__StringsJVMKt.isBlank(c2) ? defaultValue.invoke() : c2;
    }
    ...
    public static final CharSequence padEnd(@NotNull CharSequence charSequence, int i2, char c2) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        if (i2 < 0) {
            throw new IllegalArgumentException(C1499a.m628n("Desired length ", i2, " is less than zero."));
        }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(CharSequence charSequence, final char[] cArr, int i2, final boolean z, int i3) {
        ...
        return new DelimitedRangesSequence(charSequence, i2, i3, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$1
            ...
            public final Pair<Integer, Integer> invoke(@NotNull CharSequence $receiver, int i4) {
                ...
                return TuplesKt.m5318to(Integer.valueOf(indexOfAny), 1);
            }
        });
    }
    ...
    public static final void requireNonNegativeLimit(int i2) {
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(C1499a.m626l("Limit must be non-negative, but was ", i2).toString());
        }
    }
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull String[] delimiters, boolean z, int i2) {
        ...
        Iterable asIterable = SequencesKt___SequencesKt.asIterable(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, delimiters, 0, z, i2, 2, (Object) null));
    ...
    public static final boolean toBooleanStrict(@NotNull String str) {
        ...
        throw new IllegalArgumentException(C1499a.m637w("The string doesn't represent a boolean value: ", str));
    }
    ...
    public static final CharSequence trim(@NotNull CharSequence charSequence, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        boolean z = false;
        while (i2 <= length) {
            boolean booleanValue = ((Boolean) C1499a.m609c(charSequence, !z ? i2 : length, predicate)).booleanValue();
            if (z) {
                if (!booleanValue) {
                    break;
                }
    ...
    public static final CharSequence trimEnd(@NotNull CharSequence charSequence, @NotNull Function1<? super Character, Boolean> predicate) {
        ...
        while (true) {
            int i2 = length - 1;
            if (!((Boolean) C1499a.m609c(charSequence, length, predicate)).booleanValue()) {
    ...
    public static final CharSequence trimStart(@NotNull CharSequence charSequence, @NotNull Function1<? super Character, Boolean> function1) {
        int m587I = C1499a.m587I(charSequence, "<this>", function1, "predicate");
        for (int i2 = 0; i2 < m587I; i2++) {
            if (!((Boolean) C1499a.m609c(charSequence, i2, function1)).booleanValue()) {
        ...
        return new DelimitedRangesSequence(charSequence, i2, i3, new Function2<CharSequence, Integer, Pair<? extends Integer, ? extends Integer>>() { // from class: kotlin.text.StringsKt__StringsKt$rangesDelimitedBy$2
            ...
            public final Pair<Integer, Integer> invoke(@NotNull CharSequence $receiver, int i4) {
                ...
                if (findAnyOf$StringsKt__StringsKt != null) {
                    return TuplesKt.m5318to(findAnyOf$StringsKt__StringsKt.getFirst(), Integer.valueOf(((String) findAnyOf$StringsKt__StringsKt.getSecond()).length()));
                }
                return null;
            }
        });
    ...
    @NotNull
    public static final String padStart(@NotNull String str, int i2, char c2) {
        Intrinsics.checkNotNullParameter(str, "<this>");
