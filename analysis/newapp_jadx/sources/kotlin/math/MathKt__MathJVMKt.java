...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final double m5330ln(double d2) {
        return Math.log(d2);
    }
    ...
    public static final double truncate(double d2) {
        return (Double.isNaN(d2) || Double.isInfinite(d2)) ? d2 : d2 > ShadowDrawableWrapper.COS_45 ? Math.floor(d2) : Math.ceil(d2);
    }
    ...
    @InlineOnly
    /* renamed from: ln */
    private static final float m5331ln(float f2) {
