...
public abstract class BaseContinuationImpl implements Continuation<Object>, CoroutineStackFrame, Serializable {
    ...
    public final void resumeWith(@NotNull Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                result = Result.m6055constructorimpl(ResultKt.createFailure(th));
            }
            if (invokeSuspend == IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            result = Result.m6055constructorimpl(invokeSuspend);
    ...
    public String toString() {
        StringBuilder m586H = C1499a.m586H("Continuation at ");
        Object stackTraceElement = getStackTraceElement();
        if (stackTraceElement == null) {
            stackTraceElement = getClass().getName();
        }
        m586H.append(stackTraceElement);
