...
public final class RunSuspend implements Continuation<Unit> {
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> m7242getResultxLWZpok = m7242getResultxLWZpok();
                if (m7242getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(m7242getResultxLWZpok.getValue());
                }
            }
        }
    }
    ...
    public final Result<Unit> m7242getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(@NotNull Object result) {
        synchronized (this) {
            this.result = Result.m6054boximpl(result);
            notifyAll();
