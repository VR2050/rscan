...
public final class SequenceBuilderIterator<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMappedMarker {
    ...
    private final Throwable exceptionalState() {
        ...
        StringBuilder m586H = C1499a.m586H("Unexpected state of the iterator: ");
        m586H.append(this.state);
        return new IllegalStateException(m586H.toString());
    }
    ...
    public boolean hasNext() {
        while (true) {
            ...
            continuation.resumeWith(Result.m6055constructorimpl(Unit.INSTANCE));
        }
    }
