...
public abstract class ListenableWorker {
    ...
    public static abstract class Result {
        ...
        public static final class Failure extends Result {
            ...
            public String toString() {
                StringBuilder m586H = C1499a.m586H("Failure {mOutputData=");
        ...
        public static final class Success extends Result {
            ...
            public String toString() {
                StringBuilder m586H = C1499a.m586H("Success {mOutputData=");
                m586H.append(this.mOutputData);
                m586H.append('}');
                return m586H.toString();
            }
    ...
    @NonNull
    public final InterfaceFutureC2413a<Void> setForegroundAsync(@NonNull ForegroundInfo foregroundInfo) {
        this.mRunInForeground = true;
        return this.mWorkerParams.getForegroundUpdater().setForegroundAsync(getApplicationContext(), getId(), foregroundInfo);
    }

    @NonNull
    public final InterfaceFutureC2413a<Void> setProgressAsync(@NonNull Data data) {
    ...
    @NonNull
    @MainThread
    public abstract InterfaceFutureC2413a<Result> startWork();
