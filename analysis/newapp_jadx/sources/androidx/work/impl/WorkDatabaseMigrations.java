...
public class WorkDatabaseMigrations {
    ...
    public static class RescheduleMigration extends Migration {
        ...
        public RescheduleMigration(@NonNull Context context, int i2, int i3) {
            super(i2, i3);
    ...
    static {
        ...
        int i3 = 7;
        MIGRATION_6_7 = new Migration(6, i3) { // from class: androidx.work.impl.WorkDatabaseMigrations.4
            @Override // androidx.room.migration.Migration
            public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        int i4 = 8;
        MIGRATION_7_8 = new Migration(i3, i4) { // from class: androidx.work.impl.WorkDatabaseMigrations.5
            @Override // androidx.room.migration.Migration
            public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) {
                supportSQLiteDatabase.execSQL(WorkDatabaseMigrations.CREATE_INDEX_PERIOD_START_TIME);
            }
        };
        MIGRATION_8_9 = new Migration(i4, 9) { // from class: androidx.work.impl.WorkDatabaseMigrations.6
            @Override // androidx.room.migration.Migration
            public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) {
