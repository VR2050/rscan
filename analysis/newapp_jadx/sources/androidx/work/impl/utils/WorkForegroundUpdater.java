...
public class WorkForegroundUpdater implements ForegroundUpdater {
    ...
    @NonNull
    public InterfaceFutureC2413a<Void> setForegroundAsync(@NonNull final Context context, @NonNull final UUID uuid, @NonNull final ForegroundInfo foregroundInfo) {
