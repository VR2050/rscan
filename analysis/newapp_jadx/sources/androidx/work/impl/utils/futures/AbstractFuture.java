...
public abstract class AbstractFuture<V> implements InterfaceFutureC2413a<V> {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractFuture<V> abstractFuture, InterfaceFutureC2413a<? extends V> interfaceFutureC2413a) {
    ...
    public static Object getFutureValue(InterfaceFutureC2413a<?> interfaceFutureC2413a) {
        if (interfaceFutureC2413a instanceof AbstractFuture) {
            Object obj = ((AbstractFuture) interfaceFutureC2413a).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
    ...
    public final boolean cancel(boolean z) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractFuture, obj, cancellation)) {
                ...
                abstractFuture = (AbstractFuture) interfaceFutureC2413a;
    ...
    public final V get(long j2, TimeUnit timeUnit) {
        ...
        throw new TimeoutException(C1499a.m639y(str, " for ", abstractFuture));
    }
