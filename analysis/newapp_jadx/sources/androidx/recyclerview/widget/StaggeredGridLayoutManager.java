    ...
    */
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        if (iArr == null) {
            ...
            StringBuilder m586H = C1499a.m586H("Provided int[]'s size must be more than or equal to span count. Expected:");
            m586H.append(this.mSpanCount);
            m586H.append(", array size:");
            m586H.append(iArr.length);
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder m586H = C1499a.m586H("FullSpanItem{mPosition=");
                m586H.append(this.mPosition);
                m586H.append(", mGapDir=");
                m586H.append(this.mGapDir);
                m586H.append(", mHasUnwantedGapAfter=");
                m586H.append(this.mHasUnwantedGapAfter);
                m586H.append(", mGapPerSpan=");
                m586H.append(Arrays.toString(this.mGapPerSpan));
                m586H.append('}');
