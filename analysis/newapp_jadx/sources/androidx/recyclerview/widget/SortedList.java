...
public class SortedList<T> {
    ...
    private void addToData(int i2, T t) {
        int i3 = this.mSize;
        if (i2 > i3) {
            StringBuilder m588J = C1499a.m588J("cannot add item to ", i2, " because size is ");
            m588J.append(this.mSize);
    ...
    public T get(int i2) {
        ...
        StringBuilder m588J = C1499a.m588J("Asked to get item at ", i2, " but size is ");
        m588J.append(this.mSize);
        throw new IndexOutOfBoundsException(m588J.toString());
    }
