...
public class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public class C06161 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                ...
                while (next != null) {
                    int i2 = next.what;
                    if (i2 == 1) {
                        C06161.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i2 == 2) {
                        C06161.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i2 == 3) {
                        C06161.this.val$callback.removeTile(next.arg1, next.arg2);
                    }
        ...
        public C06161(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public class C06172 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C06172.this.mQueue.next();
                    if (next == null) {
                        C06172.this.mBackgroundRunning.set(false);
                        return;
                    }
                    int i2 = next.what;
                    if (i2 == 1) {
                        C06172.this.mQueue.removeMessages(1);
                        C06172.this.val$callback.refresh(next.arg1);
                    } else if (i2 == 2) {
                        C06172.this.mQueue.removeMessages(2);
                        C06172.this.mQueue.removeMessages(3);
                        C06172.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                    } else if (i2 == 3) {
                        C06172.this.val$callback.loadTile(next.arg1, next.arg2);
                    } else if (i2 == 4) {
                        C06172.this.val$callback.recycleTile((TileList.Tile) next.data);
                    }
                }
            }
        };

        public C06172(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C06172(backgroundCallback);
    }

    @Override // androidx.recyclerview.widget.ThreadUtil
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C06161(mainThreadCallback);
    }
