...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            ...
            m586H.append(this.mCoordinate);
            m586H.append(", mLayoutFromEnd=");
            m586H.append(this.mLayoutFromEnd);
            m586H.append(", mValid=");
            m586H.append(this.mValid);
            m586H.append('}');
    ...
    public void validateChildOrder() {
        ...
        if (this.mShouldReverseLayout) {
            for (int i2 = 1; i2 < getChildCount(); i2++) {
                ...
                if (position2 < position) {
                    logChildren();
                    StringBuilder m586H = C1499a.m586H("detected invalid position. loc invalid? ");
                    m586H.append(decoratedStart2 < decoratedStart);
        ...
        for (int i3 = 1; i3 < getChildCount(); i3++) {
            ...
            if (position3 < position) {
                logChildren();
                StringBuilder m586H2 = C1499a.m586H("detected invalid position. loc invalid? ");
                m586H2.append(decoratedStart3 < decoratedStart);
