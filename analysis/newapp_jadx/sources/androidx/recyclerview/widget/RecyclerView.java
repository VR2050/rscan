...
import androidx.recyclerview.C0590R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static /* synthetic */ class C06287 {
        ...
        static {
            ...
            try {
                f201x3d106619[Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY.ordinal()] = 2;
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i2, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (indexOfChild == -1) {
                    StringBuilder m586H = C1499a.m586H("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                    m586H.append(this.mRecyclerView.indexOfChild(view));
                    throw new IllegalStateException(C1499a.m621i(this.mRecyclerView, m586H));
                }
                if (indexOfChild != i2) {
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2, int i3) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0590R.styleable.RecyclerView, i2, i3);
            properties.orientation = obtainStyledAttributes.getInt(C0590R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0590R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0590R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0590R.styleable.RecyclerView_stackFromEnd, false);
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(C1499a.m621i(this.mRecyclerView, C1499a.m586H("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i2) {
            ...
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException(C1499a.m621i(RecyclerView.this, C1499a.m586H("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
            }
            ...
            if (findPositionOffset < 0 || findPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                StringBuilder m589K = C1499a.m589K("Inconsistency detected. Invalid item position ", i2, "(offset:", findPositionOffset, ").state:");
                m589K.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(C1499a.m621i(RecyclerView.this, m589K));
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i2) {
            ...
            StringBuilder m588J = C1499a.m588J("invalid position ", i2, ". State item count is ");
            m588J.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(C1499a.m621i(RecyclerView.this, m588J));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i2, boolean z) {
            ...
            throw new IllegalStateException(C1499a.m621i(RecyclerView.this, sb));
        }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                StringBuilder m586H = C1499a.m586H("Scrapped or attached views may not be recycled. isScrap:");
                m586H.append(viewHolder.isScrap());
                m586H.append(" isAttached:");
                m586H.append(viewHolder.itemView.getParent() != null);
                throw new IllegalArgumentException(C1499a.m621i(RecyclerView.this, m586H));
            }
            if (viewHolder.isTmpDetached()) {
                StringBuilder sb = new StringBuilder();
                sb.append("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
                sb.append(viewHolder);
                throw new IllegalArgumentException(C1499a.m621i(RecyclerView.this, sb));
            }
            if (viewHolder.shouldIgnore()) {
                throw new IllegalArgumentException(C1499a.m621i(RecyclerView.this, C1499a.m586H("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(C1499a.m621i(RecyclerView.this, C1499a.m586H("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        ...
        */
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            ...
            if (i2 < 0 || i2 >= RecyclerView.this.mAdapter.getItemCount()) {
                ...
                sb.append(viewHolder);
                throw new IndexOutOfBoundsException(C1499a.m621i(RecyclerView.this, sb));
            }
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i2) {
            ...
            StringBuilder m586H = C1499a.m586H("Layout state should be one of ");
            m586H.append(Integer.toBinaryString(i2));
            m586H.append(" but it is ");
            m586H.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            StringBuilder m586H = C1499a.m586H("State{mTargetPosition=");
            m586H.append(this.mTargetPosition);
            m586H.append(", mData=");
            m586H.append(this.mData);
            m586H.append(", mItemCount=");
            m586H.append(this.mItemCount);
            m586H.append(", mIsMeasuring=");
            m586H.append(this.mIsMeasuring);
            m586H.append(", mPreviousLayoutItemCount=");
            m586H.append(this.mPreviousLayoutItemCount);
            m586H.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            m586H.append(this.mDeletedInvisibleItemCountSincePreviousLayout);
            m586H.append(", mStructureChanged=");
            m586H.append(this.mStructureChanged);
            m586H.append(", mInPreLayout=");
            m586H.append(this.mInPreLayout);
            m586H.append(", mRunSimpleAnimations=");
            m586H.append(this.mRunSimpleAnimations);
            m586H.append(", mRunPredictiveAnimations=");
            m586H.append(this.mRunPredictiveAnimations);
            m586H.append('}');
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder m590L = C1499a.m590L(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            m590L.append(Integer.toHexString(hashCode()));
            m590L.append(" position=");
            m590L.append(this.mPosition);
            m590L.append(" id=");
            m590L.append(this.mItemId);
            m590L.append(", oldPos=");
            m590L.append(this.mOldPosition);
            m590L.append(", pLpos:");
            m590L.append(this.mPreLayoutPosition);
            StringBuilder sb = new StringBuilder(m590L.toString());
            if (isScrap()) {
                sb.append(" scrap ");
            ...
            if (!isRecyclable()) {
                StringBuilder m586H = C1499a.m586H(" not recyclable(");
                m586H.append(this.mIsRecyclableCount);
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j2) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(C1499a.m621i(this, sb));
                }
                ...
                throw new IllegalStateException(C1499a.m621i(this, sb2));
            }
        }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i2) {
        ...
        sb.append(i2);
        throw new IllegalArgumentException(C1499a.m621i(this, sb));
    }
    ...
    */
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(C1499a.m621i(this, C1499a.m586H(str)));
        }
        throw new IllegalStateException(C1499a.m621i(this, C1499a.m586H("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            throw new IllegalStateException(C1499a.m621i(this, C1499a.m586H("Cannot call this method while RecyclerView is computing a layout or scrolling")));
        }
        if (this.mDispatchScrollCounter > 0) {
            new IllegalStateException(C1499a.m621i(this, C1499a.m586H("")));
        }
    }
    ...
    public String exceptionLabel() {
        ...
        m586H.append(super.toString());
        m586H.append(", adapter:");
        m586H.append(this.mAdapter);
        m586H.append(", layout:");
        m586H.append(this.mLayout);
        m586H.append(", context:");
        m586H.append(getContext());
        return m586H.toString();
    }
    ...
    */
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(C1499a.m621i(this, C1499a.m586H("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(C1499a.m621i(this, C1499a.m586H("Trying to set fast scroller without both required drawables.")));
        }
        Resources resources = getContext().getResources();
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0590R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0590R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0590R.dimen.fastscroll_margin));
    }
    ...
    */
    ...
    public void setLayoutManager(@Nullable LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView != null) {
                ...
                throw new IllegalArgumentException(C1499a.m621i(layoutManager.mRecyclerView, sb));
            }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, C0590R.attr.recyclerViewStyle);
    }
    ...
    */
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        int[] iArr = C0590R.styleable.RecyclerView;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i2, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, iArr, attributeSet, obtainStyledAttributes, i2, 0);
        String string = obtainStyledAttributes.getString(C0590R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C0590R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C0590R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = obtainStyledAttributes.getBoolean(C0590R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0590R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0590R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0590R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0590R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        obtainStyledAttributes.recycle();
