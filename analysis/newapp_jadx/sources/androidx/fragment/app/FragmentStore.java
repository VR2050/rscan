        ...
        if (!this.mActive.isEmpty()) {
            ...
            for (FragmentStateManager fragmentStateManager : this.mActive.values()) {
                ...
                if (fragmentStateManager != null) {
                    ...
                    fragment.dump(m637w, fileDescriptor, printWriter, strArr);
                } else {
        ...
        if (list != null) {
            for (String str : list) {
                ...
                if (findActiveFragment == null) {
                    throw new IllegalStateException(C1499a.m639y("No instantiated fragment for (", str, ChineseToPinyinResource.Field.RIGHT_BRACKET));
                }
                if (FragmentManager.isLoggingEnabled(2)) {
