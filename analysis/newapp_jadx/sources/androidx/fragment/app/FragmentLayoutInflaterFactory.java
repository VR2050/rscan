...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0407R.styleable.Fragment);
        if (attributeValue == null) {
            attributeValue = obtainStyledAttributes.getString(C0407R.styleable.Fragment_android_name);
        }
        int resourceId = obtainStyledAttributes.getResourceId(C0407R.styleable.Fragment_android_id, -1);
        String string = obtainStyledAttributes.getString(C0407R.styleable.Fragment_android_tag);
        ...
        if (view2 == null) {
            throw new IllegalStateException(C1499a.m639y("Fragment ", attributeValue, " did not create a view."));
        }
        if (resourceId != 0) {
