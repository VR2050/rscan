...
public abstract class FragmentTransaction {
    ...
    public static final class C0458Op {
        public int mCmd;
        ...
        public C0458Op(int i2, Fragment fragment) {
            this.mCmd = i2;
        ...
        public C0458Op(int i2, @NonNull Fragment fragment, Lifecycle.State state) {
            this.mCmd = i2;
            this.mFragment = fragment;
    ...
    public void addOp(C0458Op c0458Op) {
        this.mOps.add(c0458Op);
        c0458Op.mEnterAnim = this.mEnterAnim;
        c0458Op.mExitAnim = this.mExitAnim;
        c0458Op.mPopEnterAnim = this.mPopEnterAnim;
        c0458Op.mPopExitAnim = this.mPopExitAnim;
    }
        ...
        if (FragmentTransition.supportsTransition()) {
            ...
            if (this.mSharedElementSourceNames == null) {
                ...
                if (this.mSharedElementTargetNames.contains(str)) {
                    throw new IllegalArgumentException(C1499a.m639y("A shared element with the target name '", str, "' has already been added to the transaction."));
                }
                if (this.mSharedElementSourceNames.contains(transitionName)) {
                    throw new IllegalArgumentException(C1499a.m639y("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                }
            }
    ...
    public void doAddOp(int i2, Fragment fragment, @Nullable String str, int i3) {
        ...
        if (cls.isAnonymousClass() || !Modifier.isPublic(modifiers) || (cls.isMemberClass() && !Modifier.isStatic(modifiers))) {
            ...
            m586H.append(" must be a public static class to be  properly recreated from instance state.");
        ...
        if (str != null) {
            ...
            if (str2 != null && !str.equals(str2)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                throw new IllegalStateException(C1499a.m583E(sb, fragment.mTag, " now ", str));
            }
            fragment.mTag = str;
        }
        if (i2 != 0) {
        ...
        addOp(new C0458Op(i3, fragment));
    }

    @NonNull
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        addOp(new C0458Op(4, fragment));
        return this;
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        addOp(new C0458Op(10, fragment, state));
        return this;
    }

    @NonNull
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        addOp(new C0458Op(8, fragment));
        return this;
    }
