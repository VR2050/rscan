...
public class FragmentAnim {
                    ...
                    viewGroup.post(new Runnable() { // from class: androidx.fragment.app.FragmentAnim.2.1
                        ...
                        public void run() {
                            if (fragment.getAnimatingAway() != null) {
                                ...
                                AnimationAnimationListenerC04372 animationAnimationListenerC04372 = AnimationAnimationListenerC04372.this;
    ...
    private static int transitToAnimResourceId(int i2, boolean z) {
        if (i2 == 4097) {
            return z ? C0407R.animator.fragment_open_enter : C0407R.animator.fragment_open_exit;
        }
        if (i2 == 4099) {
            return z ? C0407R.animator.fragment_fade_enter : C0407R.animator.fragment_fade_exit;
        }
        if (i2 != 8194) {
            return -1;
        }
        return z ? C0407R.animator.fragment_close_enter : C0407R.animator.fragment_close_exit;
    }
