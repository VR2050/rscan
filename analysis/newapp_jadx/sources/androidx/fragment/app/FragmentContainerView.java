...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        if (attributeSet != null) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0407R.styleable.FragmentContainerView);
            if (classAttribute == null) {
                classAttribute = obtainStyledAttributes.getString(C0407R.styleable.FragmentContainerView_android_name);
                str = "android:name";
            } else {
                str = "class";
            }
    ...
    public FragmentContainerView(@NonNull Context context, @NonNull AttributeSet attributeSet, @NonNull FragmentManager fragmentManager) {
        ...
        String classAttribute = attributeSet.getClassAttribute();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0407R.styleable.FragmentContainerView);
        classAttribute = classAttribute == null ? obtainStyledAttributes.getString(C0407R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string = obtainStyledAttributes.getString(C0407R.styleable.FragmentContainerView_android_tag);
        obtainStyledAttributes.recycle();
        int id = getId();
        Fragment findFragmentById = fragmentManager.findFragmentById(id);
        if (classAttribute != null && findFragmentById == null) {
            if (id <= 0) {
                throw new IllegalStateException(C1499a.m639y("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? C1499a.m637w(" with tag ", string) : ""));
            }
