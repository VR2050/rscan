...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public String toString() {
            ...
            StringBuilder m586H = C1499a.m586H("textSize=");
            m586H.append(this.mPaint.getTextSize());
            sb.append(m586H.toString());
            sb.append(", textScaleX=" + this.mPaint.getTextScaleX());
            sb.append(", textSkewX=" + this.mPaint.getTextSkewX());
            int i2 = Build.VERSION.SDK_INT;
            StringBuilder m586H2 = C1499a.m586H(", letterSpacing=");
            m586H2.append(this.mPaint.getLetterSpacing());
            sb.append(m586H2.toString());
            sb.append(", elegantTextHeight=" + this.mPaint.isElegantTextHeight());
            if (i2 >= 24) {
                StringBuilder m586H3 = C1499a.m586H(", textLocale=");
                m586H3.append(this.mPaint.getTextLocales());
                sb.append(m586H3.toString());
            } else {
                StringBuilder m586H4 = C1499a.m586H(", textLocale=");
                m586H4.append(this.mPaint.getTextLocale());
                sb.append(m586H4.toString());
            }
            StringBuilder m586H5 = C1499a.m586H(", typeface=");
            m586H5.append(this.mPaint.getTypeface());
            sb.append(m586H5.toString());
            if (i2 >= 26) {
                StringBuilder m586H6 = C1499a.m586H(", variationSettings=");
                m586H6.append(this.mPaint.getFontVariationSettings());
                sb.append(m586H6.toString());
            }
            StringBuilder m586H7 = C1499a.m586H(", textDir=");
            m586H7.append(this.mTextDir);
            sb.append(m586H7.toString());
