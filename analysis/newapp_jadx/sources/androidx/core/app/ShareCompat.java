...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i2) {
            ...
            StringBuilder m586H = C1499a.m586H("Stream items available: ");
            m586H.append(getStreamCount());
            m586H.append(" index requested: ");
            m586H.append(i2);
    ...
    public static void configureMenuItem(@NonNull MenuItem menuItem, @NonNull IntentBuilder intentBuilder) {
        ...
        StringBuilder m586H = C1499a.m586H(HISTORY_FILENAME_PREFIX);
        m586H.append(intentBuilder.getContext().getClass().getName());
        shareActionProvider.setShareHistoryFileName(m586H.toString());
    ...
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i2, @NonNull IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(C1499a.m628n("Could not find menu item with id ", i2, " in the supplied menu"));
    }
}
