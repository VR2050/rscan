...
public final class NavUtils {
    ...
    public static void navigateUpFromSameTask(@NonNull Activity activity) {
        ...
        m586H.append(activity.getClass().getSimpleName());
        m586H.append(" does not have a parent activity name specified. (Did you forget to add the android.support.PARENT_ACTIVITY <meta-data>  element in your manifest?)");
