...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m5728clone() {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int min;
            boolean z2 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0261R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0261R.id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0261R.id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            int i3 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0261R.id.actions, i3);
            applyStandardTemplate.setViewVisibility(C0261R.id.action_divider, i3);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0261R.layout.notification_action_tombstone : C0261R.layout.notification_action);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0261R.id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0261R.color.notification_action_color_filter)));
            }
    ...
    public static abstract class Style {
        ...
        private Bitmap createIconWithBackground(int i2, int i3, int i4, int i5) {
            int i6 = C0261R.drawable.notification_icon_background;
            if (i5 == 0) {
                i5 = 0;
            }
        ...
        */
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            int i2 = C0261R.id.notification_main_column;
    ...
    public static final class WearableExtender implements Extender {
        ...
        @NonNull
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m5729clone() {
            WearableExtender wearableExtender = new WearableExtender();
