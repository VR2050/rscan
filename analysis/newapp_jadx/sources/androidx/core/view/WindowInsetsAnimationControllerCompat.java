...
public final class WindowInsetsAnimationControllerCompat {
    ...
    public static class Impl {
        ...
        public void setInsetsAndAlpha(@Nullable Insets insets, @FloatRange(from = 0.0d, m110to = 1.0d) float f2, @FloatRange(from = 0.0d, m110to = 1.0d) float f3) {
        }
    }
    ...
    public WindowInsetsAnimationControllerCompat() {
        ...
        StringBuilder m586H = C1499a.m586H("On API 30+, the constructor taking a ");
        m586H.append(WindowInsetsAnimationController.class.getSimpleName());
        m586H.append(" as parameter");
