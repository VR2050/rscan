...
public class WindowInsetsCompat {
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m153of(rect)).setSystemWindowInsets(Insets.m153of(rect2)).build();
    ...
    public static class Impl20 extends Impl {
        ...
        public Insets getInsetsForType(int i2, boolean z) {
            ...
            int i3;
            if (i2 == 1) {
                return z ? Insets.m152of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0) : Insets.m152of(0, getSystemWindowInsets().top, 0, 0);
            }
            if (i2 == 2) {
                if (z) {
                    Insets rootStableInsets = getRootStableInsets();
                    Insets stableInsets2 = getStableInsets();
                    return Insets.m152of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m152of(systemWindowInsets.left, 0, systemWindowInsets.right, i4);
            }
            if (i2 != 8) {
                if (i2 == 16) {
                ...
                return displayCutout != null ? Insets.m152of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom()) : Insets.NONE;
            }
            ...
            if (i5 > rootStableInsets2.bottom) {
                return Insets.m152of(0, 0, 0, i5);
            }
            Insets insets = this.mRootViewVisibleInsets;
            return (insets == null || insets.equals(Insets.NONE) || (i3 = this.mRootViewVisibleInsets.bottom) <= rootStableInsets2.bottom) ? Insets.NONE : Insets.m152of(0, 0, 0, i3);
        }
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m152of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    public static final class Type {
        ...
        public static int indexOf(int i2) {
            ...
            throw new IllegalArgumentException(C1499a.m626l("type needs to be >= FIRST and <= LAST, type=", i2));
        }
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i2, int i3, int i4, int i5) {
        ...
        return (max == i2 && max2 == i3 && max3 == i4 && max4 == i5) ? insets : Insets.m152of(max, max2, max3, max4);
    }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i2, int i3, int i4, int i5) {
        return new Builder(this).setSystemWindowInsets(Insets.m152of(i2, i3, i4, i5)).build();
    }
    ...
    public static class Impl21 extends Impl20 {
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m152of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(@NonNull Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m153of(rect)).build();
    }
