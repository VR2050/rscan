...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public static BoundsCompat computeAnimationBounds(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2, int i2) {
            ...
            return new BoundsCompat(Insets.m152of(Math.min(insets.left, insets2.left), Math.min(insets.top, insets2.top), Math.min(insets.right, insets2.right), Math.min(insets.bottom, insets2.bottom)), Insets.m152of(Math.max(insets.left, insets2.left), Math.max(insets.top, insets2.top), Math.max(insets.right, insets2.right), Math.max(insets.bottom, insets2.bottom)));
        }
        ...
        public static void setCallback(@NonNull View view, @Nullable Callback callback) {
            ...
            view.setTag(C0261R.id.tag_window_insets_animation_callback, createProxyListener);
            if (tag == null) {
    ...
    public void setAlpha(@FloatRange(from = 0.0d, m110to = 1.0d) float f2) {
        this.mImpl.setAlpha(f2);
    }

    public void setFraction(@FloatRange(from = 0.0d, m110to = 1.0d) float f2) {
    ...
    public static final class BoundsCompat {
        ...
        public String toString() {
            StringBuilder m586H = C1499a.m586H("Bounds{lower=");
            m586H.append(this.mLowerBound);
            m586H.append(" upper=");
            m586H.append(this.mUpperBound);
            m586H.append("}");
