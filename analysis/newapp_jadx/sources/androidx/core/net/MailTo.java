...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f158CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f159TO = "to";
    ...
    public static MailTo parse(@NonNull String str) {
        ...
        if (to != null) {
            decode = C1499a.m639y(decode, ", ", to);
        }
        mailTo.mHeaders.put(f159TO, decode);
        return mailTo;
    }
    ...
    @Nullable
    public String getCc() {
        return this.mHeaders.get(f158CC);
    }
    ...
    @Nullable
    public String getTo() {
        return this.mHeaders.get(f159TO);
    }
