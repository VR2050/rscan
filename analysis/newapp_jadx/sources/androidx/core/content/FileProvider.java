...
public class FileProvider extends ContentProvider {
    ...
    public static class SimplePathStrategy implements PathStrategy {
        ...
        public void addRoot(String str, File file) {
            ...
            try {
                ...
                throw new IllegalArgumentException(C1499a.m634t("Failed to resolve canonical path for ", file), e2);
            }
        }
        ...
        public File getFileForUri(Uri uri) {
            ...
            if (file == null) {
                throw new IllegalArgumentException(C1499a.m632r("Unable to find configured root for ", uri));
            }
            ...
            try {
                ...
                throw new IllegalArgumentException(C1499a.m634t("Failed to resolve canonical path for ", file2));
            }
        }
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                if (entry == null) {
                    throw new IllegalArgumentException(C1499a.m637w("Failed to find configured root that contains ", canonicalPath));
                }
                ...
                throw new IllegalArgumentException(C1499a.m634t("Failed to resolve canonical path for ", file));
            }
        }
    }
    ...
    private static int modeToMode(String str) {
        ...
        throw new IllegalArgumentException(C1499a.m637w("Invalid mode: ", str));
    }
    ...
    private static PathStrategy parsePathStrategy(Context context, String str) {
        ...
        if (resolveContentProvider == null) {
            throw new IllegalArgumentException(C1499a.m637w("Couldn't find meta-data for provider with authority ", str));
        }
