...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0261R.styleable.FontFamily);
        String string = obtainAttributes.getString(C0261R.styleable.FontFamily_fontProviderAuthority);
        String string2 = obtainAttributes.getString(C0261R.styleable.FontFamily_fontProviderPackage);
        String string3 = obtainAttributes.getString(C0261R.styleable.FontFamily_fontProviderQuery);
        int resourceId = obtainAttributes.getResourceId(C0261R.styleable.FontFamily_fontProviderCerts, 0);
        int integer = obtainAttributes.getInteger(C0261R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int integer2 = obtainAttributes.getInteger(C0261R.styleable.FontFamily_fontProviderFetchTimeout, 500);
        String string4 = obtainAttributes.getString(C0261R.styleable.FontFamily_fontProviderSystemFontFamily);
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) {
        TypedArray obtainAttributes = resources.obtainAttributes(Xml.asAttributeSet(xmlPullParser), C0261R.styleable.FontFamilyFont);
        int i2 = C0261R.styleable.FontFamilyFont_fontWeight;
        if (!obtainAttributes.hasValue(i2)) {
            i2 = C0261R.styleable.FontFamilyFont_android_fontWeight;
        }
        int i3 = obtainAttributes.getInt(i2, NORMAL_WEIGHT);
        int i4 = C0261R.styleable.FontFamilyFont_fontStyle;
        if (!obtainAttributes.hasValue(i4)) {
            i4 = C0261R.styleable.FontFamilyFont_android_fontStyle;
        }
        boolean z = 1 == obtainAttributes.getInt(i4, 0);
        int i5 = C0261R.styleable.FontFamilyFont_ttcIndex;
        if (!obtainAttributes.hasValue(i5)) {
            i5 = C0261R.styleable.FontFamilyFont_android_ttcIndex;
        }
        int i6 = C0261R.styleable.FontFamilyFont_fontVariationSettings;
        if (!obtainAttributes.hasValue(i6)) {
            i6 = C0261R.styleable.FontFamilyFont_android_fontVariationSettings;
        }
        String string = obtainAttributes.getString(i6);
        int i7 = obtainAttributes.getInt(i5, 0);
        int i8 = C0261R.styleable.FontFamilyFont_font;
        if (!obtainAttributes.hasValue(i8)) {
            i8 = C0261R.styleable.FontFamilyFont_android_font;
        }
