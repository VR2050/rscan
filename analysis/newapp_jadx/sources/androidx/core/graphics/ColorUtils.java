...
public final class ColorUtils {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, m110to = 100.0d) double d2, @FloatRange(from = -128.0d, m110to = 127.0d) double d3, @FloatRange(from = -128.0d, m110to = 127.0d) double d4) {
        double[] tempDouble3Array = getTempDouble3Array();
        LABToXYZ(d2, d3, d4, tempDouble3Array);
        return XYZToColor(tempDouble3Array[0], tempDouble3Array[1], tempDouble3Array[2]);
    }

    public static void LABToXYZ(@FloatRange(from = 0.0d, m110to = 100.0d) double d2, @FloatRange(from = -128.0d, m110to = 127.0d) double d3, @FloatRange(from = -128.0d, m110to = 127.0d) double d4, @NonNull double[] dArr) {
    ...
    public static void RGBToHSL(@IntRange(from = 0, m111to = 255) int i2, @IntRange(from = 0, m111to = 255) int i3, @IntRange(from = 0, m111to = 255) int i4, @NonNull float[] fArr) {
        float f2;
        float abs;
        float f3 = i2 / 255.0f;
        float f4 = i3 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, m111to = 255) int i2, @IntRange(from = 0, m111to = 255) int i3, @IntRange(from = 0, m111to = 255) int i4, @NonNull double[] dArr) {
        RGBToXYZ(i2, i3, i4, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, m111to = 255) int i2, @IntRange(from = 0, m111to = 255) int i3, @IntRange(from = 0, m111to = 255) int i4, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, m110to = 95.047d) double d2, @FloatRange(from = 0.0d, m110to = 100.0d) double d3, @FloatRange(from = 0.0d, m110to = 108.883d) double d4) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, m110to = 95.047d) double d2, @FloatRange(from = 0.0d, m110to = 100.0d) double d3, @FloatRange(from = 0.0d, m110to = 108.883d) double d4, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int blendARGB(@ColorInt int i2, @ColorInt int i3, @FloatRange(from = 0.0d, m110to = 1.0d) float f2) {
        float f3 = 1.0f - f2;
        return Color.argb((int) ((Color.alpha(i3) * f2) + (Color.alpha(i2) * f3)), (int) ((Color.red(i3) * f2) + (Color.red(i2) * f3)), (int) ((Color.green(i3) * f2) + (Color.green(i2) * f3)), (int) ((Color.blue(i3) * f2) + (Color.blue(i2) * f3)));
    }

    public static void blendHSL(@NonNull float[] fArr, @NonNull float[] fArr2, @FloatRange(from = 0.0d, m110to = 1.0d) float f2, @NonNull float[] fArr3) {
        if (fArr3.length != 3) {
    ...
    public static void blendLAB(@NonNull double[] dArr, @NonNull double[] dArr2, @FloatRange(from = 0.0d, m110to = 1.0d) double d2, @NonNull double[] dArr3) {
        if (dArr3.length != 3) {
    ...
    public static double calculateContrast(@ColorInt int i2, @ColorInt int i3) {
        if (Color.alpha(i3) != 255) {
            StringBuilder m586H = C1499a.m586H("background can not be translucent: #");
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i2, @IntRange(from = 0, m111to = 255) int i3) {
        if (i3 < 0 || i3 > 255) {
    ...
    public static Color compositeColors(@NonNull Color color, @NonNull Color color2) {
        ...
        StringBuilder m586H = C1499a.m586H("Color models must match (");
        m586H.append(color.getModel());
        m586H.append(" vs. ");
        m586H.append(color2.getModel());
