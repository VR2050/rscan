...
public final class PathKt {
    ...
    @NotNull
    /* renamed from: or */
    public static final Path m154or(@NotNull Path path, @NotNull Path p) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(p, "p");
        Path path2 = new Path(path);
