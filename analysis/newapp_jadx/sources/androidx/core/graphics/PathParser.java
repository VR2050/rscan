...
public class PathParser {
    ...
    public static Path createPathFromPathData(String str) {
        ...
        try {
            ...
            throw new RuntimeException(C1499a.m637w("Error in parsing ", str), e2);
        }
    }
    ...
    */
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException(C1499a.m639y("error in parsing \"", str, "\""), e2);
        }
    }
    ...
    public static class PathDataNode {
        ...
        private static void arcToBezier(Path path, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9, double d10) {
            ...
            while (i2 < ceil) {
                ...
                path.cubicTo((float) ((d22 * sqrt) + d23), (float) ((d21 * sqrt) + d24), (float) (d26 - (sqrt * d28)), (float) (d27 - (sqrt * d29)), (float) d26, (float) d27);
                i2++;
                d19 = d19;
                sin = sin;
                d23 = d26;
