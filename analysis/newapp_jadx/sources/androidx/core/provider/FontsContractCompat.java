...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        @Deprecated
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i2, @IntRange(from = 1, m111to = 1000) int i3, boolean z, int i4) {
        ...
        public static FontInfo create(@NonNull Uri uri, @IntRange(from = 0) int i2, @IntRange(from = 1, m111to = 1000) int i3, boolean z, int i4) {
