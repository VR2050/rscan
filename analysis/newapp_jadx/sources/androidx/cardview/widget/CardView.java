...
public class CardView extends FrameLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0223R.styleable.CardView, i2, C0223R.style.CardView);
        int i3 = C0223R.styleable.CardView_cardBackgroundColor;
        if (obtainStyledAttributes.hasValue(i3)) {
            ...
            if (fArr[2] > 0.5f) {
                color = getResources().getColor(C0223R.color.cardview_light_background);
            } else {
                color = getResources().getColor(C0223R.color.cardview_dark_background);
            }
        ...
        rect.left = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPaddingLeft, dimensionPixelSize);
        rect.top = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPaddingTop, dimensionPixelSize);
        rect.right = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPaddingRight, dimensionPixelSize);
        rect.bottom = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPaddingBottom, dimensionPixelSize);
