    ...
    public static class AndroidViewModelFactory extends NewInstanceFactory {
        ...
        public <T extends ViewModel> T create(@NonNull Class<T> cls) {
            ...
            try {
                ...
                throw new RuntimeException(C1499a.m635u("Cannot create an instance of ", cls), e2);
            } catch (InstantiationException e3) {
                throw new RuntimeException(C1499a.m635u("Cannot create an instance of ", cls), e3);
            } catch (NoSuchMethodException e4) {
                throw new RuntimeException(C1499a.m635u("Cannot create an instance of ", cls), e4);
            } catch (InvocationTargetException e5) {
                throw new RuntimeException(C1499a.m635u("Cannot create an instance of ", cls), e5);
            }
        }
    }
