...
public final class ClassesInfoCache {
    ...
    private void verifyAndPutHandler(Map<MethodReference, Lifecycle.Event> map, MethodReference methodReference, Lifecycle.Event event, Class<?> cls) {
        ...
        StringBuilder m586H = C1499a.m586H("Method ");
        m586H.append(method.getName());
        m586H.append(" in ");
        m586H.append(cls.getName());
        m586H.append(" already declared with different @OnLifecycleEvent value: previous value ");
        m586H.append(event2);
        m586H.append(", new value ");
        m586H.append(event);
