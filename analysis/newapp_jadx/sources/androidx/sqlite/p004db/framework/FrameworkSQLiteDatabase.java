...
public class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public int delete(String str, String str2, Object[] objArr) {
        StringBuilder m590L = C1499a.m590L("DELETE FROM ", str);
        m590L.append(TextUtils.isEmpty(str2) ? "" : C1499a.m637w(" WHERE ", str2));
        SupportSQLiteStatement compileStatement = compileStatement(m590L.toString());
    ...
    public int update(String str, int i2, ContentValues contentValues, String str2, Object[] objArr) {
        ...
        for (String str3 : contentValues.keySet()) {
            sb.append(i3 > 0 ? ChineseToPinyinResource.Field.COMMA : "");
            sb.append(str3);
