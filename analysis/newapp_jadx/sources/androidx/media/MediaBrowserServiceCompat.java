...
public abstract class MediaBrowserServiceCompat extends Service {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int i2, Bundle bundle) {
            ...
            if (bundle == null || bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) == 0) {
                ...
                if (token != null) {
                    ...
                    BundleCompat.putBinder(bundle2, MediaBrowserProtocol.EXTRA_SESSION_BINDER, interfaceC4184b == null ? null : interfaceC4184b.asBinder());
                } else {
                ...
                public void run() {
                    if (!MediaBrowserServiceImplApi21.this.mRootExtrasList.isEmpty()) {
                        ...
                        if (interfaceC4184b != null) {
                            ...
                            while (it.hasNext()) {
                                BundleCompat.putBinder(it.next(), MediaBrowserProtocol.EXTRA_SESSION_BINDER, interfaceC4184b.asBinder());
                            }
                        }
                        MediaBrowserServiceImplApi21.this.mRootExtrasList.clear();
                    }
                    MediaBrowserServiceCompatApi21.setSessionToken(MediaBrowserServiceImplApi21.this.mServiceObj, token.f57c);
                }
            });
        }
    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (this.mDetachCalled) {
                StringBuilder m586H = C1499a.m586H("detach() called when detach() had already been called for: ");
                m586H.append(this.mDebug);
                throw new IllegalStateException(m586H.toString());
            }
            if (this.mSendResultCalled) {
                StringBuilder m586H2 = C1499a.m586H("detach() called when sendResult() had already been called for: ");
                m586H2.append(this.mDebug);
                throw new IllegalStateException(m586H2.toString());
            }
            if (!this.mSendErrorCalled) {
                this.mDetachCalled = true;
            } else {
                StringBuilder m586H3 = C1499a.m586H("detach() called when sendError() had already been called for: ");
                m586H3.append(this.mDebug);
                throw new IllegalStateException(m586H3.toString());
            }
        }
        ...
        public void onErrorSent(Bundle bundle) {
            StringBuilder m586H = C1499a.m586H("It is not supported to send an error for ");
            m586H.append(this.mDebug);
            throw new UnsupportedOperationException(m586H.toString());
        }

        public void onProgressUpdateSent(Bundle bundle) {
            StringBuilder m586H = C1499a.m586H("It is not supported to send an interim update for ");
            m586H.append(this.mDebug);
            throw new UnsupportedOperationException(m586H.toString());
        }
        ...
        public void sendError(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder m586H = C1499a.m586H("sendError() called when either sendResult() or sendError() had already been called for: ");
                m586H.append(this.mDebug);
                throw new IllegalStateException(m586H.toString());
            }
        ...
        public void sendProgressUpdate(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder m586H = C1499a.m586H("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
                m586H.append(this.mDebug);
                throw new IllegalStateException(m586H.toString());
            }
        ...
        public void sendResult(T t) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder m586H = C1499a.m586H("sendResult() called when either sendResult() or sendError() had already been called for: ");
                m586H.append(this.mDebug);
                throw new IllegalStateException(m586H.toString());
            }
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final ResultReceiver resultReceiver, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                ...
                public void run() {
                    ...
                    StringBuilder m586H = C1499a.m586H("sendCustomAction for callback that isn't registered action=");
                    m586H.append(str);
                    m586H.append(", extras=");
                    m586H.append(bundle);
                    m586H.toString();
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 8:
                    ...
                    MediaSessionCompat.m23a(bundle4);
                ...
                case 9:
                    ...
                    MediaSessionCompat.m23a(bundle5);
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result<Bundle> result = new Result<Bundle>(str) { // from class: androidx.media.MediaBrowserServiceCompat.4
            ...
            public void onErrorSent(Bundle bundle2) {
                resultReceiver.m108e(-1, bundle2);
            }
            ...
            public void onResultSent(Bundle bundle2) {
                resultReceiver.m108e(0, bundle2);
            }
        };
        this.mCurConnection = connectionRecord;
    ...
    public void performLoadChildren(final String str, final ConnectionRecord connectionRecord, final Bundle bundle, final Bundle bundle2) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C1499a.m583E(C1499a.m586H("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
        }
    }
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        Result<MediaBrowserCompat.MediaItem> result = new Result<MediaBrowserCompat.MediaItem>(str) { // from class: androidx.media.MediaBrowserServiceCompat.2
            ...
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
                    resultReceiver.m108e(-1, null);
                    return;
                }
                Bundle bundle = new Bundle();
                bundle.putParcelable(MediaBrowserServiceCompat.KEY_MEDIA_ITEM, mediaItem);
                resultReceiver.m108e(0, bundle);
            }
        };
        this.mCurConnection = connectionRecord;
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C1499a.m637w("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(C1499a.m637w("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
