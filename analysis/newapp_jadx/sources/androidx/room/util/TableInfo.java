...
public class TableInfo {
    ...
    public static class Column {
        ...
        public String toString() {
            StringBuilder m586H = C1499a.m586H("Column{name='");
            m586H.append(this.name);
            m586H.append('\'');
            m586H.append(", type='");
            m586H.append(this.type);
            m586H.append('\'');
            m586H.append(", affinity='");
            m586H.append(this.affinity);
            m586H.append('\'');
            m586H.append(", notNull=");
            m586H.append(this.notNull);
            m586H.append(", primaryKeyPosition=");
            m586H.append(this.primaryKeyPosition);
            m586H.append(", defaultValue='");
            m586H.append(this.defaultValue);
            m586H.append('\'');
            m586H.append('}');
    ...
    public static class ForeignKey {
        ...
        public int hashCode() {
            return this.referenceColumnNames.hashCode() + ((this.columnNames.hashCode() + C1499a.m598T(this.onUpdate, C1499a.m598T(this.onDelete, this.referenceTable.hashCode() * 31, 31), 31)) * 31);
        }

        public String toString() {
            StringBuilder m586H = C1499a.m586H("ForeignKey{referenceTable='");
            m586H.append(this.referenceTable);
            m586H.append('\'');
            m586H.append(", onDelete='");
            m586H.append(this.onDelete);
            m586H.append('\'');
            m586H.append(", onUpdate='");
            m586H.append(this.onUpdate);
            m586H.append('\'');
            m586H.append(", columnNames=");
            m586H.append(this.columnNames);
            m586H.append(", referenceColumnNames=");
            m586H.append(this.referenceColumnNames);
            m586H.append('}');
            return m586H.toString();
        }
    }
    ...
    public static class Index {
        ...
        public String toString() {
            StringBuilder m586H = C1499a.m586H("Index{name='");
            m586H.append(this.name);
            m586H.append('\'');
            m586H.append(", unique=");
            m586H.append(this.unique);
    ...
    public String toString() {
        StringBuilder m586H = C1499a.m586H("TableInfo{name='");
        m586H.append(this.name);
        m586H.append('\'');
        m586H.append(", columns=");
        m586H.append(this.columns);
        m586H.append(", foreignKeys=");
        m586H.append(this.foreignKeys);
        m586H.append(", indices=");
        m586H.append(this.indices);
        m586H.append('}');
        return m586H.toString();
    }
