...
public class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i2) {
        ...
        int[] iArr = C0047R.styleable.AppCompatTextView;
        ...
        if (supportsAutoSizeText()) {
            ...
            if (length > 0) {
                ...
                if (!setupAutoSizeUniformPresetSizesConfiguration()) {
                    StringBuilder m586H = C1499a.m586H("None of the preset sizes is valid: ");
                    m586H.append(Arrays.toString(iArr));
    ...
    public void setAutoSizeTextTypeWithDefaults(int i2) {
        if (supportsAutoSizeText()) {
            ...
            if (i2 != 1) {
                throw new IllegalArgumentException(C1499a.m626l("Unknown auto-size text type: ", i2));
            }
            DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
