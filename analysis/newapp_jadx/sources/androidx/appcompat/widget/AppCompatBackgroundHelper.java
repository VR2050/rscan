...
public class AppCompatBackgroundHelper {
    ...
    public void loadFromAttributes(@Nullable AttributeSet attributeSet, int i2) {
        ...
        int[] iArr = C0047R.styleable.ViewBackgroundHelper;
        ...
        try {
            int i3 = C0047R.styleable.ViewBackgroundHelper_android_background;
            ...
            int i4 = C0047R.styleable.ViewBackgroundHelper_backgroundTint;
            if (obtainStyledAttributes.hasValue(i4)) {
                ViewCompat.setBackgroundTintList(this.mView, obtainStyledAttributes.getColorStateList(i4));
            }
            int i5 = C0047R.styleable.ViewBackgroundHelper_backgroundTintMode;
