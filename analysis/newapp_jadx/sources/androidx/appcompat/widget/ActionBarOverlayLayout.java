...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static final int[] ATTRS = {C0047R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    */
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        StringBuilder m586H = C1499a.m586H("Can't make a decor toolbar out of ");
        m586H.append(view.getClass().getSimpleName());
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mActionBarTop.getVisibility() == 0) {
            i2 = (int) (this.mActionBarTop.getTranslationY() + this.mActionBarTop.getBottom() + 0.5f);
        } else {
            i2 = 0;
        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.mOverlayMode || z) {
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m152of(windowInsetsCompat.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom() + 0)).build();
        } else {
