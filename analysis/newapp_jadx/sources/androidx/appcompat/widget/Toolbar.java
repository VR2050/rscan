...
public class Toolbar extends ViewGroup {
    ...
    */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(getPaddingRight() + getPaddingLeft() + max2 + i9, getSuggestedMinimumWidth()), i2, (-16777216) & i8), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(getPaddingBottom() + getPaddingTop() + max3, getSuggestedMinimumHeight()), i3, i8 << 16));
    }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        int[] iArr = C0047R.styleable.Toolbar;
        ...
        int i3 = C0047R.styleable.Toolbar_titleMargins;
