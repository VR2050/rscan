...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    ...
    public void setBaselineAlignedChildIndex(int i2) {
        ...
        StringBuilder m586H = C1499a.m586H("base aligned child index out of range (0, ");
        m586H.append(getChildCount());
    ...
    public LinearLayoutCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        int[] iArr = C0047R.styleable.LinearLayoutCompat;
        ...
        int i3 = obtainStyledAttributes.getInt(C0047R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i3 >= 0) {
            setOrientation(i3);
        }
        int i4 = obtainStyledAttributes.getInt(C0047R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i4 >= 0) {
            setGravity(i4);
        }
