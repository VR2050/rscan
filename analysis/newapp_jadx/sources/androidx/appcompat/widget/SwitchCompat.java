...
public class SwitchCompat extends CompoundButton {
    ...
    */
    ...
    public SwitchCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        int[] iArr = C0047R.styleable.SwitchCompat;
        ...
        this.mTextOn = obtainStyledAttributes.getText(C0047R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = obtainStyledAttributes.getText(C0047R.styleable.SwitchCompat_android_textOff);
