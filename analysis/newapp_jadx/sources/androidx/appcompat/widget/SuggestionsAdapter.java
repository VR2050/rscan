...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public Drawable getDrawableFromResourceUri(Uri uri) {
        ...
        if (TextUtils.isEmpty(authority)) {
            throw new FileNotFoundException(C1499a.m632r("No authority: ", uri));
        }
        try {
            ...
            if (pathSegments == null) {
                throw new FileNotFoundException(C1499a.m632r("No path: ", uri));
            }
            ...
            if (size == 1) {
                try {
                    ...
                    throw new FileNotFoundException(C1499a.m632r("Single path segment is not a resource ID: ", uri));
                }
            } else {
                if (size != 2) {
                    throw new FileNotFoundException(C1499a.m632r("More than two path segments: ", uri));
                }
            ...
            throw new FileNotFoundException(C1499a.m632r("No resource found for: ", uri));
        } catch (PackageManager.NameNotFoundException unused2) {
            throw new FileNotFoundException(C1499a.m632r("No package found for authority: ", uri));
        }
    }
