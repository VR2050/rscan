...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder m586H = C1499a.m586H("SearchView.SavedState{");
            m586H.append(Integer.toHexString(System.identityHashCode(this)));
            m586H.append(" isIconified=");
            m586H.append(this.isIconified);
            m586H.append("}");
    ...
    public void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0047R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0047R.dimen.abc_dropdownitem_icon_width) : 0;
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0047R.styleable.SearchView, i2, 0);
        ...
        int i3 = C0047R.styleable.SearchView_searchIcon;
        ...
        int i4 = obtainStyledAttributes.getInt(C0047R.styleable.SearchView_android_imeOptions, -1);
        if (i4 != -1) {
            setImeOptions(i4);
        }
        int i5 = obtainStyledAttributes.getInt(C0047R.styleable.SearchView_android_inputType, -1);
        if (i5 != -1) {
            setInputType(i5);
        }
