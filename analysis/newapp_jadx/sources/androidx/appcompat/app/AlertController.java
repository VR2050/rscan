...
public class AlertController {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i2, int i3) {
        final View findViewById = this.mWindow.findViewById(C0047R.id.scrollIndicatorUp);
        final View findViewById2 = this.mWindow.findViewById(C0047R.id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0047R.id.custom);
