...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        /* renamed from: P */
        private final AlertController.AlertParams f104P;
        ...
        public AlertDialog create() {
            AlertDialog alertDialog = new AlertDialog(this.f104P.mContext, this.mTheme);
            this.f104P.apply(alertDialog.mAlert);
            alertDialog.setCancelable(this.f104P.mCancelable);
            if (this.f104P.mCancelable) {
                alertDialog.setCanceledOnTouchOutside(true);
            }
            alertDialog.setOnCancelListener(this.f104P.mOnCancelListener);
            alertDialog.setOnDismissListener(this.f104P.mOnDismissListener);
            DialogInterface.OnKeyListener onKeyListener = this.f104P.mOnKeyListener;
        ...
        public Context getContext() {
            return this.f104P.mContext;
        }

        public Builder setAdapter(ListAdapter listAdapter, DialogInterface.OnClickListener onClickListener) {
            AlertController.AlertParams alertParams = this.f104P;
        ...
        public Builder setCustomTitle(@Nullable View view) {
            this.f104P.mCustomTitleView = view;
            return this;
        }

        public Builder setIcon(@DrawableRes int i2) {
            this.f104P.mIconId = i2;
            return this;
        }

        public Builder setIconAttribute(@AttrRes int i2) {
            TypedValue typedValue = new TypedValue();
            this.f104P.mContext.getTheme().resolveAttribute(i2, typedValue, true);
            this.f104P.mIconId = typedValue.resourceId;
            return this;
        }

        @Deprecated
        public Builder setInverseBackgroundForced(boolean z) {
            this.f104P.mForceInverseBackground = z;
            return this;
        }
        ...
        public Builder setItems(@ArrayRes int i2, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f104P.mOnClickListener = onClickListener;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(@ArrayRes int i2, boolean[] zArr, DialogInterface.OnMultiChoiceClickListener onMultiChoiceClickListener) {
            AlertController.AlertParams alertParams = this.f104P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i2);
            AlertController.AlertParams alertParams2 = this.f104P;
        ...
        public Builder setNegativeButton(@StringRes int i2, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f104P.mNegativeButtonListener = onClickListener;
            return this;
        }

        public Builder setNegativeButtonIcon(Drawable drawable) {
            this.f104P.mNegativeButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNeutralButton(@StringRes int i2, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f104P.mNeutralButtonListener = onClickListener;
            return this;
        }

        public Builder setNeutralButtonIcon(Drawable drawable) {
            this.f104P.mNeutralButtonIcon = drawable;
            return this;
        }

        public Builder setOnCancelListener(DialogInterface.OnCancelListener onCancelListener) {
            this.f104P.mOnCancelListener = onCancelListener;
            return this;
        }

        public Builder setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
            this.f104P.mOnDismissListener = onDismissListener;
            return this;
        }

        public Builder setOnItemSelectedListener(AdapterView.OnItemSelectedListener onItemSelectedListener) {
            this.f104P.mOnItemSelectedListener = onItemSelectedListener;
            return this;
        }

        public Builder setOnKeyListener(DialogInterface.OnKeyListener onKeyListener) {
            this.f104P.mOnKeyListener = onKeyListener;
            return this;
        }
        ...
        public Builder setPositiveButton(@StringRes int i2, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f104P.mPositiveButtonListener = onClickListener;
            return this;
        }

        public Builder setPositiveButtonIcon(Drawable drawable) {
            this.f104P.mPositiveButtonIcon = drawable;
            return this;
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public Builder setRecycleOnMeasureEnabled(boolean z) {
            this.f104P.mRecycleOnMeasure = z;
            return this;
        }
        ...
        public Builder(@NonNull Context context, @StyleRes int i2) {
            this.f104P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i2)));
            this.mTheme = i2;
        }

        public Builder setIcon(@Nullable Drawable drawable) {
            this.f104P.mIcon = drawable;
            return this;
        }

        public Builder setMessage(@Nullable CharSequence charSequence) {
            this.f104P.mMessage = charSequence;
            return this;
        }

        public Builder setTitle(@Nullable CharSequence charSequence) {
            this.f104P.mTitle = charSequence;
            return this;
        }
