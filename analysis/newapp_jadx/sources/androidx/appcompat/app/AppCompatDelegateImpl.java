...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class C00601 implements Thread.UncaughtExceptionHandler {
        public final /* synthetic */ Thread.UncaughtExceptionHandler val$defHandler;

        public C00601(Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    public class C00634 implements FitWindowsViewGroup.OnFitSystemWindowsListener {
        public C00634() {
        }
    ...
    private void applyFixedSizeWindow() {
        ...
        int i2 = C0047R.styleable.AppCompatTheme_windowFixedWidthMajor;
        if (obtainStyledAttributes.hasValue(i2)) {
            obtainStyledAttributes.getValue(i2, contentFrameLayout.getFixedWidthMajor());
        }
        int i3 = C0047R.styleable.AppCompatTheme_windowFixedWidthMinor;
        if (obtainStyledAttributes.hasValue(i3)) {
            obtainStyledAttributes.getValue(i3, contentFrameLayout.getFixedWidthMinor());
        }
        int i4 = C0047R.styleable.AppCompatTheme_windowFixedHeightMajor;
        if (obtainStyledAttributes.hasValue(i4)) {
            obtainStyledAttributes.getValue(i4, contentFrameLayout.getFixedHeightMajor());
        }
        int i5 = C0047R.styleable.AppCompatTheme_windowFixedHeightMinor;
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0047R.styleable.AppCompatTheme);
        int i2 = C0047R.styleable.AppCompatTheme_windowActionBar;
        if (!obtainStyledAttributes.hasValue(i2)) {
            obtainStyledAttributes.recycle();
        ...
        if (this.mWindowNoTitle) {
            ...
            viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new androidx.appcompat.view.ContextThemeWrapper(this.mContext, typedValue.resourceId) : this.mContext).inflate(C0047R.layout.abc_screen_toolbar, (ViewGroup) null);
        ...
        if (viewGroup == null) {
            StringBuilder m586H = C1499a.m586H("AppCompat does not support the current theme features: { windowActionBar: ");
            m586H.append(this.mHasActionBar);
            m586H.append(", windowActionBarOverlay: ");
            m586H.append(this.mOverlayActionBar);
            m586H.append(", android:windowIsFloating: ");
            m586H.append(this.mIsFloating);
            m586H.append(", windowActionModeOverlay: ");
            m586H.append(this.mOverlayActionMode);
            m586H.append(", windowNoTitle: ");
            m586H.append(this.mWindowNoTitle);
            m586H.append(" }");
    ...
    private static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            int i21 = configuration.screenLayout & Opcodes.CHECKCAST;
            int i22 = configuration2.screenLayout;
            if (i21 != (i22 & Opcodes.CHECKCAST)) {
                configuration3.screenLayout |= i22 & Opcodes.CHECKCAST;
            }
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((i2 == 0 || i2 == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0047R.attr.actionBarTheme, typedValue, true);
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup == null || panelFeatureState.refreshDecorView) {
                ...
                if (view != null && (layoutParams = view.getLayoutParams()) != null && layoutParams.width == -1) {
                    ...
                    WindowManager.LayoutParams layoutParams3 = new WindowManager.LayoutParams(i2, -2, panelFeatureState.f105x, panelFeatureState.f106y, 1002, 8519680, -3);
            ...
            i2 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(i2, -2, panelFeatureState.f105x, panelFeatureState.f106y, 1002, 8519680, -3);
    ...
    */
    ...
    private void updateStatusGuardColor(View view) {
        view.setBackgroundColor((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0 ? ContextCompat.getColor(this.mContext, C0047R.color.abc_decor_view_status_guard_light) : ContextCompat.getColor(this.mContext, C0047R.color.abc_decor_view_status_guard));
    }
