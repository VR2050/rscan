...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        appendModifier(sb, i2, 65536, resources.getString(C0047R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, i2, 4096, resources.getString(C0047R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, i2, 2, resources.getString(C0047R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, i2, 1, resources.getString(C0047R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, i2, 4, resources.getString(C0047R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, i2, 8, resources.getString(C0047R.string.abc_menu_function_shortcut_label));
        if (shortcut == '\b') {
