    ...
    public void placeFragmentInViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder) {
        ...
        if (fragment.isAdded() && view.getParent() != null) {
            ...
            if (shouldDelayFragmentTransactions()) {
                ...
                StringBuilder m586H = C1499a.m586H("f");
                m586H.append(fragmentViewHolder.getItemId());
                beginTransaction.add(fragment, m586H.toString()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
        ...
        for (String str : bundle.keySet()) {
            if (isValidKey(str, KEY_PREFIX_FRAGMENT)) {
                ...
                if (!isValidKey(str, KEY_PREFIX_STATE)) {
                    throw new IllegalArgumentException(C1499a.m637w("Unexpected key in savedState: ", str));
                }
