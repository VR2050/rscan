        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    throw new RuntimeException(C1499a.m637w("Failed to instantiate ", str), e2);
                }
            } catch (NoSuchMethodException e3) {
                StringBuilder m586H = C1499a.m586H("Class");
                m586H.append(asSubclass.getSimpleName());
                m586H.append(" must have default constructor in order to be automatically recreated");
                throw new IllegalStateException(m586H.toString(), e3);
            }
        } catch (ClassNotFoundException e4) {
            throw new RuntimeException(C1499a.m639y("Class ", str, " wasn't found"), e4);
        }
    }
