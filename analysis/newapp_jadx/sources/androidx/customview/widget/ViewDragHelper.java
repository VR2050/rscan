...
public class ViewDragHelper {
    ...
    private int computeAxisDuration(int i2, int i3, int i4) {
        ...
        float f2 = width / 2;
        float distanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, Math.abs(i2) / width)) * f2) + f2;
        int abs = Math.abs(i3);
    ...
    private int computeSettleDuration(View view, int i2, int i3, int i4, int i5) {
        ...
        return (int) ((computeAxisDuration(i3, clampMag2, this.mCallback.getViewVerticalDragRange(view)) * (f4 / f5)) + (computeAxisDuration(i2, clampMag, this.mCallback.getViewHorizontalDragRange(view)) * f6));
    }
    ...
    public void captureChildView(@NonNull View view, int i2) {
        if (view.getParent() != this.mParentView) {
            StringBuilder m586H = C1499a.m586H("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
            m586H.append(this.mParentView);
    ...
    */
    ...
    public static ViewDragHelper create(@NonNull ViewGroup viewGroup, float f2, @NonNull Callback callback) {
        ...
        create.mTouchSlop = (int) ((1.0f / f2) * create.mTouchSlop);
        return create;
    }
