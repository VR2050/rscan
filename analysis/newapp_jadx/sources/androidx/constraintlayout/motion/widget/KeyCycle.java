...
public class KeyCycle extends Key {
    ...
    public void addValues(HashMap<String, SplineSet> hashMap) {
        SplineSet splineSet;
        StringBuilder m586H = C1499a.m586H("add ");
        m586H.append(hashMap.size());
        m586H.append(" values");
        Debug.logStack("KeyCycle", m586H.toString(), 2);
        for (String str : hashMap.keySet()) {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0257R.styleable.KeyCycle));
    }
