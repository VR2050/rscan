...
public class MotionScene {
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0257R.styleable.MotionScene);
    ...
    public ConstraintSet getConstraintSet(Context context, String str) {
        if (this.DEBUG_DESKTOP) {
            ...
            m586H.append(this.mConstraintSetMap.size());
    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public TransitionOnClick(Context context, Transition transition, XmlPullParser xmlPullParser) {
                ...
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0257R.styleable.OnClick);
                int indexCount = obtainStyledAttributes.getIndexCount();
                for (int i2 = 0; i2 < indexCount; i2++) {
                    int index = obtainStyledAttributes.getIndex(i2);
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0257R.styleable.Transition);
        ...
        public String debugString(Context context) {
            ...
            if (this.mConstraintSetEnd == -1) {
                return C1499a.m637w(resourceEntryName, " -> null");
            }
            StringBuilder m590L = C1499a.m590L(resourceEntryName, " -> ");
            m590L.append(context.getResources().getResourceEntryName(this.mConstraintSetEnd));
