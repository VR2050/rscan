...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        ...
        zArr[1] = zArr[1] | diff(this.f134x, motionPaths.f134x) | z;
        zArr[2] = z | diff(this.f135y, motionPaths.f135y) | zArr[2];
        zArr[3] = zArr[3] | diff(this.width, motionPaths.width);
        zArr[4] = diff(this.height, motionPaths.height) | zArr[4];
    }

    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f134x, this.f135y, this.width, this.height, this.mPathRotate};
        int i2 = 0;
    ...
    public void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f11 = motionPaths.f134x;
        float f12 = motionPaths.f135y;
        float f13 = ((f5 / 2.0f) + motionPaths2.f134x) - ((f6 / 2.0f) + f11);
        float f14 = ((f8 / 2.0f) + motionPaths2.f135y) - ((f9 / 2.0f) + f12);
        float f15 = (f7 * f3) / 2.0f;
        this.f134x = (int) (((f13 * f2) + f11) - f15);
        float f16 = (f14 * f2) + f12;
        float f17 = (f10 * f4) / 2.0f;
        this.f135y = (int) (f16 - f17);
        ...
        this.mMode = 2;
        this.f134x = (int) (((f20 * f14) + ((f18 * f13) + motionPaths.f134x)) - f15);
        this.f135y = (int) (((f14 * f2) + ((f13 * f19) + motionPaths.f135y)) - f17);
    ...
    public void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f7 = motionPaths.f134x;
        float f8 = motionPaths.width;
        float f9 = motionPaths.f135y;
        float f10 = motionPaths.height;
        float f11 = ((motionPaths2.width / 2.0f) + motionPaths2.f134x) - ((f8 / 2.0f) + f7);
        float f12 = ((motionPaths2.height / 2.0f) + motionPaths2.f135y) - ((f10 / 2.0f) + f9);
        float f13 = f11 * f2;
        float f14 = (f5 * f3) / 2.0f;
        this.f134x = (int) ((f7 + f13) - f14);
        float f15 = f2 * f12;
        float f16 = (f6 * f4) / 2.0f;
        this.f135y = (int) ((f9 + f15) - f16);
        this.width = (int) (f8 + r7);
        this.height = (int) (f10 + r8);
        float f17 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f18 = (int) ((motionPaths.f134x + f13) - f14);
        this.f134x = f18;
        float f19 = (int) ((motionPaths.f135y + f15) - f16);
        this.f135y = f19;
        this.f134x = f18 + ((-f12) * f17);
        this.f135y = f19 + (f11 * f17);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    public void initScreen(int i2, int i3, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.position = this.time;
        float f9 = motionPaths.f134x;
        float f10 = motionPaths.f135y;
        float f11 = (f5 / 2.0f) + motionPaths2.f134x;
        float f12 = (f7 / 2.0f) + motionPaths2.f135y;
        float f13 = f6 * f3;
        this.f134x = (int) ((((f11 - ((r8 / 2.0f) + f9)) * f2) + f9) - (f13 / 2.0f));
        float f14 = f8 * f4;
        this.f135y = (int) ((((f12 - ((r11 / 2.0f) + f10)) * f2) + f10) - (f14 / 2.0f));
        this.width = (int) (r8 + f13);
        this.height = (int) (r11 + f14);
        this.mMode = 3;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f134x = (int) (keyPosition.mPercentX * ((int) (i2 - this.width)));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f135y = (int) (keyPosition.mPercentY * ((int) (i3 - this.height)));
        }
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    public void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        while (true) {
            ...
            if (isNaN && (dArr3 == null || dArr3[i4] == ShadowDrawableWrapper.COS_45)) {
                f2 = f3;
            } else {
                if (dArr3 != null) {
                    d2 = dArr3[i4];
