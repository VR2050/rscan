...
public class PriorityGoalRow extends ArrayRow {
    ...
    public class GoalVariableAccessor implements Comparable {
        ...
        public int compareTo(Object obj) {
            return this.variable.f136id - ((SolverVariable) obj).f136id;
        }
        ...
        public String toString() {
            ...
            if (this.variable != null) {
                for (int i2 = 0; i2 < 9; i2++) {
                    ...
                    m586H.append(this.variable.goalStrengthVector[i2]);
                    m586H.append(" ");
                    str = m586H.toString();
                }
            }
            StringBuilder m590L = C1499a.m590L(str, "] ");
            m590L.append(this.variable);
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        int i5 = i4 + 1;
        this.numGoals = i5;
        if (i5 > 1 && solverVariableArr3[i5 - 1].f136id > solverVariable.f136id) {
            int i6 = 0;
            while (true) {
                i2 = this.numGoals;
                if (i6 >= i2) {
            ...
            Arrays.sort(this.sortArray, 0, i2, new Comparator<SolverVariable>() { // from class: androidx.constraintlayout.solver.PriorityGoalRow.1
                ...
                public int compare(SolverVariable solverVariable2, SolverVariable solverVariable3) {
                    return solverVariable2.f136id - solverVariable3.f136id;
                }
            });
    ...
    public String toString() {
        StringBuilder m590L = C1499a.m590L("", " goal -> (");
        m590L.append(this.constantValue);
        m590L.append(") : ");
