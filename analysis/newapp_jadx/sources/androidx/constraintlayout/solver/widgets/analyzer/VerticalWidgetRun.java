...
public class VerticalWidgetRun extends WidgetRun {
    ...
    public static /* synthetic */ class C02491 {
        ...
        static {
            ...
            try {
                f148xbf6f0c8e[WidgetRun.RunType.END.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f148xbf6f0c8e[WidgetRun.RunType.CENTER.ordinal()] = 3;
    ...
    public String toString() {
        StringBuilder m586H = C1499a.m586H("VerticalRun ");
        m586H.append(this.widget.getDebugName());
            ...
            if (i3 == 2) {
                ...
                if (dimensionRatioSide != -1) {
                    if (dimensionRatioSide == 0) {
                        i2 = (int) ((this.widget.getDimensionRatio() * r7.horizontalRun.dimension.value) + 0.5f);
