...
public class LinearSystem {
    ...
    private SolverVariable createVariable(String str, SolverVariable.Type type) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f136id = i2;
    ...
    private void displayRows() {
        ...
        for (int i2 = 0; i2 < this.mNumRows; i2++) {
            ...
            m586H.append(this.mRows[i2]);
            str = C1499a.m637w(m586H.toString(), "\n");
        }
        StringBuilder m586H2 = C1499a.m586H(str);
        m586H2.append(this.mGoal);
        m586H2.append("\n");
        System.out.println(m586H2.toString());
    }

    private void displaySolverVariables() {
        StringBuilder m586H = C1499a.m586H("Display Rows (");
        m586H.append(this.mNumRows);
        m586H.append("x");
        System.out.println(C1499a.m580B(m586H, this.mNumColumns, ")\n"));
    }
    ...
    private String getDisplaySize(int i2) {
        ...
        int i4 = i3 / 1024;
        int i5 = i4 / 1024;
        return i5 > 0 ? C1499a.m628n("", i5, " Mb") : i4 > 0 ? C1499a.m628n("", i4, " Kb") : C1499a.m628n("", i3, " bytes");
    }
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f136id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                boolean[] zArr = this.mAlreadyTestedCandidates;
                int i4 = pivotCandidate.f136id;
                if (zArr[i4]) {
                    return i3;
                }
                zArr[i4] = true;
    ...
    */
    ...
    public SolverVariable createErrorVariable(int i2, String str) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f136id = i3;
    ...
    public void displayReadableRows() {
        displaySolverVariables();
        String m580B = C1499a.m580B(C1499a.m586H(" num vars "), this.mVariablesID, "\n");
        for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
            SolverVariable solverVariable = this.mCache.mIndexedVariables[i2];
            if (solverVariable != null && solverVariable.isFinalValue) {
                m580B = m580B + " $[" + i2 + "] => " + solverVariable + " = " + solverVariable.computedValue + "\n";
            }
        }
        String m637w = C1499a.m637w(m580B, "\n");
        for (int i3 = 0; i3 < this.mVariablesID + 1; i3++) {
            ...
            if (solverVariable2 != null && solverVariable2.isSynonym) {
                m637w = m637w + " ~[" + i3 + "] => " + solverVariable2 + " = " + solverVariableArr[solverVariable2.synonym] + " + " + solverVariable2.synonymDelta + "\n";
            }
        }
        String m637w2 = C1499a.m637w(m637w, "\n\n #  ");
        for (int i4 = 0; i4 < this.mNumRows; i4++) {
            StringBuilder m586H = C1499a.m586H(m637w2);
            m586H.append(this.mRows[i4].toReadableString());
            m637w2 = C1499a.m637w(m586H.toString(), "\n #  ");
        }
        if (this.mGoal != null) {
            StringBuilder m590L = C1499a.m590L(m637w2, "Goal: ");
            m590L.append(this.mGoal);
            m590L.append("\n");
            m637w2 = m590L.toString();
        }
        System.out.println(m637w2);
    }
    ...
    public void displaySystemInformations() {
        ...
        for (int i5 = 0; i5 < this.mNumRows; i5++) {
            ...
            if (arrayRowArr2[i5] != null) {
                i4 = arrayRowArr2[i5].sizeInBytes() + i4;
            }
        }
        PrintStream printStream = System.out;
        StringBuilder m586H = C1499a.m586H("Linear System -> Table size: ");
        m586H.append(this.TABLE_SIZE);
        m586H.append(" (");
        int i6 = this.TABLE_SIZE;
        m586H.append(getDisplaySize(i6 * i6));
        m586H.append(") -- row sizes: ");
        m586H.append(getDisplaySize(i2));
        m586H.append(", actual size: ");
        m586H.append(getDisplaySize(i4));
        m586H.append(" rows: ");
        m586H.append(this.mNumRows);
        m586H.append("/");
        m586H.append(this.mMaxRows);
        m586H.append(" cols: ");
        m586H.append(this.mNumColumns);
        m586H.append("/");
        m586H.append(this.mMaxColumns);
        m586H.append(" ");
        m586H.append(0);
        m586H.append(" occupied cells, ");
        m586H.append(getDisplaySize(0));
        printStream.println(m586H.toString());
    }
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i2 = 0; i2 < this.mNumRows; i2++) {
            if (this.mRows[i2].variable.mType == SolverVariable.Type.UNRESTRICTED) {
                StringBuilder m586H = C1499a.m586H(str);
                m586H.append(this.mRows[i2].toReadableString());
                str = C1499a.m637w(m586H.toString(), "\n");
            }
        }
        StringBuilder m586H2 = C1499a.m586H(str);
    ...
    public void addEquality(SolverVariable solverVariable, int i2) {
        if (USE_BASIC_SYNONYMS && solverVariable.definitionId == -1) {
            ...
            for (int i3 = 0; i3 < this.mVariablesID + 1; i3++) {
                ...
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f136id) {
