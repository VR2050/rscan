...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f2, boolean z) {
        ...
        if (f2 <= (-f3) || f2 >= f3) {
            ...
            if (i2 == -1) {
                ...
                this.mArrayIndices[0] = solverVariable.f136id;
            ...
            this.mArrayIndices[i8] = solverVariable.f136id;
    ...
    public boolean contains(SolverVariable solverVariable) {
        ...
        for (int i3 = 0; i2 != -1 && i3 < this.currentSize; i3++) {
            if (this.mArrayIndices[i2] == solverVariable.f136id) {
                return true;
            }
            i2 = this.mArrayNextIndices[i2];
        }
    ...
    public String toString() {
        ...
        String str = "";
        for (int i3 = 0; i2 != -1 && i3 < this.currentSize; i3++) {
            StringBuilder m586H = C1499a.m586H(C1499a.m637w(str, " -> "));
            m586H.append(this.mArrayValues[i2]);
            m586H.append(" : ");
            StringBuilder m586H2 = C1499a.m586H(m586H.toString());
            m586H2.append(this.mCache.mIndexedVariables[this.mArrayIndices[i2]]);
            str = m586H2.toString();
            i2 = this.mArrayNextIndices[i2];
        }
        return str;
