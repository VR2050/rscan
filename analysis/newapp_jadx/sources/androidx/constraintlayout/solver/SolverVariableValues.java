...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    private void addToHashMap(SolverVariable solverVariable, int i2) {
        int[] iArr;
        int i3 = solverVariable.f136id % this.HASH_SIZE;
        int[] iArr2 = this.keys;
        int i4 = iArr2[i3];
        if (i4 == -1) {
            iArr2[i3] = i2;
    ...
    private void addVariable(int i2, SolverVariable solverVariable, float f2) {
        this.variables[i2] = solverVariable.f136id;
        this.values[i2] = f2;
        this.previous[i2] = -1;
        this.next[i2] = -1;
        ...
        for (int i2 = 0; i2 < this.HASH_SIZE; i2++) {
            if (this.keys[i2] != -1) {
                ...
                while (!z) {
                    ...
                    m590L.append(this.variables[i3]);
                    str = m590L.toString();
    ...
    public String toString() {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (variable != null) {
                ...
                String m637w3 = C1499a.m637w(str2, "[p: ");
                if (this.previous[indexOf] != -1) {
                    StringBuilder m586H = C1499a.m586H(m637w3);
                    m586H.append(this.mCache.mIndexedVariables[this.variables[this.previous[indexOf]]]);
                    m637w = m586H.toString();
                } else {
                    m637w = C1499a.m637w(m637w3, "none");
                }
                String m637w4 = C1499a.m637w(m637w, ", n: ");
                if (this.next[indexOf] != -1) {
                    StringBuilder m586H2 = C1499a.m586H(m637w4);
                    m586H2.append(this.mCache.mIndexedVariables[this.variables[this.next[indexOf]]]);
                    m637w2 = m586H2.toString();
                } else {
                    m637w2 = C1499a.m637w(m637w4, "none");
                }
                str = C1499a.m637w(m637w2, "]");
            }
        }
        return C1499a.m637w(str, " }");
    }
