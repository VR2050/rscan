        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(C1499a.m582D(C1499a.m586H("Left to "), sideToString(i4), " undefined"));
                    }
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(C1499a.m582D(C1499a.m586H("right to "), sideToString(i4), " undefined"));
                    }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(C1499a.m582D(sb, sideToString(i4), " unknown"));
        }
    }
