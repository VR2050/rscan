...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private void offsetChildByInset(View view, Rect rect, int i2) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                ...
                StringBuilder m586H = C1499a.m586H("Rect should be within the child's bounds. Rect:");
                m586H.append(acquireTempRect.toShortString());
                m586H.append(" | Bounds:");
                m586H.append(acquireTempRect2.toShortString());
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(C1499a.m637w("Could not inflate Behavior subclass ", str), e2);
        }
    }
    ...
    */
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i2) {
        ...
        if (i2 == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0258R.styleable.CoordinatorLayout, 0, C0258R.style.Widget_Support_CoordinatorLayout);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0258R.styleable.CoordinatorLayout, i2, 0);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            if (i2 == 0) {
                saveAttributeDataForStyleable(context, C0258R.styleable.CoordinatorLayout, attributeSet, obtainStyledAttributes, 0, C0258R.style.Widget_Support_CoordinatorLayout);
            } else {
                saveAttributeDataForStyleable(context, C0258R.styleable.CoordinatorLayout, attributeSet, obtainStyledAttributes, i2, 0);
            }
        }
        int resourceId = obtainStyledAttributes.getResourceId(C0258R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = obtainStyledAttributes.getDrawable(C0258R.styleable.CoordinatorLayout_statusBarBackground);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (findViewById == null) {
                if (coordinatorLayout.isInEditMode()) {
                    ...
                    StringBuilder m586H = C1499a.m586H("Could not find CoordinatorLayout descendant view with id ");
                    m586H.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
                    m586H.append(" to anchor view ");
                    m586H.append(view);
        ...
        public LayoutParams(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            this.dodgeInsetEdges = 0;
            this.mLastChildRect = new Rect();
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0258R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0258R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0258R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0258R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0258R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0258R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0258R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            int i2 = C0258R.styleable.CoordinatorLayout_Layout_layout_behavior;
