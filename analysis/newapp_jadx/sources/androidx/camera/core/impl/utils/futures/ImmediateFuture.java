...
public abstract class ImmediateFuture<V> implements InterfaceFutureC2413a<V> {
    ...
    public static <V> InterfaceFutureC2413a<V> nullFuture() {
    ...
    public void addListener(@NonNull Runnable runnable, @NonNull Executor executor) {
        ...
        try {
            ...
            Logger.m126e(TAG, "Experienced RuntimeException while attempting to notify " + runnable + " on Executor " + executor, e2);
        }
    }
