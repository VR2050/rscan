...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo5731clone = transition.mo5731clone();
        mo5731clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo5731clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo5731clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo5731clone);
    }
    ...
    /* renamed from: go */
    public static void m171go(@NonNull Scene scene) {
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition mo5731clone = transition.mo5731clone();
        sceneChangeSetup(viewGroup, mo5731clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo5731clone);
    }

    /* renamed from: go */
    public static void m172go(@NonNull Scene scene, @Nullable Transition transition) {
