...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i2) {
        if (i2 == 0) {
            ...
            if (i2 != 1) {
                throw new AndroidRuntimeException(C1499a.m626l("Invalid parameter for TransitionSet ordering: ", i2));
            }
    ...
    public String toString(String str) {
        ...
        for (int i2 = 0; i2 < this.mTransitions.size(); i2++) {
            StringBuilder m590L = C1499a.m590L(transition, "\n");
            m590L.append(this.mTransitions.get(i2).toString(str + "  "));
            transition = m590L.toString();
        }
        return transition;
    }
    ...
    public Transition mo5731clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo5731clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i2 = 0; i2 < size; i2++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i2).mo5731clone());
        }
