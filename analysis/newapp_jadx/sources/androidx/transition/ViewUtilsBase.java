...
public class ViewUtilsBase {
    ...
    public void clearNonTransitionAlpha(@NonNull View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C0702R.id.save_non_transition_alpha, null);
        }
    }

    public float getTransitionAlpha(@NonNull View view) {
        Float f2 = (Float) view.getTag(C0702R.id.save_non_transition_alpha);
        return f2 != null ? view.getAlpha() / f2.floatValue() : view.getAlpha();
    }

    public void saveNonTransitionAlpha(@NonNull View view) {
        int i2 = C0702R.id.save_non_transition_alpha;
    ...
    public void setTransitionAlpha(@NonNull View view, float f2) {
        Float f3 = (Float) view.getTag(C0702R.id.save_non_transition_alpha);
        if (f3 != null) {
