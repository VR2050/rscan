...
public abstract class VersionedParcel {
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(C1499a.m639y("VersionedParcelable encountered IOException reading a Serializable object (name = ", readString, ChineseToPinyinResource.Field.RIGHT_BRACKET), e2);
        } catch (ClassNotFoundException e3) {
            throw new RuntimeException(C1499a.m639y("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", readString, ChineseToPinyinResource.Field.RIGHT_BRACKET), e3);
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(C1499a.m639y("VersionedParcelable encountered IOException writing serializable object (name = ", name, ChineseToPinyinResource.Field.RIGHT_BRACKET), e2);
        }
    }
